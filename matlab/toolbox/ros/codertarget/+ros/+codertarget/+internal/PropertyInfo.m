...
%   Copyright 2020-2023 The MathWorks, Inc.
    ...
    methods (Static)
        ...
        function out = setgetPackageMaintainerName(~,data)
            ...
            % Set operation
            if nargin > 1
                data = i_validateCharArray(data,'PackageMaintainerName');
        ...
        function out = setgetPackageMaintainerEmail(~,data)
            ...
            % Set operation
            if nargin > 1
                data = i_validateCharArray(data,'PackageMaintainerEmail');
        ...
        function out = setgetPackageLicense(~,data)
            ...
            % Set operation
            if nargin > 1
                data = i_validateCharArray(data,'PackageLicense');
        ...
        function out = setgetPackageVersion(~,data)
            ...
            % Set operation
            if nargin > 1
                data = i_validateCharArray(data,'PackageVersion');
        ...
        function out = setgetROS2Folder(~,data)
            ...
            % Set operation
            if nargin > 1
                data = i_validateCharArray(data,'ROS2Folder');
        ...
        function out = setgetROSFolder(~,data)
            ...
            % Set operation
            if nargin > 1
                data = i_validateCharArray(data,'ROSFolder');
        ...
        function out = setgetROS2Workspace(~,data)
            ...
            % Set operation
            if nargin > 1
                data = i_validateCharArray(data,'ROS2Workspace');
        ...
        function out = setgetCatkinWorkspace(~,data)
            ...
            % Set operation
            if nargin > 1
                data = i_validateCharArray(data,'CatkinWorkspace');
        ...
        function out = setgetRemoteDeviceAddress(~,data)
            ...
            % Set operation
            if nargin > 1
                data = i_validateCharArray(data,'RemoteDeviceAddress');
        ...
        function out = setgetRemoteDeviceUsername(~,data)
            ...
            % Set operation
            if nargin > 1
                data = i_validateCharArray(data,'RemoteDeviceUsername');
        ...
        function out = setgetRemoteDevicePassword(~,data)
            ...
            % Set operation
            if nargin > 1
                data = i_validateCharArray(data,'RemoteDevicePassword');
...
function data = i_validateCharArray(data,varName)
