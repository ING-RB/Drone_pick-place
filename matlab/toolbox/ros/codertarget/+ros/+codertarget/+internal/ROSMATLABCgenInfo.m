...
%   Copyright 2020-2022 The MathWorks, Inc.
    ...
    properties (SetAccess = private)
        ...
        % Parameters declared during node creation
        NodeParameters = struct('Key','','Value','')
    end
    ...
    methods
        ...
        % information.
            ...
            obj.NodeList = {};
            obj.NodeParameters = struct('Key','','Value','');
        end
        ...
        function addNodeParameter(obj, parameterStruct)
            obj.NodeParameters = parameterStruct;
        end
