...
#include "slros_busmsg_conversion.cpp"          // For ConvertFromBus, ConvertToBus functions
 ...
 * @retval True if the goal handle is available, otherwise false
 */
template <class ActType>
