...
%   Copyright 2019-2024 The MathWorks, Inc.
    ...
    properties (Nontunable)
        ...
        % From R2025a the depth queue is utilised correctly. So it is
        % changed from 1 to 10 which is the default provided by ROS2
        QOSDepth = 10;
    ...
    properties(Constant,Access=protected)
        ...
        HeaderFile = 'slros2_generic_pubsub.h'
    end
