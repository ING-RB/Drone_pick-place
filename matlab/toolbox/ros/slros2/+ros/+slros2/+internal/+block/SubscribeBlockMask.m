classdef SubscribeBlockMask < ros.slros.internal.block.SubscribeBlockMask
...
%   Copyright 2019-2024 The MathWorks, Inc.
    ...
    methods
        ...
        function maskInitialize(~, block)
            ...
            ros.internal.setBlockIcon(blkH, 'rosicons.ros2lib_subscribe');
            
            if ~ros.slros.internal.block.CommonMask.isLibraryBlock(block)
                % Load message bus into model during mask initialization
                rosMsgType = get_param(block, 'messageType');
                ros.slros2.internal.bus.Util.createBusIfNeeded(rosMsgType, bdroot(block));
            end
        end        
    ...
    methods(Static)
        ...
        function dispatch(methodName, varargin)
            obj = ros.slros2.internal.block.SubscribeBlockMask();
