...
%UInt16MultiArray gives an empty data for std_msgs/UInt16MultiArray

% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'std_msgs/UInt16MultiArray';
...
info.MessageType = 'std_msgs/UInt16MultiArray';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
