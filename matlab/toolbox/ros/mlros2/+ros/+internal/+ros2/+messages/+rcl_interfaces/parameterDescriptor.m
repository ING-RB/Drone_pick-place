...
[data.dynamic_typing, info.dynamic_typing] = ros.internal.ros2.messages.ros2.default_type('logical',1,0, NaN, [0]);
...
info.MatPath{6} = 'dynamic_typing';
info.MatPath{7} = 'floating_point_range';
info.MatPath{8} = 'floating_point_range.from_value';
info.MatPath{9} = 'floating_point_range.to_value';
info.MatPath{10} = 'floating_point_range.step';
info.MatPath{11} = 'integer_range';
info.MatPath{12} = 'integer_range.from_value';
info.MatPath{13} = 'integer_range.to_value';
info.MatPath{14} = 'integer_range.step';
