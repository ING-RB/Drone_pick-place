function [data, info] = int32MultiArray
%Int32MultiArray gives an empty data for std_msgs/Int32MultiArray

% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'std_msgs/Int32MultiArray';
[data.layout, info.layout] = ros.internal.ros2.messages.std_msgs.multiArrayLayout;
info.layout.MLdataType = 'struct';
[data.data, info.data] = ros.internal.ros2.messages.ros2.default_type('int32',NaN,0);
info.MessageType = 'std_msgs/Int32MultiArray';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
