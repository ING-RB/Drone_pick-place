function [data, info] = int8MultiArray
%Int8MultiArray gives an empty data for std_msgs/Int8MultiArray

% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'std_msgs/Int8MultiArray';
...
info.MessageType = 'std_msgs/Int8MultiArray';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
