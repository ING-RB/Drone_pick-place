function [data, info] = setLoggerLevelsRequest
%SetLoggerLevels gives an empty data for rcl_interfaces/SetLoggerLevelsRequest

% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'rcl_interfaces/SetLoggerLevelsRequest';
...
info.MessageType = 'rcl_interfaces/SetLoggerLevelsRequest';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
