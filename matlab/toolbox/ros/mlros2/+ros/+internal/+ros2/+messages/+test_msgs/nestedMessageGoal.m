function [data, info] = nestedMessageGoal
%NestedMessageGoal gives an empty data for test_msgs/NestedMessageGoal

% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'test_msgs/NestedMessageGoal';
...
info.MessageType = 'test_msgs/NestedMessageGoal';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
