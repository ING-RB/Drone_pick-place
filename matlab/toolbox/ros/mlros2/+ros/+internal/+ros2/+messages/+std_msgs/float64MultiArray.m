function [data, info] = float64MultiArray
%Float64MultiArray gives an empty data for std_msgs/Float64MultiArray

% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'std_msgs/Float64MultiArray';
[data.layout, info.layout] = ros.internal.ros2.messages.std_msgs.multiArrayLayout;
info.layout.MLdataType = 'struct';
[data.data, info.data] = ros.internal.ros2.messages.ros2.default_type('double',NaN,0);
info.MessageType = 'std_msgs/Float64MultiArray';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
