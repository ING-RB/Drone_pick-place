...
info.MatPath{7} = 'descriptors.dynamic_typing';
info.MatPath{8} = 'descriptors.floating_point_range';
info.MatPath{9} = 'descriptors.floating_point_range.from_value';
info.MatPath{10} = 'descriptors.floating_point_range.to_value';
info.MatPath{11} = 'descriptors.floating_point_range.step';
info.MatPath{12} = 'descriptors.integer_range';
info.MatPath{13} = 'descriptors.integer_range.from_value';
info.MatPath{14} = 'descriptors.integer_range.to_value';
info.MatPath{15} = 'descriptors.integer_range.step';
