...
info.MatPath{36} = 'markers.ARROW_STRIP';
info.MatPath{37} = 'markers.ADD';
info.MatPath{38} = 'markers.MODIFY';
info.MatPath{39} = 'markers.DELETE';
info.MatPath{40} = 'markers.DELETEALL';
info.MatPath{41} = 'markers.header';
info.MatPath{42} = 'markers.header.stamp';
info.MatPath{43} = 'markers.header.stamp.sec';
info.MatPath{44} = 'markers.header.stamp.nanosec';
...
info.MatPath{71} = 'markers.lifetime.nanosec';
...
info.MatPath{82} = 'markers.texture_resource';
info.MatPath{83} = 'markers.texture';
info.MatPath{84} = 'markers.texture.header';
info.MatPath{85} = 'markers.texture.header.stamp';
info.MatPath{86} = 'markers.texture.header.stamp.sec';
info.MatPath{87} = 'markers.texture.header.stamp.nanosec';
info.MatPath{88} = 'markers.texture.header.frame_id';
info.MatPath{89} = 'markers.texture.format';
info.MatPath{90} = 'markers.texture.data';
info.MatPath{91} = 'markers.uv_coordinates';
info.MatPath{92} = 'markers.uv_coordinates.u';
info.MatPath{93} = 'markers.uv_coordinates.v';
info.MatPath{94} = 'markers.text';
info.MatPath{95} = 'markers.mesh_resource';
info.MatPath{96} = 'markers.mesh_file';
info.MatPath{97} = 'markers.mesh_file.filename';
info.MatPath{98} = 'markers.mesh_file.data';
info.MatPath{99} = 'markers.mesh_use_embedded_materials';
info.MatPath{100} = 'independent_marker_orientation';
info.MatPath{101} = 'description';
