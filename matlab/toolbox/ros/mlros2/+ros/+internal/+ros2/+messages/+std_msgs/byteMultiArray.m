function [data, info] = byteMultiArray
%ByteMultiArray gives an empty data for std_msgs/ByteMultiArray

% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'std_msgs/ByteMultiArray';
...
info.MessageType = 'std_msgs/ByteMultiArray';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
