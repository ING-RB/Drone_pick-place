...
%
% Note: The Python environment created by this function is used by ROS
% Toolbox for generating custom messages and deploying a Simulink model as
% a ROS node. The Python virtual environment persists between MATLAB
% sessions.
%
% Examples:
%
% % Get current Python virtual environment parameters
% [localPythonPath, activatePath, pyenvDir] = ros.ros2.internal.createOrGetLocalPython
%
...
% [~, ~, venvDir] = ros.ros2.internal.createOrGetLocalPython(true)
%
...
checkAndCreateVenv(rosEnv,'ros2',forceRecreateVenv);
[localPythonPath,activatePath,venvDir] = getVenvInformation(rosEnv,'ros2');
end
