...
for /f "delims=" %%i in ("%CMAKE_PATH%") do set "CMAKE_PATH=%%~i"
...
SET PATH=%CMAKE_PATH%;%CUSTOM_PATH%;%AMENT_PREFIX_PATH%\Scripts;%AMENT_PREFIX_PATH%\bin;%PATH%
SET PYTHONPATH=%CUSTOM_SITE_PACKAGES_PATH%;%AMENT_PREFIX_PATH%\lib\site-packages;%PYTHON_VENV_PATH%\lib\site-packages
SET PKG_CONFIG_PATH="%AMENT_PREFIX_PATH%\lib\pkgconfig"
SET AMENT_PREFIX_PATH=%CUSTOM_AMENT_PREFIX_PATH%;%AMENT_PREFIX_PATH%
...
SET _all=%*
call SET ACTUAL_ENV_CMD_PARAM=%%_all:*%4=%%
SET ACTUAL_ENV_CMD_PARAM=%4%ACTUAL_ENV_CMD_PARAM%
call SET ACTUAL_CMD_PARAM=%%ACTUAL_ENV_CMD_PARAM:*%5=%%
SET ACTUAL_CMD_PARAM=%5%ACTUAL_CMD_PARAM%
