    ...
    methods
        ...
        function obj = NetworkAddressSpecifier
            ...
            if isempty(obj.Profile.RMWImplementation)
                obj.Profile.RMWImplementation = obj.Profile.getCurrentRMWImplementation();
            end
        end
        ...
        function dlgstruct = getDialogSchema(obj)
            ...
            rmwImplementation.Value = obj.Profile.getCurrentRMWImplementation();
            ...
            rmwImplementation.Enabled = 0;
            obj.Profile.RMWImplementation = rmwImplementation.Value;
            ...
            rmwImplementationContainer.Items = {rmwImplementationLabel, rmwImplementation};
