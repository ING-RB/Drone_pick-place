...
%   Copyright 2022 The MathWorks, Inc.
    properties (Constant)
        ...
        MaskType = 'ROS 2 Header Assignment'
    ...
    methods
        ...
        % * Copies the block
            ...
            ros.internal.setBlockIcon(blkH, 'rosicons.ros2lib_headerassignment');
        end
        ...
        % Execute frame id setting only when the 'FrameID' is visible
            ...
            if (strcmp(frameIdEditBox.Visible,'on'))
                ...
                maxLength = msgtypeInfo.getMaxLength('frame_id');

                % Check if the length of the frameId is shorter than
                % VariableSize Message
                ros.slros2.internal.block.HeaderAssignmentBlockMask.dispatch(...
        ...
        % 'HeaderfieldName' is visible
            ...
            if(strcmp(fillHeader.Visible, 'on'))
                ...
                busFrameId = strcat(paramCheck,'.frame_id');
                busCurlen= strcat(paramCheck,'.frame_id_SL_Info.CurrentLength');
                ...
                ros.slros2.internal.block.HeaderAssignmentBlockMask.dispatch('checkHeaderFieldNameErr', blockFullName);
            end
        end
        ...
        %exists in the ROS message or not
            ...
            if(~isempty(busInputSig))
                ...
                assert(value > 0,message('ros:slros2:blockmask:InvalidHdrFldError',...
                                         userHeaderFieldName))
            end
        end
        ...
        % VariableSize Message
            ...
            if frameLen > maxLength
                sldiagviewer.reportError(message('ros:slros2:blockmask:ShortFrameIdError',...
    ...
    methods (Static)
        function dispatch(methodName, varargin)
            obj = ros.slros2.internal.block.HeaderAssignmentBlockMask();
