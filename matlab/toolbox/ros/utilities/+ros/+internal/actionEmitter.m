...
% Parse the message into MessageParser and get its data structure.
    ...
    if isequal(rosver,'ros2')
        parserForHeader = ros.internal.MessageParser('std_msgs/Header',dirsToLook);
    else
    ...
    if isequal(rosver,'ros2')
        parserForGoalID = ros.internal.MessageParser('actionlib_msgs/GoalID',dirsToLook);
    else
    ...
    if isequal(rosver,'ros2')
        parserForGoalStatus = ros.internal.MessageParser('actionlib_msgs/GoalStatus',dirsToLook);
    else
    ...
    if isequal(rosver,'ros')
        ...
        files = [files structGenFileNameForActionGoal, structGenFileNameForActionResult, ...
                ...
                classGenFileNameForGoal, classGenFileNameForResult, classGenFileNameForFeedback ...
