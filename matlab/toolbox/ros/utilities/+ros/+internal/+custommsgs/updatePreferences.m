...
for i = 1:numel(msgFullName)
    ...
    msgDllPathMap = containers.Map({'win64','maci64','maca64','glnxa64'}, ...
        { ...
...
for i = 1:numel(srvFullName)
    ...
    srvDllPathMap = containers.Map({'win64','maci64','maca64','glnxa64'}, ...
        { ...
...
for i = 1:numel(actionFullName)
    ...
    actionDllPathMap = containers.Map({'win64','maci64','maca64','glnxa64'}, ...
        { ...
    ...
    if isequal(rosver,'ros2')
        reg.updateMessageEntry([actionFullName{i} 'Goal'], actionInstallDir, actionSrcPath, actionDllPath);
        reg.updateMessageEntry([actionFullName{i} 'Result'], actionInstallDir, actionSrcPath, actionDllPath);
        reg.updateMessageEntry([actionFullName{i} 'Feedback'], actionInstallDir, actionSrcPath, actionDllPath);
    end
end
end
