...
%   Copyright 2019-2022 The MathWorks, Inc.
    ...
    % Add first MessageType into msgDependsMap for ROS 2 Action
    if strcmp(rosver,'ros2') && endsWith(msgName, 'Feedback')
        [actPkgName,actMsgName] = fileparts(msgName);
        msgDependsMap(actPkgName) = {actMsgName};
    end
