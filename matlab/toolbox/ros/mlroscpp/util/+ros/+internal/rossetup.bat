...
SET CMAKE_BIN_PATH=%1

SET PATH=%CMAKE_BIN_PATH%;%CATKIN_PREFIX_PATH%\Scripts;%CATKIN_PREFIX_PATH%\bin;%CATKIN_PREFIX_PATH%\console_bridge\bin;%CATKIN_PREFIX_PATH%\tinyxml2\bin;%PYTHON_VENV_PATH%;%PATH%
