...
%   Copyright 2021-2022 The MathWorks, Inc.
    ...
    envPathMap = ...
                containers.Map({'win64', 'glnxa64', 'maci64', 'maca64'}, ...
                                   {'PATH', ...             % win64
                                    'LD_LIBRARY_PATH', ...  % glnxa64
                                    'DYLD_LIBRARY_PATH', ...% maci64
                                    'DYLD_LIBRARY_PATH'});  % maca64
    ros1LibPath = containers.Map({'win64','maci64','maca64', 'glnxa64'}, ...
                                     { ...
    ...
    rosConsoleLibPath = containers.Map({'win64','maci64', 'maca64','glnxa64'}, ...
                                     { ...
    ...
    rostinyXML2LibPath = containers.Map({'win64','maci64', 'maca64','glnxa64'}, ...
                                     { ...
    ...
    rosLZ4LibPath = containers.Map({'win64','maci64', 'maca64','glnxa64'}, ...
                                     { ...
