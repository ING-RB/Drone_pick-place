...
%#codegen
    ...
    methods
        ...
        %   documentation (help ros.ServiceClient) for more details.
            ...
            isPersistent = coder.internal.getParameterValue(pStruct.IsPersistent,true,varargin{2:end});
            validateattributes(isPersistent,{'logical'},...
                {'scalar','nonempty'},'ServiceClient','IsPersistent');
            ...
            coder.ceval('MATLABSvcClient_createSvcClient',obj.SvcClientHelperPtr,coder.rref(obj.ServiceName),...
                        size(obj.ServiceName,2), coder.rref(isPersistent));
