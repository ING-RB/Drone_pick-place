...
% Default output
    ...
    arch = computer('arch');
	% as per g2860963 we need to list out all the used ports(TCP and UDP) instead of just TCP ports
    ...
    portPatternMap = ...
        containers.Map(archKeys, ...
                       {lookBehindBoundary(":")+digitsPattern+whitespaceBoundary("start"), ...  % win64
                        ...
                        lookBehindBoundary(".")+digitsPattern+whitespaceBoundary("start")});    % maca64
