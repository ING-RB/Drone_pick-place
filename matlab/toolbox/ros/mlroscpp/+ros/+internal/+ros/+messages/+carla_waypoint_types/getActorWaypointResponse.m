function [data, info] = getActorWaypointResponse
%GetActorWaypoint gives an empty data for carla_waypoint_types/GetActorWaypointResponse

% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'carla_waypoint_types/GetActorWaypointResponse';
[data.Waypoint, info.Waypoint] = ros.internal.ros.messages.carla_waypoint_types.carlaWaypoint;
info.Waypoint.MLdataType = 'struct';
info.MessageType = 'carla_waypoint_types/GetActorWaypointResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
