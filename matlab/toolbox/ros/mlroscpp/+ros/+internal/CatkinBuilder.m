...
% Copyright 2019-2024 The MathWorks, Inc.
    ...
    methods (Static, Hidden)
        function ret = getBuildCommand(rootFolder, useNinja)
            if ~useNinja
                ...
                cmdmap = containers.Map({'win64','maci64', 'maca64','glnxa64'}, ...
                    {['catkin_make install -C "' rootFolder '" ' ' --use-ninja '], ...use -C in windows
                    'catkin_make install --use-ninja ',... no other option for mac and linux
