classdef SimpleActionClientParser < ...
    ...
    methods
        function [node, actionNamespace, actionType, dataFormat, activationFcn, feedbackFcn, resultFcn] = parseConstructorInput(obj, defaultActionType, node, actionNamespace, varargin)
        ...
        % Convert all strings to character vectors
            ...
            % No need to validate here since we are validating in
            % ros.SimpleActionClient constructor
            addParameter(paramParser, 'ActivationFcn', obj.defaultActivationFcn);
            addParameter(paramParser, 'FeedbackFcn', obj.defaultFeedbackFcn);
            addParameter(paramParser, 'ResultFcn', obj.defaultResultFcn);
            ...
            activationFcn = paramParser.Results.ActivationFcn;
            feedbackFcn = paramParser.Results.FeedbackFcn;
            resultFcn = paramParser.Results.ResultFcn;
        end
