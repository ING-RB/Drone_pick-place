classdef Publisher < ros.internal.mixin.ROSInternalAccess & ...
    ...
    properties (Transient, Access = ?ros.internal.mixin.ROSInternalAccess)
        ...
        %InternalMsgUtils - MCOS object that contains message utilities
        InternalMsgUtils
    end
    ...
    methods (Access = public)
        ...
        %   (help ros.Publisher) for more details.
            ...
            if obj.EnableValidation && obj.EnableBuffering
                try
                    ...
                    obj.InternalMsgUtils = rosutils.msgutils.internal.RosmsgUtilsWrapper;
                    ...
                    obj.InternalMsgUtils.validate(obj.MessageType,...
                        rosmessage(obj.MessageType,"DataFormat","struct"));
                catch
        ...
        % Publish message
            try
                ...
                if obj.EnableValidation && obj.EnableBuffering
                    obj.InternalMsgUtils.validate(obj.MessageType,msgStruct);
                end
    ...
    methods (Access = private)
        ...
        %createPublisher Create publisher on ROS network
            ...
            try
                ...
                % Initialize qos event callback to process requests (ros2)
                % Added here for consistency with ros2 file
