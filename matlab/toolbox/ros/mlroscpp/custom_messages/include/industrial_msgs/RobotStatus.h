...
#ifdef __APPLE__
// Apple's mach/boolean.h defines TRUE and FALSE, causing failures with the enum definition below.
// A better long-term fix here would be to add an extra prefix to the common names used in this 
// enum, but someone more familiar with the code should probably tackle that project. The .msg file
// that isn't supposed to be edited can't be fixed by modifying the input, so the only option I can
// see here is to patch up clients as we find them for now to unblock the Biat_task1 snap.
#undef TRUE
#undef FALSE
#endif
...
// {'industrial_msgs': ['/mathworks/home/pmurali/Documents/Working/matlab_msg_gen_ros1/glnxa64/src/industrial_msgs/msg'], 'std_msgs': ['/mathworks/devel/sbs/31/pmurali.Brobot.j1329247.2/matlab/sys/ros1/glnxa64/ros1/share/std_msgs/cmake/../msg', '/mathworks/devel/sbs/31/pmurali.Brobot.j1329247.2/matlab/sys/ros1/glnxa64/ros1/share/std_msgs/cmake/../msg']}
