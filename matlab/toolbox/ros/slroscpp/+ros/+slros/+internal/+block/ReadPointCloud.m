classdef ReadPointCloud < ros.slros.internal.block.ReadXBase ...
        & ros.slros.internal.block.mixin.ConfigureUsingROS
    %This class is for internal use only. It may be removed in the future.

    %ReadPointCloud Extracts XYZ and RGB Data From ROS PointCloud
    ...
    properties (Constant, Access = {...
        ...
        InvalidTypeID = 'ros:slros:pointcloud:InvalidType'
    end
    ...
    properties (Access=private, Transient)
        ...
        % Simulink bus struct to a MATLAB ROS message.
        Converter = []
    ...
    methods
        ...
        function val = get.IconImage(~)
            val = 'robotlib_readpointcloud.svg';
        end
    ...
    methods(Access = protected)
        ...
        %stepImpl Extract signals from point cloud message
            ...
            pc = ros.slros.internal.block.PointCloud2BusWrapper(busstruct);
            ...
            xyz = obj.resizeXYZOutputs(xyzTmp, pcHeight, pcWidth);

            if obj.ShowRGBOutput
                rgb = obj.resizeRGBOutputs(rgbTmp, pcHeight, pcWidth);
            end
            if obj.ShowIntensityOutput
                intensity = obj.resizeIntensityOutputs(intensityTmp, pcHeight, pcWidth);
            end
        ...
        function xyz = resizeXYZOutputs(obj, xyzIn, pcHeight, pcWidth)
            if obj.PreserveStructure
        ...
        function rgb = resizeRGBOutputs(obj, rgbIn, pcHeight, pcWidth)
            if obj.PreserveStructure
        ...
        function intensity = resizeIntensityOutputs(obj, intensityIn, pcHeight, pcWidth)
            if obj.PreserveStructure
    ...
    methods(Access = protected, Static)
        ...
        % Define property section(s) for System block dialog
            ...
            pointCloudGroup = ros.slros.internal.block.mixin.ConfigureUsingROS.getConfigurableSettingsGroup( ...
                slrosBlockmaskMessage('PointCloudPropertiesPrompt'), ...
                {'MaximumPointCloudSize'}, ...
                message('ros:slros:topicselector:PointCloudDialogTitle').string);
        ...
        function topicSelector = generateTopicTable(node, varargin)
            topicSelector = ros.slroscpp.internal.PointCloudTopicTable(node, varargin{:});
        end
    end
end
