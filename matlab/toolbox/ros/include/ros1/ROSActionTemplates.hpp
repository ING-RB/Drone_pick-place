...
class  ROSActClientImpl: public MATLABActClientInterface {
  ...
  public:
    ...
    virtual bool sendGoaltoActserver( const matlab::data::StructArray arr,
        ...
        mClient->sendGoal(*goal,boost::bind(&ROSActClientImpl::onResultReceivedCallback,this,boost::placeholders::_1,boost::placeholders::_2),
                               boost::bind(&ROSActClientImpl::onGoalActiveCallback, this),
                               boost::bind(&ROSActClientImpl::onFeedbackReceivedCallback, this,boost::placeholders::_1));
        return true;
    }
        ...
        if(enableGoalExecCallback){
            mServer = 
                std::make_shared<actionlib::SimpleActionServer<RosActType>>(
                        *theNode, act_name, boost::bind(&ROSActServerImpl::executeGoalCB, this, boost::placeholders::_1), false);
        }else{
            mServer = 
                std::make_shared<actionlib::SimpleActionServer<RosActType>>(
