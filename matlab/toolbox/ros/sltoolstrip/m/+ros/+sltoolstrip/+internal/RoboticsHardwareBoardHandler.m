...
%   Copyright 2018-2024 The MathWorks, Inc.
    ...
    methods(Access=public)
        ...
        function available = isSignalLoggingAvailable(this)
            % This API should support both model name and model handle
            cs = getActiveConfigSet(this.ModelHandle);
            hardwareboard = cs.get_param('HardwareBoard');
            available = contains(hardwareboard, 'ROS 2');
        end
    end
    %
