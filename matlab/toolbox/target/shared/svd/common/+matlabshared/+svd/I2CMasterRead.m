classdef (StrictDefaults)I2CMasterRead < matlabshared.svd.I2CBlock ...
        & matlabshared.svd.BlockSampleTime
    %I2CMASTERREAD Read data on the I2C bus from Master from the 
    ...
    methods (Access=protected)
        ...
        function maskDisplayCmds = getMaskDisplayImpl(obj)
            ...
            maskDisplayCmds = [ ...
                ...
                ['text(50,40,''\fontsize{10}\bfController Read'',''texmode'',''on'',''horizontalAlignment'',''center'',''verticalAlignment'',''middle'');', char(10)], ...
    ...
    methods(Static, Access=protected)
        function header = getHeaderImpl()
            header = matlab.system.display.Header(mfilename('class'),...
                ...
                'Title','I2C Controller Read', ...
                'Text', ['Read data from an I2C peripheral device or an I2C peripheral device register.' char(10) char(10) ...
