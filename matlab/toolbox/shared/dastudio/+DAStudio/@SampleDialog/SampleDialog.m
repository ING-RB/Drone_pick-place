classdef SampleDialog < handle

%    DAStudio.SampleDialog properties:
%       Path - Property is of type 'ustring'  (read only) 
%       radioProp1 - Property is of type 'TestLevels enumeration: {'lvlOne','lvlTwo','lvlThree'}'  
%       radioProp2 - Property is of type 'MyEnum enumeration: {'Red','Green','Blue','Black','White','Gray'}'  
%       checkProp - Property is of type 'bool'  
%       stringProp - Property is of type 'string'  
%       intProp - Property is of type 'int32'  
%       doubleProp - Property is of type 'double'  

    properties (SetObservable)
        %RADIOPROP1 Property is of type 'TestLevels enumeration: {'lvlOne','lvlTwo','lvlThree'}' 
        radioProp1 DAStudio.Enums.TestLevels = DAStudio.Enums.TestLevels.lvlOne;
        %RADIOPROP2 Property is of type 'MyEnum enumeration: {'Red','Green','Blue','Black','White','Gray'}' 
        radioProp2 DAStudio.Enums.MyEnum = DAStudio.Enums.MyEnum.Red;
        %CHECKPROP Property is of type 'bool' 
        checkProp (1, 1) logical = false;
        %STRINGPROP Property is of type 'string' 
        stringProp string = '';
        %INTPROP Property is of type 'int32' 
        intProp int32 = [];
        %DOUBLEPROP Property is of type 'double' 
        doubleProp (1,1) double = 0;
    end

    methods  % constructor block
        function this = SampleDialog()
        end
