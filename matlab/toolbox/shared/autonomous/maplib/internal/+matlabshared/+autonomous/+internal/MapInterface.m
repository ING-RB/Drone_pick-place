classdef (Hidden) MapInterface < matlabshared.autonomous.map.internal.InternalAccess
%MapInterface interface class defines common properties for MapLayer and
%   MultiLayerMap
...
%#codegen
    ...
    methods (Hidden)
        ...
        function [moveValue, syncObj, fillValInternal] = moveParser(map, moveValue, varargin)
            ...
            isMultiMap = matlabshared.autonomous.internal.MapInterface.isaMultiMap(map);
            if isMultiMap
    ...
    methods (Hidden, Static)
        ...
        %cartesian coords to cells
            lowFPE  = ceil(val)-val <= eps(val)*matlabshared.autonomous.internal.MapInterface.FPECorrFactor;
        ...
        %cartesian coords to cells
            highFPE = val-floor(val) <= eps(val)*matlabshared.autonomous.internal.MapInterface.FPECorrFactor;
        ...
        % multiplied by obj.Resolution.
            ...
            lowFPE  = ceil(valIn)-valIn <= eps(valIn)*matlabshared.autonomous.internal.MapInterface.FPECorrFactor;
            highFPE = valIn-floor(valIn) <= eps(valIn)*matlabshared.autonomous.internal.MapInterface.FPECorrFactor;
        ...
        %calculateMapDimensions Return matrix size and map footprint
            ...
            if useGridSizeInitialization
                ...
                if strcmp(frame,'grid')
                    ...
                    width = matlabshared.autonomous.internal.MapInterface.removeFPE(arg1);
                    height = matlabshared.autonomous.internal.MapInterface.removeFPE(arg2);
        ...
        %updateParsedResolution Use NV-pair Resolution if supplied, otherwise use optional input
            ...
            if ~userSupplied.Resolution
                f = matlabshared.autonomous.internal.MapInterface.getValResolutionFcn(className);
        ...
        %isaMultiMap Checks whether input is a valid MultiLayerMap
        ...
        %validateLayer Verifies that input is a valid MultiLayerMap
        ...
        %validateLayer Verifies that input is a valid MapInterface
