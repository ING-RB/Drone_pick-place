classdef NameValueParser < matlabshared.autonomous.core.internal.NameValueParserInterface
    ...
    %   inputParser. This class redirects to matlabshared.autonomous.core.internal.codegen.NameValueParser
    ...
    methods
        ...
        function obj = NameValueParser(names, defaults)
            ...
            obj = obj@matlabshared.autonomous.core.internal.NameValueParserInterface(names, defaults);
        ...
        function newobj = copy(obj)
            newobj = matlabshared.autonomous.core.internal.NameValueParser(obj.Names, ...
                                                            obj.Defaults);
    ...
    methods (Access = private, Static)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'matlabshared.autonomous.core.internal.codegen.NameValueParser';
        end
