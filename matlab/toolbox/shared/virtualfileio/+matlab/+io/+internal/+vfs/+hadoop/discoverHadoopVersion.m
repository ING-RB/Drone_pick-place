...
mlock;
    ...
    [status, versionMsg] = matlab.io.internal.vfs.hadoop.callHadoop(hadoopInstallFolder, 'version');
    if status == 0
    ...
    error(message('MATLAB:virtualfileio:hadooploader:indeterminateHadoopVer'));
...
if majorVersionNumber == 1
    error(message('MATLAB:virtualfileio:hadooploader:hadoopVersion1', versionString));
end
end
