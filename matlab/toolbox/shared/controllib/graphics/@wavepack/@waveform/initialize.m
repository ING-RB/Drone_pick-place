function initialize(this,Nwaves,ViewClass)
...
if nargin < 3
    ...
    [this.Data, this.View, DataProps] = createdataview(this.Parent,Nwaves,ViewClass);
end
...
View = this.View;
for ct = 1:Nwaves
   initialize(View(ct),reshape(this.Group,size(Axes))); 
end
