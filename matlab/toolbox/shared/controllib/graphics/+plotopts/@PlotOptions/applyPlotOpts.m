...
if strcmp(this.ColorMode.Title,"manual")
...
if strcmp(this.ColorMode.XLabel,"manual")
...
if strcmp(this.ColorMode.YLabel,"manual")
...
if strcmp(this.ColorMode.TickLabel,"manual")
...
if strcmp(this.ColorMode.Grid,"manual")
    AxGrid.AxesStyle.GridColor = this.GridColor;
end
