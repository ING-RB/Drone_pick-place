...
L1 = [event.listener(Constr,'DataChanged',@(h,evt) LocalUpdateLims(Viewer, this.AxesGrid))];
Constr.addlisteners(L1);
L1 = [handle.listener(Constr.EventManager,'MouseEdit',{@LocalReframe Viewer this.AxesGrid})];
...
% LocalWords:  userdata viewgui Siso buttondown
