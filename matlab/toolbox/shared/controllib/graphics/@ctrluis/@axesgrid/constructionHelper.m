function constructionHelper(h,gridsize,hndl,varargin)
% This is a helper that can be called from the axesgrid constructor and the
% axesgridPlotmatrix subclass constructor.

%   Copyright 2015-2020 The MathWorks, Inc.

% initialize @axesgrid instance
