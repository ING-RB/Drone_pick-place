...
WarnID = 'Controllib:plots:axesgroupInvalidAxesOption';
...
% Need to set all values at once for sync otherwise listeners for property changes 
% updates labels and change values of handle(h)
set(labstyle, ...
    'Color', h.Color, ...
