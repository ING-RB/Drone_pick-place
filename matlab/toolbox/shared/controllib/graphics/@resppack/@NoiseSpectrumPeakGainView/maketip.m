...
%MAKETIP  Build data tips for NoiseSpectrumPeakGainView Characteristics.
%
...
YData = idpack.specmagunitconv(cData.PeakGain(info.Row,info.Col),cData.Parent.MagUnits,MagUnits);
