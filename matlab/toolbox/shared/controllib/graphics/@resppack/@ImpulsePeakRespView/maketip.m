...
PeakDeviation = cData.PeakResponse(info.Row,info.Col);  % always > 0
str{end+1,1} = getString(message('Controllib:plots:strPeakDeviationLabel', ...
   sprintf('%0.3g',PeakDeviation)));
