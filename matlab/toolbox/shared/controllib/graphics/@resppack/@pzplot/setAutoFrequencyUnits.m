...
if isempty(this.Responses)
    ...
    this.AutoUnitsListener.FrequencyUnits = h;
else
...
try
    if isempty(r.DataSrc)
        this.FrequencyUnits = r.Data.FreqUnits;
    else
        this.FrequencyUnits = r.DataSrc.getFrequencyUnits;
    end
end
end
...
delete(this.AutoUnitsListener.FrequencyUnits)
end