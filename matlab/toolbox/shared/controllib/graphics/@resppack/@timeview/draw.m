function draw(this, Data,NormalRefresh) %#ok<INUSD>
...
% Time:      Ns x 1 or [] for NaN systems
% Amplitude: Ns x Ny x Nu or [] for NaN systems
...
% Redraw the curves
if isempty(Data.Amplitude) || strcmp(this.AxesGrid.YNormalization,'on')
