...
AxesGrid = ctrluis.axesgrid( ...
   ...
   'XLimSharing', 'column', ...
   'YLimSharing', 'row', ...
   'Title',       getString(message('Controllib:plots:strNicholsChart')), ...
   'XLabel',      getString(message('Controllib:plots:strOpenLoopPhase')),...
   'XScale',      'linear',...
   'XUnits',      'deg',...
   'YLabel',      getString(message('Controllib:plots:strOpenLoopGain')),...
   'YScale',      'linear',...
   'YUnits',      'dB'  );
...
% --------------------------------------------------------------------------- %
function LocalSetVisible(~, eventdata, this)
