function h = DirectionalIndexPlot(varargin)
% Constructor for @DirectionalIndexPlot class
%
%  H = DirectionalIndexPlot([1 1]) or H = DirectionalIndexPlot creates a 
%  @DirectionalIndexPlot object with a 1-by-1 @axesgrid object.
%
%  H = DirectionalIndexPlot([1 1],'Property1','Value1',...) initializes the 
%  plot with the specified attributes.

%  Copyright 1986-2021 The MathWorks, Inc.

% Create class instance
h = resppack.DirectionalIndexPlot;
...
% Initialize the handle graphics objects used in @DirectionalIndexPlot class.
