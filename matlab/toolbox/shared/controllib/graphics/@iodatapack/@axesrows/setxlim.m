...
% Note: Copied from @axesgroup. Modified this function to handle
% datetime/duration array. Need to revisit later.
...
% Error checking
if ~isdatetime(Xlim(1)) & Xlim(1)<=0 & any(strcmp(h.XScale(col_index),'log'))
