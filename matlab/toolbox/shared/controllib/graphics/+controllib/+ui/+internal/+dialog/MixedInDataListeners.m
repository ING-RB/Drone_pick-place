classdef MixedInDataListeners < handle
    ...
    methods
        ...
        function unregisterDataListeners(this, varargin)
            % Method "unregisterDataListeners": 
            %
            % Example:
    ...
    methods (Access = private)
        ...
        function onoffListeners(this, value, varargin)
            ...
            if ~ishandle(this.DataListeners)
                % MCOS Listeners
                ...
                % UDD Listeners
                if value
                    set(this.DataListeners,'Enabled','on');
                else
                    set(this.DataListeners,'Enabled','off');
                end
            end
        end
