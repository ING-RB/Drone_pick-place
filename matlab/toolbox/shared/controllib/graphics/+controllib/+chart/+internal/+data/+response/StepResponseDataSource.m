classdef StepResponseDataSource < controllib.chart.internal.data.response.TimeResponseDataSource
    % controllib.chart.internal.data.response.StepResponseDataSource
    %   - base class for managing source and data objects for given step response
    %   - inherited from controllib.chart.internal.data.response.TimeResponseDataSource
    %
    % h = StepResponseDataSource()
    %
    % h = StepResponseDataSource(_____,Name-Value)
    ...
    %   RiseTimeLimits               limits to compute rise time
    ...
    %   RiseTime                     rise time characteristic, controllib.chart.internal.data.characteristics.TimeRiseTimeData
    %   SettlingTime                 settling time characteristic, controllib.chart.internal.data.characteristics.TimeSettlingTimeData
    %   TransientTime                transient time characteristic, controllib.chart.internal.data.characteristics.TimeTransientTimeData
    %   SteadyState                  steady state characteristic, controllib.chart.internal.data.characteristics.TimeSteadyStateData
    %   ConfidenceRegion             confidence region characteristic, controllib.chart.internal.data.characteristics.StepConfidenceRegionData
    %
    ...
    properties (Dependent,SetAccess=private)
        ...
        PeakResponse    
        % "RiseTime": controllib.chart.internal.data.characteristics.TimeRiseTimeData scalar
        % Rise time characteristic.
        RiseTime        
        % "SettlingTime": controllib.chart.internal.data.characteristics.TimeSettlingTimeData scalar
        ...
        TransientTime   
        % "SteadyState": controllib.chart.internal.data.characteristics.TimeSteadyStateData scalar
        % Steady state characteristic.
        SteadyState
        % "ConfidenceRegion": controllib.chart.internal.data.characteristics.StepConfidenceRegionData scalar
    ...
    %% Constructor
    methods
        function this = StepResponseDataSource(model,stepResponseOptionalArguments,timeResponseOptionalInputs)
            arguments
                model
                stepResponseOptionalArguments.SettlingTimeThreshold = get(cstprefs.tbxprefs,'SettlingTimeThreshold')
                stepResponseOptionalArguments.RiseTimeLimits = get(cstprefs.tbxprefs,'RiseTimeLimits')
                stepResponseOptionalArguments.NumberOfStandardDeviations = 1
            ...
            this.SettlingTimeThreshold = stepResponseOptionalArguments.SettlingTimeThreshold;
            this.RiseTimeLimits = stepResponseOptionalArguments.RiseTimeLimits;
            this.NumberOfStandardDeviations = stepResponseOptionalArguments.NumberOfStandardDeviations;
            this.Type = "StepResponse";
    ...
    methods
        function [commonTimeFocus, commonAmplitudeFocus, timeUnit] = getCommonFocusForMultipleData(this,...
            ...
            arguments
                this (:,1) controllib.chart.internal.data.response.StepResponseDataSource
    ...
    methods
        ...
        function PeakResponse = get.PeakResponse(this)
            arguments
                this (1,1) controllib.chart.internal.data.response.StepResponseDataSource
            end
            PeakResponse = getCharacteristics(this,"PeakResponse");
        end

        % RiseTime
        function RiseTime = get.RiseTime(this)
            arguments
                this (1,1) controllib.chart.internal.data.response.StepResponseDataSource
            end
            RiseTime = getCharacteristics(this,"RiseTime");
        end

        % SettlingTime
        function SettlingTime = get.SettlingTime(this)
            arguments
                this (1,1) controllib.chart.internal.data.response.StepResponseDataSource
            end
            SettlingTime = getCharacteristics(this,"SettlingTime");
        end
        ...
        % SteadyState
        function SteadyState = get.SteadyState(this)
            arguments
                this (1,1) controllib.chart.internal.data.response.StepResponseDataSource
            end
            SteadyState = getCharacteristics(this,"SteadyState");
        end
        ...
        function set.SettlingTimeThreshold(this,SettlingTimeThreshold)
            ...
            if ~isempty(this.SettlingTime) %#ok<MCSUP>
                update(this.SettlingTime,SettlingTimeThreshold); %#ok<MCSUP>
            end
        ...
        function set.RiseTimeLimits(this,RiseTimeLimits)
            ...
            if ~isempty(this.RiseTime) %#ok<MCSUP>
                update(this.RiseTime,RiseTimeLimits); %#ok<MCSUP>
            end
            this.RiseTimeLimits = RiseTimeLimits;
        end
    ...
    methods (Access = protected)
        function updateData(this,stepResponseOptionalArguments,timeResponseOptionalInputs)
            arguments
                this (1,1) controllib.chart.internal.data.response.StepResponseDataSource
                stepResponseOptionalArguments.SettlingTimeThreshold = this.SettlingTimeThreshold
                stepResponseOptionalArguments.RiseTimeLimits = this.RiseTimeLimits
                stepResponseOptionalArguments.NumberOfStandardDeviations = this.NumberOfStandardDeviations;
            ...
            try
                ...
                [sysList,t,p,Config] = DynamicSystem.checkStepInputs(sysList,ParamList);
            ...
            try
                ...
                for ka = 1:this.NResponses
                    [y,t,focus,y0,yf] = getTimeResponseData_(this.ModelValue,timeSpec,...
                        this.ParameterInput,this.Config,'step',ka);
        ...
        function characteristics = createCharacteristics_(this)
            ...
            characteristicTypes = getSupportedCharacteristicsForResponseType_(this.ModelValue,"step");
            characteristics = [];

            % PeakResponse
            if any(strcmp(characteristicTypes,"PeakResponse"))
                characteristics = [characteristics,...
                    controllib.chart.internal.data.characteristics.StepPeakResponseData(this)];
            end

            % RiseTime
            if any(strcmp(characteristicTypes,"RiseTime"))
                characteristics = [characteristics,...
                    controllib.chart.internal.data.characteristics.TimeRiseTimeData(this,this.RiseTimeLimits)];
            end

            %% SettlingTime
            if any(strcmp(characteristicTypes,"SettlingTime"))
                characteristics = [characteristics,...
                    controllib.chart.internal.data.characteristics.StepSettlingTimeData(this,this.SettlingTimeThreshold)];
            end
            
            % TransientTime
            if any(strcmp(characteristicTypes,"TransientTime"))
                characteristics = [characteristics,...
                    controllib.chart.internal.data.characteristics.StepTransientTimeData(this,this.SettlingTimeThreshold)];
            end

            % SteadyState
            if any(strcmp(characteristicTypes,"SteadyState"))
                characteristics = [characteristics,...
                    controllib.chart.internal.data.characteristics.TimeSteadyStateData(this)];
            end
            
            % ConfidenceRegion
            if any(strcmp(characteristicTypes,"ConfidenceRegion"))
                characteristics = [characteristics,...
                    controllib.chart.internal.data.characteristics.StepConfidenceRegionData(this,...
                    this.NumberOfStandardDeviations)];
            end
        end

        function IsReal = getIsReal_(this)
            IsReal = getIsReal_@controllib.chart.internal.data.response.ModelResponseDataSource(this);
            IsReal = IsReal & isreal(this.Config.Amplitude) & isreal(this.Config.Bias);
        end
    end
end
