classdef StepConfidenceRegionView < controllib.chart.internal.view.characteristic.TimeInputOutputCharacteristicView
    ...
    %% Constructor
    methods
        function this = StepConfidenceRegionView(responseView,data)
    ...
    methods (Access = protected)
        function build_(this)
            this.ConfidenceRegionPatch = createGraphicsObjects(this,"patch",this.Response.NRows,...
                this.Response.NColumns,this.Response.NResponses,HitTest="off",PickableParts="none",Tag='StepConfidencePatch');
                ...
                for ko = 1:this.Response.NRows
                    for ki = 1:this.Response.NColumns
                        for ka = 1:this.Response.NResponses
                            this.ConfidenceRegionPatch(ko,ki,ka).XData = conversionFcn(this.ConfidenceRegionPatch(ko,ki,ka).XData);
                        end
                    end
                end
            end
