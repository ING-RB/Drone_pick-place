classdef SectorWorstIndexResponse < controllib.chart.internal.characteristics.AbstractCharacteristic        
    
    methods
        function this = SectorWorstIndexResponse(optionalInputs)
            arguments
