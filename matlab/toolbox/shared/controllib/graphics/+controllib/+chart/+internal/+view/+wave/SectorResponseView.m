classdef SectorResponseView < controllib.chart.internal.view.wave.BaseResponseView & ...
    ...
    %% Public methods
    methods
        function this = SectorResponseView(response,optionalInputs)            
            arguments
                response (1,1) controllib.chart.response.SectorResponse
    ...
    methods
        ...
        function set.FrequencyScale(this,FrequencyScale)
            arguments
                this (1,1) controllib.chart.internal.view.wave.SectorResponseView
    ...
    methods (Access = protected)
        function createCharacteristics(this,data)
            ...
            % PeakResponse
            if isprop(data,"SectorWorstIndexResponse") && ~isempty(data.SectorWorstIndexResponse)
                c = controllib.chart.internal.view.characteristic.SectorWorstIndexResponseView(this,data.SectorWorstIndexResponse);
            end 
        ...
        function legendLine = createLegendObjects(this)
            nLines = max(this.NLines,1);
            legendLine = createGraphicsObjects(this,"line",nLines,1,this.Response.NResponses,...
