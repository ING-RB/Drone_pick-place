classdef TimeMagnitudeInputOutputTransientTimeView < controllib.chart.internal.view.characteristic.TimeInputOutputCharacteristicView
    ...
    %% Constructor
    methods
        function this = TimeMagnitudeInputOutputTransientTimeView(response,data)
