classdef NicholsView < controllib.chart.editor.internal.EditorView
    % NicholsEditor Wrapper
    ...
    %% Constructor
    methods
        function this = NicholsView(chart)
            arguments
    ...
    methods (Static,Hidden)
        function props = getCopyableProperties()
            props = [controllib.chart.editor.internal.EditorView.getCopyableProperties();...
                ...
                "MinimumGainEnabled";"MinimumGainValue";"PhaseMatchingEnabled";...
                "PhaseMatchingFrequency";"PhaseMatchingValue";"PhaseUnit";...
