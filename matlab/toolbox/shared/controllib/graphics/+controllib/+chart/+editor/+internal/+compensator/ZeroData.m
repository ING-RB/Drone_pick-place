classdef ZeroData < controllib.chart.internal.data.characteristics.BaseCharacteristicData
    ...
    methods
        ...
        function Locations = get.Locations(this)
            ...
            for ii = 1:numel(Locations)
                p = this.ResponseData.CompensatorZeros{ii};
