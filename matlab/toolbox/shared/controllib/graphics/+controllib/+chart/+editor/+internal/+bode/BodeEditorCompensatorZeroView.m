classdef BodeEditorCompensatorZeroView < controllib.chart.internal.view.characteristic.FrequencyCharacteristicView & ...
    ...
    %% Constructor
    methods
        function this = BodeEditorCompensatorZeroView(responseView,data)
    ...
    methods (Access = protected)
        function build_(this)
            this.MagnitudeZeroMarkers = createGraphicsObjects(this,"scatter",this.Response.NRows,...
                this.Response.NColumns,this.Response.NResponses,Tag='BodeMagnitudeTunableZeroScatter');
            this.PhaseZeroMarkers = createGraphicsObjects(this,"scatter",this.Response.NRows,...
                this.Response.NColumns,this.Response.NResponses,Tag='BodePhaseTunableZeroScatter');
            this.StabilityYLines = createGraphicsObjects(this,"constantLine",this.Response.NRows,...
                this.Response.NColumns,this.Response.NResponses,Tag='BodePhaseTunableZeroStabilityLine');
        ...
        function updateData(this,ko,ki,ka)
            pzData = this.Response.ResponseData.BodeCompensatorZeros;
        ...
        function updateStyle_(this,~,ko,ki,ka)
            if this.IsInitialized
                set(this.MagnitudeZeroMarkers(ko,ki,ka),Marker='o',MarkerFaceColor='none');
                set(this.PhaseZeroMarkers(ko,ki,ka),Marker='o',MarkerFaceColor='none');
        ...
        function removeZero(this,source,isMag)
            arguments
                this (1,1) controllib.chart.editor.internal.bode.BodeEditorCompensatorZeroView
        ...
        function moveZero(this,source,action,isMag,optionalInputs)
            ...
            persistent WML WBMClear location stabValue ptr ko ki idx zidx;
            ax = ancestor(source,'axes');
            fig = ancestor(ax,'figure');
            if strcmp(fig.SelectionType,"normal")
                response = getResponse(this.Response);
                zeroData = this.Response.ResponseData.BodeCompensatorZeros;
                switch action
                    case 'init'
                    ...
                    case 'move'
                        ...
                        zeta = zeroData.Dampings{ko,ki}(idx);
                        location = computeNewLocation(this,newPoint,zeta,stabValue);
        ...
        function stabValue = computeStabilityBound(this,w,zeta,ko,ki)
            ...
            threshold = phaseConversionFcn(45);
            if zeta > 0 %stable
        ...
        function location = computeNewLocation(this,newPoint,zeta,stabValue)
            ...
            if ~isempty(stabValue)
                if (zeta > 0 && newPoint(2) < stabValue) || ...
                        (zeta < 0 && newPoint(2) > stabValue)
                    location = -location;
                end
            end
            if this.Response.IsDiscrete
