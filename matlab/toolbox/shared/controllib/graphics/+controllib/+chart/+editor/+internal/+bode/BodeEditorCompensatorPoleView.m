classdef BodeEditorCompensatorPoleView < controllib.chart.internal.view.characteristic.FrequencyCharacteristicView & ...
    ...
    %% Constructor
    methods
        function this = BodeEditorCompensatorPoleView(responseView,data)
    ...
    methods (Access = protected)
        function build_(this)
            this.MagnitudePoleMarkers = createGraphicsObjects(this,"scatter",this.Response.NRows,...
                this.Response.NColumns,this.Response.NResponses,Tag='BodeMagnitudeTunablePoleScatter');
            this.PhasePoleMarkers = createGraphicsObjects(this,"scatter",this.Response.NRows,...
                this.Response.NColumns,this.Response.NResponses,Tag='BodePhaseTunablePoleScatter');
            this.StabilityYLines = createGraphicsObjects(this,"constantLine",this.Response.NRows,...
                this.Response.NColumns,this.Response.NResponses,Tag='BodePhaseTunablePoleStabilityLine');
        ...
        function updateData(this,ko,ki,ka)
            pzData = this.Response.ResponseData.BodeCompensatorPoles;
        ...
        function updateStyle_(this,~,ko,ki,ka)
            if this.IsInitialized
                set(this.MagnitudePoleMarkers(ko,ki,ka),Marker='x');
                set(this.PhasePoleMarkers(ko,ki,ka),Marker='x');
        ...
        function removePole(this,source,isMag)
            arguments
                this (1,1) controllib.chart.editor.internal.bode.BodeEditorCompensatorPoleView
        ...
        function movePole(this,source,action,isMag,optionalInputs)
            ...
            persistent WML WBMClear location stabValue ptr ko ki idx pidx;
            ax = ancestor(source,'axes');
            fig = ancestor(ax,'figure');
            if strcmp(fig.SelectionType,"normal")
                response = getResponse(this.Response);
                poleData = this.Response.ResponseData.BodeCompensatorPoles;
                switch action
                    case 'init'
