...
% Copyright 2009-2024 The MathWorks, Inc.
        ...
        % should at least be one property name associated with it.
            ...
            for ii = 1:length(categoryNames)
                ...
                categoryHeader =  [categoryHeader internal.DisplayFormatter. ...
                                   getPropertiesString(displayObject, propertyNames{ii}, maxPropertyLength)]; %#ok<*AGROW>
            end
        end
    ...
    methods (Static, Access = 'private')
        ...
        %Storing the size of the command window.
            commandWindowLength = matlab.desktop.commandwindow.size();
...
% LocalWords:  Gaama GETDISPLAYHEADER CATEGORYHEADER GETDISPLAYCATEGORIES DISPLAYOBJECT DISPLAYTABLE
% LocalWords:  GETDISPLAYTABLE COLUMNPROPERTIES GETDISPLAYFOOTER DISPLAYTABLEOBJ CREATEDISPLAYTABLE
% LocalWords:  PROPSNAME CONVERTTOCELLARRAY CURRPROP PROPSNAME propsname PROPERTIESSTRING abc
% LocalWords:  GETPROPERTIESSTRING PROPERTYNAMES PROPPRETEXT LARGESTPROPLEN PROPERTIESSTRING PROPERTYNAMES
% LocalWords:  MAXPROPERTYLENGTH DISPLAYTABLESTRING GETTABLESTRING COLUMNNAME PROPVALTOSTRING
