function info = nilist()
% nilist Return information on available NI device channels.
%
%   INFO = NILIST() returns information about available NI CAN devices as a table.
%
%   Example:
%       info = nilist()
...
arch = computer('arch');
devicePath = fullfile(toolboxdir(fullfile('shared','testmeaslib','hwutils','vnt')), 'private', arch, 'nixnetlistplugin');
