classdef insAccelerometer <  positioning.INSSensorModel
%   This class is for internal use only. It may be removed in the future. 
%INSACCELEROMETER Internal Accelerometer related functions
    ...
    methods (Access = {?positioning.internal.insEKFBase,?positioning.internal.INSSensorModelBase}) 
        ...
        function [h, H] = validateAndTrimMeasurements(~, numMeas, ~, h, H)
            ...
            coder.internal.assert(numMeas == 3, ...
                'insframework:insEKF:MeasSize3', 'insAccelerometer');
        end
    end
    methods (Static, Hidden)
        function funhelp
            % The INSACCELEROMETER requires a 3-element measurement MEAS and a
            ...
            %   filt = insEKF(acc);
            %   residual(filt, acc, [0 0 9.8], 0.1);
            %   fuse(filt, acc, [0 0 9.8], 0.1*eye(3));
        end
    end
end
