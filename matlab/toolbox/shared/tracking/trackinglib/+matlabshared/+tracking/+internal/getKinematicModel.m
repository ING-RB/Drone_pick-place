...
%   [A,B,C,D] = matlabshared.tracking.internal.getKinematicModel(IDX,N,T)
%   returns the state space model matrices, A, B, C, and D, for either
%   constant velocity or constant acceleration kinematic models. If IDX is
%   1, the model is for constant velocity. If IDX is 2, the model is for
%   constant acceleration. N is an integer between 1 and 3 indicating the
%   dimensions for kinematic models and T is the discrete sample time of
%   the model.
%
