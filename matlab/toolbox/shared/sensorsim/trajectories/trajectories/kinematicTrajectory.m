classdef kinematicTrajectory < matlab.System & ...
...
%#codegen
    ...
    properties (Nontunable)
        ...
        SamplesPerFrame (1, 1) {mustBePositive, mustBeInteger} = 1;
    end
    ...
    methods (Access = protected)
        ...
        function perts = defaultPerturbations(~)
            perturbableProps = {"Position", "Velocity"};
            perts = struct(...
    ...
    methods (Access = private)
        function setupInitialState(obj)
