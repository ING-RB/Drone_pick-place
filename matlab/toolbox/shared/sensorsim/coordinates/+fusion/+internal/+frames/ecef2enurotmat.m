function R = ecef2enurotmat(lat, lon)
%ECEF2ENUROTMAT Rotation matrix to transform ECEF to ENU
%
%   Inputs
%       lat - Nx1 latitude vector (deg)
%       lon - Nx1 longitude vector (deg)
%   Outputs
%       R - 3x3xN ECEF to ENU rotation matrix array
%
...
%#codegen
    ...
    % Calculate ECEF to ENU rotation matrix.
    R = [          -sinLon,            cosLon,    zero;...
