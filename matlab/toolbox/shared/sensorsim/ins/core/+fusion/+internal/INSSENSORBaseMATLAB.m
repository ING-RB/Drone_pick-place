classdef (Hidden, StrictDefaults) INSSENSORBaseMATLAB < fusion.internal.INSSENSORBase
...
%#codegen
    ...
    properties (Access = protected)
        % Internal HasGNSSFix. Protected so Simulink can touch
        pHasGNSSFix (1,1) logical = true;
    end
    ...
    methods
        ...
        function set.pHasGNSSFix(obj,val)
            oldVal = obj.pHasGNSSFix;
            obj.pHasGNSSFix = val;
    ...
    methods (Access = protected)
        ...
        function in = applyMountingLocation(obj, in)
            ...
            % [roll, pitch, yaw]
                ...
                orientPQuat = quaternion(fliplr(in.Orientation), 'eulerd', 'ZYX', 'frame');
            end
            ...
            if hasAccAndAngvel
                angvelP = deg2rad(in.AngularVelocity);
        ...
        function resetImpl(obj)
            resetImpl@fusion.internal.INSSENSORBase(obj);
            obj.pCurrTime = 0;
        ...
        function s = saveObjectImpl(obj)
            ...
            s = saveObjectImpl@fusion.internal.INSSENSORBase(obj);
        ...
        function loadObjectImpl(obj, s, wasLocked)
            ...
            loadObjectImpl@fusion.internal.INSSENSORBase(obj, s, wasLocked);
