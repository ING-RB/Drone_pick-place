function ddz = ddfresnelg2(x,dk,k,theta)
%MATLABSHARED.TRACKING.INTERNAL.SCENARIO.DDFRESNELG2 Second derivative of generalized Fresnel integral
%
%   This function is for internal use only and may be removed in a later
%   release.
%
%   DDZ = MATLABSHARED.TRACKING.INTERNAL.SCENARIO.DDFRESNELG2(L,DK,K,THETA)
