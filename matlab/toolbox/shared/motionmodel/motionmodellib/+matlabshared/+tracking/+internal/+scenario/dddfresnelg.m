function dddz = dddfresnelg(x,dk,k,theta)
%MATLABSHARED.TRACKING.INTERNAL.SCENARIO.DDDFRESNELG Third derivative of generalized Fresnel integral
%
%   This function is for internal use only and may be removed in a later
%   release.
%
%   DDDZ = MATLABSHARED.TRACKING.INTERNAL.SCENARIO.DDDFRESNELG(L,DK,K,THETA)
