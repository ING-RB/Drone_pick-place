...
#ifndef AMCL_PF_KDTREE_H
#define AMCL_PF_KDTREE_H
...
// Create a tree
LIBRARY_API extern pf_kdtree_t *pf_kdtree_alloc(int max_size);

// Destroy a tree
LIBRARY_API extern void pf_kdtree_free(pf_kdtree_t *self);

// Clear all entries from the tree
LIBRARY_API extern void pf_kdtree_clear(pf_kdtree_t *self);

// Insert a pose into the tree
LIBRARY_API extern void pf_kdtree_insert(pf_kdtree_t *self, pf_vector_t pose, double value);

// Cluster the leaves in the tree
LIBRARY_API extern void pf_kdtree_cluster(pf_kdtree_t *self);

// Determine the probability estimate for the given pose
LIBRARY_API extern double pf_kdtree_get_prob(pf_kdtree_t *self, pf_vector_t pose);

// Determine the cluster label for the given pose
LIBRARY_API extern int pf_kdtree_get_cluster(pf_kdtree_t *self, pf_vector_t pose);


#ifdef INCLUDE_RTKGUI

// Draw the tree
LIBRARY_API extern void pf_kdtree_draw(pf_kdtree_t *self, rtk_fig_t *fig);
