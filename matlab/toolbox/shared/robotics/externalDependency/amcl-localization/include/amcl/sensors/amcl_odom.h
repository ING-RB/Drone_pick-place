...
class LIBRARY_API AMCLOdomData : public AMCLSensorData
{
  // Odometric pose
...
class LIBRARY_API AMCLOdom : public AMCLSensor
{
  // Default constructor
  public: AMCLOdom();

  public: void SetModelDiff(double alpha1_in, 
                            double alpha2_in, 
                            double alpha3_in, 
                            double alpha4_in);

  public: void SetModelOmni(double alpha1_in, 
                            double alpha2_in, 
                            double alpha3_in, 
                            double alpha4_in,
                            double alpha5_in);
