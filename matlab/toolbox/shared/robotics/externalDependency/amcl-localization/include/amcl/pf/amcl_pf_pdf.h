...
#ifndef AMCL_PF_PDF_H
#define AMCL_PF_PDF_H
...
LIBRARY_API pf_pdf_gaussian_t *pf_pdf_gaussian_alloc(pf_vector_t x, pf_matrix_t cx);

// Destroy the pdf
LIBRARY_API void pf_pdf_gaussian_free(pf_pdf_gaussian_t *pdf);

// Reset random number generator seed
LIBRARY_API void pf_pdf_reset_seed(unsigned int pdfseed);
...
LIBRARY_API double pf_ran_gaussian(double sigma);

// Generate a sample from the the pdf.
LIBRARY_API pf_vector_t pf_pdf_gaussian_sample(pf_pdf_gaussian_t *pdf);
...
LIBRARY_API pf_pdf_discrete_t *pf_pdf_discrete_alloc(int count, double *probs);

// Destroy the pdf
LIBRARY_API void pf_pdf_discrete_free(pf_pdf_discrete_t *pdf);

// Compute the value of the probability of some element [i]
LIBRARY_API double pf_pdf_discrete_value(pf_pdf_discrete_t *pdf, int i);

// Generate a sample from the the pdf.
LIBRARY_API int pf_pdf_discrete_sample(pf_pdf_discrete_t *pdf);
#endif
