...
// Laser sensor data
class LIBRARY_API AMCLLaserData : public AMCLSensorData
{
  public:
...
class LIBRARY_API AMCLLaser : public AMCLSensor
{
  // Default constructor
  ...
  public: void SetModelBeam(double z_hit_in,
                            double z_short_in,
                            double z_max_in,
                            double z_rand_in,
                            double sigma_hit_in,
                            double labda_short_in,
                            double chi_outlier_in);

  public: void SetModelLikelihoodField(double z_hit_in,
                                       double z_rand_in,
                                       double sigma_hit_in,
                                       double max_occ_dist_in);

  //a more probabilistically correct model - also with the option to do beam skipping
  public: void SetModelLikelihoodFieldProb(double z_hit_in,
					   double z_rand_in,
					   double sigma_hit_in,
					   double max_occ_dist_in, 
					   bool do_beamskip_in, 
  ...
  public: void SetLaserPose(pf_vector_t& laser_pose_in) 
          {this->laser_pose = laser_pose_in;}
  ...
  //temp data that is kept before observations are integrated to each particle (required for beam skipping)
