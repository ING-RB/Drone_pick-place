...
void
AMCLOdom::SetModelDiff(double alpha1_in, 
                       double alpha2_in, 
                       double alpha3_in, 
                       double alpha4_in)
{
  this->model_type = ODOM_MODEL_DIFF;
  this->alpha1 = alpha1_in;
  this->alpha2 = alpha2_in;
  this->alpha3 = alpha3_in;
  this->alpha4 = alpha4_in;
}

void
AMCLOdom::SetModelOmni(double alpha1_in, 
                       double alpha2_in, 
                       double alpha3_in, 
                       double alpha4_in,
                       double alpha5_in)
