...
%  Simulink.Bus object. This allows ROS/Gazebo-specific metadata to stored
%  with the Bus object.
%
...
%    'PrimitiveStringType=string:IsVarLen=1:VarLenCategory=data:VarLenElem=Key_SL_Info:TruncateAction=warn'
...
%   Copyright 2019-2022 The MathWorks, Inc.
    ...
    properties
        ...
        % PropName - Name of the property (needed when the name is
        % on the Simulink reserved list).
        PropName = ''

        % PrimitiveStringType - indicates a string or string[] primitive
        ...
        % Int64Type - Indicates whether this was a u/int64 datatype
        ...
        % VariableBusDefaultLength - Define default length of variable bus
        % field dimensions
        VariableBusDefaultLength = 128
    end
    ...
    methods
        ...
        function obj = set.PrimitiveStringType(obj, val)
            validatestring(lower(val), {'string', 'string[]', ''});
            obj.PrimitiveStringType = lower(val);
        end
        ...
        function desc = toDescription(obj)
            ...
            for i=1:numel(fldnames)
                ...
                elseif ~isempty(obj.(fldnames{i})) && ...
                        ~strcmp(fldnames{i},'VariableBusDefaultLength')
                    % need to avoid VariableBusDefaultLength property as it
