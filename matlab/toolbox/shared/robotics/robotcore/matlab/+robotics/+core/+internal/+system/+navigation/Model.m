classdef (StrictDefaults) Model < matlab.System
...
%#codegen
    ...
    properties (Nontunable)
        ...
        %NumInstances - Number of instances of the guidance model.
        NumInstances = 1;
    end
    ...
    methods (Access = protected)
        ...
        %   object setup the model implementation.
            ...
            basemodel = robotics.core.internal.navigation.ModelFactory.getMotionModel(obj.ModelType, obj.DataType, obj.NumInstances);
            obj.validateStruct(control, basemodel.control('struct', obj.DataType, obj.NumInstances));
            obj.validateStruct(environment, basemodel.environment('struct', obj.DataType, obj.NumInstances));

            if nargin == 5
                obj.validateStruct(config, basemodel.Configuration.toStruct(obj.DataType, obj.NumInstances));
            end
        end
        ...
        %resetImpl initialize / reset discrete-state properties
            ...
            obj.ModelImpl = robotics.core.internal.navigation.ModelFactory.getMotionModel(obj.ModelType, obj.DataType, obj.NumInstances);
            obj.ModelImpl.Name = string(obj.ModelName);
            obj.ModelImpl.Configuration = obj.ModelImpl.Configuration.fromStruct(obj.ModelConfiguration, obj.DataType, obj.NumInstances);
        end
        ...
        %   the motion model
            ...
            if nargin == 5
                obj.ModelImpl.Configuration = obj.ModelImpl.Configuration.fromStruct(config, obj.DataType, obj.NumInstances);
            end

            stateDerivative = cast(derivative(obj.ModelImpl, obj.NumInstances, state, control, environment), obj.DataType);
        end
        ...
        % has to create a local model.
            ...
            model = robotics.core.internal.navigation.ModelFactory.getMotionModel(obj.ModelType, obj.DataType, obj.NumInstances);
            out = size(state(model, 'vector', obj.DataType, obj.NumInstances));
        end
