...
%
%  See also: robotics.utils.internal.PreferenceProfile
    ...
    methods
        ...
        function profile = getProfile(obj)
            if obj.ProfileMap.isKey(obj.ProfileName)
                ...
                assert(isa(profile, 'robotics.utils.internal.PreferenceProfile'));
            else
        ...
        function setProfile(obj, profile)
            validateattributes(profile, {'robotics.utils.internal.PreferenceProfile'}, {'scalar'});
            profile.ProfileName = obj.ProfileName;
    ...
    methods (Access=private)
        ...
        function prefs = loadPrefs(obj)
            ...
            for i=1:numel(profileStructs)
                s = profileStructs{i};
                prefs(s.ProfileName) = ...
                    robotics.utils.internal.PreferenceProfile.setPropsStruct(s, obj.getDefaultProfile());
            end
        end
