...
cufftHandle acquireCUFFTPlan(int rank,
                             int* n,
                             int* inembed,
                             int istride,
                             int idist,
                             cufftType type,
                             int batch) {
    return gcutil::CUFFTPlanManager::getInstance().acquirePlan(
        rank, n, inembed, istride, idist, inembed, istride, idist, type, batch);
}
