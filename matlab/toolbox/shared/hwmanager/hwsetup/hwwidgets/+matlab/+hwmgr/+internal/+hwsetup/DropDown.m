classdef DropDown < matlab.hwmgr.internal.hwsetup.Widget & ...
        matlab.hwmgr.internal.hwsetup.mixin.EnableWidget
    %matlab.hwmgr.internal.hwsetup.Dropdown is a class that defines a HW
    ...
    %   Editable         - Enable Editable Dropdown property ('on' or 'off') 
    %
    %   DROPDOWN Methods
    ...
    %   d = matlab.hwmgr.internal.hwsetup.DropDown.getInstance(w);
    ...
    properties(Access=public, Dependent)
        ...
        % Editable property to configure the dropdown to Editable or not
        Editable
    end
    ...
    methods
        ...
        function set.Editable(obj, value)                        
            set(obj.Peer, 'Editable', value);
        end
        
        function value = get.Editable(obj)           
            value = get(obj.Peer, 'Editable') ;
        end
