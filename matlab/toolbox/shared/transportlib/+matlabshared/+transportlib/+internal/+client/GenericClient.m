classdef GenericClient < handle
    ...
    methods
        ...
        function write(obj, varargin)
            ...
            try
                % Suspend MATLAB timers to avoid timer callbacks from
                % interruption. Refer g3320001. Timer suspension is lifted
                % when the variable goes out of scope at the end of this
                % function.
                timerGuard = matlab.internal.structuredoutput.TimerSuspender; %#ok<NASGU>
                data = varargin{1};
