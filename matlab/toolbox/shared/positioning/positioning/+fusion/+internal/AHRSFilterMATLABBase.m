classdef (Hidden) AHRSFilterMATLABBase < fusion.internal.AHRSFilterBase
%AHRSFILTERMATLABBASE Soft-nontunable properties for ahrsfilter in MATLAB 
%
...
%#codegen
    ...
    properties 
        ...
        %   matrix as a 12-by-12 real, finite matrix. This property is
        %   tunable.
        ...
        %   a finite numeric scalar. This property is tunable.
        SampleRate = 100;
    end
    ...
    methods (Static, Hidden)
        function props = matlabCodegenSoftNontunableProperties(~)
            props = {'SampleRate', 'DecimationFactor', ...
                'InitialProcessNoise'};
        end
    end
end
