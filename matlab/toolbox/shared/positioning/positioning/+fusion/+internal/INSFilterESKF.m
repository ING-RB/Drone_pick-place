classdef (Hidden) INSFilterESKF < fusion.internal.BasicESKF
%INSFilterESKF Abstract class for ESKF-based classes returned by insfilter
%
...
%#codegen 
    ...
    methods
        function obj = INSFilterESKF
            obj = obj@fusion.internal.BasicESKF;
        end
