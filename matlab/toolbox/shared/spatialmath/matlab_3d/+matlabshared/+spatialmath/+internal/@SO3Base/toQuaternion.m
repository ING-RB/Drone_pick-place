...
%toQuaternion Convert so3 rotation to quaternion
%   Q = toQuaternion(T) returns a quaternion array, Q,
%   corresponding to the so3 rotation T. Q will be a column vector of size
...
%#codegen
    ...
    if nargin == 3
        ...
        q = quaternion(obj.M(:,:,idx), "rotmat", "point");
    else
        R = obj.M;
