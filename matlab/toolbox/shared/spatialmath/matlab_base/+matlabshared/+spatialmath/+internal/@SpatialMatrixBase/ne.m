function tf = ne(T1,T2)
%NE Element-by-element inequality check
%
%   T1 ~= T2 does element-by-element comparisons between the
%   arrays T1 and T2 and returns an array with elements set
%   to logical 1 (TRUE) where the underlying matrices are not equal and
%   elements set to logical 0 (FALSE) where they are. T1
