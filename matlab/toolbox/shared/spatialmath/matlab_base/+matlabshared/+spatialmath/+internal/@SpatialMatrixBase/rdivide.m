function o = rdivide(obj1, obj2)
%rdivide Pose composition with element-wise right division
%   T = T1./T2 composes se3 object arrays
%   element-by-element by right dividing each element of T1
%   with each corresponding element of T2. This is the same
%   as calling T1e* inv(T2e) for each element of the input arrays.
