...
% Separate codegen implementation because we use or4() to eliminate if-statements in the generated code.
...
function tf = or4(w,x,y,z)
% Implements a 4-way OR. Because we know the inputs are the same size, turn
