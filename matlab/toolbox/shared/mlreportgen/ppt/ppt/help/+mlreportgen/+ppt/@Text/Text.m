...
%
%     textObj = Text(text) creates a mlreportgen.ppt.Text object with the
...
%    p1 = Paragraph;
%
%    % Create a Text object, with bold and red title content, and append it
%    % to the paragraph
...
%    rptview(ppt);
%
%    See also mlreportgen.ppt.Paragraph, mlreportgen.ppt.TextBox,
%    mlreportgen.ppt.ExternalLink, mlreportgen.ppt.InternalLink
...
properties
     ...
     %Content Text content
     %  Text content, specified as a character vector or a string scalar.
     Content;
     ...
     %  scalar. Use either a CSS color name or a hexadecimal RGB value
     %  or an RGB triplet  (eg. [0 0 1] corresponds to blue color)
     %  or an RGB  triplet string (eg. 'rgb(0,0,255)' corresponds to blue color).
     %
