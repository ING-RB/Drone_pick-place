%mlreportgen.dom.Heading Create a heading paragraph.
%     headingObj = Heading(n) creates an empty level n heading.
%
%     headingObj = Heading(n, 'text') creates a level n heading
%     containing text string.
%
%     headingObj = Heading(n, 'text', 'styleName') creates a level n heading
...
%
%     headingObj = Heading(n, domObj) creates a level n heading
...
%        Children          - Children of this heading
...
properties
     ...
     %    You may specify the color either as a color
     %    name (e.g., 'red') or a hexadecimal RGB value of the form
     %    '#rrggbb', e.g., 'FF0000' or an RGB triplet (eg. [0 0 1] 
     %    corresponds to blue color) or an RGB triplet string
     %    (eg. 'rgb(0,0,255)' corresponds to blue color). 
