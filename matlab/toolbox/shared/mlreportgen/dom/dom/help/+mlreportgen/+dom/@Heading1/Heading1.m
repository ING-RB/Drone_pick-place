%mlreportgen.dom.Heading1 Create a heading paragraph.
%     headingObj = Heading1() creates an empty level 1 heading.
%
%     headingObj = Heading1('text') creates a level 1 heading
%     containing text string.
%
%     headingObj = Heading1('text', 'styleName') creates a level 1 heading
...
%
%     headingObj = Heading1(domObj) creates a level 1 heading
