%mlreportgen.dom.Heading6 Create a heading paragraph.
%     headingObj = Heading6() creates an empty level 6 heading.
%
%     headingObj = Heading6('text') creates a level 6 heading
%     containing text string.
%
%     headingObj = Heading6('text', 'styleName') creates a level 6 heading
...
%
%     headingObj = Heading6(domObj) creates a level 6 heading
