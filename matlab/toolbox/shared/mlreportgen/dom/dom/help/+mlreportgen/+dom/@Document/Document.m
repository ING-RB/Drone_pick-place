...
%        Parent             - Parent of this document
...
%
%     See also mlreportgen.dom.DocumentPart, mlreportgen.dom.Template,
...
properties
    ...
    %    An mlreportgen.dom.EndnoteOptions object specifies endnote options. 
    %    Set the properties of this object to specify endnote options. 
    %    The endnote options specified by the page layout override the endnote 
    %    options specified by the document to which the page layout belongs.
    %    If any property of EndnoteOptions specified in Document is
    %    empty, the default value is used.
    %
    %    See also mlreportgen.dom.EndnoteOptions, mlreportgen.dom.PDFPageLayout.EndnoteOptions,
    %    mlreportgen.dom.DOCXPageLayout.EndnoteOptions
    EndnoteOptions;

    %FootnoteOptions Specifies the formatting options of footnotes
    %    An mlreportgen.dom.FootnoteOptions object specifies footnote options. 
    %    Set the properties of this object to specify footnote options. 
    %    The footnote options specified by the page layout override the footnote 
    %    options specified by the document to which the page layout belongs.
    %    If any property of FootnoteOptions specified in Document is
    %    empty, the default value is used.
    %
    %    See also mlreportgen.dom.FootnoteOptions, mlreportgen.dom.PDFPageLayout.FootnoteOptions
    %    mlreportgen.dom.DOCXPageLayout.FootnoteOptions
    FootnoteOptions;
