...
%    reset = CounterReset() creates an empty couter reset object.
%
%    reset = CounterReset('streams') creates a counter resetter for the
...
%
%    To specify multiple stream names, add a space between the stream names.
%    reset = CounterReset('stream1 stream2 streamN')
%
