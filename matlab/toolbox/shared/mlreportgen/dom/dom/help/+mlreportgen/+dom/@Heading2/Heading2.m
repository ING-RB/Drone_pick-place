%mlreportgen.dom.Heading2 Create a heading paragraph.
%     headingObj = Heading2() creates an empty level 2 heading.
%
%     headingObj = Heading2('text') creates a level 2 heading
%     containing text string.
%
%     headingObj = Heading2('text', 'styleName') creates a level 2 heading
...
%
%     headingObj = Heading2(domObj) creates a level 2 heading
