%mlreportgen.dom.Heading4 Create a heading paragraph.
%     headingObj = Heading4() creates an empty level 4 heading.
%
%     headingObj = Heading4('text') creates a level 4 heading
%     containing text string.
%
%     headingObj = Heading4('text', 'styleName') creates a level 4 heading
...
%
%     headingObj = Heading4(domObj) creates a level 4 heading
