%mlreportgen.dom.Heading3 Create a heading paragraph.
%     headingObj = Heading3() creates an empty level 3 heading.
%
%     headingObj = Heading3('text') creates a level 3 heading
%     containing text string.
%
%     headingObj = Heading3('text', 'styleName') creates a level 3 heading
...
%
%     headingObj = Heading3(domObj) creates a level 3 heading
