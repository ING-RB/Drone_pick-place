...
%
%   entryObj = TableHeaderEntry('text') creates a table header header entry
%   containing a Text object containing the specified text.
%
%   entryObj = TableHeaderEntry('text','StyleName') creates a table header 
%   entry containing a Text object containing the specified text and having 
%   the specified style.
%
