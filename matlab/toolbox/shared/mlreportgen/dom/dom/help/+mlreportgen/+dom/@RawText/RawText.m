...
%
%    text = RawText(htmlMarkup) creates a RawText object containing
...
properties
     ...
     %HTMLText HTML markup to output to an HTML document
     %      The value of this property is included in a document if its
     %      type is "html" or "html-file". The value of this property must 
     %      be valid HTML markup that can be inserted into a body, p, or td
