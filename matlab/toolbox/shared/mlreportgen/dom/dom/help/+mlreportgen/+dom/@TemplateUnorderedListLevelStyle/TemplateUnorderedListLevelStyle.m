%mlreportgen.dom.TemplateUnorderedListLevelStyle Style that formats a level in an unordered list
%    This class represents a level of an unordered list style. Creating an
%    mlreportgen.dom.TemplateUnorderedListStyle object populates the
%    object's Levels property with instances of this class. Use the
%    LevelStyles property to format the unordered list's levels.
%
%    TemplateUnorderedListLevelStyle properties:
%        Level                  - List level modified by this style
%        BulletStyle            - Style of bullet used for this level
%        Formats                - DOM formatting objects that define this style
%        BulletFormats          - DOM formatting objects that apply to this level's list bullets
%        Id                     - Id of this style
...
%     rptview(d);
%
%     See also mlreportgen.dom.TemplateUnorderedListStyle.LevelStyles
...
properties
    ...
    %BulletStyle Style of bullet used for this level
    %     Style of bullet used for this level, specified as a string. 
    %     The default value of this property is "disc". The following
    %     are valid values:
    %
    ...
    %BulletFormats DOM formatting objects that apply to this level's list bullet
    %     Array of DOM formatting objects that are applied to only the list
    %     bullets for this level. This property is ignored for PDF list
    %     styles.
    BulletFormats;
end
%}