%mlreportgen.dom.TemplateUnorderedListStyle Style that formats unordered lists
%    style = TemplateUnorderedListStyle() creates a list style object with
%    default property values. You must set the object's Name property to
%    use this style.
%
%    style = TemplateUnorderedListStyle(name) creates a list style and sets
...
%    style to format lists based on the template. Set an unordered lists's
%    StyleName property to the name of this style to format the list as
%    defined by the style.
%
%    TemplateUnorderedListStyle properties:
...
properties
    ...
    %LevelStyles DOM style objects that define formats for specific list levels
    %     Array of nine mlreportgen.dom.TemplateUnorderedListLevelStyle
