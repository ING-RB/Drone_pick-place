...
%
%   In case of co-linear lines, returns [Inf Inf].
%   In case of parallel but not co-linear lines, returns [NaN NaN].
%
...
%% Check parallel and co-linear lines
...
dx = bsxfun(@minus, newline(:,1), line1(:,1));
dy = bsxfun(@minus, newline(:,2), line1(:,2));
