...
%
%   PP = nav.algs.internal.PUREPURSUITBASE returns a pure pursuit
...
%       pp = nav.algs.internal.PurePursuit;
%
...
%
%   See also controllerPurePursuit, nav.slalgs.internal.PurePursuit.
...
%#ok<*EMCA>
    ...
    properties (Access = {?nav.algs.internal.PurePursuitBase, ?matlab.unittest.TestCase})
    ...
    methods
        ...
        %set.MaxAngularVelocity Setter for Angular Velocity property
            ...
            validateattributes(omega, {'double', 'single'},{'nonnan', 'real', 'scalar', ...
                                'positive', 'nonempty'}, 'controllerPurePursuit', 'MaxAngularVelocity');
        ...
        %set.LookaheadDistance Setter for LookaheadDistance property
            ...
            validateattributes(dist, {'double', 'single'},{'nonnan', 'real', 'scalar', ...
                'nonnegative', 'nonempty', 'finite'},'controllerPurePursuit', 'LookaheadDistance');
        ...
        %set.DesiredLinearVelocity Setter for DesiredLinearVelocity
            ...
            validateattributes(val, {'double', 'single'},{'nonnan', 'real', 'scalar', ...
                'nonnegative', 'nonempty', 'finite'},'controllerPurePursuit', 'DesiredLinearVelocity');
            obj.DesiredLinearVelocity = val;
        end
    end

    methods (Access = {?nav.algs.internal.PurePursuitBase, ?matlab.unittest.TestCase})
        ...
        %stepInternal Compute control commands
            ...
            % If angular velocity is NaN, then set to 0. This can happen if
            % both alpha and LookaheadDistance are 0.
            w(isnan(w)) = cast(0, "like", w);
    ...
    methods (Access = protected)
        ...
        %computeProjectionPoint Find closest point past the last Projection point
            ...
            [obj.ProjectionPoint, minDistance] = ...
                nav.algs.internal.closestPointOnLine(obj.ProjectionPoint, ...
            ...
            for i = obj.ProjectionLineIndex+1:size(waypoints,1)-1
                ...
                [tempPoint, tempDistance] = ...
                    nav.algs.internal.closestPointOnLine(waypoints(i,1:2), ...
    ...
    methods(Static, Access = {?nav.algs.internal.PurePursuitBase})
