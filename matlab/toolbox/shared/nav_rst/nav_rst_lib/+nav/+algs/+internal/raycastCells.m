...
if coder.target('MATLAB')
    % Run mex
    [endPts, middlePts] = ...
        nav.algs.internal.mex.raycastCells(p1, p2, rows, cols, resolution, gridLocation, rangeIsMax);
else
    % Run MATLAB-code
    [~, ~, endPts, middlePts] = ...
        nav.algs.internal.impl.raycastInternal(p1, p2, rows, cols, resolution, gridLocation, rangeIsMax);
end
