classdef SharedAppExportHandler < matlabshared.transportapp.internal.toolstrip.export.ExportHandlerBase

    % SHAREDAPPEXPORTHANDLER handles the business logic for the Shared App
    ...
    %% Lifetime
    methods
        function obj = SharedAppExportHandler(mediator, viewConfiguration)
            arguments
