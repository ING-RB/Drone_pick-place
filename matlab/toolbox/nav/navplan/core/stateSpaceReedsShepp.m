...
%
%   Example:
%      % Create a ReedsShepp state space object
%      space = stateSpaceReedsShepp
%
%      % Calculate ReedsShepp distance between two states
%      dist = distance(space,[2 10 -pi],[0 -2.5 -pi/4])
%
%      % Decrease the minimum turning radius and recalculate
%      space.MinTurningRadius = 0.25;
%      dists = distance(space,[2 10 -pi; 2 10 0],[0 -2.5 -pi/4;...
%      0 -2.5 -pi/2])
%
