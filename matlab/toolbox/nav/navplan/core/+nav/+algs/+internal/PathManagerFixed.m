...
%   Copyright 2021-2023 The MathWorks, Inc.
    ...
    properties (SetAccess = immutable)
        ...
        %                       create a re-sizeable path when 
    ...
    methods
        function obj = PathManagerFixed(waypoints, maxSize)
            ...
            % Reserve max memory for each re-sizeable property. Each
        ...
        function set.Arclengths(obj,s)
            obj.Arclengths = obj.embedMatrix(obj.MaxNumWaypoints,s,2); %#ok<MCSUP>
        end
        ...
        function set.BoundingBoxes(obj,bbox)
            obj.BoundingBoxes = obj.embedMatrix(obj.MaxNumWaypoints,bbox,1); %#ok<MCSUP>
        end
        ...
        function set.SegStarts(obj,ss)
            obj.SegStarts = obj.embedMatrix(obj.MaxNumWaypoints,ss,2); %#ok<MCSUP>
        end
    end
