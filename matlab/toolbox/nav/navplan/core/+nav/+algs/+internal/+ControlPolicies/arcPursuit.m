...
%   Copyright 2021-2023 The MathWorks, Inc.
    ...
    methods
        function [u, numStep] = sampleControl(obj, propagator, q, ~, qTgt)
    ...
    methods (Static)        
        ...
        %   intersects with Q's xy position and tangentially intersects with
        %   QTGT. 
        %   
        ...
        %   See also evaluateArc, plotArc, posePointArc
            ...
            % the goal pose and intersects the current xy point.
            if rGoal > 1e6
                v1 = qTgt(1:2)-q(1:2);
