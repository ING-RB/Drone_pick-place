...
%#codegen
    ...
    methods(Hidden)
        ...
        % to set the builtin heuristic cost function for A* object.
            ...
            obj.AStarObjPointer.HeuristicMethod=distMethod; 
            
	    end
        function val = getHeuristicMethod(obj)
            val = obj.AStarObjPointer.HeuristicMethod;
        end
        ...
        % gcost function for A* object.
            ...
            obj.AStarObjPointer.GCostMethod=distMethod;
        end
        function val = getGCostMethod(obj)
            val = obj.AStarObjPointer.GCostMethod;
        end
        ...
        function setDiagonalSearchFlag(obj,flag)
        % setDiagonalSearchFlag Dispatch DiagonalSearchFlag call which
        % sets the flag for diagonal search for A* object.
        % Call standard builtin in MATLAB
            obj.AStarObjPointer.DiagonalSearchFlag=flag;
        end
        function val = getDiagonalSearchFlag(obj)
        % Call standard builtin in MATLAB
            val = obj.AStarObjPointer.DiagonalSearchFlag;
        end
