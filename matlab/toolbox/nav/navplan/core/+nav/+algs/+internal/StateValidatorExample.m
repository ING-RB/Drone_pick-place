...
%---------------------------------------------------------------------
% Step 1: Define properties to be used by your state validator. These
% are user-defined properties.
    ...
    methods
        % a) Use the constructor to create the state validator object and
        % set the StateSpace property. Add extra arguments if required for
        % your application.
        %
