...
%#codegen
    ...
    methods
        ...
        %       hold off
            ...
            % stateSpaceDubins and stateSpaceReedsShepp are faster in
            % mex if the following section is vectorized.
            if  coder.target("MATLAB") || (isa(obj.StateSpace,'stateSpaceDubins') || ...
    ...
    methods (Access = {?nav.algs.internal.InternalAccess})
        ...
        %   environment is obstacle-free and 0 indicating that the
        %   state is on an obstacle.
        %
        %   [MINDIST, XYPTSOBSTACLE] = nearestObstacleDistance(OBJ,
        %   STATE) also returns XY-coordinate of nearest obstacle grid
