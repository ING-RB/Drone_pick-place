...
%   for TEMPLATETYPE are "StateSpace", "StateValidator", and
%   "StateSampler".
%
%
%   Example:
...
%
%      % Open state sampler template in editor
%      createPlanningTemplate("StateSampler")
%
%   See also nav.StateSpace, nav.StateValidator, nav.StateSampler.
...
%   Copyright 2019-2024 The MathWorks, Inc.
    ...
    templateType = validatestring(templateType, ["StateSpace", "StateValidator", "StateSampler"],...
                                  "createPlanningTemplate", "templateType");
