...
%#codegen
    ...
    methods (Static)
        ...
        function numParticles = getNumParticles(mclObj)
        %getNumParticles Get number of particles from internal object
        %   getNumParticles(MCLOBJ) returns the number of particles from
        %   the nav.algs.internal.MonteCarloLocalization object
        %   MCLOBJ.
            numParticles = mclObj.getNumParticles;
        end
