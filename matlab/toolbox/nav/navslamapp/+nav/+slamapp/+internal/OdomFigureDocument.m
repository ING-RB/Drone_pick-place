...
% Copyright 2018-2023 The MathWorks, Inc.
    ...
    properties (Constant)
        %OdometryLineColor
        OdometryLineColor = "--mw-graphics-colorSpace-rgb-blue";
    end
    ...
    methods
        ...
        %OdomFigureDocument Constructor
            ...
            obj.SensorHandle = patch(obj.SensorTransform, 'XData',vertPos(1,:).', 'YData', vertPos(2,:).', 'LineWidth', 1, 'Visible', 'off');
            ...
            patch(obj.SensorTransform, 'XData',3*vertPos(1,:).', 'YData', 3*vertPos(2,:).', 'FaceColor', 'none', 'EdgeColor', 'none', 'Visible', 'on');
        ...
        %drawOdom
            ...
            if ~isempty(obj.OdomLineObject) && isvalid(obj.OdomLineObject)
                ...
                hold(obj.Axes, 'on');
                obj.OdomLineObject = plot(obj.Axes, poses(:,1), poses(:,2), '.-');      
                matlab.graphics.internal.themes.specifyThemePropertyMappings(obj.OdomLineObject, "Color", obj.OdometryLineColor);
                hold(obj.Axes, 'off');
