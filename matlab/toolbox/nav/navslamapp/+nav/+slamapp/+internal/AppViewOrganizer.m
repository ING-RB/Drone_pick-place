        ...
        %refreshAppViewAccordingToState
            ...
            switch(state)
                ...
                case States.SensorDataReady
                    ...
                    matlab.graphics.internal.themes.specifyThemePropertyMappings(obj.MapFigDoc.InfoText, "BackgroundColor", obj.MapFigDoc.BannerBackgroundColor);
                    matlab.graphics.internal.themes.specifyThemePropertyMappings(obj.MapFigDoc.Banner, "BackgroundColor", obj.MapFigDoc.BannerBackgroundColor);  
                ...
                case States.Mapping
                    ...
                    matlab.graphics.internal.themes.specifyThemePropertyMappings(obj.MapFigDoc.InfoText, "BackgroundColor", obj.MapFigDoc.SyncColor);
                    matlab.graphics.internal.themes.specifyThemePropertyMappings(obj.MapFigDoc.Banner, "BackgroundColor", obj.MapFigDoc.SyncColor); 
