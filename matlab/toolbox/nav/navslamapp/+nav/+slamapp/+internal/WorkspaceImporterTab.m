classdef WorkspaceImporterTab < handle & ...
    ...
    methods
        ...
        %addWSRefreshButtonSection Add "refresh workspace" section
            ...
            button = Button(obj.retrieveMsg('RefreshWSButtonName'), Icon('revert'));
        ...
        %addCloseSection
            ...
            %
            column = section.addColumn();
            button = Button(obj.retrieveMsg('ApplyButtonName'), Icon('apply')); % accept and close
            ...
            column = section.addColumn();
            button = Button(obj.retrieveMsg('CloseButtonName'), Icon('close')); % cancel actions and close
