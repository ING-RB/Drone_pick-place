classdef FigureDocument < handle & ...
    ...
    properties (Constant)
        ...
        BannerBackgroundColor = "--mw-backgroundColor-searchHighlight-secondary"; % pale yellow or beige
        ...
        %RefScanColor
        RefScanColor = "--mw-graphics-colorOrder-1-primary"; % blue

        %RefScanColorGrey
        RefScanColorGrey = "--mw-graphics-colorNeutral-line-primary"; % darker gray

        %CurrentScanColor
        CurrentScanColor = "--mw-graphics-colorOrder-3-primary"; % gold

        %CurrentScanColorGrey
        CurrentScanColorGrey = "--mw-graphics-colorNeutral-line-quaternary"; % lighter gray

        %SyncColor
        SyncColor = "--mw-backgroundColor-primary-warning"; % orange banner giving sort of warning to user to apply sync

        %ConnectorColor
        ConnectorColor = "--mw-graphics-colorNeutral-line-tertiary"; % Black


        %SensorColor
        SensorColor = "--mw-graphics-backgroundColor-axes-primary"; % White

        %SensorEdgeColor
        SensorEdgeColor = "--mw-graphics-colorNeutral-line-tertiary"; % Black
...
methods
    ...
    %FigureDocument Constructor
        ...
        matlab.graphics.internal.themes.specifyThemePropertyMappings(obj.Banner, "BackgroundColor", obj.BannerBackgroundColor);
        ...
        obj.InfoText = uilabel( ...
            ...
            'Position', [1 1 1 1],   ...
            'Visible', 'on');
        matlab.graphics.internal.themes.specifyThemePropertyMappings(obj.InfoText, "BackgroundColor", obj.BannerBackgroundColor);
    ...
    function dim(obj)
    %dim
        matlab.graphics.internal.themes.specifyThemePropertyMappings(obj.RefScanLineObj, "Color", obj.RefScanColorGrey);
        matlab.graphics.internal.themes.specifyThemePropertyMappings(obj.CurrentScanLineObj, "Color", obj.CurrentScanColorGrey);
    end
