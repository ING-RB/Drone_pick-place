...
%   Copyright 2017-2018 The MathWorks, Inc.
    ...
    prodComponentAdapterMap = appdesigner.internal.appmetadata.getProductionComponentAdapterMap();
    ...
    devComponentMetaClasses = appdesigner.internal.appmetadata.findDevComponentAdapter();
    devComponentAdapterMap = appdesigner.internal.appmetadata.createComponentAdapterMap(devComponentMetaClasses);
