...
%    Copyright 2015-2020 The MathWorks, Inc
    ...
    mlappFileNames = dir(fullfile(filePath, ['*', expectedExtension]));
    
    if ~any(strcmp(passedInFileName, {mlappFileNames.name}))       
        ...
        if any(idx)
            ...
            error(message('appmigration:appmigration:InvalidFileName', fullFileName));
        end
    else
