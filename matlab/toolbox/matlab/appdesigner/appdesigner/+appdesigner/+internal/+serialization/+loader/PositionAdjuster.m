        ...
        function updatePosition(obj,component)
            ...
            if ( isprop(component,'Children')) && ~isa( component, 'matlab.ui.control.UIAxes')
                ...
                for i = 1:length(children)
                    ...
                    % Some graphics components are not directly descended
                    % from UIAxes, but they report their parents as UIAxes.
                    % These components must be ignored.
                    % g2272719
                    if isa(childComponent.Parent, 'matlab.ui.control.UIAxes')
                        continue;
                    end
