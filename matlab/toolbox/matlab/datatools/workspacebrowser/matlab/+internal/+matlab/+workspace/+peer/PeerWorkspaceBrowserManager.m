classdef PeerWorkspaceBrowserManager < internal.matlab.workspace.MLWorkspaceBrowserManager & internal.matlab.legacyvariableeditor.peer.PeerManager
    ...
    methods(Access='public')
        function this = PeerWorkspaceBrowserManager(Workspace, Channel)
            this@internal.matlab.legacyvariableeditor.peer.PeerManager(Channel, '/WorkspaceBrowser_Root', false);
    ...
    methods(Access='protected')
        function initialize(this)
            ...
            ViewModel = internal.matlab.legacyvariableeditor.StructureViewModel(DataModel);
