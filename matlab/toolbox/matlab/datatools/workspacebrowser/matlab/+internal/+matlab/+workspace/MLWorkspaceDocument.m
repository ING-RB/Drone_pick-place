classdef MLWorkspaceDocument < internal.matlab.legacyvariableeditor.MLDocument    
    methods
        function this = MLWorkspaceDocument(manager, variable, userContext)
            this@internal.matlab.legacyvariableeditor.MLDocument(manager, variable, userContext);
        end
