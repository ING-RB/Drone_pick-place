classdef PeerWorkspaceBrowserFactory < handle
    ...
    properties (Constant)
        % PeerModelChannel
        PeerModelChannel = '/LegacyWorkspaceBrowserManager';
    ...
    methods(Access='protected')
        function this = PeerWorkspaceBrowserFactory()
            ...
            this.PeerManager = internal.matlab.legacyvariableeditor.peer.PeerManager(internal.matlab.workspace.peer.PeerWorkspaceBrowserFactory.PeerModelChannel, Root, true);
    ...
    methods(Static, Access='public')
        ...
        function obj = createWorkspaceBrowser(Workspace, Channel)
            ...
            if ~isKey(WSBInstances, Channel)
                ...
                % Factory
                veManagerInstances = internal.matlab.legacyvariableeditor.peer.PeerManagerFactory.getManagerInstances();
                if ~isKey(veManagerInstances, Channel)
                    ...
                    internal.matlab.legacyvariableeditor.peer.PeerManagerFactory.getManagerInstances(veManagerInstances);
                end
            ...
            internal.matlab.legacyvariableeditor.peer.PeerUtils.sendPeerEvent(factoryInstance.PeerManager.getRoot(), 'WorkspaceBrowserCreated', 'Workspace', obj.WorkspaceKey, 'Channel', Channel);
        end
...
clb =  @(~,~) (internal.matlab.legacyvariableeditor.peer.PeerManagerFactory.getManagerInstances(veManagerInstances.remove(Channel)));
end
