            ...
            for object = this.ProxyObjects
                ...
                for prop = 1:length(props)
                    ...
                    if isempty(findprop(this, propName))
                        ...
                        % Take the proxy objects property display names and
                        % tooltips
                        this.PropertyDisplayNameMap = object.PropertyDisplayNameMap;
                        this.PropertyTooltipMap = object.PropertyTooltipMap;
