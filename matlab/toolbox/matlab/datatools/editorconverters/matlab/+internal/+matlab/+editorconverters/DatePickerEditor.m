classdef DatePickerEditor < internal.matlab.editorconverters.EditorConverter
    ...
    methods
        ...
        function value = getServerValue(this)
            value = internal.matlab.editorconverters.datatype.Date(this.value);
        end
        ...
        function setServerValue(this, value, ~, ~)
            if isempty(value)
                this.value = NaT;
            elseif isa(value, 'internal.matlab.editorconverters.datatype.Date')
        ...
        function props = getEditorState(~)
            props.editorValueDependencies = {'Limits', 'DisabledDaysOfWeek', 'DisabledDates'};
        end
