classdef ColorEditor < internal.matlab.editorconverters.EditorConverter
    ...
    methods
        ...
        function value = getClientValue(this)
            ...
            if this.isColorKeyword
                value = this.color;
            elseif colorCount>1
                value = [num2str(colorCount) internal.matlab.datatoolsservices.FormatDataUtils.TIMES_SYMBOL '3 double'];
            else
        ...
        function props = getEditorState(this)
            ...
            if strcmp(dataTypeName, 'matlab.graphics.datatype.RGBAColor')
                props.showStyle = true;
    ...
    methods(Access = private)
        function b = isColorKeyword(this)
            b = ischar(this.color) && any(this.color == internal.matlab.editorconverters.ColorEditor.COLOR_ENUMS);
        end
    end
end
