classdef (Abstract) VEAction  < internal.matlab.datatoolsservices.actiondataservice.Action
    ...
    methods 
        ...
        function this = VEAction(props, manager)
            ...
            factory = internal.matlab.legacyvariableeditor.peer.PeerManagerFactory.getInstance();
        ...
        function handleVEDocumentFocus(this, es, ~)
            ...
            if ~isempty(es.FocusedDocument)
                ...
                if isa(es.FocusedDocument.ViewModel,'internal.matlab.legacyvariableeditor.SelectionModel')        
        ...
        function handleDocTypeChanged(this, es, ~)
            if isa(es.ViewModel,'internal.matlab.legacyvariableeditor.SelectionModel')
                if ~isempty(this.veSelectionChangeListener)
                     delete(this.veSelectionChangeListener);
                end
        ...
        function delete(this)
            ...
            this.deleteListener('veDocumentClosedListener');
