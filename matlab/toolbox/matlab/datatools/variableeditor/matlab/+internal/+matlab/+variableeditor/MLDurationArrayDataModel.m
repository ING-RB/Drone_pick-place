classdef MLDurationArrayDataModel < internal.matlab.variableeditor.MLArrayDataModel & internal.matlab.variableeditor.DurationArrayDataModel
    ...
    methods(Access='public')
        ...
        function varargout = setData(this,varargin)
            setStrings = this.setData@internal.matlab.variableeditor.DurationArrayDataModel(varargin{:});
