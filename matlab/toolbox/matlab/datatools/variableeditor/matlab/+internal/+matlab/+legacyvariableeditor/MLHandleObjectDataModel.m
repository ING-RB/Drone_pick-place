classdef MLHandleObjectDataModel < ...
        internal.matlab.legacyvariableeditor.MLObjectDataModel
    ...
    methods(Access = public)
        function this = MLHandleObjectDataModel(name, workspace, useTimer)
            ...
            this@internal.matlab.legacyvariableeditor.MLObjectDataModel(...
                name, workspace);
        ...
        function b = isTimerRunning(this)
            ...
            try
                if ~isempty(this.UpdateTimer) && isvalid(this.UpdateTimer)
                    b = strcmp(this.UpdateTimer.Running, 'on');
                end
            catch
            end
        end
        ...
        function evalStr = executeSetCommand(this, setCommand, errorMsg)
            ...
            evalStr = this.executeSetCommand@internal.matlab.legacyvariableeditor.MLObjectDataModel(...
                setCommand, errorMsg);
    ...
    methods(Access = protected)
        ...
        function propAddedCallback(this, es, ed) %#ok<*INUSD>
        ...
        function firePropertyEvent(this, eventName, properties, values)
            ...
            e = internal.matlab.legacyvariableeditor.PropertyChangeEventData;
