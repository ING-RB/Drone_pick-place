classdef MLTimeTableAdapter < internal.matlab.legacyvariableeditor.MLAdapter
    %MLTableAdapter
    ...
    methods
        function storedValue = get.DataModel(this)
            if isempty(this.DataModel_I)
                this.DataModel = internal.matlab.legacyvariableeditor.MLTimeTableDataModel(this.Name, this.Workspace);
            end
    ...
    methods
        function storedValue = get.ViewModel(this)
            if isempty(this.ViewModel_I)
                this.ViewModel_I = internal.matlab.legacyvariableeditor.TimeTableViewModel(this.DataModel);
            end
    ...
    % Constructor
    methods
        function hObj = MLTimeTableAdapter(name, workspace, data)
            hObj.Name = name;
    ...
    methods(Static)
        function c = getClassType()
            c = internal.matlab.legacyvariableeditor.MLTimeTableDataModel.ClassType;
        end
    end
end
