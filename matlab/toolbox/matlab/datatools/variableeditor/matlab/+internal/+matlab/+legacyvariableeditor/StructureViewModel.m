classdef StructureViewModel < ...
    ...
    methods(Access='public')
        % Constructor
        function this = StructureViewModel(dataModel, viewID)
            if nargin <= 1
                viewID = '';
            end
        ...
        function [renderedData, renderedDims, metaData] = getRenderedData(...
            ...
            renderedData = cell([numRows ...
                internal.matlab.legacyvariableeditor.StructureDataModel.NumberOfColumns]);
        ...
        function varargout = setData(this,varargin)
            ...
            if this.SortAscending || nargin == 2
                varargout{1} = this.setData@internal.matlab.legacyvariableeditor.ArrayViewModel(varargin{:});
                return;
            end
            ...
            varargout{1} = this.setData@internal.matlab.legacyvariableeditor.ArrayViewModel(args{:});
        end
        
        function varargout = setSelection(this, varargin)
            varargout{1} = this.setSelection@internal.matlab.legacyvariableeditor.ArrayViewModel(varargin{:});
