classdef NumericArrayDataModel < internal.matlab.legacyvariableeditor.ArrayDataModel
    ...
    properties (SetObservable=false, SetAccess='private', GetAccess='public', Dependent=false, Hidden=false)
        ...
        % Class Type Property
        ClassType = internal.matlab.legacyvariableeditor.NumericArrayDataModel.NumericTypes;
    end %properties
