classdef StructureDataModel < internal.matlab.legacyvariableeditor.ArrayDataModel & internal.matlab.legacyvariableeditor.EditableVariable
    %StructureDataModel 
    ...
    methods
        ...
        function set.Data(this, newValue)
            ...
            if isempty(fn)
                ...
                % columns
                this.CachedSize = [0, internal.matlab.legacyvariableeditor.StructureDataModel.NumberOfColumns];
            else
