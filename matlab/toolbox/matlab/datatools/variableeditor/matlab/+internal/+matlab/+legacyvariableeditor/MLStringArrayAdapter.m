classdef MLStringArrayAdapter < internal.matlab.legacyvariableeditor.MLAdapter
    ...
    methods
        function storedValue = get.DataModel(this)
            if isempty(this.DataModel_I)
                this.DataModel = internal.matlab.legacyvariableeditor.MLStringArrayDataModel(...
    ...
    methods
        function storedValue = get.ViewModel(this)
            if isempty(this.ViewModel_I)
                this.ViewModel_I = internal.matlab.legacyvariableeditor.StringArrayViewModel(...
                    this.DataModel);
            end
    ...
    methods(Static)
        function c = getClassType()
            c = internal.matlab.legacyvariableeditor.MLStringArrayDataModel.ClassType;
        end
    end
end
