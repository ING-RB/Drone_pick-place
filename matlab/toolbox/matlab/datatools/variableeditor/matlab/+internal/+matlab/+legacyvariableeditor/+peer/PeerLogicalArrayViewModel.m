classdef PeerLogicalArrayViewModel < ...
        ...
        internal.matlab.legacyvariableeditor.LogicalArrayViewModel
    ...
    methods
        ...
        function this = PeerLogicalArrayViewModel(parentNode, variable, viewID, usercontext)
            if nargin < 3 
                usercontext = '';
                viewID = '';
            elseif nargin < 4
            ...
            this = this@internal.matlab.legacyvariableeditor.peer.PeerArrayViewModel(...
                parentNode,variable, 'viewID', viewID);
            this@internal.matlab.legacyvariableeditor.LogicalArrayViewModel(...
            ...
            % logical arrays
            widgets = w(1).getWidgets('', 'logical');
    ...
    methods (Access = public)
        ...
        function [renderedData, renderedDims] = getRenderedData(...
            ...
            data = this.getRenderedData@internal.matlab.legacyvariableeditor.LogicalArrayViewModel(...
                startRow, endRow, startColumn, endColumn);
            this.setCurrentPage(startRow, endRow, startColumn, ...
                endColumn, false);
            
            renderedData = internal.matlab.legacyvariableeditor.peer.PeerLogicalArrayViewModel.getJSONForLogicalData(data, startRow, endRow, startColumn, endColumn);
        ...
        function renderedData = getJSONForLogicalData(data, startRow, endRow, startColumn, endColumn)
            ...
            for row = 1:min(size(renderedData, 1), size(data, 1))
                for col = 1:min(size(renderedData, 2), size(data, 2))
                    jsonData = internal.matlab.legacyvariableeditor.peer.PeerUtils.toJSON(...
                        false, ...
