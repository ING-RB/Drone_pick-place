classdef MLTimeTableAdapter < internal.matlab.variableeditor.MLAdapter
    %MLTableAdapter
    ...
    methods
        function storedValue = get.DataModel(this)
            if isempty(this.DataModel_I)
                this.DataModel = internal.matlab.variableeditor.MLTimeTableDataModel(this.Name, this.Workspace);
            end
    ...
    methods
        function storedValue = get.ViewModel(this)
            if isempty(this.ViewModel_I)
                this.ViewModel_I = internal.matlab.variableeditor.TimeTableViewModel(this.DataModel);
            end
