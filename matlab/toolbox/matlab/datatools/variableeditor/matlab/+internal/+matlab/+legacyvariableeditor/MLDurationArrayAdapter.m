classdef MLDurationArrayAdapter < internal.matlab.legacyvariableeditor.MLAdapter
    ...
    methods
        function storedValue = get.DataModel(this)
            if isempty(this.DataModel_I)
                this.DataModel = internal.matlab.legacyvariableeditor.MLDurationArrayDataModel(this.Name, this.Workspace);
            end
    ...
    methods
        function storedValue = get.ViewModel(this)
            if isempty(this.ViewModel_I)
                this.ViewModel_I = internal.matlab.legacyvariableeditor.DurationArrayViewModel(this.DataModel);
            end
    ...
    methods(Static)
        function c = getClassType()
            c = internal.matlab.legacyvariableeditor.MLDurationArrayDataModel.ClassType;
        end
    end   
end
