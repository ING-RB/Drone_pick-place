classdef MLCalendarDurationArrayAdapter < internal.matlab.legacyvariableeditor.MLAdapter
    %MLCalendarDurationArrayAdapter
    ...
    methods
        function storedValue = get.DataModel(this)
            if isempty(this.DataModel_I)
                this.DataModel = internal.matlab.legacyvariableeditor.MLCalendarDurationArrayDataModel(this.Name, this.Workspace);
            end
    ...
    methods
        function storedValue = get.ViewModel(this)
            if isempty(this.ViewModel_I)
                this.ViewModel_I = internal.matlab.legacyvariableeditor.CalendarDurationArrayViewModel(this.DataModel);
            end
    ...
    % Constructor
    methods
        function hObj = MLCalendarDurationArrayAdapter(name, workspace, data)
            hObj.Name = name;
    ...
    methods(Static)
        function c = getClassType()
            c = internal.matlab.legacyvariableeditor.MLCalendarDurationArrayDataModel.ClassType;
        end
    end
end
