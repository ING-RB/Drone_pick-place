classdef CellArrayViewModel < internal.matlab.legacyvariableeditor.ArrayViewModel
    %CellARRAYVIEWMODEL
    ...
    methods(Access='public')
        ...
        function varargout = getFormattedSelection(this, varargin)
            ...
            if ~isempty(data) && ~isempty(this.SelectedRowIntervals) && ~isempty(this.SelectedColumnIntervals)                                
                selectionString = this.getFormattedSelection@internal.matlab.legacyvariableeditor.BlockSelectionModel();
