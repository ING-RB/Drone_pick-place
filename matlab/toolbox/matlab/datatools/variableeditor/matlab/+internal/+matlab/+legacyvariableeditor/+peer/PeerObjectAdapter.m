classdef PeerObjectAdapter < internal.matlab.legacyvariableeditor.MLObjectAdapter
    %PeerObjectAdapter
    ...
    methods
        function this = PeerObjectAdapter(name, workspace, data)
            ...
            this@internal.matlab.legacyvariableeditor.MLObjectAdapter(name, workspace, data);
        end
    end
    ...
    methods (Access = public)
        ...
        function viewModel = getViewModel(this, document)
            ...
            if (isempty(this.ViewModel_I) || ...
                    ~isa(this.ViewModel_I,'internal.matlab.legacyvariableeditor.peer.PeerObjectViewModel')) && ...
                    ~isempty(document) && ~isempty(document.PeerNode)
                delete(this.ViewModel_I);
                this.ViewModel_I = internal.matlab.legacyvariableeditor.peer.PeerObjectViewModel(...
