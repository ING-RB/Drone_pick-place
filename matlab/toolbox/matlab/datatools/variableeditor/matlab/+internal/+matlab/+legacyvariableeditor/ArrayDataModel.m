classdef ArrayDataModel < internal.matlab.legacyvariableeditor.DataModel & internal.matlab.legacyvariableeditor.EditableVariable
    %ARRAYDATAMODEL 
    ...
    methods(Access='public')
        ...
        function varargout = getData(this,varargin)
            if nargin>=5 && ~isempty(this.Data)
                ...
                % that cannot be concatenated. Fallback to returning entire Data
                try
