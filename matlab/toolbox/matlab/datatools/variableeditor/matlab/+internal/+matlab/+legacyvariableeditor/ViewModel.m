classdef (CaseInsensitiveProperties=true, TruncatedProperties=true, ConstructOnLoad=true) ViewModel < internal.matlab.legacyvariableeditor.Variable & internal.matlab.legacyvariableeditor.EditableVariable & internal.matlab.legacyvariableeditor.ActionMixin& JavaVisible
    % ViewModel
    ...
    methods(Access='public',Abstract=false)
        function [valueSummary, isMeta] = getValueSummaryData(this)
            [valueSummary, isMeta] = internal.matlab.legacyvariableeditor.ViewModel.getValueSummary(this.DataModel.Data);
        end
