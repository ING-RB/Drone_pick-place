classdef MLStructureDataModel < internal.matlab.legacyvariableeditor.MLArrayDataModel & internal.matlab.legacyvariableeditor.StructureDataModel
    ...
    methods(Access='protected')
        function [I,J] = doCompare(this, newData)
            ...
            if length(fieldNames)==length(newFieldNames)
                ...
                % should be changed.
                [I,J] = find(cellfun(@(a,b) ~internal.matlab.legacyvariableeditor.areVariablesEqual(a,b), ...
