classdef ObjectViewModel < internal.matlab.legacyvariableeditor.StructureViewModel
    ...
    methods (Access = public)
        % Constructor
        function this = ObjectViewModel(dataModel, viewID)
            if nargin <= 1
                viewID = '';
            end
            this@internal.matlab.legacyvariableeditor.StructureViewModel(dataModel, viewID);
