...
classdef DataCleaningWorkspace < internal.matlab.legacyvariableeditor.MLWorkspace & dynamicprops
    ...
    methods
        function this = DataCleaningWorkspace(outputName, outputData, variableName, variableDataSummary)
            ...
            this.VariableName_I = variableName;
            ...
            this.setVariableValue(this.VariableName_I, this.DisplayedCategorySummaryTable_I);
