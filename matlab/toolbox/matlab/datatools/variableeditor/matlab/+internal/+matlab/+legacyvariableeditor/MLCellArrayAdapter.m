classdef MLCellArrayAdapter < internal.matlab.legacyvariableeditor.MLAdapter
    %MLCellArrayAdapter
    ...
    methods
        function storedValue = get.DataModel(this)
            if isempty(this.DataModel_I)
                this.DataModel = internal.matlab.legacyvariableeditor.MLCellArrayDataModel(this.Name, this.Workspace);
            end
    ...
    methods
        function storedValue = get.ViewModel(this)
            if isempty(this.ViewModel_I)
                this.ViewModel_I = internal.matlab.legacyvariableeditor.CellArrayViewModel(this.DataModel);
            end
    ...
    % Constructor
    methods
        function hObj = MLCellArrayAdapter(name, workspace, data)
            hObj.Name = name;
    ...
    methods(Static)
        function c = getClassType()
            c = internal.matlab.legacyvariableeditor.MLCellArrayDataModel.ClassType;
        end
    end
end
