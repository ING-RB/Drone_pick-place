classdef MLStructureArrayDataModel < internal.matlab.legacyvariableeditor.MLArrayDataModel & internal.matlab.legacyvariableeditor.StructureArrayDataModel
    ...
    methods(Access='public')    
        ...
        function eq = equalityCheck(this, oldData, newData)
            eq = this.equalityCheck@internal.matlab.legacyvariableeditor.StructureArrayDataModel(oldData, newData);
        end
    end
end
