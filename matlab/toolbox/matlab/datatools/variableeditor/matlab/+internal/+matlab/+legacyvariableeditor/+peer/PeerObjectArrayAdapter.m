classdef PeerObjectArrayAdapter < ...
        internal.matlab.legacyvariableeditor.MLObjectArrayAdapter
    ...
    methods
        function this = PeerObjectArrayAdapter(name, workspace, data)
            this@internal.matlab.legacyvariableeditor.MLObjectArrayAdapter(...
                name, workspace, data);
        end
    end
    ...
    methods
        ...
        function viewModel = getViewModel(this, document)
            if (isempty(this.ViewModel_I) || ...
                    ~isa(this.ViewModel_I, 'internal.matlab.legacyvariableeditor.peer.PeerObjectArrayViewModel')) && ...
