classdef MLNumericArrayAdapter < internal.matlab.legacyvariableeditor.MLAdapter
    %MLNumericArrayAdapter
    ...
    methods
        function storedValue = get.DataModel(this)
            if isempty(this.DataModel_I)
                this.DataModel = internal.matlab.legacyvariableeditor.MLNumericArrayDataModel(this.Name, this.Workspace);
            end
    ...
    methods
        function storedValue = get.ViewModel(this)
            if isempty(this.ViewModel_I)
                this.ViewModel_I = internal.matlab.legacyvariableeditor.NumericArrayViewModel(this.DataModel);
            end
    ...
    % Constructor
    methods
        function hObj = MLNumericArrayAdapter(name, workspace, data)
            hObj.Name = name;
