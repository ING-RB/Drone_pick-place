classdef PeerDurationArrayAdapter < ...
        internal.matlab.legacyvariableeditor.MLDurationArrayAdapter
    ...
    methods
        function this = PeerDurationArrayAdapter(name, workspace, data)
            this@internal.matlab.legacyvariableeditor.MLDurationArrayAdapter( ...
                name, workspace, data);
        end
    end
    ...
    methods(Access='public')
        ...
        function viewModel = getViewModel(this, document)
            if (isempty(this.ViewModel_I) || ...
                    ~isa(this.ViewModel_I, 'internal.matlab.legacyvariableeditor.peer.PeerDurationArrayViewModel')) ...
                    && ~isempty(document) && ~isempty(document.PeerNode)
                delete(this.ViewModel_I);
                this.ViewModel_I = internal.matlab.legacyvariableeditor.peer.PeerDurationArrayViewModel(...
