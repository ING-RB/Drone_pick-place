classdef MLLogicalArrayAdapter < internal.matlab.legacyvariableeditor.MLAdapter
    ...
    methods
        function storedValue = get.DataModel(this)
            ...
            if isempty(this.DataModel_I)
                ...
                this.DataModel = ...
                    internal.matlab.legacyvariableeditor.MLLogicalArrayDataModel(...
    ...
    methods(Static)
        function c = getClassType()
            c = internal.matlab.legacyvariableeditor.LogicalArrayDataModel.ClassType;
        end
    end
end