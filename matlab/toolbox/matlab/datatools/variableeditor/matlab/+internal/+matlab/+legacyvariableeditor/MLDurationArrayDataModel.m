classdef MLDurationArrayDataModel < internal.matlab.legacyvariableeditor.MLArrayDataModel & internal.matlab.legacyvariableeditor.DurationArrayDataModel
    %MLDURATIONARRAYDATAMODEL
    %   MATLAB Duration Array Data Model

    % Copyright 2015 The MathWorks, Inc.
        
    methods(Access='public')
        % Constructor
        function this = MLDurationArrayDataModel(name, workspace)
        ...
        function varargout = setData(this,varargin)
            setStrings = this.setData@internal.matlab.legacyvariableeditor.DurationArrayDataModel(varargin{:});
        ...
        function data = updateData(this, varargin)
            ...
            if isequal(size(origData), size(newData)) && isequaln(origData,newData)
                ...
                % If the format of the duration has changed, pass back
                % empty, which will trigger the client to refresh its view.
                ...
                this.updateData@internal.matlab.legacyvariableeditor.MLArrayDataModel(varargin{1});
            end
            data = this.Data;
        end
    end %methods
