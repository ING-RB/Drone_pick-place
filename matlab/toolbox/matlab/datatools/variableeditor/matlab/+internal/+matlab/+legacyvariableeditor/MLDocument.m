classdef MLDocument < internal.matlab.legacyvariableeditor.Document & internal.matlab.legacyvariableeditor.MLNamedVariableObserver
    ...
    methods
        function this = MLDocument(manager, variable, userContext)
            this@internal.matlab.legacyvariableeditor.Document(manager, variable.DataModel, variable.ViewModel, userContext);
            this@internal.matlab.legacyvariableeditor.MLNamedVariableObserver(variable.getDataModel.Name, variable.getDataModel.Workspace);
        ...
        function data = variableChanged(this, varargin)
            ...
            adapter = [];
            dimsChanged = false;
            if (isa(newData, 'internal.matlab.legacyvariableeditor.VariableEditorMixin'))
                ...
                currAdapterName = this.Manager.getAdapterClassNameForData(class(this.DataModel.Data), ...
                    size(this.DataModel.Data), this.DataModel.Data);
                newAdapterName = this.Manager.getAdapterClassNameForData( newClass, newSize, newData);
            ...
            if ~isempty(adapter)
                ...
                dataChanged = ~internal.matlab.legacyvariableeditor.areVariablesEqual(...
...
%                 end
                ...
                if ~strcmp(this.PreviousFormat, currFormat)
                    ed = internal.matlab.legacyvariableeditor.DataChangeEventData;
