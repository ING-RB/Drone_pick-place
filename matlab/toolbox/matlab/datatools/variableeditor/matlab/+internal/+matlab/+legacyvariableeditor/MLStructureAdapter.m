classdef MLStructureAdapter < internal.matlab.legacyvariableeditor.MLAdapter
    %MLStructureAdapter
    ...
    methods
        function storedValue = get.DataModel(this)
            ...
            if isempty(this.DataModel_I)
                this.DataModel = internal.matlab.legacyvariableeditor.MLStructureDataModel(...
    ...
    methods
        function storedValue = get.ViewModel(this)
            ...
            if isempty(this.ViewModel_I)
                this.ViewModel_I = internal.matlab.legacyvariableeditor.StructureViewModel(...
                    this.DataModel);
            end
    ...
    % Constructor
    methods
        function hObj = MLStructureAdapter(name, workspace, data)
            hObj.Name = name;
    ...
    methods(Static)
        function c = getClassType()
            c = internal.matlab.legacyvariableeditor.MLStructureDataModel.ClassType;
        end
    end
end
