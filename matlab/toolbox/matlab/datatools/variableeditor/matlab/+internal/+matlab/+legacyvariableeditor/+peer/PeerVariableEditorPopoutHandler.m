classdef PeerVariableEditorPopoutHandler < internal.matlab.datatoolsservices.peer.PeerPopoutHandler
    ...
    %the variable editor.
    properties(Constant)        
        cefDialogHandler = "internal.matlab.legacyvariableeditor.peer.PeerVariableEditorPopoutHandler";
    ...
    methods        
        ...
        function close(this)                        
            ...
            if (isprop(this, 'channel'))
                try
                    manager = internal.matlab.legacyvariableeditor.peer.PeerManagerFactory.createInstance(this.channel);                    
    ...
    methods(Static = true)
        function InitDialogHandler(varargin)
            cefHandler = internal.matlab.legacyvariableeditor.peer.PeerVariableEditorPopoutHandler.cefDialogHandler;
            iframeHandler = internal.matlab.legacyvariableeditor.peer.PeerVariableEditorPopoutHandler.iframeDialogHandler;
