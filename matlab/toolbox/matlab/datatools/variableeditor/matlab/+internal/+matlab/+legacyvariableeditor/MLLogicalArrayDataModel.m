classdef MLLogicalArrayDataModel < ...
        internal.matlab.legacyvariableeditor.MLArrayDataModel & ...
        internal.matlab.legacyvariableeditor.LogicalArrayDataModel
    % MLLOGICALARRAYDATAMODEL
    % MATLAB Logical Array Data Model
    
    % Copyright 2015 The MathWorks, Inc.
    
    methods (Access = public)
        % Constructor
        function this = MLLogicalArrayDataModel(name, workspace)
