classdef CategoricalDataModel < ...
        internal.matlab.legacyvariableeditor.ArrayDataModel & ...
        internal.matlab.legacyvariableeditor.EditableVariable
    ...
    methods
        ...
        function set.Data(this, newValue)
            ...
            if reallyDoCopy
                ...
                this.Categories(internal.matlab.datatoolsservices.FormatDataUtils.MAX_CATEGORICALS:end) = [];
