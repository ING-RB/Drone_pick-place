    ...
    methods
        function this = PeerObjectArrayViewModel(parentNode, variable)
            ...
            this = this@internal.matlab.legacyvariableeditor.peer.PeerArrayViewModel(...
                parentNode, variable);
            this@internal.matlab.legacyvariableeditor.ObjectArrayViewModel(...
                variable.DataModel);
            ...
            widgets = widgetRegistryInstance(1).getWidgets('','cell');
        ...
        function [renderedData, renderedDims] = getRenderedData(this, ...
            ...
            % startRow/endRow, startColumn/endColumn.
            data = this.getRenderedData@internal.matlab.legacyvariableeditor.ObjectArrayViewModel(...
                startRow, endRow, startColumn, endColumn);
