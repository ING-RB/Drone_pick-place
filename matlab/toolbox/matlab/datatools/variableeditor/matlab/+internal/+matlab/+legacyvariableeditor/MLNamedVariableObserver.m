classdef MLNamedVariableObserver < internal.matlab.legacyvariableeditor.VariableObserver & internal.matlab.legacyvariableeditor.NamedVariable & JavaVisible
    ...
    methods(Access='public')
        ...
        function this = MLNamedVariableObserver(name, workspace)
            ...
            if isa(workspace, 'internal.matlab.legacyvariableeditor.MLWorkspace')
