classdef PeerManagerFactory < handle
    ...
    properties (Constant)
        % PeerModelChannel
        PeerModelChannel = '/LegacyVariableEditorManager';
    ...
    properties (SetObservable=false, SetAccess='protected', GetAccess='public', Dependent=false, Hidden=false)
        PeerManager;
        Channel = internal.matlab.legacyvariableeditor.peer.PeerManagerFactory.PeerModelChannel;
    end
    ...
    methods(Access='protected')
        function this = PeerManagerFactory()
            Root = [internal.matlab.legacyvariableeditor.peer.PeerManagerFactory.PeerModelChannel '_Root'];
            this.PeerManager = internal.matlab.legacyvariableeditor.peer.PeerManager(internal.matlab.legacyvariableeditor.peer.PeerManagerFactory.PeerModelChannel, Root, true);
            ...
            internal.matlab.legacyvariableeditor.peer.PeerUtils.sendPeerEvent(this.PeerManager.getRoot(), 'FactoryInitialized');
        end
    ...
    methods(Static, Access='public')
        ...
        function obj = getSetFocusedManager(varargin)
            ...
            if nargin == 0 || ...
               ...
               (~isempty(varargin{1}) && ~isa(varargin{1}, 'internal.matlab.legacyvariableeditor.peer.PeerManager')) || ...
               (~isempty(varargin{1}) && strcmp(varargin{1}.Channel,internal.matlab.legacyvariableeditor.peer.PeerManagerFactory.PeerModelChannel))
                return;
            end
            ...
            % Factory Instance
            factoryInstance = internal.matlab.legacyvariableeditor.peer.PeerManagerFactory.getInstance();
            ...
            if ~isempty(oldManager) && isvalid(oldManager)
                internal.matlab.legacyvariableeditor.peer.PeerManagerFactory.inFocusUpdate(true);
                oldManager.HasFocus = false;
                internal.matlab.legacyvariableeditor.peer.PeerManagerFactory.inFocusUpdate(false);
            end
            if ~isempty(newManager)
                internal.matlab.legacyvariableeditor.peer.PeerManagerFactory.inFocusUpdate(true);
        ...
        function setFocusedManager(manager)
            internal.matlab.legacyvariableeditor.peer.PeerManagerFactory.getSetFocusedManager(manager);
        end
    end
    ...
    methods(Static, Access='public')
        ...
        function obj = getInstance(varargin)
            ...
            if isempty(managerInstance) || (nargin>0 && strcmpi(varargin{1},internal.matlab.legacyvariableeditor.peer.PeerManager.ForceNewInstance))
                managerInstance = internal.matlab.legacyvariableeditor.peer.PeerManagerFactory();
            end
            obj = managerInstance;
        end
        ...
        function obj = createManager(Channel, IgnoreUpdates)
            ...
            obj = internal.matlab.legacyvariableeditor.peer.PeerManagerFactory.createInstance(Channel, IgnoreUpdates);
        end
        ...
        function obj = createInstance(Channel, IgnoreUpdates)
            ...
            managerInstances = internal.matlab.legacyvariableeditor.peer.PeerManagerFactory.getManagerInstances();
            ...
            if ~isKey(managerInstances, Channel)
                Root = [Channel '_Root'];
                managerInstance = ...
                       internal.matlab.legacyvariableeditor.peer.PeerManager(...
                ...
                deleteListeners(Channel) = event.listener(managerInstance,...
                    ...
                    @(es,ed) (internal.matlab.legacyvariableeditor.peer.PeerManagerFactory.getManagerInstances(managerInstances.remove(Channel))));

                internal.matlab.legacyvariableeditor.peer.PeerManagerFactory.getManagerInstances(managerInstances);
            end
            
            % Send event for the manager creation
            if (internal.matlab.legacyvariableeditor.peer.PeerUtils.isTestingOn)
               internal.matlab.legacyvariableeditor.peer.PeerUtils.sendPeerEvent(factoryInstance.PeerManager.getRoot(), 'ManagerCreated', 'Channel', Channel); 
            end
        ...
        function startup()
            ...
            [~]=internal.matlab.legacyvariableeditor.peer.PeerManagerFactory.getInstance();
        end

        function obj = getFocusedManager()
            % Get the currently focused manager
            obj = internal.matlab.legacyvariableeditor.peer.PeerManagerFactory.getSetFocusedManager();
        end
    end
end
