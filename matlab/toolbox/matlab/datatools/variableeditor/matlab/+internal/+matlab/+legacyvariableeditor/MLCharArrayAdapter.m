classdef MLCharArrayAdapter < internal.matlab.legacyvariableeditor.MLAdapter
    % MLCharArrayAdapter
    ...
    methods
        function storedValue = get.DataModel(this)
            if isempty(this.DataModel_I)
                this.DataModel = internal.matlab.legacyvariableeditor.MLCharArrayDataModel(...
    ...
    methods
        function storedValue = get.ViewModel(this)
            if isempty(this.ViewModel_I)
                this.ViewModel_I = internal.matlab.legacyvariableeditor.CharArrayViewModel(...
                    this.DataModel);
            end
    ...
    % Constructor
    methods
        function hObj = MLCharArrayAdapter(name, workspace, data)
            hObj.Name = name;
    ...
    methods(Static)
        function c = getClassType()
            c = internal.matlab.legacyvariableeditor.MLCharArrayDataModel.ClassType;
        end
    end
end
