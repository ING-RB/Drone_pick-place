classdef PeerStructureArrayViewModel < internal.matlab.legacyvariableeditor.peer.PeerArrayViewModel & internal.matlab.legacyvariableeditor.StructureArrayViewModel
    ...
    methods
        function this = PeerStructureArrayViewModel(parentNode, variable)
            ...
            this@internal.matlab.legacyvariableeditor.StructureArrayViewModel(variable.DataModel);
        ...
        function [renderedData, renderedDims] = getRenderedData(this, startRow, endRow, ...
            ...
            data = this.getRenderedData@internal.matlab.legacyvariableeditor.StructureArrayViewModel(...
            ...
            for col = 1:size(renderedData,2)
                ...
                for row = 1:size(renderedData,1)
                    ...
                    if isNumericCell && ~isMetaData(row,col) && isscalar(rawDataAtIndex)
                        format('long');
                        cellVal = char(strtrim(matlab.display.internal.obsoleteCellDisp(rawDataAsCell(row+sRow-1,col+sCol-1))));
                    ...
                    % and \t for strings alone
                        data{row,col} = internal.matlab.legacyvariableeditor.peer.PeerUtils.formatGetJSONforCell( rawDataAsCell{row+sRow-1,col+sCol-1}, data{row,col});                                                    
