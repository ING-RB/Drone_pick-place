classdef MLTableAdapter < internal.matlab.legacyvariableeditor.MLAdapter
    %MLTableAdapter
    ...
    methods
        function storedValue = get.DataModel(this)
            if isempty(this.DataModel_I)
                this.DataModel = internal.matlab.legacyvariableeditor.MLTableDataModel(this.Name, this.Workspace);
            end
    ...
    methods
        function storedValue = get.ViewModel(this)
            if isempty(this.ViewModel_I)
                this.ViewModel_I = internal.matlab.legacyvariableeditor.TableViewModel(this.DataModel);
            end
    ...
    methods(Static)
        function c = getClassType()
            c = internal.matlab.legacyvariableeditor.MLTableDataModel.ClassType;
        end
    end
end
