classdef StructureArrayViewModel < internal.matlab.legacyvariableeditor.ArrayViewModel
    ...
    methods(Access='public')
        ...
        function varargout = getFormattedSelection(this, varargin)
            ...
            if isempty(selectedRows) || isempty(selectedColumns)
                ...
                varargout{1} = internal.matlab.legacyvariableeditor.StructureArrayViewModel.getFormattedSelectionString(selectedRows, ...
    ...
    methods(Static=true)
            ...
            if ~isempty(selectedRows) || ~isempty(selectedColumns)
                ...
                for i=1:size(selectedRows,1)
                    ...
                    if (selectedRows(i,1) == selectedRows(i,2))                       
                        ...
                        selectionRowString = [selectionRowString internal.matlab.legacyvariableeditor.StructureArrayViewModel.localCreateSubindex([selectedRows(i,1) selectedRows(i,2)],rowCount)];%#ok<AGROW>
                    end
                end
        ...
        function subindexString = localCreateSubindex(selectedInterval,count)
            subindexString = internal.matlab.legacyvariableeditor.BlockSelectionModel.localCreateSubindex(selectedInterval,count);
