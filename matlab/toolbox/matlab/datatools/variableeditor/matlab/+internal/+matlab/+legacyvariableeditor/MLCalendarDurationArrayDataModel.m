classdef MLCalendarDurationArrayDataModel < internal.matlab.legacyvariableeditor.MLArrayDataModel & internal.matlab.legacyvariableeditor.CalendarDurationArrayDataModel
    ...
    methods(Access='public')
        ...
        function varargout = setData(this,varargin)
            setStrings = this.setData@internal.matlab.legacyvariableeditor.CalendarDurationArrayDataModel(varargin{:});
