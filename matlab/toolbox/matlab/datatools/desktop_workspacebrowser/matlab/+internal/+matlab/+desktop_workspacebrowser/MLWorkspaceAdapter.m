    ...
    methods
        function storedValue = get.DataModel(this)
            ...
            if isempty(this.DataModel_I)
                this.DataModel = internal.matlab.desktop_workspacebrowser.MLWorkspaceDataModel(...
    ...
    methods
        function storedValue = get.ViewModel(this)
            ...
            if isempty(this.ViewModel_I)
                ...
                % Do not create the ViewModel here.  It will be created for the
                % Workspace Browser via the RemoteWorkspaceAdapter class
                % instead.
