...
if ischar(varargin{1})
	compression_scheme = matlab.internal.imagesci.cdflib('getConstantValue',varargin{1});
else
	compression_scheme = varargin{1};
end

if nargin == 3
	matlab.internal.imagesci.cdflib('setVarCompression',cdfid,varnum,compression_scheme);
else
	matlab.internal.imagesci.cdflib('setVarCompression',cdfid,varnum,compression_scheme,varargin{2});
end
