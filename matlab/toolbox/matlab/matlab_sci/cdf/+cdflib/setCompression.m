...
if nargin > 1
    ctype = convertStringsToChars(ctype);
end

if ischar(ctype)
	ctype = matlab.internal.imagesci.cdflib('getConstantValue',ctype);
end

if nargin == 2
	matlab.internal.imagesci.cdflib('setCompression',cdfId,ctype);
else
	matlab.internal.imagesci.cdflib('setCompression',cdfId,ctype,cparm);
end
