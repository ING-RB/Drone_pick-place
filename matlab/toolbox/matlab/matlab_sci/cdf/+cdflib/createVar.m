...
if ischar(dtype)
    ...
    dtype = matlab.internal.imagesci.cdflib('getConstantValue',dtype);
end
validateattributes(recVariance,{'numeric','logical'},{'scalar'},'','RECVARIANCE');
varNum = matlab.internal.imagesci.cdflib('createVar',cdfId,varname,dtype,numElems,dims,recVariance,dimVariance);
