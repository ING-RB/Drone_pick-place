...
if nargin > 2
    stype = convertStringsToChars(stype);
end

if ischar(stype)
	stype = matlab.internal.imagesci.cdflib('getConstantValue',stype);
end
matlab.internal.imagesci.cdflib('setVarSparseRecords',cdfId,varNum,stype);
