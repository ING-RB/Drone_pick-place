...
validateattributes(filename,{'char','string'},{'scalartext','nonempty'},'openFile','FILENAME');
validateattributes(mode,    {'char','string'},{'scalartext','nonempty'},'openFile','MODE');
...
fptr = matlab.internal.imagesci.fitsiolib('open_file',filename,mode);
