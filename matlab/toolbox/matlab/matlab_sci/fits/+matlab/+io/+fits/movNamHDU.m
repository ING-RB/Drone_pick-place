...
if nargin > 1
    hdutype = convertStringsToChars(hdutype);
end
...
hdutype = matlab.internal.imagesci.fitsiolib('get_constant_value',hdutype);

validateattributes(extname,{'char'},{'nonempty'},'','EXTNAME');
validateattributes(extver,{'double'},{'scalar','integer','nonnegative'},'','EXTVER');

matlab.internal.imagesci.fitsiolib('movnam_hdu',fptr,hdutype,extname,extver);
