...
if nargout > 1
    [coldata,nullval] = matlab.internal.imagesci.fitsiolib('read_col',fptr,colnum,firstrow,numrows);
else
    [coldata,~] = matlab.internal.imagesci.fitsiolib('read_col',fptr,colnum,firstrow,numrows);
end
