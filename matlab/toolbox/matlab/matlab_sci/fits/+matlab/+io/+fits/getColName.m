...
if nargin > 1
    templt = convertStringsToChars(templt);
end
...
if casesen
	casesen = matlab.internal.imagesci.fitsiolib('get_constant_value','CASESEN');
else
	casesen = matlab.internal.imagesci.fitsiolib('get_constant_value','CASEINSEN');
end
[colnum,colname] = matlab.internal.imagesci.fitsiolib('get_col_name',fptr,casesen,templt);
