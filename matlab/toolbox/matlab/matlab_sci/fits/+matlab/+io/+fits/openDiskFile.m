...
validateattributes(filename,{'char','string'},{'scalartext','nonempty'},'openDiskFile','FILENAME');
validateattributes(mode,    {'char','string'},{'scalartext','nonempty'},'openDiskFile','MODE');
...
fptr = matlab.internal.imagesci.fitsiolib('open_diskfile',filename,mode);
