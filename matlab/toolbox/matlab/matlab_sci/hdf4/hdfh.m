...
%   HDFH(funcstr,param1,param2,...).  There is a one-to-one correspondence
%   between H functions in the HDF library and valid values for funcstr.
%   For example, HDFH('close',file_id) corresponds to the C library call
%   Hclose(file_id).
%
%   Syntax conventions
%   ------------------
...
%
%   See also HDF, HDFAN, HDFDF24, HDFDFR8, HDFHD, HDFHE, HDFHX, HDFML,  
%            MATLAB.IO.HDF4.SD, HDFV, HDFVF, HDFVH, HDFVS
