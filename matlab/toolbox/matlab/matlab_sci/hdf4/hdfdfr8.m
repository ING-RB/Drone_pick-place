...
%   HDFDFR8 is a gateway to the HDF 8-bit raster image interface (DFR8). 
%
%   The general syntax for HDFDFR8 is
%   HDFDFR8(funcstr,param1,param2,...). There is a one-to-one
%   correspondence between DFR8 functions in the HDF library and valid
...
%
%   See also HDF, MATLAB.IO.HDF4.SD, HDFAN, HDFDF24, HDFH, HDFHD, 
