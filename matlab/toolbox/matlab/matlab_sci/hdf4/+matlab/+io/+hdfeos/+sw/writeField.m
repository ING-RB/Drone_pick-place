...
% HDFEOS currently supports only numeric and char datatypes. For char
% datatypes, we expect inputs to be character arrays and not strings. The
% data to be written need not be converted.
validateattributes(data, {'numeric','char'}, {}, '', 'DATA');
