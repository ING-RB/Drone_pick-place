...
%   
%   PTdeflinkage
%       STATUS = HDFPT('deflinkage',POINT_ID,PARENT,CHILD,LINKFIELD)
...
%   
%   PTupdatelevel
%       STATUS = HDFPT('updatelevel',POINT_ID,LEVEL,FIELDLIST,RECORDS,DATA)
...
%
%   See also HDF, MATLAB.IO.HDFEOS.SW, MATLAB.IO.HDFEOS.GD.
