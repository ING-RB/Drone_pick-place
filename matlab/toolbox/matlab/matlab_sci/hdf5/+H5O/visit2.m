function [status,opdata_out] = visit2(obj_id,index_type,order,cbFunc,opdata_in,fields)
%H5O.visit2  Visit objects accessible from specified object.
%   [status,opdata_out] = H5O.visit2(obj_id,index_type,order,iter_func,opdata_in,fields) 
...
%
%   fields contains flags to determine which fields will be retrieved by
%   the 'cbFunc' callback function.  Valid values are:
...
%                 failure.
%
%   See also H5O, H5O.visit_by_name2, H5O.visit, H5O.visit_by_name.
   
%   Copyright 2021-2024 The MathWorks, Inc.

arguments
    obj_id H5ML.id {mustBeNonempty}
    index_type
    order
...
[status,opdata_out] = matlab.internal.sci.hdf5lib2('H5Ovisit2',...
    obj_id,index_type,order,cbFunc,opdata_in,fields);
