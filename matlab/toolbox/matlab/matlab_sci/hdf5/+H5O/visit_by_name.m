function [status, opdata_out] = visit_by_name(loc_id,obj_name,index_type,order,cbFunc,opdata_in,lapl_id)
...
[status, opdata_out] = matlab.internal.sci.hdf5lib2('H5Ovisit_by_name',...
    loc_id,obj_name,index_type,order,cbFunc,opdata_in,lapl_id);
