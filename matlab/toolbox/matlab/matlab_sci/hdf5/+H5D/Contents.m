...
%   the Dataset Interface contained in the HDF5 User's Guide and Reference 
%   Manual. This documentation may be obtained from The HDF Group at
%   <http://www.hdfgroup.org>.
%
%     close             - Closes the specified dataset.
%     create            - Creates a new dataset.
%     flush             - Flushes all buffers for a dataset.
...
%     refresh           - Refreshes all buffers for a dataset.
