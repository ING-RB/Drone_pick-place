function src_file_name = get_virtual_filename(dcpl_id,mapping_index)
%H5P.get_virtual_filename  Get filename of source dataset in the mapping.
%   src_file_name = get_virtual_filename(dcpl_id,mapping_index) returns
%   the name of the file for a source dataset used in the mapping for the
%   virtual dataset.  dcpl_id is the identifier for the virtual dataset
%   creation property list.  mapping_index is the index of the number
%   of mappings for the virtual dataset (zero or greater, and less than 
%   number of mappings returned by H5P.get_virtual_count).  src_file_name
%   is the name of the file containing the source dataset.
%
%   Example:
...
src_file_name = matlab.internal.sci.hdf5lib2('H5Pget_virtual_filename',...
