function [status, opdata_out]  = visit_by_name(loc_id,group_name,index_type,order,iter_func,opdata_in,lapl_id)
...
%   perform a common function whose function handle is iter_func. The 
...
validateattributes(iter_func,{'function_handle'},{'scalar'},'H5L.visit_by_name','iter_func');
...
[status, opdata_out] = matlab.internal.sci.hdf5lib2('H5Lvisit_by_name',...
    loc_id, group_name, index_type, order, iter_func, opdata_in, lapl_id);            
