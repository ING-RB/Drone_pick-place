...
validateattributes(h5_start, {'numeric'}, {'nonnegative'});
validateattributes(h5_stride, {'numeric'}, {'nonnegative'});
validateattributes(h5_count, {'numeric'}, {'>=',-1});
validateattributes(h5_block, {'numeric'}, {'>=',-1});

matlab.internal.sci.hdf5lib2('H5Sselect_hyperslab',...
    space_id,op,h5_start,h5_stride,h5_count,h5_block);
