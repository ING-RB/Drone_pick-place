...
%   the Dataspace Interface contained in the HDF5 User's Guide and Reference
...
%     get_regular_hyperslab      - Retrieves a regular hyperslab selection.
...
%     is_regular hyperslab       - Determines if a hyperslab selection is regular.
