...
%HDF5lib A gateway to the HDF5 library.  
...
try
	if localNargOut == 0
		matlab.internal.sci.hdf5lib2(functionName,varargin{:});
	else
		[localVarargout{:}] = matlab.internal.sci.hdf5lib2(functionName,varargin{:});
	end
catch ME %#ok<NASGU>
	err = -1;
end
