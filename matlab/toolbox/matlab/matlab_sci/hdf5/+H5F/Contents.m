...
%   the File Interface contained in the HDF5 User's Guide and Reference
%   Manual. This documentation may be obtained from The HDF Group at
...
%     get_intent                   - Returns the read/write or read-only status of a file.
...
%     get_metadata_read_retry_info - Returns metadata read retry information. 
...
%     start_swmr_write             - Enables SWMR writing mode on a file.
