...
%   the Datatype Interface contained in the HDF5 User's Guide and Reference
...
%   flush             - Flushes all buffers of committed datatype to disk.
...
%   refresh           - Refreshes buffers of a committed datatype.
%
%  Array Datatype
