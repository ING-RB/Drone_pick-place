...
if strcmp(action,'initialize')
   ...
   cmdList = char({' surf(z)';' surfl(z)';' mesh(z)';...
   ...
   cmdList = char({' ';' shading flat';' shading interp'});
   callbackStr = 'graf3d eval';
   ...
   cmdList = char({' colormap(gcf, parula)'; ' colormap(gcf, hsv)';' colormap(gcf, jet)'; ...
   ...
   cmdList = char({' ';' axis off';' axis ij';' axis xy'});
   callbackStr = 'graf3d eval';
