...
old_format = format().NumericFormat;
if nargin < 1
   action = 'initialize';
end
...
if strcmp(action,'initialize')
   ...
   popupStr = char('Cape Town','Dakar','London','Miami','Moscow', ...
...
elseif strcmp(action,'hemisphere')
   ...
   if gco == westHndl
      ...
      popupStr = char('Anchorage','Beijing','Guam','Honolulu','Natick', ...
...
elseif nargin == 2
   ...
   [tht3,phi3] = cart2sph(out(1),out(2),out(3));
