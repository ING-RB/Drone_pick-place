function ax = xpsubplt(nrows, ncols, thisPlot)
...
if (thisPlot < 1)
   error('MATLAB:xpsubplt:IllegalPlotNumber','%s',...
      getString(message('MATLAB:demos:shared:IllegalPlotNumber')))
elseif (thisPlot > ncols*nrows)
   error('MATLAB:xpsubplt:IllegalPlotNumber','%s',...
      getString(message('MATLAB:demos:shared:IndexExceedsNumberOfSubplots')))
else
