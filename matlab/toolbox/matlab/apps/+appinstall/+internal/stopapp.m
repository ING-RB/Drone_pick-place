...
function cleanup(obj)
    ...
    allpaths = matlab.internal.apputil.AppUtil.genpath(canonicalpath);
    resourcesfolder = matlab.internal.ResourcesFolderUtils.FolderName;
    pathsToRemove = strrep(strrep(allpaths, [canonicalpath filesep resourcesfolder pathsep], ''), [canonicalpath filesep 'metadata;'], '');
