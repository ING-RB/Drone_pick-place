classdef ExtensionsPathFixture < matlab.unittest.fixtures.PathFixture
    %
    ...
    methods
        function fixture = ExtensionsPathFixture(folders, resourceSpecifications)
            %   FIXTURE = ExtensionsPathFixture(FOLDERS, RESOURCESPECIFICATIONS) constructs a fixture for adding FOLDERS to
            %   the MATLAB path. The fixture subscribes and waits for notifications from specific
            %   resources inside all such root folders using the provided RESOURCESPECIFICATION.
            %
            arguments
                folders string {mustBeNonempty, mustBeNonzeroLengthText}
                resourceSpecifications = []
            end
            fixture@matlab.unittest.fixtures.PathFixture(folders);
            for folder=folders
    ...
    methods(Hidden)
        function setup(fixture)
            ...
            setup@matlab.unittest.fixtures.PathFixture(fixture);
        ...
        function teardown(fixture)
            ...
            teardown@matlab.unittest.fixtures.PathFixture(fixture);
            matlab.internal.mvm.test.flush_cache();
