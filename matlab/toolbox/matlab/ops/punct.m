...
%     It is also used to call superclass methods and to define class
%     folders. Defining a class folder means that the at symbol is used at
%     the beginning of directory names that contain matlab object methods
%     and the constructor for the object, e.g. the directory @inline
%     contains the constructor inline.m for the inline object and all
...
%
%
%     See also COLON, LISTS, PAREN, CD, FUNCTION_HANDLE.
