...
dashX      = mcc_settings.dash_X;

orgDataDetec = matlab.depfun.internal.requirementsSettings.isDataDetectionOn;
if dashX
    matlab.depfun.internal.requirementsSettings.setDataDetection(false);
else
    matlab.depfun.internal.requirementsSettings.setDataDetection(true);
end
resetRequirementsSettings = ...
    onCleanup(@() matlab.depfun.internal.requirementsSettings.setDataDetection(orgDataDetec));
