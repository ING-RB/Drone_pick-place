...
%   Copyright 2012-2024 The MathWorks, Inc.
    ...
    enumeration
        ...
        SimulinkDataDictionary(20) % Simulink Data Dictionary
    end  
    ...
    methods
       ...
       function tf = isClass(t)
        ...
        function tf = isData(t)
            import matlab.depfun.internal.MatlabType;
            tf = (t == MatlabType.Data);
        end
        ...
        function tf = isCppAPI(t)
            import matlab.depfun.internal.MatlabType;
            tf =  (t == MatlabType.CppAPI);
        end

        function tf = isSimulinkModel(t)
            import matlab.depfun.internal.MatlabType;
            tf =  (t == MatlabType.SimulinkModel);
        end

        function tf = isSimulinkDataDictionary(t)
            import matlab.depfun.internal.MatlabType;
            tf =  (t == MatlabType.SimulinkDataDictionary);
        end
    end
end
