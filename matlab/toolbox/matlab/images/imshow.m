...
%
%   'Interpolation'         Interpolation technique when scaling the image,
...
%   Copyright 1993-2025 The MathWorks, Inc.
...
hh = images.internal.basicImageDisplay(fig_handle,ax_handle,...
    cdata,cdatamapping,clim,map,xdata,ydata,interpolation,isSpatiallyReferenced);
...
if new_figure && ~figureDefaultVisibleOff
    ...
    matlab.graphics.internal.InteractionInfoPanel.maybeShow(ax_handle);
end
...
% Ignore first position if filename is a string, looking for p/v pairs.
