...
%   case-insensitive unambiguous match between MAG_IN and the strings in
%   VALID_STRINGS.
%
...
elseif isscalar(in)
  ...
  error('images:checkInitialMagnification:invalidInitialMagnification', '%s',getString(message('MATLAB:images:checkInitialMagnification:invalidInitialMagnification', variable_name, sprintf( '%s ', valid_strings{ : } ))))
