        ...
        function updateBuildInfo(buildInfo,context)
            ...
            switch arch
                case {'win32','win64'}
                    ...
                    nonBuildFiles = {'libmwrgb2gray_tbb'};
                    nonBuildFiles = strcat(binArch,nonBuildFiles, execLibExt);
                
                case {'glnxa64','maca64','maci64'}
                    ...
                    nonBuildFiles = [libstdcpp nonBuildFilesExt];
            ...
            % Add Tbb and TbbMalloc Libs to  nonBuildFiles
            nonBuildFiles = images.internal.coder.importTbbLibs(nonBuildFiles, arch, binArch, execLibExt);
            nonBuildFiles = images.internal.coder.importTbbMallocLibs(nonBuildFiles, arch, binArch, execLibExt);            
