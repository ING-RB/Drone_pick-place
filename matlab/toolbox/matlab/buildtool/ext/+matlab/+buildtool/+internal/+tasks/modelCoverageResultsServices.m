function services = modelCoverageResultsServices()
% This function is unsupported and might change or be removed without notice
% in a future version.

% Copyright 2023-2024 The MathWorks, Inc.

import matlab.buildtool.internal.services.modelcoverage.CoberturaFormatService
import matlab.buildtool.internal.services.modelcoverage.HTMLCoverageReportService


services = [CoberturaFormatService HTMLCoverageReportService locateCoverageResultsServices()];
...
namespace = "matlab.buildtool.internal.services.modelcoverage.located";
