...
function destinationDir = pcodedirs(sourceDir)
    ...
    destinationDir = matlab.lang.internal.introspective.separateImplicitDirs(destinationDir);

    % get the implicit dirs from the source dir
    [~, sourceImplicitDirs] = matlab.lang.internal.introspective.separateImplicitDirs(sourceDir);
