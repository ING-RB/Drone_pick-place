...
if ~isduration(k) && ~istabular(A)
    try
        M = matlab.internal.math.movmean(A,k,varargin{:});
    catch ME
    ...
    M = matlab.internal.math.applyMovFun("movmean", @matlab.internal.math.movmeanInternal, hasBiasOption, omitNaNByDefault, A, k, varargin{:});
end