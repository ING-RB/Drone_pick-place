...
if hasDim
    if ~isvector(dim) || (nargin == 4 && isValidText(dim) && ~strncmpi(dim,'all',max(strlength(dim), 1)))
...
if hasFlag
    ...
    s = strncmpi(flag, {'omitnan', 'includenan','omitmissing','includemissing'}, len);
