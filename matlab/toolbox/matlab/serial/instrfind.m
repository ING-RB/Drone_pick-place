...
%
%   INSTRFIND will be removed in a future release. For serialport,
...
% 
%   OUT = INSTRFIND returns all communication
%   interface objects that exist in memory. The communication interface
