...
%   Copyright 2016-2022 The MathWorks, Inc.
    ...
    properties (Access = private)
        ...
        % Store data from first read for concatenation
        FirstReadData;
    end
    ...
    methods
        ...
        function tds = TallDatastore(files, varargin)
            try
                ...
                if strcmpi(tds.ReadFailureRule,'skipfile')
                    % Initialize the error handling struct to all zeros
    ...
    methods (Access = private)
        ...
        function initializeForConstruction(ds, files, info)
            ...
            % FileExtensions is not supported currently
    ...
    methods (Static, Access = private)
        ...
        function parsedStruct = parseNameValues(varargin)
            ...
            if isempty(inpP)
                ...
                addParameter(inpP, MatSeqDatastore.INCLUDE_SUBFOLDERS_NV_NAME, MatSeqDatastore.DEFAULT_INCLUDE_SUBFOLDERS);
