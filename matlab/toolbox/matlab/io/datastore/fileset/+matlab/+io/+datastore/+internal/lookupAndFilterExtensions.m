...
%lookupAndFilterExtensions    This function is responsible for determining
%   whether a given location is supported by a FileBasedDatastore. It also
%   returns a resolved filelist and the corresponding file sizes.
