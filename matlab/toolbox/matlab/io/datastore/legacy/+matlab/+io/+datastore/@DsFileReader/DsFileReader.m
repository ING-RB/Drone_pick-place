...
%   Copyright 2017-2024 The MathWorks, Inc.
    ...
    properties (Dependent, SetAccess = private)
        ...
        %POSITION Current position in the file in bytes.
    ...
    methods (Access = private)
                ...
                switch inputs.SizeMethod
                    case DsFileReader.SIZE_MODE_SIZE_IN
                        ...
                        try
                            ...
                            seek(fr, -count);
                            if strcmp(ME.identifier,'MATLAB:typecast:unsupportedClass')
                                error(message('MATLAB:datastoreio:dsfilereader:invalidOutputType'));
                            elseif strcmp(ME.identifier, 'MATLAB:typecast:notMultipleInputElements') && ...
                                   count ~= size
        ...
        function handleStreamException(fr, exc)
            ...
            if strcmp(exc.identifier, 'MATLAB:virtualfileio:stream:streamOpenError')
                % Try to create the stream, if open has failed before.
                fr.Stream = iCreateStream(fr.Name, fr.TextEncoding);
            elseif strcmp(exc.identifier, 'MATLAB:virtualfileio:stream:streamNotOpen')
