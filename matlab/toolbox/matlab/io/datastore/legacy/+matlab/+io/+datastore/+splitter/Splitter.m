...
%   Copyright 2015 The MathWorks, Inc.
    ...
    methods(Access = 'public')
        ...
        %   of the data corresponding with the partition and index chosen.
            ...
            import matlab.io.datastore.internal.validators.validatePartitionNumericStrategy;
            validatePartitionNumericStrategy(N, ii);

            % The actual partitioning.
            splitIndices = matlab.io.datastore.internal.util.pigeonHole(N, splitter.NumSplits, ii);
