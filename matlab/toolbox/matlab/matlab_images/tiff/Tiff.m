...
%   Copyright 2009-2023 The MathWorks, Inc.
    ...
    methods
        ...
        function obj = Tiff(filename,mode)
            ...
            obj.FileID = matlab.internal.imagesci.tifflib('open',filename,mode);
        ...
        %       t.close();
            ...
            if ( obj.FileID ~= 0 )
                ...
                matlab.internal.imagesci.tifflib('close',obj.FileID);
        ...
        %   See also Tiff.computeTile.
            ...
            if nargin == 2
                stripNumber = matlab.internal.imagesci.tifflib('computeStrip',obj.FileID,row-1);
            else
                validateattributes(plane,{'double'},{'scalar','positive','<=',65536},'','PLANE');
                stripNumber = matlab.internal.imagesci.tifflib('computeStrip',obj.FileID,row-1,plane-1);
            end
        end
        ...
        %   See also Tiff.computeStrip.
            ...
            if nargin == 2
                tile = matlab.internal.imagesci.tifflib('computeTile',obj.FileID,pixel-1);
            else
                validateattributes(plane,{'double'},{'scalar','positive','<=',65536},'','PLANE');
                tile = matlab.internal.imagesci.tifflib('computeTile',obj.FileID,pixel-1,plane-1);
            end
        end
        ...
        %   See also Tiff.setDirectory.
            ...
            dirNum = matlab.internal.imagesci.tifflib('currentDirectory',obj.FileID);
        end
        ...
        %   See also Tiff.setTag.
            ...
            switch(class(tagId))
                case 'char' 
                    ...
                    tagValue = matlab.internal.imagesci.tifflib('getField',obj.FileID,Tiff.TagID.(tagId));
                ...
                case 'double'
                    ...
                    tagValue = matlab.internal.imagesci.tifflib('getField',obj.FileID,tagId);
        ...
        %       t.close();
            ...
            yn = matlab.internal.imagesci.tifflib('isTiled',obj.FileID);
        end
        ...
        %   See also Tiff.setDirectory.
            ...
            yn = matlab.internal.imagesci.tifflib('lastDirectory',obj.FileID);
        end
        ...
        %   See also Tiff.setDirectory.
            ...
            matlab.internal.imagesci.tifflib('readDirectory',obj.FileID);
        end
        ...
        %   See also Tiff.numberOfTiles, Tiff.isTiled.
            ...
            numStrips = matlab.internal.imagesci.tifflib('numberOfStrips',obj.FileID);
        end
        ...
        %   See also Tiff.numberOfStrips, Tiff.isTiled.
            ...
            numTiles = matlab.internal.imagesci.tifflib('numberOfTiles',obj.FileID);
        end
        ...
        %   See also Tiff.readEncodedTile, Tiff.read.        
            meta = matlab.internal.imagesci.tifflib('retrieveMetadata', obj.FileID);
            ...
            [varargout{:}] = matlab.internal.imagesci.tifflib('readEncodedStrip',obj.FileID,stripNumber-1);
        end
        ...
        %   See also:  Tiff.readEncodedStrip, Tiff.read.       
            ...
            [varargout{:}] = matlab.internal.imagesci.tifflib('readEncodedTile',obj.FileID,tileNumber-1);
        end
        %------------------------------------------------------------------
        ...
        %   See also:  Tiff.writeDirectory.
            ...
            matlab.internal.imagesci.tifflib('rewriteDirectory',obj.FileID);
        end
        ...
        %   See also Tiff.readRGBATile, Tiff.readRGBAImage.
            ...
            x = matlab.internal.imagesci.tifflib('readRGBAStrip',obj.FileID,row-1);
        ...
        %   See also Tiff.readRGBAStrip, Tiff.readRGBAImage.        
            ...
            x = matlab.internal.imagesci.tifflib('readRGBATile',obj.FileID,col-1,row-1);
        ...
        function [RGB,A] = readRGBAImage(obj)
            ...
            try
                meta = matlab.internal.imagesci.tifflib('retrieveMetadata', obj.FileID);
                if meta.RowsPerStrip ~=0 % Stripped image
                   [RGB,A] = readRGBAStrippedImage(obj,meta);
                else
                   [RGB,A] = readRGBATiledImage(obj,meta);
                end
            catch ME
                error(message('MATLAB:imagesci:Tiff:imageReadErrorRGBA'));
            end
        end
        ...
        %   See also Tiff.currentDirectory, Tiff.nextDirectory.
            ...
            matlab.internal.imagesci.tifflib('setDirectory',obj.FileID,dirNum-1);
        end
        ...
        %   See also Tiff.setDirectory.
            ...
            matlab.internal.imagesci.tifflib('setSubDirectory',obj.FileID,dirOff);
        end
        ...
        %   See also Tiff.TagID, Tiff.getTag, Tiff.rewriteDirectory.
            ...
            switch(class(varargin{1}))
                case 'struct' 
                    ...
                    for j = 1:numel(obj.CriticalTags)
                        if isfield(tagstruct, obj.CriticalTags{j})
                            matlab.internal.imagesci.tifflib('setField',obj.FileID, ...
                ...
                case 'char'
                    % convert all strings in the cell to char vectors
                    % for instance, setTag(t,'Artist',"xyz")
                ...
                case {'double', 'single', 'uint8', 'uint16', 'uint32', 'uint64', 'int8', 'int16', 'int32', 'int64'}
                    ...
                    matlab.internal.imagesci.tifflib('setField',obj.FileID,varargin{:});
        ...
        %   See also Tiff.close.
            ...
            matlab.internal.imagesci.tifflib('writeDirectory',obj.FileID);
        end
        ...
        %   See also Tiff.writeEncodedTile, Tiff.write.
            ...
            matlab.internal.imagesci.tifflib('writeEncodedStrip',obj.FileID,stripNumber-1,varargin{:});
        end
        ...
        %   See also Tiff.writeEncodedStrip, Tiff.write.
            ...
            validateattributes(tileNumber,{'double'},{'scalar','positive'},'','TILENUMBER');
            matlab.internal.imagesci.tifflib('writeEncodedTile',obj.FileID,tileNumber-1,varargin{:});
        end
    ...
    methods (Access = protected)
        ...
        function disp_single_obj(obj) 
            ...
            try
                ...
                if strcmp(ME.identifier, 'MATLAB:imagesci:Tiff:noPhotometricYet')
                    % if any of the tags 'Photometric', 'ImageWidth' or
                    % 'ImageLength' are not set
                    displayHeader(header);
                    disp(getString(message( 'MATLAB:imagesci:Tiff:NonDefaultTagsNotSet')));
                    return
                else
                    rethrow(ME);
                end
        ...
        %   See also writeAllYCbCrTiles
            ...
            if spp ~= 3 || config == Tiff.PlanarConfiguration.Separate
            ...
            if ~isequal(size(Y), [h w])
                error(message('MATLAB:imagesci:Tiff:badYChannelDimensions', h, w));
            end
            if ~(isequal(size(Cb), size(Cr)) && isequal(size(Cr), [cbcr_h cbcr_w]))
            ...
            for yrow = 1:rps:sz(1)
                ...
                stripNum = matlab.internal.imagesci.tifflib('computeStrip',obj.FileID,yrow-1);
                ...
                matlab.internal.imagesci.tifflib('writeEncodedStrip', obj.FileID, stripNum-1, ...
                                      Y(yrow_idx,:),...
                                      Cb(cbcr_row_idx,:),...
                                      Cr(cbcr_row_idx,:));
        ...
        %   See also writeAllTiles
            ...
            case Tiff.PlanarConfiguration.Chunky
                ...
                for r = 1:rps:imageLength
                    stripNum = matlab.internal.imagesci.tifflib('computeStrip', obj.FileID, r-1);
                    ...
                    if (spp>1)
                        matlab.internal.imagesci.tifflib('writeEncodedStrip',obj.FileID,stripNum-1,imageData(row_inds,:,:));
                    else
                        matlab.internal.imagesci.tifflib('writeEncodedStrip',obj.FileID, stripNum-1,imageData(row_inds,:));
                    end
                end
            ...
            case Tiff.PlanarConfiguration.Separate
                ...
                for r = 1:rps:imageLength
                    ...
                    for k = 1:spp
                        ...
                        % it to be.
                        stripNum = matlab.internal.imagesci.tifflib('computeStrip',obj.FileID, r-1,k-1);
                        ...
                        matlab.internal.imagesci.tifflib('writeEncodedStrip',obj.FileID,stripNum-1,squeeze(imageData(row_inds,:,k)));
                    end
                end
        ...
        %   See also readAllYCbCrTiles
            ...
            for r = 1:rps:h
                ...
                [yStrip,cbStrip,crStrip] = matlab.internal.imagesci.tifflib('readEncodedStrip', obj.FileID, stripNum-1);
                Y(yrow_inds,:,:) = yStrip;
        ...
        %   See also writeAllTiles
            ...
            if config == Tiff.PlanarConfiguration.Chunky
                ...
                for r = 1:rps:h
                    ...
                    if (spp>1) 
                        imageData(row_inds,:,:) = matlab.internal.imagesci.tifflib('readEncodedStrip',obj.FileID,stripNum-1);
                    else
                        imageData(row_inds,:) = matlab.internal.imagesci.tifflib('readEncodedStrip',obj.FileID,stripNum-1);
                    end
                end
                ...
                for r = 1:rps:h
                    ...
                    for k = 1:spp
                        ...
                        % it to be.
                        stripNum = matlab.internal.imagesci.tifflib('computeStrip',obj.FileID,r-1,k-1);
                        imageData(row_inds,:,k) = ...
                            matlab.internal.imagesci.tifflib('readEncodedStrip',obj.FileID,stripNum-1);
                    end
                end
            end
       ...
       %------------------------------------------------------------------
        ...
        %   See also writeAllYCbCrStrips
            ...
            for yrow = 1:tHeight:sz(1)
                ...
                for ycol = 1:tWidth:sz(2)
                    ...
                    tileNumber = matlab.internal.imagesci.tifflib('computeTile', ...
                        obj.FileID, [yrow ycol]-1);
                    matlab.internal.imagesci.tifflib('writeEncodedTile', ...
                        obj.FileID, tileNumber-1,...
                        Y(yrow_idx,ycol_idx), ...
            ...
            for r = 1:tHeight:imageHeight
                ...
                for c = 1:tWidth:imageWidth
                    ...
                    case Tiff.PlanarConfiguration.Chunky
                        ...
                        if ( spp > 1 )
                            matlab.internal.imagesci.tifflib('writeEncodedTile',...
                                obj.FileID,tileNumber-1,imageData(row_inds,col_inds,:));
                        else
                            matlab.internal.imagesci.tifflib('writeEncodedTile',...
                                obj.FileID,tileNumber-1,imageData(row_inds,col_inds));
                        end
                    ...
                    case Tiff.PlanarConfiguration.Separate
                        ...
                        for k = 1:spp
                            tileNumber = matlab.internal.imagesci.tifflib(...
                                'computeTile',obj.FileID, [r c]-1,k-1);
                            matlab.internal.imagesci.tifflib('writeEncodedTile',...
                                obj.FileID,tileNumber-1,imageData(row_inds,col_inds,k));
                        end
        ...
        %   See also readAllStrips
			...
			for j = 1:numTiles
                tileImage = matlab.internal.imagesci.tifflib('readEncodedTile',...
                    obj.FileID,j-1);
        ...
        %   See also readAllYCbCrStrips
            ...
            for r = 1:tHeight:h
                ...
                for c = 1:tWidth:w
                    ...
                    [ystrip,cbStrip,crStrip] = matlab.internal.imagesci.tifflib('readEncodedTile', obj.FileID, tileNumber-1);
    ...
    methods(Static)
        ...
        %
            ...
            tiffVersion = matlab.internal.imagesci.tifflib('getVersion');
        end
    ...
    methods(Access='private')
        function addRowsPerStripTagIfMissing(obj)
            ...
            if rowsPerStrip == intmax('uint32')
                matlab.internal.imagesci.tifflib('setField', ...
                    obj.FileID, Tiff.TagID.RowsPerStrip, obj.getTag('ImageLength'));
            end
        end
        ...
        function [image,alpha] = readRGBAStrippedImage(obj,meta)
            % Allocate a large array of zeros equivalent to the size
            % of the image which contain the RGB data.
            image = zeros( meta.ImageLength,meta.ImageWidth,3,'uint8');
            
            %Allocate the alpha channel array for the image
            alpha = zeros(meta.ImageLength,meta.ImageWidth,'uint8');
            
            % Read the strips
            startRow = 1;
            while startRow <= meta.ImageLength
                %numRows should be sliceHeight or remaining rows to read
                numRows = min(meta.RowsPerStrip, meta.ImageLength - startRow + 1);
                [data,A] = readRGBAStrip(obj,startRow);
                image(startRow:startRow + numRows-1,:,:) =  data;
                alpha(startRow:startRow + numRows -1,:)  =  A;
                startRow = startRow + numRows;
            end
        end

        function [image,alpha] = readRGBATiledImage(obj,meta)
            % Allocate a large array of zeros equivalent to the size
            % of the image which contain the RGB data.
            image = zeros( meta.ImageLength,meta.ImageWidth,3,'uint8');
            ...
            while startRow <= meta.ImageLength
                %numRows should be sliceHeight or remaining rows to read
                numRows = min(meta.TileLength, meta.ImageLength - startRow + 1);
                startCol = 1;
                while startCol <= meta.ImageWidth
                    % numCols should be sliceWidth or remaining colums
                    % to read
                    numCols = min(meta.TileWidth, meta.ImageWidth - startCol + 1);
                    [data,A] = readRGBATile(obj,startRow, startCol);
                    image(startRow:startRow + numRows-1,...
                        startCol:startCol + numCols-1,...
                        :) = data;
                    
                    alpha(startRow:startRow + numRows-1,...
                        startCol:startCol + numCols-1) = A;
