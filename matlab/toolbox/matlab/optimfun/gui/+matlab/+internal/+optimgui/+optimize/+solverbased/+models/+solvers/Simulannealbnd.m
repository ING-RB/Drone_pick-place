classdef Simulannealbnd < matlab.internal.optimgui.optimize.solverbased.models.BoundsConstrainedSolver
    % obj = matlab.internal.optimgui.optimize.solverbased.models.solver.Simulannealbnd(State)
    % constructs an Simulannealbnd object with the specified State property
    ...
    methods (Access = public)
        ...
        function obj = Simulannealbnd(State)
