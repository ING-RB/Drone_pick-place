classdef Fmincon < matlab.internal.optimgui.optimize.solverbased.models.NonlinearConstrainedSolver
    % obj = matlab.internal.optimgui.optimize.solverbased.models.solver.Fmincon(State)
    % constructs an Fmincon object with the specified State property.
