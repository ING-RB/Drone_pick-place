...
validValues = {fieldnames(matlab.internal.optimfun.utils.createProblemStruct('solvers')), {} };
[validProblemStruct,errmsg,myStruct] = matlab.internal.optimfun.utils.validOptimProblemStruct(myStruct,requiredFields,validValues);
...
myStruct = matlab.internal.optimfun.utils.createProblemStruct(solver,[],myStruct); % Second argument is required but can be []
