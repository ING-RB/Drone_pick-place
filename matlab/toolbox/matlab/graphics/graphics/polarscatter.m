...
try
    ...
    switch e.identifier
        case {'MATLAB:scatter:InvalidXYData','MATLAB:scatter:InvalidXYSizeData'}
        ...
        case 'MATLAB:Chart:InvalidTableSubscript'
            ...
            throw(e)
        case 'MATLAB:scatter:InvalidTableArguments'
            error(message(e.identifier, 'polarscatter', 'theta', 'rho'));
        otherwise
            throw(e);
    end
end
