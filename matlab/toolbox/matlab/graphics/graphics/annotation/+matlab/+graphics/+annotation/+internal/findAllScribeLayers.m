...
% needed
scribelayer = matlab.graphics.annotation.internal.getDefaultCamera(container,'overlay');
...
for k=1:length(childpanels)
    child_scribelayers = [child_scribelayers, ...
        matlab.graphics.annotation.internal.getDefaultCamera(childpanels(k),'overlay','-peek')]; %#ok<AGROW>
end
