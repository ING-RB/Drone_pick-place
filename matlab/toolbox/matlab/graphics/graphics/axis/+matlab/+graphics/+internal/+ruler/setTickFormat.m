function setTickFormat(ruler, val, thetaflag)
...
arguments
    ruler
    val
    thetaflag = false % optional input; specify as true for degree-formated 
                      % theta ruler tick format
end
...
for r = ruler(:)'
    setFormat(r, data, thetaflag)
end

end

function setFormat(r, data, thetaflag)
