...
%   boxchart     - Boxplot chart.
%   comet        - Comet-like trajectory.
%   compass      - Compass plot.
%   errorbar     - Error bar plot.
%   fplot        - Easy to use function plotter.
...
%   scatterhistogram - Scatter plot with marginal histograms.
...
%   fcontour     - Easy to use contour plotter.
%   fimplicit    - Easy to use implicit function plotter.
...
%   fimplicit3   - Easy to use 3-D implicit surface plotter.
%   fmesh        - Easy to use 3-D mesh plotter.
%   fplot3       - Easy to use 3-D parametric curve plotter.
%   fsurf        - Easy to use 3-D colored surface plotter.
...
%   contrast     - Gray scale colormap to enhance image contrast.
%
