...
%   Copyright 2013-2023 The MathWorks, Inc.
    ...
    if ~is3D && strcmp(hScatter.Jitter,'on')
        % Utilizing the same RandomNumberGenerator and seed as
        % AbstractScatter
        customStream = RandStream("dsfmt19937","Seed",4514);
        x = x + (rand(customStream,size(x))-0.5)*(2*hScatter.JitterAmount);
    end
