...
%   'degrees', 'usd', 'eur', 'gbp', 'jpy', 'auto', or a custom numeric
%   format. For example, specify fmt as 'usd' to display the labels as US
%   dollars, or '%,g' to display commas in the thousandth place.
%   
