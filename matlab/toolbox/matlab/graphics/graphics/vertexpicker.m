...
if len==1
   ...
   for n = 1:len
      ...
      if ~isempty(pout{n})
          targetViewer = matlab.graphics.chart.internal.convertDataSpaceCoordsToViewerCoords(ax,target(1,:)');
          poutViewer = matlab.graphics.chart.internal.convertDataSpaceCoordsToViewerCoords(ax,pout{n}');
...
panelpixpos = matlab.graphics.chart.internal.convertDataSpaceCoordsToViewerCoords...
    (ax,target(1,:)');
...
panelpixinterppos = matlab.graphics.chart.internal.convertDataSpaceCoordsToViewerCoords...
    (ax,pout(1,:)');
