...
[hScribeLayer, hPanelScribeLayers] = matlab.graphics.annotation.internal.findAllScribeLayers(hFig);
...
switch lower(item)
    case 'facecolor'
        ...
        matlab.graphics.annotation.internal.scribeContextMenuCallback(obj,evd,'localExecuteColorCallback',hFig,propNames,undoName,'');
        set(obj,'State','off');
    ...
    case 'textfont'
        ...
        matlab.graphics.annotation.internal.scribeContextMenuCallback(obj,evd,'localExecuteFontCallback',hFig,undoName,'');
        set(obj,'State','off');
    case 'textbold'
        hObjs = hMode.ModeStateData.SelectedObjects;
        [propNames, undoName] = localGetPropNames(hObjs(end),'Bold');
        matlab.graphics.annotation.internal.scribeContextMenuCallback(obj,evd,'localUpdateValue',hFig,propNames,'bold',undoName,'');
    case 'textnobold'
        hObjs = hMode.ModeStateData.SelectedObjects;
        propNames = '';
        undoName = '';
        ...
        if ~all(cellfun('isempty',propNames))
            matlab.graphics.annotation.internal.scribeContextMenuCallback(obj,evd,'localUpdateValue',hFig,propNames,'normal',undoName,'');
        end
    case 'textitalic'
        hObjs = hMode.ModeStateData.SelectedObjects;
        [propNames, undoName] = localGetPropNames(hObjs(end),'Italic');
        matlab.graphics.annotation.internal.scribeContextMenuCallback(obj,evd,'localUpdateValue',hFig,propNames,'italic',undoName,'');
    case 'textnoitalic'
        hObjs = hMode.ModeStateData.SelectedObjects;
        propNames = {};
        undoName = '';
    ...
    case 'textleft'
        ...
        matlab.graphics.annotation.internal.scribeContextMenuCallback(obj,evd,'localUpdateValue',hFig,propNames,'left',undoName,'');
    ...
    case 'textcenter'
        ...
        matlab.graphics.annotation.internal.scribeContextMenuCallback(obj,evd,'localUpdateValue',hFig,propNames,'center',undoName,'');
    ...
    case 'textright'
        ...
        matlab.graphics.annotation.internal.scribeContextMenuCallback(obj,evd,'localUpdateValue',hFig,propNames,'right',undoName,'');
