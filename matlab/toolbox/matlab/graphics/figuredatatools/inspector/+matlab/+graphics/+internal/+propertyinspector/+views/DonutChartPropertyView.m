classdef DonutChartPropertyView < internal.matlab.inspector.InspectorProxyMixin & ...
        matlab.graphics.internal.propertyinspector.views.FontSizeMixin
    % This class has the metadata information on the matlab.graphics.chart.DonutChart
    ...
    methods
        function view = DonutChartPropertyView(obj)
            ...
            g1.addProperties('Title','Labels','LabelStyle','CenterLabel','LegendVisible','LegendTitle','Interpreter');
            g1.Expanded = true;
            g1.addSubGroup('LabelsMode','LabelStyleMode');

            g2 = view.createGroup(getString(message('MATLAB:propertyinspector:ColorandStyling')),'','');
            g2.addProperties('ColorOrder','FaceColor','EdgeColor','FaceAlpha','LineWidth','InnerRadius','ExplodedWedges','Direction');
            g2.Expanded = true;
            ...
            g4.addProperties('FontName','FontSize','FontColor','CenterLabelFontSize');
            g4.addSubGroup('CenterLabelFontSizeMode');
