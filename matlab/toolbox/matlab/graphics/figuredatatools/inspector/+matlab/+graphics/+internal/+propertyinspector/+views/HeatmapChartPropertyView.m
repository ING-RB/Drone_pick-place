classdef HeatmapChartPropertyView < internal.matlab.inspector.InspectorProxyMixin & matlab.graphics.internal.propertyinspector.views.FontSizeMixin
    ...
    properties
        ...
        XDisplayLabels
        XLabel
        XLimits internal.matlab.editorconverters.datatype.VectorData
        XVariable
        YData
        YDisplayData
        YDisplayLabels
        YLabel
        YLimits internal.matlab.editorconverters.datatype.VectorData
        YVariable        
    end
    ...
    methods
        function this = HeatmapChartPropertyView(obj)
            ...
            g11 = g1.addSubGroup('');
            g11.addProperties('MissingDataLabel',...
                'Interpreter');
        ...
        function set.XLimits(this, value)
            ...
            for idx = 1:length(this.OriginalObjects)
                if ~isequal(this.OriginalObjects(idx).XLimits,value.getVector)
                    this.OriginalObjects(idx).XLimits = value.getVector;
                end
            end
        ...
        function set.YLimits(this, value)
            ...
            for idx = 1:length(this.OriginalObjects)
                if ~isequal(this.OriginalObjects(idx).YLimits,value.getVector)
                    this.OriginalObjects(idx).YLimits = value.getVector;
                end
            end
