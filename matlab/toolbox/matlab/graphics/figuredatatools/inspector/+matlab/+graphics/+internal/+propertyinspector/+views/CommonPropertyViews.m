    ...
    methods        
        ...
        function createCommonInspectorGroup(this)                   
            g10 = this.createGroup(getString(message('MATLAB:propertyinspector:Interactivity')),'','');
             ...
             if isprop(this,'DataTipTemplate')
                 g10.addProperties('DataTipTemplate');
             end
            ...
            g10.addProperties('Visible','ContextMenu','Selected','SelectionHighlight');
            ...
            % ValueChangedFcn is not always available, add it conditionally
            if isprop(this,'ValueChangedFcn')
                g11.addProperties('ValueChangedFcn');
            end
