classdef PrimitivePolygonPropertyView < matlab.graphics.internal.propertyinspector.views.CommonPropertyViews
    ...
    methods
        function this = PrimitivePolygonPropertyView(obj)
            ...
            g1.addProperties('FaceColor','EdgeColor','HoleEdgeColor','FaceAlpha','SeriesIndex');
            g1.addSubGroup('EdgeAlpha','HoleEdgeAlpha','LineStyle','LineWidth',...
                'LineJoin','AlignVertexCenters','FaceColorMode','HoldeEdgeColorMode',...
                'HoleEdgeAlphaMode');
            g1.Expanded = true;
