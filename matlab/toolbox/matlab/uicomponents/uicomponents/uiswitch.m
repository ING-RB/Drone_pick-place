...
args.defaultClassName = 'matlab.ui.control.Switch';

args.functionName = 'uiswitch';

args.userInputs = varargin;

try
    switchComponent = matlab.ui.control.internal.model.ComponentCreation.createComponentInFamily(args);
catch ex
