...
if (usev0tree(varargin{:}))
    ...
    addOptional(p, 'Parent', [], @(x)isa(x, 'matlab.ui.container.TreeNode')||isa(x, 'matlab.ui.container.internal.model.TreeComponent'));
    ...
    args.className = 'matlab.ui.container.TreeNode';
    
    args.functionName = 'uitreenode';
    
    args.userInputs = componentCreationArgs;
    
    try
        treeNodeComponent = matlab.ui.control.internal.model.ComponentCreation.createComponent(args);
    catch ex
