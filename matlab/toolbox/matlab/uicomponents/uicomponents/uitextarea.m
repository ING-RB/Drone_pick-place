...
args.className = 'matlab.ui.control.TextArea';

args.functionName = 'uitextarea';

args.userInputs = varargin;

try
    textAreaComponent = matlab.ui.control.internal.model.ComponentCreation.createComponent(args);
