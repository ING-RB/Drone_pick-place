...
args.className = 'matlab.ui.control.CheckBox';

args.functionName = 'uicheckbox';

args.userInputs = varargin;

try    
    checkBoxComponent = matlab.ui.control.internal.model.ComponentCreation.createComponent(args);
