...
args.className = 'matlab.ui.control.ListBox';

args.functionName = 'uilistbox';

args.userInputs = varargin;

try
    listBoxComponent = matlab.ui.control.internal.model.ComponentCreation.createComponent(args);
catch ex
