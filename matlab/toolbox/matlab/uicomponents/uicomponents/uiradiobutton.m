...
args.className = 'matlab.ui.control.RadioButton';

args.functionName = 'uiradiobutton';

args.userInputs = varargin;

try
    radioButtonComponent = matlab.ui.control.internal.model.ComponentCreation.createComponent(args);
catch ex
