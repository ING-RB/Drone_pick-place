...
args.defaultClassName = 'matlab.ui.control.EditField';

args.functionName = 'uieditfield';

args.userInputs = varargin;

try
    editfieldComponent = matlab.ui.control.internal.model.ComponentCreation.createComponentInFamily(args);
catch ex
