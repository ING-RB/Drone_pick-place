...
args.defaultClassName = 'matlab.ui.control.Gauge';

args.functionName = 'uigauge';

args.userInputs = varargin;

try
    gaugeComponent = matlab.ui.control.internal.model.ComponentCreation.createComponentInFamily(args);
catch ex
