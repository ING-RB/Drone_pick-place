...
args.defaultClassName = 'matlab.ui.control.Button';

args.functionName = 'uibutton';

args.userInputs = varargin;

try    
    buttonComponent = matlab.ui.control.internal.model.ComponentCreation.createComponentInFamily(args);    
catch ex
