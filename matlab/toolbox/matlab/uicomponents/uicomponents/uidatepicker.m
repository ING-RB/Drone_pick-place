...
args.className = 'matlab.ui.control.DatePicker';

args.functionName = 'uidatepicker';

args.userInputs = varargin;

try
    datePickerComponent = matlab.ui.control.internal.model.ComponentCreation.createComponent(args);
catch exc
