...
args.defaultClassName = 'matlab.ui.control.Knob';

args.functionName = 'uiknob';

args.userInputs = varargin;

try
    knobComponent = matlab.ui.control.internal.model.ComponentCreation.createComponentInFamily(args);
catch ex
