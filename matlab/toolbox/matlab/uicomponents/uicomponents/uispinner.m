...
args.className = 'matlab.ui.control.Spinner';

args.functionName = 'uispinner';

args.userInputs = varargin;

try
    spinnerComponent = matlab.ui.control.internal.model.ComponentCreation.createComponent(args);
catch ex
