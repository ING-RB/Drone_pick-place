classdef (Hidden) HorizontalClippingWithNoneComponent < appdesservices.internal.interfaces.model.AbstractModelMixin
    % This undocumented class may be removed in a future release.
    
    % This is a mixin parent class for all visual components that have an
    % 'HorizontalClipping' property which allows 'none', 'right' and 'left'
    %
    ...
    properties(Access = 'private')
        ...
        PrivateHorizontalClipping = 'none';
    end
        ...
        function set.HorizontalClipping(obj, newValue)
            ...
            try
                ...
                messageObj = message('MATLAB:ui:components:invalidThreeStringEnum', ...
                    'HorizontalClipping', 'none', 'left', 'right');
