classdef (Hidden) IconableComponentController < ...
                ...
                if(strcmp(propertyName, 'Icon'))
                    ...
                    if (~isEmptyFileName)
                        if ~exist(imageFileName, 'file')
                            ...
                            ex = MException(message('MATLAB:ui:components:fileNotFoundOnMatlabPath', 'Icon'));
    ...
    methods
        ...
        function viewPvPairs = getIconPropertiesForView(obj, propertyNames)
            ...
            if (ismemberForStringArrays("Icon", propertyNames))
                iconPvPairs = {'IconURL', obj.Model.IconURL};
    ...
    methods (Static = true)
        ...
        function excludedPropertyNames = getExcludedPropertyNamesForIconableComponent()
            % Property names that needs to be excluded from the properties
            % to sent to the view at Run time
            excludedPropertyNames = {'Icon';};
        end
    end
