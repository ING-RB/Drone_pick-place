classdef WSDropDownDataStrategy < matlab.ui.control.internal.model.SelectedDataValueStrategy

    % Selection Data Strategy for the Workspace Dropdown.  Needed to handle
