classdef (Hidden) AbstractMutualExclusiveComponent < ...
    ...
    properties (Access = {...
            ?appdesservices.internal.interfaces.model.AbstractModel, ... % give access to subclasses
    ...
    events (NotifyAccess = 'private', ...
            ListenAccess = {?matlab.ui.container.ButtonGroup, ...
                            ?matlab.ui.internal.controller.uicontrol.RadioButtonRedirectStrategy, ...
                            ?matlab.ui.internal.controller.uicontrol.ToggleButtonRedirectStrategy} ...
            )
    ...
    methods(Access = {?matlab.ui.container.ButtonGroup})
    ...
    methods(Access = 'protected')
        ...
        function validateParentAndState(obj, newParent)
            ...
            if ~isa(newParent, 'matlab.ui.container.ButtonGroup')
