classdef (Hidden) ExactlyOneSelectionStrategy < matlab.ui.control.internal.model.StateComponentSelectionStrategy
    ...
    methods(Access = {  ?matlab.ui.control.internal.model.StateComponentSelectionStrategy, ...
        ...
        function calibrateSelectedIndexAfterSelectionStrategyChange(obj)
            ...
            % Selected index can be invalid if
            % User typed in a dropdown
            % Value was set to char array when Editable was on 
            % ValueIndex was set to [] programmatically
            if(isSelectedIndexAString || currentIndex == -1)
        ...
        function calibrateSelectedIndexInTextSpace(obj, currentSelectedText)
            ...
            isElementPresent = matlab.ui.control.internal.model.PropertyHandling.isTextElementPresent(currentSelectedText, obj.Component.PrivateItems);
        ...
        function calibrateSelectedIndexInDataSpace(obj, currentSelectedData)
            ...
            maxValidIndex = min(length(obj.Component.PrivateItems), length(obj.Component.PrivateItemsData));
            if ~isnumeric(index) || isempty(index) || index > maxValidIndex
        ...
        function newValue = validateValuePresentInItems(obj, newValue)
            ...
            if(isempty(obj.Component.PrivateItems))
                ...
                % Check whether the new value is in Items
                isValueInItems = matlab.ui.control.internal.model.PropertyHandling.isTextElementPresent(newValue, obj.Component.PrivateItems);
        ...
        function newValueData = validateValuePresentInItemsData(obj, newValueData)
            ...
            if(isempty(obj.Component.PrivateItems))
                ...
                index = matlab.ui.control.internal.model.PropertyHandling.findElementInVector(newValueData, obj.Component.PrivateItemsData);
        ...
        function value = validateValueIndex(obj, index)
            ...
            if(~isnumeric(index) || ~isscalar(index) || rem(index, 1) ~=0 || index < 1 || index > itemsCount)
                messageObj = message('MATLAB:ui:components:invalidValueIndexExactlyOne', ...
                    'ValueIndex', 'Items');
        ...
        function index = getIndexGivenSelectedText(obj, value)
            ...
            index = matlab.ui.control.internal.model.PropertyHandling.findTextElementInVector(value, obj.Component.PrivateItems);
        end
        ...
        function index = getIndexGivenSelectedData(obj, valueData)
            ...
            index = matlab.ui.control.internal.model.PropertyHandling.findElementInVector(valueData, obj.Component.PrivateItemsData);
        end
