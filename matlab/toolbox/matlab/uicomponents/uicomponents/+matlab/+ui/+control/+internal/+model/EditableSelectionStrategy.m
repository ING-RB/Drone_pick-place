classdef (Hidden) EditableSelectionStrategy <  matlab.ui.control.internal.model.ExactlyOneSelectionStrategy
    ...
    methods(Access = {  ?matlab.ui.control.internal.model.StateComponentSelectionStrategy, ...
        ...
        function value = validateValueIndex(obj, index)
            ...
            % If selected index is a string, it is a user edit. Do not
            % change it.  This is only settable from view.
            if(~isSelectedIndexAString)
                % an item was selected
                value = validateValueIndex@matlab.ui.control.internal.model.ExactlyOneSelectionStrategy(obj, index);
            end
        end
        ...
        function index = getIndexGivenSelectedData(obj, value)
            ...
            isInItems = matlab.ui.control.internal.model.PropertyHandling.isElementPresent(value, obj.Component.PrivateItems);
        ...
        function index = getValueIndexGivenSelectedIndex(obj, index)
            ...
            if isequal(index, -1) || ischar(index)
                index = [];
            end
        end
    end
