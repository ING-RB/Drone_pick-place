classdef (Sealed, ConstructOnLoad=true)NinetyDegreeGauge < ...
    ...
    properties (Access = protected, Constant)
        ...
        ValidOrientations cell = {'northwest', 'northeast', 'southwest', 'southeast'};
    end
    ...
    methods
        function obj = NinetyDegreeGauge(varargin)
            ...
            obj.PrivateOrientation = 'northwest';
            
            % Set MajorTicks and Labels to most common default
            obj.PrivateMajorTicks = 0:50:100;
            doSetMajorTicks(obj, obj.MajorTicks, obj.MajorTickLabelsMode);
