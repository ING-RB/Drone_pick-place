classdef (Hidden) ButtonBackgroundColorableComponent < appdesservices.internal.interfaces.model.AbstractModelMixin & ...
    ...
    % background color customization. The default is consistent with
    % button.
    %
    ...
    properties (Dependent)
        ...
        BackgroundColor matlab.internal.datatype.matlab.graphics.datatype.RGBColor = [.96, .96, .96];
        
    end
    properties(AbortSet, Hidden)
        BackgroundColor_I matlab.internal.datatype.matlab.graphics.datatype.RGBColor = [.96, .96, .96];
    ...
    methods (Hidden, Static) 
        ...
        function modifyIncomingSerializationContent(sObj) 
            legacyDefaultBackgroundColor = matlab.ui.control.internal.model.mixin.ButtonBackgroundColorableComponent.DefaultGray;
