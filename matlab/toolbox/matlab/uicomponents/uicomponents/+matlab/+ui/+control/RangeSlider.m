classdef (Sealed, ConstructOnLoad=true) RangeSlider < ...
        ... % Shared slider functionality
        matlab.ui.control.internal.model.mixin.SliderComponent & ...
        matlab.ui.control.internal.model.LimitedRangeValueComponent
    %
    ...
    % ---------------------------------------------------------------------
    methods
        function obj = RangeSlider(varargin)
            %

            % Do not remove above white space
            obj@matlab.ui.control.internal.model.mixin.SliderComponent(varargin{:});
            obj@matlab.ui.control.internal.model.LimitedRangeValueComponent(varargin{:});
    ...
    methods(Access=protected)
        ...
        function updatedProperties = updatePropertiesAfterLimitsChange(obj)
            ...
            obj.updateStepFromLimits();
            updatedProperties = updatePropertiesAfterLimitsChange@matlab.ui.control.internal.model.LimitedRangeValueComponent(obj);
