classdef (Sealed, ConstructOnLoad=true) Lamp < ...
    ...
    properties(Dependent, AbortSet)
        Color matlab.internal.datatype.matlab.graphics.datatype.RGBColor = 'green';
    end
    ...
    properties(Access = 'protected')
        ...
        % Default is green
        PrivateColor matlab.internal.datatype.matlab.graphics.datatype.RGBColor = 'green';
    end
