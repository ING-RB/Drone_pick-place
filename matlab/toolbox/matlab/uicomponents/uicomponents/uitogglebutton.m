...
args.className = 'matlab.ui.control.ToggleButton';

args.functionName = 'uitogglebutton';

args.userInputs = varargin;

try
    toggleButtonComponent = matlab.ui.control.internal.model.ComponentCreation.createComponent(args);
catch ex
