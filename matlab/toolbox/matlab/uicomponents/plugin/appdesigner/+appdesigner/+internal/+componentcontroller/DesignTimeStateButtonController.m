classdef DesignTimeStateButtonController < ...
        matlab.ui.control.internal.controller.StateButtonController & ...
    ...
    %DESIGNTIMESTATEBUTTONCONTROLLER - This class contains design time logic
    %specific to the state button
    
    % Copyright 2020-2021 The MathWorks, Inc.
    
    methods
        function obj = DesignTimeStateButtonController(component, parentController, proxyView, adapter)
            obj = obj@matlab.ui.control.internal.controller.StateButtonController(component, parentController, proxyView);
        ...
        function populateView(obj, proxyView)
            populateView@matlab.ui.control.internal.controller.StateButtonController(obj, proxyView);
    ...
    methods (Access = 'protected')
        ...
        function handleEvent(obj, src, event)
            ...
            if strcmp(event.Data.Name, 'PropertyEditorEdited') && strcmp(event.Data.PropertyName, 'Icon')
                ...
                handleEvent@matlab.ui.control.internal.controller.StateButtonController(obj, src, event);
