classdef DesignTimeTextAreaController < ...
        matlab.ui.control.internal.controller.TextAreaController & ...
        appdesigner.internal.componentcontroller.DesignTimeVisualComponentsController
    %DESIGNTIMETEXTAREACONTROLLER - This class contains design time logic
    %for the TextArea controller.
    
    % Copyright 2020 The MathWorks, Inc.
    
    
    methods
        function obj = DesignTimeTextAreaController(component, parentController, proxyView, adapter)
            obj = obj@matlab.ui.control.internal.controller.TextAreaController(component, parentController, proxyView);
        ...
        function populateView(obj, proxyView)
            populateView@matlab.ui.control.internal.controller.TextAreaController(obj, proxyView);
