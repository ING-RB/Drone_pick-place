classdef NinetyDegreeGaugeAdapter < appdesigner.internal.componentadapter.uicomponents.adapter.BaseUIComponentAdapter
    ...
    properties (SetAccess=protected, GetAccess=public)
        ...
        OrderSpecificProperties = {'Limits','MajorTicks','MajorTickLabels','Orientation','ScaleDirection','MinorTicks'}
        
        % the "Value" property of the component
        ValueProperty = 'Value';        
           
        ComponentType = 'matlab.ui.control.NinetyDegreeGauge';
    end
