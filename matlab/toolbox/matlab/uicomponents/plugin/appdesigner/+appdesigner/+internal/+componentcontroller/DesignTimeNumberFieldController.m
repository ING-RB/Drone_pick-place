classdef DesignTimeNumberFieldController < ...
    ...
    %DESIGNTIMENUMBERFIELDCONTROLLER - This class contains design time logic
    %specific to the Number Field
    
    % Copyright 2020 The MathWorks, Inc.
    
    
    methods
        function obj = DesignTimeNumberFieldController(component, parentController, proxyView, adapter)
            obj = obj@matlab.ui.control.internal.controller.NumberFieldController(component, parentController, proxyView);
        ...
        function populateView(obj, proxyView)
            populateView@matlab.ui.control.internal.controller.NumberFieldController(obj, proxyView);
