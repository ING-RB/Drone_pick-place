classdef DesignTimeLabelController < ...
        matlab.ui.control.internal.controller.LabelController & ...
        appdesigner.internal.componentcontroller.DesignTimeVisualComponentsController
    %DESIGNTIMELABELCONTROLLER - This class contains design time logic
    %specific to the Label
    
    % Copyright 2020 The MathWorks, Inc.
    
    
    methods
        function obj = DesignTimeLabelController(component, parentController, proxyView, adapter)
            obj = obj@matlab.ui.control.internal.controller.LabelController(component, parentController, proxyView);
        ...
        function populateView(obj, proxyView)
            populateView@matlab.ui.control.internal.controller.LabelController(obj, proxyView);
