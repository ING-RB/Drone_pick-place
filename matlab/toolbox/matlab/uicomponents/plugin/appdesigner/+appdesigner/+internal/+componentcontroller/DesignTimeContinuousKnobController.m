classdef DesignTimeContinuousKnobController < ...
        matlab.ui.control.internal.controller.ContinuousKnobController & ...
        appdesigner.internal.componentcontroller.DesignTimeVisualComponentsController
    %DESIGNTIMECONTINUOUSKNOBCONTROLLER - This class contains design time logic
    %specific to the continuous knob
    
    % Copyright 2020 The MathWorks, Inc.
    
    
    methods
        function obj = DesignTimeContinuousKnobController(component, parentController, proxyView, adapter)
            obj = obj@matlab.ui.control.internal.controller.ContinuousKnobController(component, parentController, proxyView);
        ...
        function populateView(obj, proxyView)
            populateView@matlab.ui.control.internal.controller.ContinuousKnobController(obj, proxyView);
