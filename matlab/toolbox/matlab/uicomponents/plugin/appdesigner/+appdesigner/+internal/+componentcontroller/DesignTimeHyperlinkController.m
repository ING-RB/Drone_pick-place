classdef DesignTimeHyperlinkController < ...
        matlab.ui.control.internal.controller.HyperlinkController & ...
    ...
    % DESIGNTIMEHYPERLINKCONTROLLER - This class contains design time logic
    % specific to the Hyperlink
    
    % Copyright 2020 The MathWorks, Inc.
    
    methods
        function obj = DesignTimeHyperlinkController(component, parentController, proxyView, adapter)
            obj = obj@matlab.ui.control.internal.controller.HyperlinkController(component, parentController, proxyView);
        ...
        function populateView(obj, proxyView)
            populateView@matlab.ui.control.internal.controller.HyperlinkController(obj, proxyView);
