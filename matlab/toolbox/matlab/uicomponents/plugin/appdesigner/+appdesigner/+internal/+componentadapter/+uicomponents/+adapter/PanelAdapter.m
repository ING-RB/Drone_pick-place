classdef PanelAdapter < appdesigner.internal.componentadapter.uicomponents.adapter.BaseUIComponentAdapter
    % Adapter for Panel
    ...
    properties (SetAccess=protected, GetAccess=public)
        ...
        ComponentType = 'matlab.ui.container.Panel';
    end
    ...
    % ---------------------------------------------------------------------
    methods
        function obj = PanelAdapter(varargin)
        ...
        function propertyNames = getCodeGenPropertyNames(obj, componentHandle)
            ...
            propertyNames = [ ...
                ...
                [ignoredProperties, propertiesAtBeginning, propertiesAtEnd], 'stable');...
                propertiesAtEnd' ...                
            ];
        ...
        function controllerClass = getComponentDesignTimeController(obj)
            controllerClass = 'matlab.ui.internal.DesignTimePanelController';
        end
    end
    ...
    methods (Access = protected)
        function applyCustomComponentDesignTimeDefaults(obj, component)
            ...
            component.Title = getString(message('MATLAB:ui:defaults:PanelTitle'));
        end
    end
    ...
    methods(Static)
        function adapter = getJavaScriptAdapter()
            adapter = 'uicomponents_appdesigner_plugin/model/PanelModel';
        end       
    end
    ...
    methods(Static)
        ...
        function codeSnippet = getCodeGenCreation(componentHandle, codeName, parentName)
            codeSnippet = sprintf('uipanel(%s)', parentName);
        end
    end
end
