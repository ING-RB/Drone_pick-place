classdef DesignTimeDropDownController < ...
	...
	%DESIGNTIMEDROPDOWNCONTROLLER - This class contains design time logic
	%specific to the DROPDOWN
    
    % Copyright 2020-2024 The MathWorks, Inc.
	
	
	methods
		function obj = DesignTimeDropDownController(component, parentController, proxyView, adapter)
			obj = obj@matlab.ui.control.internal.controller.DropDownController(component, parentController, proxyView);
        ...
        function populateView(obj, proxyView)
            populateView@matlab.ui.control.internal.controller.DropDownController(obj, proxyView);
	...
	methods
        ...
        function adjustedProperties = adjustParsedCodegenPropertiesForAppLoad(obj, parsedProperties)
            ...
            adjustedProperties{end+1} = 'SelectedIndex';
        end
