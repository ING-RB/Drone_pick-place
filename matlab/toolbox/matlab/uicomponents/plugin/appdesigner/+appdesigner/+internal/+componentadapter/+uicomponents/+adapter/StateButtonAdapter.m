classdef StateButtonAdapter < appdesigner.internal.componentadapter.uicomponents.adapter.BaseUIComponentAdapter
    % Adapter for State Button
    ...
    properties(SetAccess=protected, GetAccess=public)
        ...
        ComponentType = 'matlab.ui.control.StateButton';
    end
    ...
    % ---------------------------------------------------------------------
    methods
        function obj = StateButtonAdapter(varargin)
    ...
    methods(Static)
        function adapter = getJavaScriptAdapter()
            adapter = 'uicomponents_appdesigner_plugin/model/StateButtonModel';
        end
    end
    ...
    methods(Static)
        ...
        function codeSnippet = getCodeGenCreation(componentHandle, codeName, parentName)
            ...
            codeSnippet = sprintf('uibutton(%s, ''state'')', parentName);
        end
    end
end
