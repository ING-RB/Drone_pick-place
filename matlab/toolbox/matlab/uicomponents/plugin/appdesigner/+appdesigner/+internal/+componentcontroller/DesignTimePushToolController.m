classdef DesignTimePushToolController < ...
        appdesigner.internal.componentcontroller.DesignTimeToolController & ...
        matlab.ui.internal.controller.WebPushToolController     
    
    % DesignTimePushToolController - A push tool controller class which
    ...
    methods
        function obj = DesignTimePushToolController( model, parentController, proxyView, adapter)
            % CONSTRUCTOR
            ...
            obj = obj@matlab.ui.internal.controller.WebPushToolController(model, parentController, proxyView);
    ...
    methods (Access = 'protected')
        ...
        function additionalPropertyNamesForView = getAdditionalPropertyNamesForView(obj)
            ...
            % The ClickedCallback is not pushed to the view by
            % PropertyManagementService and must be defined here.
