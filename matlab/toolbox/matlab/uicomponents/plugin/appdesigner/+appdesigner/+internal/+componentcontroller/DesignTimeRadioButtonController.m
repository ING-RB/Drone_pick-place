classdef DesignTimeRadioButtonController < ...
        matlab.ui.control.internal.controller.RadioButtonController & ...
        appdesigner.internal.componentcontroller.DesignTimeVisualComponentsController
    %DESIGNTIMERADIOBUTTONCONTROLLER - This class contains design time logic
    %specific to the radio button
    
    % Copyright 2020 The MathWorks, Inc.
    
    
    methods
        function obj = DesignTimeRadioButtonController(component, parentController, proxyView, adapter)
            obj = obj@matlab.ui.control.internal.controller.RadioButtonController(component, parentController, proxyView);
        ...
        function populateView(obj, proxyView)
            populateView@matlab.ui.control.internal.controller.RadioButtonController(obj, proxyView);
