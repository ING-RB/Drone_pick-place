classdef NumericEditFieldAdapter < appdesigner.internal.componentadapter.uicomponents.adapter.BaseUIComponentAdapter
    ...
    properties (SetAccess=protected, GetAccess=public)
        ...
        ComponentType = 'matlab.ui.control.NumericEditField';
    end
    ...
    % ---------------------------------------------------------------------
    methods
        function obj = NumericEditFieldAdapter(varargin)
