classdef HyperlinkAdapter < appdesigner.internal.componentadapter.uicomponents.adapter.BaseUIComponentAdapter
    % Adapter for Hyperlink
    ...
    properties (SetAccess=protected, GetAccess=public)
        ...
        ComponentType = 'matlab.ui.control.Hyperlink';
    end
    ...
    % ---------------------------------------------------------------------
    methods
        function obj = HyperlinkAdapter(varargin)
    ...
    methods(Static)
        function adapter = getJavaScriptAdapter()
            adapter = 'uicomponents_appdesigner_plugin/model/HyperlinkModel';
        end
    end
    ...
    methods(Static)
        ...
        function codeSnippet = getCodeGenCreation(componentHandle, codeName, parentName)
            codeSnippet = sprintf('uihyperlink(%s)', parentName);
        end
    end
end
