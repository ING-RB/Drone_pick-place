classdef DesignTimeLampController < ...
    ...
    %DESIGNTIMELAMPCONTROLLER - This class contains design time logic
    ...
    methods
        function obj = DesignTimeLampController(component, parentController, proxyView, adapter)
            obj = obj@matlab.ui.control.internal.controller.ComponentController(component, parentController, proxyView);
