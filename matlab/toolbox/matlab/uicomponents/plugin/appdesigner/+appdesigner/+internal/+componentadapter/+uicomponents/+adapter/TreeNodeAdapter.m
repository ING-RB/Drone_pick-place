classdef TreeNodeAdapter < appdesigner.internal.componentadapter.uicomponents.adapter.BaseUIComponentAdapter
    ...
    properties (SetAccess=protected, GetAccess=public)
        ...
        ComponentType = 'matlab.ui.container.TreeNode';
    end
    ...
    methods
        ...
        function defaultValues = getComponentRunTimeDefaults(obj, theme, parentType)
            ...
            defaultValues = getComponentRunTimeDefaults@appdesigner.internal.componentadapterapi.mixins.ComponentDefaults(obj, theme, 'matlab.ui.container.Tree');
        end
