classdef DesignTimeGaugeComponentController < ...
    ...
    methods
        function obj = DesignTimeGaugeComponentController(component, parentController, proxyView, adapter)
        ...
        function populateView(obj, proxyView)
            populateView@matlab.ui.control.internal.controller.GaugeComponentController(obj, proxyView);
    ...
    methods (Access = 'protected')
        ...
        function handleDesignTimeEvent(obj, src, event)
            ...
            if(strcmp(event.Data.Name, 'PropertyEditorEdited'))
                ...
                % Convert scalecolors and scalecolorlimits
                if(any(strcmp(propertyName, {'ScaleColors', 'ScaleColorLimits'})))
                    [propertyName, propertyValue] = appdesigner.internal.controller.utils.convertScaleColorClientValueToServerValue(propertyName,propertyValue);
