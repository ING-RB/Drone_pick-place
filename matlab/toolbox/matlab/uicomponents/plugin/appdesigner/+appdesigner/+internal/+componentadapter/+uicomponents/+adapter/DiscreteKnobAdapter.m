classdef DiscreteKnobAdapter < appdesigner.internal.componentadapter.uicomponents.adapter.BaseUIComponentAdapter
    ...
    properties (SetAccess=protected, GetAccess=public)
        ...
        ComponentType = 'matlab.ui.control.DiscreteKnob';
    end
