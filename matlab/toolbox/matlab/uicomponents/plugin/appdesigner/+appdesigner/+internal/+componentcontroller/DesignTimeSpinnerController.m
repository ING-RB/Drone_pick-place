classdef DesignTimeSpinnerController < ...
        matlab.ui.control.internal.controller.SpinnerController & ...
        appdesigner.internal.componentcontroller.DesignTimeVisualComponentsController
    %DESIGNTIMESPINNERCONTROLLER - This class contains design time logic
    %specific to the spinner
    
    % Copyright 2020 The MathWorks, Inc.
    
    
    methods
        function obj = DesignTimeSpinnerController(component, parentController, proxyView, adapter)
            obj = obj@matlab.ui.control.internal.controller.SpinnerController(component, parentController, proxyView);
        ...
        function populateView(obj, proxyView)
            populateView@matlab.ui.control.internal.controller.SpinnerController(obj, proxyView);
