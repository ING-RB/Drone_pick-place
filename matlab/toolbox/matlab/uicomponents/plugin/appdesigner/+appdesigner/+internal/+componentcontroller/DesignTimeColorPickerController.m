classdef DesignTimeColorPickerController < ...
        matlab.ui.control.internal.controller.ColorPickerController & ...
    ...
    methods
        function obj = DesignTimeColorPickerController(component, parentController, proxyView, adapter)
            obj = obj@matlab.ui.control.internal.controller.ColorPickerController(component, parentController, proxyView);
        ...
        function populateView(obj, proxyView)
            populateView@matlab.ui.control.internal.controller.ColorPickerController(obj, proxyView);
    ...
    methods (Access = 'protected')
        ...
        function handleEvent(obj, src, event)
            ...
            if strcmp(event.Data.Name, 'PropertyEditorEdited') && strcmp(event.Data.PropertyName, 'Icon')
                ...
                handleEvent@matlab.ui.control.internal.controller.ColorPickerController(obj, src, event);
            end
        end  
