classdef DesignTimeEditFieldController < ...
        matlab.ui.control.internal.controller.EditFieldController & ...
        appdesigner.internal.componentcontroller.DesignTimeVisualComponentsController
    %DESIGNTIMEEDITFIELDCONTROLLER - This class contains design time logic
    %specific to the edit field.
    
    % Copyright 2020 The MathWorks, Inc.
    
    
    methods
        function obj = DesignTimeEditFieldController(component, parentController, proxyView, adapter)
            obj = obj@matlab.ui.control.internal.controller.EditFieldController(component, parentController, proxyView);
        ...
        function populateView(obj, proxyView)
            populateView@matlab.ui.control.internal.controller.EditFieldController(obj, proxyView);
