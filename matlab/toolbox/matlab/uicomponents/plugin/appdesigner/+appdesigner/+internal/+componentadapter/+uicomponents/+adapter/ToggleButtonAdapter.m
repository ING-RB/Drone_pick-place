classdef ToggleButtonAdapter < appdesigner.internal.componentadapter.uicomponents.adapter.BaseUIComponentAdapter
    % Adapter for ToggleButton
    ...
    properties (SetAccess=protected, GetAccess=public)
        ...
        ComponentType = 'matlab.ui.control.ToggleButton';
    end
    ...
    % ---------------------------------------------------------------------
    methods
        function obj = ToggleButtonAdapter(varargin)
        ...
        function processPropertiesStruct = processPropertiesToSet(obj,propertiesStruct)
            ...
            processPropertiesStruct = ...
                processPropertiesToSet@appdesigner.internal.componentadapter.uicomponents.adapter.BaseUIComponentAdapter(obj,propertiesStruct);
        end
        ...
        function defaultValues = getComponentRunTimeDefaults(obj, theme, parentType)
            ...
            defaultValues = getComponentRunTimeDefaults@appdesigner.internal.componentadapterapi.mixins.ComponentDefaults(obj, theme, 'matlab.ui.container.ButtonGroup');

            % Creating the Radio Button with 'Parent' sets the 'Value' to true
            % So we need to set it to false to match the default value.
        ...
        function codeSnippet = getCodeGenPropertySet(obj, component, objectName, propertyName, codeName, parentCodeName)
            ...
            switch (propertyName)
                ...
                case 'Text'
                    ...
                    codeSnippet = appdesigner.internal.codegeneration.ComponentCodeGenerator.generateStringForPropertySegment(...
    ...
    methods(Static)        
        function adapter = getJavaScriptAdapter()
            adapter = 'uicomponents_appdesigner_plugin/model/ToggleButtonModel';
        end
    end
    ...
    methods(Static)
        ...
        function codeSnippet = getCodeGenCreation(componentHandle, codeName, parentName)
            ...
            codeSnippet = sprintf('uitogglebutton(%s)', parentName);
        end
    end
    ...
    methods(Access = protected)
        function parent = createDesignTimeParentComponent(obj)
            ...
            % Create ButtonGroup as a parent for ToggleButton
