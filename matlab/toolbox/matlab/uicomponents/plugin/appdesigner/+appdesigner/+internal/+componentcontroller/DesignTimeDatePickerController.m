classdef DesignTimeDatePickerController < ...
        matlab.ui.control.internal.controller.DatePickerController & ...
        appdesigner.internal.componentcontroller.DesignTimeVisualComponentsController
    
    % DESIGNTIMEDATEPICKERCONTROLLER - This class contains design time logic
    % specific to the DatePicker
    % DesignTimeDatePickerController is a Visual Component Container
    
    % Copyright 2017 The MathWorks, Inc.
    methods
        function obj = DesignTimeDatePickerController(component, parentController, proxyView, adapter)
            obj = obj@matlab.ui.control.internal.controller.DatePickerController(component, parentController, proxyView);
        ...
        function populateView(obj, proxyView)
            populateView@matlab.ui.control.internal.controller.DatePickerController(obj, proxyView);
    ...
    methods (Access = 'protected')
        ...
        function handleDesignTimeEvent(obj, src, event)
            ...
            if(strcmp(event.Data.Name, 'PropertyEditorEdited'))
                ...
                propertyValue = matlab.ui.control.internal.controller.DatePickerController.convertNaTStr(event.Data.PropertyValue);
                
                %set the property on the server-side model
