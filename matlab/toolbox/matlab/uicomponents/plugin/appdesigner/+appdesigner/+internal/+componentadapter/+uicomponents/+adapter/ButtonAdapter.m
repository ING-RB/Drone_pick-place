classdef ButtonAdapter < appdesigner.internal.componentadapter.uicomponents.adapter.BaseUIComponentAdapter
    % Adapter for Button
    ...
    properties(SetAccess=protected, GetAccess=public)
        ...
        ComponentType = 'matlab.ui.control.Button';
    end
    ...
    % ---------------------------------------------------------------------
    methods
        function obj = ButtonAdapter(varargin)
        ...
        function controllerClass = getComponentDesignTimeController(obj)
            controllerClass = 'appdesigner.internal.componentcontroller.DesignTimePushButtonController';
        end
    end
    ...
    methods(Static)
        function adapter = getJavaScriptAdapter()
            adapter = 'uicomponents_appdesigner_plugin/model/PushButtonModel';
        end
    end
    ...
    methods(Static)
        ...
        function codeSnippet = getCodeGenCreation(componentHandle, codeName, parentName)
            ...
            codeSnippet = sprintf('uibutton(%s, ''push'')', parentName);
        end
    end
end
