classdef DesignTimeCheckBoxController < ...
        matlab.ui.control.internal.controller.CheckBoxController & ...
        appdesigner.internal.componentcontroller.DesignTimeVisualComponentsController
    %DESIGNTIMECHECKBOXCONTROLLER - This class contains design time logic
    %specific to check boxes
    
    % Copyright 2020 The MathWorks, Inc.
    
    
    methods
        function obj = DesignTimeCheckBoxController(component, parentController, proxyView, adapter)
            obj = obj@matlab.ui.control.internal.controller.CheckBoxController(component, parentController, proxyView);
        ...
        function populateView(obj, proxyView)
            populateView@matlab.ui.control.internal.controller.CheckBoxController(obj, proxyView);
