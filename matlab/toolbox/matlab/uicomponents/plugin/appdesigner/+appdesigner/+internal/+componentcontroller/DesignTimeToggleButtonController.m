classdef DesignTimeToggleButtonController < ...
        matlab.ui.control.internal.controller.ToggleButtonController & ...
    ...
    %DESIGNTIMETOGGLEBUTTONCONTROLLER - This class contains design time logic
    %specific to the toggle button
    
    % Copyright 2020-2021 The MathWorks, Inc.
    
    methods
        function obj = DesignTimeToggleButtonController(component, parentController, proxyView, adapter)
            obj = obj@matlab.ui.control.internal.controller.ToggleButtonController(component, parentController, proxyView);
        ...
        function populateView(obj, proxyView)
            populateView@matlab.ui.control.internal.controller.ToggleButtonController(obj, proxyView);
    ...
    methods (Access = 'protected')
        ...
        function handleEvent(obj, src, event)
            ...
            if strcmp(event.Data.Name, 'PropertyEditorEdited') && strcmp(event.Data.PropertyName, 'Icon')
                ...
                handleEvent@matlab.ui.control.internal.controller.ToggleButtonController(obj, src, event);
            end
