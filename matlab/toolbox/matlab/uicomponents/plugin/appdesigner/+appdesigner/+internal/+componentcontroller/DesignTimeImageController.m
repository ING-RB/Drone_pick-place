classdef DesignTimeImageController < ...
        matlab.ui.control.internal.controller.ImageController & ...
    ...
    % DESIGNTIMEIMAGECONTROLLER - This class contains design time logic
    % specific to the Image Component
    
    % Copyright 2018-2021 The MathWorks, Inc.
    
    methods
        function obj = DesignTimeImageController(component, parentController, proxyView, adapter)
            obj = obj@matlab.ui.control.internal.controller.ImageController(component, parentController, proxyView);
        ...
        function populateView(obj, proxyView)
            populateView@matlab.ui.control.internal.controller.ImageController(obj, proxyView);
    ...
    methods (Access = 'protected')
        ...
        function handleEvent(obj, src, event)
            ...
            if(strcmp(event.Data.Name, 'PropertyEditorEdited'))
                ...
                if (strcmp(event.Data.PropertyName, 'ImageSource') || strcmp(event.Data.PropertyName, 'URL'))
                    propertyName = event.Data.PropertyName;
                    propertyValue = event.Data.PropertyValue;

                    if (strcmp(event.Data.PropertyName, 'ImageSource'))
                        % Validate the inputted Image file
                        [propertyValue, validationStatus, imageRelativePath] = obj.validateImageFile(propertyName, event);
                ...
                handleEvent@matlab.ui.control.internal.controller.ImageController(obj, src, event);
            end
        end
