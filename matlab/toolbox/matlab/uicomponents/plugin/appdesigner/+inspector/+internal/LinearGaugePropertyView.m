classdef LinearGaugePropertyView < ...
    ...
    % This class provides the property definition and groupings for Linear
    % Gauge
    ...
    methods
        function obj = LinearGaugePropertyView(componentObject)
