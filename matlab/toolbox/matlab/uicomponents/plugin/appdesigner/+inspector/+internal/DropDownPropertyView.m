classdef DropDownPropertyView < inspector.internal.AppDesignerPropertyView & ...
    ...
    properties(SetObservable = true)
        ...
        Items internal.matlab.editorconverters.datatype.MoreThanZeroOptions
    ...
    methods
        function obj = DropDownPropertyView(componentObject)
            ...
            group = obj.createGroup(titleCatalogId, titleCatalogId, '');
			group.addEditorGroup('Value', 'Items');
			group.addProperties('Placeholder', 'ItemsData');
            group.Expanded = true;
