classdef RockerSwitchPropertyView < ...
    ...
    % This class provides the property definition and groupings for Rocker
    % switch
    ...
    methods
        function obj = RockerSwitchPropertyView(componentObject)
