classdef WrappedString < matlab.automation.internal.diagnostics.FormattableStringDecorator
    %
    ...
    methods
        function str = WrappedString(wrappableString, wrappedWidth)
            str = str@matlab.automation.internal.diagnostics.FormattableStringDecorator(wrappableString);
