classdef(Hidden, Abstract) ExtendedDiagnostic < matlab.automation.diagnostics.Diagnostic
    ...
    %       matlab.automation.diagnostics.DiagnosticData
    ...
    methods(Sealed)
        function diagnose(diag)
            import matlab.automation.diagnostics.DiagnosticData;
            diag.diagnoseWith(DiagnosticData.DefaultInstance);
        end
    end
