classdef DisplayDiagnostic < matlab.automation.diagnostics.Diagnostic
    % DisplayDiagnostic - Diagnostic using a value's displayed output
    %
    ...
    methods
        function diag = DisplayDiagnostic(value)
            ...
            %
            %       DisplayDiagnostic(5)
            %       DisplayDiagnostic(?matlab.automation.diagnostics.Diagnostic);
