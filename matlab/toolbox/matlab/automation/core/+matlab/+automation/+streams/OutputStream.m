classdef OutputStream < handle & matlab.mixin.Heterogeneous
    ...
    methods(Abstract)
        ...
        print(stream, formatSpec, args);
    end
    
    methods(Hidden)
        function printFormatted(stream, formattableString)
            stream.print("%s", formattableString.Text);
        end
...
% LocalWords:  mypackage strsplit formattable plugins unittest strjoin
% LocalWords:  Monospaced
