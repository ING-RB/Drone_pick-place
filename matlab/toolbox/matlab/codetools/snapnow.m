        ...
        switch varargin{1}
            ...
            case 'set'
                ...
                if isempty(data)
                    ...
                    data.plugins(2).classname = 'internal.matlab.publish.PublishSnapshottable';
                    data.plugins(2).instance = [];

                    
                    % Figures.
                    data.plugins(3).check = @true;
                    data.plugins(3).classname = 'internal.matlab.publish.PublishFigures';
                    data.plugins(3).instance = [];
