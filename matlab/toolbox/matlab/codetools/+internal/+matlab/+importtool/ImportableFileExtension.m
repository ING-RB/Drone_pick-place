...
function fileExt = localSpreadsheetExtn(extensionsWithDotPrefix)
    persistent fileExtDict;
    if isempty(fileExtDict)
        fileExtDict = dictionary(logical.empty, string.empty);
    end

    if isKey(fileExtDict, extensionsWithDotPrefix)
        fileExt = fileExtDict(extensionsWithDotPrefix);
        fileExt = cellstr(strsplit(fileExt, "|"));
        return
    end
    ...
    fileExtDict(extensionsWithDotPrefix) = strjoin(fileExt, "|");
end
...
dropdownList = {getString(message('MATLAB:codetools:uiimport:AudioFormatStr')),localAudioExtn(true);...
        ...
        getString(message('MATLAB:codetools:uiimport:HDF5FormatStr')),{'.h5'};...
        ...
        getString(message('MATLAB:codetools:uiimport:NetCDFFormatStr')),{'.nc'};...
