...
% Copyright 2006-2018 The MathWorks, Inc.
    ...
    linkname = LINK(:,1);
    n = numel(linkname);
    L = cell2struct(num2cell((1:n)'), linkname);
    ...
    leaves = { 'ID' 'INT' 'DOUBLE' 'HEX' 'BINARY' 'CHARVECTOR' 'STRING' ... 
               'DUAL' 'BANG' 'ANONID' 'FIELD' 'ERR' 'BREAK' 'RETURN' ...
               'CONTINUE' 'CELLMARK' 'COMMENT' };
    ...
    sect = { 'PROPERTIES' 'METHODS' 'EVENTS' 'ENUMERATION' 'ARGUMENTS' };
    ...
    ni = {
            ...
            xfun, { 'Fname', 'Ins', 'Outs', 'Body' 'Arguments' };
            xfor, { 'Index', 'Vector', 'Body' };
            cls, { 'Cexpr', 'Cattr', 'Body' };
            sect, { 'Attr', 'Body' };
            type, { 'VarName', 'VarNamedClass', 'VarNamedField', 'VarType', 'VarDimensions', 'VarValidators' };
            argument, { 'ArgumentValidation', 'ArgumentInitialization'};
         };
