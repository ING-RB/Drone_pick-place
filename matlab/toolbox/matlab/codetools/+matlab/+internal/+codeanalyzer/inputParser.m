...
% the following bins: files to be analyzed, input options, text (if
% any).
%
...
%          input argument.
%   doNotResolveFileNames - A boolean indicating that the class need
...
% Copyright 2014-2023 The MathWorks, Inc.
    ...
    properties( SetAccess=private, GetAccess=public )
        ...
        fileListWasCell;        % True if file list (given to checkcode) was a cell array
    ...
    methods
        ...
        % varargin: Input arguments to mlint/checkcode.
            ...
            % Extract all inputs beginning with a "-" and store them in the variable
...
% checkcode. If one is not found then checkcode uses the factory settings.
    ...
    s = settings;
    if s.matlab.codeanalyzer.ActiveConfigurationFile.hasActiveValue
        defaultCfgFile = s.matlab.codeanalyzer.ActiveConfigurationFile.ActiveValue;
    else
...
% LocalWords:  nout nargs GETDEFAULTOUTPUTTYPE GETDEFAULTCONFIG
