function obj = openDocument(filename, varargin)
...
%   Copyright 2008-2024 The MathWorks, Inc.
    ...
    assertEditorAvailable(varargin{:});
    ...
    if ischar(filename)
        obj = matlab.desktop.editor.Document.openEditorForExistingFile(filename, varargin{:});
    elseif iscell(filename)
        obj = matlab.desktop.editor.Document.empty(1,0);
        for i = 1:numel(filename)
            thisEditor = matlab.desktop.editor.openDocument(filename{i}, varargin{:});
