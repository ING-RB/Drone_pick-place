function editorObj = openAndGoToFunction(filename, functionname, varargin)
...
%   Copyright 2009-2021 The MathWorks, Inc.
    ...
    [filename, functionname] = convertStringsToChars(filename, functionname);
    ...
    editorObj = matlab.desktop.editor.openDocument(filename, varargin{:});
