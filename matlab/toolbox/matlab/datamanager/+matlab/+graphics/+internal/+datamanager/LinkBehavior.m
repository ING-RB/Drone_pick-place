...
properties
    ...
    % The returned data is a logical array the same size as 
    % the data array represented in the chart
    LinkBrushQueryFcn = [];
    ...
    % before updating the variable brushing arrays. In histogram charts
    % this is used to reset the brushed state of partially brushed bars
    % during extended brushing (i.e. shift-click or shift-drag)
    % The returned data is a logical array the same size as 
    % the data array represented in the chart.
    LinkBrushUpdateIFcn = [];
