...
if isempty(r) && (strcmpi(figSelectionType,'normal') || ...
    ...
    matlab.graphics.interaction.internal.setInteractiveDDUXData(ax, 'clickbrush', 'mode');
else
    matlab.graphics.interaction.internal.setInteractiveDDUXData(ax, 'dragbrush', 'mode');
end
