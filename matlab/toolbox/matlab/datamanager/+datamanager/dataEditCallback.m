...
% Called to perform various operations on linked brushed data on
    ...
    case 'remove'
        ...
        if workspaceevent           
            ...
            try
                ...
                if strcmp(e.identifier,"MATLAB:table:EmptyAssignmentToVariableRows")
                    msg = message('MATLAB:linkdata:InvalidTableRowRemove');
                    errordlg(msg.getString,'MATLAB','modal');
                else
                    rethrow(e)
                end
            end
