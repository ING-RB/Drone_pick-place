...
%CREATEFROMFIELDS Create calendarDuration component data from raw field data.
%   COMPONENTS = CREATEFROMFIELDS(FIELDS) creates component data that can
%   be assigned directly to the 'components' property of a
%   calendarDuration. FIELDS must be a cell array of numeric data.
%
%   COMPONENTS = CREATEFROMFIELDS({Y,M,D}) returns component data for a
%   calendarDuration of Y years, M months, and D days.
%
%   COMPONENTS = CREATEFROMFIELDS({Y,M,D,MS}) returns component data for a
%   calendarDuration of Y years, M months, D days, and MS milliseconds.
%
%   COMPONENTS = CREATEFROMFIELDS({Y,M,D,H,MI,S}) returns component data for a
%   calendarDuration of Y years, M months, D days, H hours, MI minutes, and S
%   seconds.
