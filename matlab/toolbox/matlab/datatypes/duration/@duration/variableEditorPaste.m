...
% obtained from another duration array.

% Copyright 2014-2019 The MathWorks, Inc.

if isa(data, 'table')
    % try converting the table to an array.  If it is an array of
    % durations, the paste will succeed.  Otherwise, if it can't be
    % converted to an array or it isn't an array of durations, it will fail
...
% Paste data onto existing duration variables
