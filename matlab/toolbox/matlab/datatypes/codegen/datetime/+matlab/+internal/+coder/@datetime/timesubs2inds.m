function inds = timesubs2inds(subscripts,labels,tol) %#codegen
...
inds = matlab.internal.coder.tabular.timesubs2inds(subsMillis,labelsMillis,tolMillis,doubledoubleMinus);
