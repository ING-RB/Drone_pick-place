function [tf, dt] = isregular(tt, unit)  %#codegen
...
%   respect to the calendar duration UNIT that is specified as: 'years',
%   'quarters, 'months', 'weeks', 'days', or 'time'.  A time vector that is
%   a duration can only be regular with respect to 'time', and will return
%   false for all other calendar duration UNITs.
%
