function unit = checkUnit(unitIn) %#codegen
...
unit = scale(matlab.internal.coder.datatypes.getChoice(unitIn,{'seconds'; 'minutes'; 'hours'; 'days'; 'years'},{'MATLAB:duration:units:InvalidUnit','MATLAB:duration:units:AmbiguousUnit'}));
