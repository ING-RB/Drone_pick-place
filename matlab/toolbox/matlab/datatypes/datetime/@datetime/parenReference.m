...
switch nsubs
    ...
    case 2 % 2-D subscripting
        obj.data = parenReference_2D(obj.data, rowIndices, colIndices);
    case 0 % obj() is legal syntax but a no-op - return as is
    otherwise % N-D subscripting
        obj.data = parenReference_ND(obj.data, nsubs, rowIndices, colIndices, varargin);
end