...
%     half            -- Half precision floating-point numeric array
...
%
%   ISA(obj,'typeCategory') returns true if obj is an instance of
%   any of the classes in the specified typeCategory, and false otherwise.
%   isa also returns true if obj is an instance of a class that is derived 
%   from any of the classes in typeCategory.
%
%   typeCategory can be 'numeric', 'float', or 'integer', representing
%   a category of classes:
%   numeric -- Integer or floating-point array (double, single, half,
%              int8, uint8, int16, uint16, int32, uint32,
%              int64, uint64)
%   float   -- Double-, single- or half-precision floating-point array
%              (double, single, half)
