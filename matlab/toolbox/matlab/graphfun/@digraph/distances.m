...
%   arrays of character vectors, or 'all' to represent the set of all
%   nodes, 1:numnodes(G). By default S and T are both 'all'.
%
...
elseif digraph.partialMatch(param, 'all')
    isSet = true;
    subset = 'all';
elseif ~digraph.partialMatch(param, 'Method')
...
elseif ismember(arg, names)
    ...
    tf = true;
elseif any(digraph.partialMatch(arg, NVpairs))
