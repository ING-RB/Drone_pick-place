...
%  be numeric node IDs or node names specifying nodes in the digraph G.
%
...
elseif nargin == 2
    ...
    s = validateNodeID(G, s, true); % true: accept categoricals
    t = validateNodeID(G, t, true); % true: accept categoricals
