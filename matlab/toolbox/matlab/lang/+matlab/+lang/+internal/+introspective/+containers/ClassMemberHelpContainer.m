classdef ClassMemberHelpContainer < matlab.lang.internal.introspective.containers.atomicHelpContainer
    ...
    methods
        function this = ClassMemberHelpContainer(helpContainerType, helpStr, metaData, h1Flag)
            ...
            this = this@matlab.lang.internal.introspective.containers.atomicHelpContainer(helpStr);
        ...
        function helpStr = getH1Line(this)
            ...
            if this.h1Flag
                ...
                helpStr = getH1Line@matlab.lang.internal.introspective.containers.atomicHelpContainer(this);
            end
        end
