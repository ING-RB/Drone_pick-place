classdef ClassMemberIterator < handle
    ...
    methods
        function this = ClassMemberIterator(varargin)
            ...
            for i = 1:nargin
                if numEntries(varargin{i})
                    this.classMemberHelpContainers = [this.classMemberHelpContainers, num2cell(values(varargin{i}))'];
                end
            end
            this.NumMembers = numel(this.classMemberHelpContainers);
        end
