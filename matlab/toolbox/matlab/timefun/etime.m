...
%ETIME  Elapsed time.
%   ETIME is not recommended. Use datetime values to represent points in 
%   time, duration or calendarDuration values to represent elapsed times, 
%   and the minus operator (-) or the between function instead.
%
...
%         0.1250
%
%   See also TIC, TOC, CPUTIME, DATETIME, DURATION, CALENDARDURATION, DATETIME/MINUS, DATETIME/PLUS.

%   Copyright 1984-2022 The MathWorks, Inc.

% Compute time difference accurately to preserve fractions of seconds.

if ~isreal(t0) || ~isreal(t1)
    error(message("MATLAB:datevec:InputMustBeReal"))
end
