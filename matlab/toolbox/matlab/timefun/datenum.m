...
%
%   See also DATETIME, DURATION, CALENDARDURATION.
...
elseif nargin == 3
    arg2 = convertStringsToChars(arg2);
    arg3 = convertStringsToChars(arg3);
    ...
    switch nargin
        case 1
            ...
            elseif ((size(arg1,2)==3) || (size(arg1,2)==6)) && ...
                ...
                if ~isreal(arg1)
                    error(message("MATLAB:datenum:InputMustBeReal"))
                end
                n = datenummx(arg1);
            else
                n = arg1;
        ...
        case 3
            if any(isdateformat)
                ...
                if ~isreal(arg1) || ~isreal(arg2) || ~isreal(arg3)
                    error(message("MATLAB:datenum:InputMustBeReal"))
                end
        ...
        case 6
            ...
            if ~isreal(arg1) || ~isreal(arg2) || ~isreal(arg3) || ~isreal(h) || ~isreal(min) || ~isreal(s)
                error(message("MATLAB:datenum:InputMustBeReal"))
            end
