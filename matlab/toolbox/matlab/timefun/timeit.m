...
if n < 0
   try
      ...
      n = 1;
       ...
       % Check errorIDs for too many outputs, including from scripts and methods
       if any(strcmp(exception.identifier, ...
               {'MATLAB:TooManyOutputs','MATLAB:maxlhs','MATLAB:class:UndefinedMethod','MATLAB:UndefinedFunction'}))
