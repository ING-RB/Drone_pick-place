...
%   DATETICK is not recommended. To display date or time values along an axis,
%   create datetime or duration values, and plot those values with your data.
%   You can also format the tick labels with the xtickformat and ytickformat
%   functions.
%
...
%
%   See also DATETIME, DURATION, XTICKFORMAT, YTICKFORMAT, ZTICKFORMAT.
