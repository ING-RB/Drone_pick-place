classdef (Abstract) PeeredProperties < matlab.mixin.SetGet
    ...
    methods
        ...
        function set.PeerNode(this, node)
            this.removePeerPropertyListener();
            if ~isempty(this.PeerNode) && isvalid(this.PeerNode)
                this.PeerNode.delete();
            end 
    ...
    methods (Access = protected)
        ...
        function removePeerPropertyListener(this)
            if ~isempty(this.PeerPropertyListener) && isvalid(this.PeerPropertyListener)
                delete(this.PeerPropertyListener);
            end
        end
