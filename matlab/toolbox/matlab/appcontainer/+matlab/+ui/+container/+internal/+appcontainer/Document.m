classdef Document < matlab.ui.container.internal.appcontainer.AppChild
    ...
    properties (Dependent, Hidden)
        ...
        % Controls whether the window hosting the document should be
        % brought to front when the document is added to view
        AddWithoutWindowFocus (1, 1) logical;
    end
    ...
    properties (GetAccess = protected, Constant)
        DocumentMCOSPropertyNames = [matlab.ui.container.internal.appcontainer.AppChild.MCOSPropertyNames ...
                                     {'Tag', 'DocumentGroupTag', 'ActiveContexts', 'Docked', 'Fullscreen', 'FullscreenEnabled', 'Tile', 'Phantom', 'Visible', 'EnableDockControls', 'DisableDockControls', 'AddWithoutWindowFocus'}];
        DocumentJSPropertyNames = [matlab.ui.container.internal.appcontainer.AppChild.JSPropertyNames ...
                                   {'documentId', 'documentType', 'activeContexts', 'isDocked', 'isFullscreen', 'enableFullscreen', 'tile', 'isPhantom', 'isVisible', 'enableDockControls', 'disableDockControls', 'addWithoutWindowFocus'}];
        DocumentDefaultPropertyValues = [matlab.ui.container.internal.appcontainer.AppChild.DefaultPropertyValues ...
                                         {"", "", [], true, false, false, 0, false, true, false, false, false}];
    ...
    properties (SetAccess=private, Hidden=true)
        % Boolean value reflecting whether we are waiting on a response from downstream CanCloseFcn - will get set to false by a Ctrl+C interruption (g2931581)
    ...
    methods
        ...
        function value = get.AddWithoutWindowFocus(this)
            value = this.getProperty('AddWithoutWindowFocus');
        end
        
        function set.AddWithoutWindowFocus(this, value)
            this.setProperty('AddWithoutWindowFocus', value);
        end
