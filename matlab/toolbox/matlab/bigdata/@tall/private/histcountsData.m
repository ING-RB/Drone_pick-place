...
if ~isempty(input)
    ...
    for i = 1:2:inputlen
        name = validateStringOption(input{i}, {'NumBins', 'MaxNumBins', 'BinEdges', 'BinWidth', 'BinLimits', ...
        ...
        switch name
            ...
            case 'Normalization'
                opts.Normalization = validateStringOption(value, {'countdensity', 'cumcount',...
                    'percentage', 'probability', 'pdf', 'cdf'}, 'InvalidNormalization');
            ...
            otherwise % 'BinMethod'
                opts.BinMethod = validateStringOption(value, {'auto','scott', ...
