...
fcnInfo = struct( ...
    "OutputType",        "preserveLogicalCharToDouble", ...
    "AllowTabularMaths", true, ...
    "Name",              fcnName);

try
    tall.checkNotTall(fcnName, 1, varargin{:});
    in = tall.validateType(in, fcnName, {'numeric', 'logical', 'char', 'duration'}, ...
        1, fcnInfo.AllowTabularMaths);
