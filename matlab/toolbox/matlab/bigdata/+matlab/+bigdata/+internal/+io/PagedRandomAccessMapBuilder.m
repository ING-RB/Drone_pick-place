...
classdef PagedRandomAccessMapBuilder < handle
    ...
    methods
        function obj = PagedRandomAccessMapBuilder(emptyIndices, numPages, pageSizeInBytes)
            ...
            % size 10 MB.
            obj.PageBoundaries = emptyIndices;
            if nargin < 2
                numPages = 10;
            end
        ...
        function add(obj, indices, slices)
            ...
            if size(obj.NextPageSlices, 1) > 0
        ...
        function map = build(obj)
            ...
            map = matlab.bigdata.internal.io.PagedRandomAccessMap(...
                obj.MemoryPages, obj.Folder, obj.PageBoundaries, obj.PageSizes, obj.EmptyCell{1});
            obj.MemoryPages = [];
            obj.Folder = [];
            obj.PageBoundaries = matlab.bigdata.internal.util.indexSlices(obj.PageBoundaries, []);
            obj.PageSizes = [];
        end
    end
    ...
    methods (Access = private)
        function addPage(obj, sizeInBytes)
            ...
            obj.PageSizes = [obj.PageSizes; page.Size];
            obj.PageBoundaries = [obj.PageBoundaries; matlab.bigdata.internal.util.indexSlices(page.Indices, 1)];
    ...
    methods (Access = {?matlab.bigdata.internal.io.PagedRandomAccessMap}, Static)
        ...
        function filename = getPageFilename(folder, pageId)
            ...
            filename = fullfile(folder.Path, sprintf('page_%06i.mat', pageId));
        end
    end
end
