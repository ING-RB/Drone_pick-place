...
classdef (Abstract) PartitionedArrayExecutor < handle
    methods (Abstract)
        ...
        %
        % Outputs:
        %  - readFailureSummary: A ReadFailureSummary object containing all
        %  known read failures in a big data job that was allowed to
        %  continue after datastore errors.
        %
        % Error Conditions:
        ...
        readFailureSummary = executeWithHandler(obj, taskGraph, outputHandlers);
    ...
    methods
        ...
        function tf = isUsable(obj)
            % Default implementation is to simply return same as isvalid.
            tf = isvalid(obj);
        end
