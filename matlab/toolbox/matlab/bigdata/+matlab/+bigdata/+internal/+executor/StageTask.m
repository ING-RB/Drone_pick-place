...
classdef (Sealed) StageTask < handle
    ...
    properties (SetAccess = private)
        % Does this stage task represent a pass through the underlying
        % data?
        IsPass (1,1) logical = false;
    ...
    methods
        ...
        function obj = addExecution(obj, compositeDataProcessorBuilder, isExecutionLarge)
            % Add a piece of execution to the StageTask.
            obj.DataProcessorFactories(end + 1, :) = compositeDataProcessorBuilder;
            obj.IsPass = obj.IsPass || isExecutionLarge;
        end
        ...
        function obj = combine(objs, newExecutionPartitionStrategy)
            ...
            obj.IsPass = obj.IsPass || any([objs.IsPass]);
...
import matlab.bigdata.internal.executor.CompositeDataProcessorBuilder;
import matlab.bigdata.internal.executor.TerminalProcessorFactory;
dataProcessorFactory = CompositeDataProcessorBuilder(...
    nodes, TerminalProcessorFactory(numel(nodes)));
end
