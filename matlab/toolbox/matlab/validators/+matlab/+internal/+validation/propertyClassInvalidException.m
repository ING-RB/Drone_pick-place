function ex = propertyClassInvalidException(className, propName, propType, origin)
%
...
%   Copyright 2019-2024 The MathWorks, Inc.
    ...
    ex = handler.classInvalidException(className, callerContextWrapper, propName, propType);
end
