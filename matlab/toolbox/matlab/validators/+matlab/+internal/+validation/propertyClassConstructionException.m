function ex = propertyClassConstructionException(className, propName, propType, origin)
%
...
%   Copyright 2019-2024 The MathWorks, Inc.
    ...
    ex = handler.classConstructionException(className,callerContextWrapper,propName,propType);
end
