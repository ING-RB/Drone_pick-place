...
%   MUSTBEPOSITIVE(A) throws an error if A contains nonpositive values.
...
if ~all(A > 0, 'all')
    throwAsCaller(matlab.internal.validation.util.createValidatorException('MATLAB:validators:mustBePositive'));
end
