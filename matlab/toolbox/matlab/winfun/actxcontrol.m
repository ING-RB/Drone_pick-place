...
%  ACTXCONTROL will be removed in a future release.
...
if feature("webui")
    error(message('MATLAB:actxcontrol:FunctionHasBeenRemoved','ACTXCONTROL'));
else  
   warning(message('MATLAB:ui:actxcontrol:FunctionToBeRemoved'));
