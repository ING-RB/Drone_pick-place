...
%   the handle to the COM object and USERINPUT is a
%   character vector, string scalar or mx2 cell array of character vectors. 
%
%   When USERINPUT is a character vector or string scalar it specifies the 
%   event handler for all events that can be registered by the COM object. 
%   For example,
%
%      registerevent(h, 'allevents')
%
%   When USERINPUT is a cell array of character vectors, an event name 
