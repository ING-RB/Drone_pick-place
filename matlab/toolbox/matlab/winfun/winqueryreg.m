...
%
%   If the specified value is a character vector or string scalar, this 
%   function returns a character vector. If the value is a 32-bit integer, 
%   this function returns the value as an integer of MATLAB type int32.
%
