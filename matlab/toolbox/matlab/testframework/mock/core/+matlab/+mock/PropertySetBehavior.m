classdef (Sealed) PropertySetBehavior < matlab.mock.InteractionBehavior
    ...
    properties (Hidden, Constant, Access=protected)
        ActionClassName = "matlab.mock.actions.PropertySetAction";
    end
    ...
    methods (Hidden)
        ...
        function bool = describesSuccessfulPropertyModification(behavior, history)
    ...
    methods (Hidden, Access=protected)
        function summary = getElementDisplaySummary(behaviorElement)
            summary = getString(message("MATLAB:mock:display:MockObjectSummary", ...
                behaviorElement.InteractionCatalog.MockObjectSimpleClassName)) + "." + ...
                behaviorElement.Name + " = " + behaviorElement.ValueRequirement.OneLineSummary;
        end
    end
end
