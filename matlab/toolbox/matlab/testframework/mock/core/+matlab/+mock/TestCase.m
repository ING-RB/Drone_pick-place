classdef (Abstract) TestCase < matlab.unittest.TestCase
    ...
    methods (Sealed)
        function [mock, behavior] = createMock(testCase, varargin)
            ...
            %           MockedMethods is a string array or cell array of character
            %           vectors specifying the names of methods that can be mocked. By
            %           default, MockedMethods is the set of added methods, abstract
            %           superclass methods, and concrete superclass methods that are
            %           overridable. For methods that are not mocked, the framework
            %           does not record method calls and you cannot change the behavior
            %           of these methods. Specify MockedMethods as an empty array such
            %           as string.empty to specify that no methods are mocked.
            %
            ...
            %           object class.
            %
            %       * AddedEvents - Events to add to the mock object.
            %           AddedEvents is a string array or cell array of character
            %           vectors specifying the names of events to add to the mock
            %           object class.
            %
            ...
            testCase.addTeardown(@deleteMockContext, context);
        ...
        function clearMockHistory(~, mock)
            % clearMockHistory - Clear history of mock object interactions.
            %
            %   testCase.clearMockHistory(MOCK) clears the history of recorded mock
            %   object interactions. The clearMockHistory method does not clear mock
            %   object behaviors. To clear both interactions and behaviors, create a
            %   new mock.
            %
            %   Examples:
            %       import matlab.mock.TestCase;
            ...
            %       testCase.verifyCalled(behavior.myMethod('abc'));
            %
            %       % Clear the history of the recorded interactions.
            %       testCase.clearMockHistory(mock);
            %
            %       % The same qualification now fails.
            %       testCase.verifyCalled(behavior.myMethod('abc'));
            
            import matlab.mock.InteractionHistory;
            InteractionHistory.clearForMock(mock);
        end
        ...
        function verifyCalled(testCase, behavior, varargin)
            ...
            decoratedConstraint = addCasualDiagnosticDecorator(WasCalled,'verifyCalled',{behavior});
        ...
        function verifyNotCalled(testCase, behavior, varargin)
            ...
            import matlab.mock.constraints.WasCalled;
            validateattributes(behavior, {'matlab.mock.MethodCallBehavior'}, {'scalar'});
            decoratedConstraint = addCasualDiagnosticDecorator(~WasCalled,'verifyNotCalled',{behavior});
            testCase.verifyThat(behavior, decoratedConstraint, varargin{:});
        end
        ...
        function assumeCalled(testCase, behavior, varargin)
            ...
            import matlab.mock.constraints.WasCalled;
            validateattributes(behavior, {'matlab.mock.MethodCallBehavior'}, {'scalar'});
            decoratedConstraint = addCasualDiagnosticDecorator(WasCalled,'assumeCalled',{behavior});
        ...
        function assumeNotCalled(testCase, behavior, varargin)
            ...
            import matlab.mock.constraints.WasCalled;
            validateattributes(behavior, {'matlab.mock.MethodCallBehavior'}, {'scalar'});
            decoratedConstraint = addCasualDiagnosticDecorator(~WasCalled,'assumeNotCalled',{behavior});
            testCase.assumeThat(behavior, decoratedConstraint, varargin{:});
        end
        ...
        function assertCalled(testCase, behavior, varargin)
            ...
            import matlab.mock.constraints.WasCalled;
            validateattributes(behavior, {'matlab.mock.MethodCallBehavior'}, {'scalar'});
            decoratedConstraint = addCasualDiagnosticDecorator(WasCalled,'assertCalled',{behavior});
        ...
        function assertNotCalled(testCase, behavior, varargin)
            ...
            import matlab.mock.constraints.WasCalled;
            validateattributes(behavior, {'matlab.mock.MethodCallBehavior'}, {'scalar'});
            decoratedConstraint = addCasualDiagnosticDecorator(~WasCalled, 'assertNotCalled',{behavior});
            testCase.assertThat(behavior, decoratedConstraint, varargin{:});
        end
        ...
        function fatalAssertCalled(testCase, behavior, varargin)
            ...
            import matlab.mock.constraints.WasCalled;
            validateattributes(behavior, {'matlab.mock.MethodCallBehavior'}, {'scalar'});
            decoratedConstraint = addCasualDiagnosticDecorator(WasCalled, 'fatalAssertCalled',{behavior});
        ...
        function fatalAssertNotCalled(testCase, behavior, varargin)
            ...
            import matlab.mock.constraints.WasCalled;
            validateattributes(behavior, {'matlab.mock.MethodCallBehavior'}, {'scalar'});
            decoratedConstraint = addCasualDiagnosticDecorator(~WasCalled,'fatalAssertNotCalled',{behavior});
            testCase.fatalAssertThat(behavior, decoratedConstraint, varargin{:});
        end
        ...
        function verifyAccessed(testCase, behavior, varargin)
            ...
            decoratedConstraint = addCasualDiagnosticDecorator(WasAccessed,'verifyAccessed',{behavior});
            testCase.verifyThat(behavior, decoratedConstraint, varargin{:});
        end
        ...
        function verifyNotAccessed(testCase, behavior, varargin)
            ...
            import matlab.mock.constraints.WasAccessed;
            validateattributes(behavior, {'matlab.mock.PropertyBehavior'}, {'scalar'});
            decoratedConstraint = addCasualDiagnosticDecorator(~WasAccessed,'verifyNotAccessed',{behavior});
            testCase.verifyThat(behavior, decoratedConstraint, varargin{:});
        end
        ...
        function assumeAccessed(testCase, behavior, varargin)
            ...
            import matlab.mock.constraints.WasAccessed;
            validateattributes(behavior, {'matlab.mock.PropertyBehavior'}, {'scalar'});
            decoratedConstraint = addCasualDiagnosticDecorator(WasAccessed,'assumeAccessed',{behavior});
            testCase.assumeThat(behavior, decoratedConstraint, varargin{:});
        end
        ...
        function assumeNotAccessed(testCase, behavior, varargin)
            ...
            import matlab.mock.constraints.WasAccessed;
            validateattributes(behavior, {'matlab.mock.PropertyBehavior'}, {'scalar'});
            decoratedConstraint = addCasualDiagnosticDecorator(~WasAccessed,'assumeNotAccessed',{behavior});
            testCase.assumeThat(behavior, decoratedConstraint, varargin{:});
        end
        ...
        function assertAccessed(testCase, behavior, varargin)
            ...
            import matlab.mock.constraints.WasAccessed;
            validateattributes(behavior, {'matlab.mock.PropertyBehavior'}, {'scalar'});
            decoratedConstraint = addCasualDiagnosticDecorator(WasAccessed,'assertAccessed',{behavior});
            testCase.assertThat(behavior, decoratedConstraint, varargin{:});
        end
        ...
        function assertNotAccessed(testCase, behavior, varargin)
            ...
            import matlab.mock.constraints.WasAccessed;
            validateattributes(behavior, {'matlab.mock.PropertyBehavior'}, {'scalar'});
            decoratedConstraint = addCasualDiagnosticDecorator(~WasAccessed,'assertNotAccessed',{behavior});
            testCase.assertThat(behavior, decoratedConstraint, varargin{:});
        end
        ...
        function fatalAssertAccessed(testCase, behavior, varargin)
            ...
            import matlab.mock.constraints.WasAccessed;
            validateattributes(behavior, {'matlab.mock.PropertyBehavior'}, {'scalar'});
            decoratedConstraint = addCasualDiagnosticDecorator(WasAccessed,'fatalAssertAccessed',{behavior});
            testCase.fatalAssertThat(behavior, decoratedConstraint, varargin{:});
        end
        ...
        function fatalAssertNotAccessed(testCase, behavior, varargin)
            ...
            import matlab.mock.constraints.WasAccessed;
            validateattributes(behavior, {'matlab.mock.PropertyBehavior'}, {'scalar'});
            decoratedConstraint = addCasualDiagnosticDecorator(~WasAccessed,'fatalAssertNotAccessed',{behavior});
            testCase.fatalAssertThat(behavior, decoratedConstraint, varargin{:});
        end
        ...
        function verifySet(testCase, behavior, varargin)
            ...
            validateattributes(behavior, {'matlab.mock.PropertyBehavior'}, {'scalar'});
            decoratedConstraint = addCasualDiagnosticDecorator(WasSet,'verifySet',{behavior});
            testCase.verifyThat(behavior, decoratedConstraint, varargin{:});
        end
        ...
        function verifyNotSet(testCase, behavior, varargin)
            ...
            import matlab.mock.constraints.WasSet;
            validateattributes(behavior, {'matlab.mock.PropertyBehavior'}, {'scalar'});
            decoratedConstraint = addCasualDiagnosticDecorator(~WasSet,'verifyNotSet',{behavior});
            testCase.verifyThat(behavior, decoratedConstraint, varargin{:});
        end
        ...
        function assumeSet(testCase, behavior, varargin)
            ...
            import matlab.mock.constraints.WasSet;
            validateattributes(behavior, {'matlab.mock.PropertyBehavior'}, {'scalar'});
            decoratedConstraint = addCasualDiagnosticDecorator(WasSet,'assumeSet',{behavior});
            testCase.assumeThat(behavior, decoratedConstraint, varargin{:});
        end
        ...
        function assumeNotSet(testCase, behavior, varargin)
            ...
            import matlab.mock.constraints.WasSet;
            validateattributes(behavior, {'matlab.mock.PropertyBehavior'}, {'scalar'});
            decoratedConstraint = addCasualDiagnosticDecorator(~WasSet,'assumeNotSet',{behavior});
            testCase.assumeThat(behavior, decoratedConstraint, varargin{:});
        end
        ...
        function assertSet(testCase, behavior, varargin)
            ...
            import matlab.mock.constraints.WasSet;
            validateattributes(behavior, {'matlab.mock.PropertyBehavior'}, {'scalar'});
            decoratedConstraint = addCasualDiagnosticDecorator(WasSet,'assertSet',{behavior});
            testCase.assertThat(behavior, decoratedConstraint, varargin{:});
        end
        ...
        function assertNotSet(testCase, behavior, varargin)
            ...
            import matlab.mock.constraints.WasSet;
            validateattributes(behavior, {'matlab.mock.PropertyBehavior'}, {'scalar'});
            decoratedConstraint = addCasualDiagnosticDecorator(~WasSet,'assertNotSet',{behavior});
            testCase.assertThat(behavior, decoratedConstraint, varargin{:});
        end
        ...
        function fatalAssertSet(testCase, behavior, varargin)
            ...
            import matlab.mock.constraints.WasSet;
            validateattributes(behavior, {'matlab.mock.PropertyBehavior'}, {'scalar'});
            decoratedConstraint = addCasualDiagnosticDecorator(WasSet,'fatalAssertSet',{behavior});
            testCase.fatalAssertThat(behavior, decoratedConstraint, varargin{:});
        end
        ...
        function fatalAssertNotSet(testCase, behavior, varargin)
            ...
            import matlab.mock.constraints.WasSet;
            validateattributes(behavior, {'matlab.mock.PropertyBehavior'}, {'scalar'});
            decoratedConstraint = addCasualDiagnosticDecorator(~WasSet,'fatalAssertNotSet',{behavior});
            testCase.fatalAssertThat(behavior, decoratedConstraint, varargin{:});
        end
    end
end

function deleteMockContext(context)
    context.delete;
end

function constraint = addCasualDiagnosticDecorator(constraint, methodName, additionalArgs)
% addCasualDiagnosticDecorator
%   methodName     - name of the casual method (ex: 'verifyCalled')
...
constraint = CasualDiagnosticDecorator(constraint,...
    ['matlab.mock.TestCase.' methodName], ...
    additionalArgs);
end

% LocalWords:  abc unittest Teardown overridable
