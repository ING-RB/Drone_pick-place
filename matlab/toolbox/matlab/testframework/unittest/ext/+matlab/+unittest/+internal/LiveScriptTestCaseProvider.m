classdef LiveScriptTestCaseProvider < matlab.unittest.internal.TestCaseProvider
    ...
    methods
        function provider = LiveScriptTestCaseProvider(testScriptMLXFileModel)
            ...
            provider = provider.setFullFilename(string(testScriptMLXFileModel.Filename));
        end
    ...
    methods (Access=private)
        ...
        function setupOnceFcn(provider, testCase)
            ...
            if ~ismember(provider.FileRelease,["R2016a","R2016b","R2017a","R2017b","R2018a","R2018b","R2019a","R2019b","R2020a","R2020b","R2021a","R2021b","R2022a","R2022b","R2023a", "R2023b", "R2024a", "R2024b"])
