classdef PieChartSummaryPart < matlab.unittest.internal.dom.ReportDocumentPart
    ...
    methods(Hidden)
        function fillImage(docPart)
            docPart.appendImages(docPart.ImageObject);
        end
    end
    
    methods(Hidden,Static,Access=protected)
        function [fig,figEnv] = createPieChartFigure(passedCount,incompleteCount,failedCount,notRunCount)
            ...
            pieColors = {[118/255, 171/255, 48/255],... %green
                [0, 113/255, 188/255],... %blue
                [216/255, 83/255, 25/255],... %red
                [1,1,1]}; %white
