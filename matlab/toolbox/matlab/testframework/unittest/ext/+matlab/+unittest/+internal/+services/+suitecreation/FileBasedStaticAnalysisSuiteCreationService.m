classdef FileBasedStaticAnalysisSuiteCreationService < matlab.unittest.internal.services.suitecreation.SuiteCreationService
    ...
    methods (Sealed, Access=protected)
        function selectFactory(service, liaison)
            ...
            [~, ~, ext] = fileparts(liaison.Filename);
            if isempty(findServiceThatSupports(testSuiteFileExtensionServices, ext))
                return;
            end
...
% LocalWords:  suitecreation mtfind isnull mcheck unittest MCheck
