classdef (Sealed) HasBaseFolder < matlab.unittest.internal.selectors.SingleAttributeSelector
    ...
    %   the test file. For test classes defined in namespaces, the base folder is
    %   the parent of the top-level namespace folder. The base folder never
    ...
    properties (Constant, Hidden, Access=protected)
        AttributeClassName = "matlab.unittest.internal.selectors.BaseFolderAttribute";
        AttributeAcceptMethodName = "acceptsBaseFolder";
    end
