classdef (Sealed) HasName < matlab.unittest.internal.selectors.SingleAttributeSelector
    ...
    %       newSuite = suite.selectIf(HasName('mynamespace.TestClass1/TestMethod3'));
    %
    %       % Select all TestSuite elements whose name starts with "mynamespace.innernamespace"
    %       newSuite = suite.selectIf(HasName(StartsWithSubstring('mynamespace.innernamespace'));
    %
    ...
    properties (Constant, Hidden, Access=protected)
        AttributeClassName = "matlab.unittest.internal.selectors.NameAttribute";
        AttributeAcceptMethodName = "acceptsName";
    end
...
% LocalWords:  mynamespace innernamespace
