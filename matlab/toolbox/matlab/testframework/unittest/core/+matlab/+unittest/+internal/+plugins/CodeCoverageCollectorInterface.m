classdef CodeCoverageCollectorInterface < handle
    % CodeCoverageCollectorInterface - Interface for code coverage collectors.
    %   The CodeCoverageCollectorInterface class is an abstract interface for classes
    %   designed for collecting code coverage.
    %
    %   CodeCoverageCollectorInterface properties:
    %       Collecting - Boolean indicating whether the collector is active.
    %       Results    - Code coverage collection results.
    %
    %   CodeCoverageCollectorInterface methods:
