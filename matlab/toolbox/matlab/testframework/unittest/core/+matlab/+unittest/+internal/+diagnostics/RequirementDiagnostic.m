classdef(Hidden) RequirementDiagnostic < matlab.unittest.diagnostics.ExtendedDiagnostic & ...
    ...
    methods(Static, Access=protected)
        function str = trimNewlines(str)
            ...
            if ~isa(str, 'matlab.unittest.internal.diagnostics.FormattableString')
                validateattributes(str,{'char','string'},{'scalartext'},'','str');
            end
    ...
    methods(Hidden, Sealed)
        function diag = toVerbosityAwareDiagnostic(requirementDiag)
            ...
            terseDiag = requirementDiag;
            if requirementDiag.DisplayDescription
                terseDiag = FormattableStringDiagnostic(requirementDiag.FormattableDescription);
            end
            conciseDiag = terseDiag;
            
            detailedDiag = requirementDiag;
            verboseDiag = requirementDiag;
...
% LocalWords:  overridable Formattable scalartext
