classdef NotConstraint < matlab.unittest.constraints.BooleanConstraint & ...
    ...
    methods (Hidden, Access = {?matlab.unittest.internal.constraints.NegatableConstraint})
    ...
    methods(Hidden)
        function diag = getCasualDiagnosticFor(notConstraint, fullCasualMethodName, actual, additionalArgs)
            diag = notConstraint.Constraint.getCasualNegativeDiagnosticFor(...
                fullCasualMethodName,actual,additionalArgs);
        end
    end
