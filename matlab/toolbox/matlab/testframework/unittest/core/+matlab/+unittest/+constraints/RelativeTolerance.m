classdef RelativeTolerance < matlab.unittest.internal.constraints.ToleranceWithValues & ...
    ...
    % RelativeTolerance - Relative floating-point numeric tolerance
    %
    %   This floating-point numeric tolerance assesses the magnitude of the 
    %   difference between actual and expected values, relative to the 
    %   expected value.
    %
    ...
    %   RelativeTolerance(single(2)) constructs a RelativeTolerance for
    %   comparing single-precision numeric arrays. If the actual and 
    %   expected values being compared contain more than one numeric data 
    %   type, the tolerance only applies to the data types specified by the 
    ...
    %   example, RelativeTolerance(10*eps, 10*eps('single'))
