classdef (Sealed) HasProcedureName < matlab.unittest.internal.selectors.SingleAttributeSelector
    ...
    properties (Constant, Hidden, Access=protected)
        AttributeClassName = "matlab.unittest.internal.selectors.ProcedureNameAttribute";
        AttributeAcceptMethodName = "acceptsProcedureName";
    end
...
% LocalWords:  mynamespace PROCEDURENAME
