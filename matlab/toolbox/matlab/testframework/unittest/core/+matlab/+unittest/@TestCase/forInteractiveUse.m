...
%   Command Prompt.
%
%   TESTCASE = TestCase.forInteractiveUse(TESTCLASS,...
%   ApplySharedTestFixtures=true) also applies the shared test fixtures
%   associated with the test class. These fixtures are set up for use with
%   the test case and then torn down when the test case is deleted.
%
%   Examples:
