classdef ExceptionEventRecord < matlab.unittest.internal.eventrecords.EventRecord
    ...
    methods
        ...
        function str = getFormattedReport(eventRecord, formatter)
            str = formatter.getExceptionEventReport(eventRecord);
        end
    end
    ...
    methods(Access=protected)
        function diagRecord = convertToDiagnosticRecord(varargin)
            ...
            diagRecord = ExceptionDiagnosticRecord(varargin{:});
        end
    end
    ...
    methods(Hidden)
        function exception = getFormattedException(eventRecord, currentIndex)
            ...
            exception = generator.useExceptionEventRecord(eventRecord, currentIndex);
        end
    end
