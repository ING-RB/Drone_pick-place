...
<xsl:transform version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
        ...
        <html>
            <head>
                <xsl:element name="link">
                    ...
                    <xsl:attribute name="href"><xsl:value-of select="css-file" /></xsl:attribute>
                </xsl:element>
                <xsl:element name="script">
                    <xsl:attribute name="type">text/javascript</xsl:attribute>
                    <xsl:attribute name="src"><xsl:value-of select="jquery-file" /></xsl:attribute>
                </xsl:element>
                <xsl:element name="script">
                    <xsl:attribute name="type">text/javascript</xsl:attribute>
                    <xsl:attribute name="src"><xsl:value-of select="helpservices-file" /></xsl:attribute>
                </xsl:element>
            ...
            <body>
                ...
                <xsl:if test="count(help-topic) = 1">
                    ...
                    <xsl:if test="@doc-installed='false'">
                        ...
                        <p>
                            MATLAB cannot find your HTML help documents based on your current <b>Documentation location</b> setting.
    ...
    <xsl:template match="help-topic" mode="single-topic">
        ...
        <xsl:if test="@helpfound='false'">
            ...
            <p><xsl:value-of select="/help-info/no-help-found" /> <span class="helptopic"><xsl:value-of select="topic" /></span>.</p>
            <p>
                <xsl:element name="a">
                    <xsl:attribute name="href">matlab:docsearch('<xsl:value-of select="escaped-topic" />')</xsl:attribute>
                    <xsl:value-of disable-output-escaping="yes" select="/help-info/search-in-documentation" />
                </xsl:element>
            </p>
        </xsl:if>
