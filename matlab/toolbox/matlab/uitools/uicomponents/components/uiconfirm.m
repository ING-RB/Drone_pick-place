...
[hUIFigure, figureID] = matlab.ui.internal.dialog.DialogHelper.validateUIfigure(hUIFigure);
...
params.Options = {'OK', 'Cancel'};
params.DefaultOption = [];
params.CancelOption = [];
params.Interpreter = 'none';

% Flag to identify custom options
params.CustomOptionsFlag = false;
