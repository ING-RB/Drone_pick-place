classdef CellstrArrayStrategy< matlab.ui.internal.controller.uitable.utils.ArrayWithColumnFormatSupportStrategy
    %CELLSTRARRAYSTRATEGY - This contains any code that specialized for
    %when the Data property contains cellstr array.  This is a specialized
    ...
    methods (Static)
        function dataType = getDataType(data)
            ...
            dataType = repmat({'cellstr'}, 1, size(data, 2));
        end
