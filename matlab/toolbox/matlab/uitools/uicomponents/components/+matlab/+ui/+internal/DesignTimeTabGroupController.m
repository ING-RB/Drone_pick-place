classdef DesignTimeTabGroupController < ...
    ...
    methods
        ...
        function obj = DesignTimeTabGroupController( model, parentController, proxyView, adapter )
            % CONSTRUCTOR
        ...
        function newPos = updatePosition(obj)
            newPos = updatePosition@matlab.ui.internal.WebTabGroupController(obj);
    ...
    methods ( Access=protected )        
        ...
        function additionalPropertyNamesForView = getAdditionalPropertyNamesForView(obj)
            ...
            additionalPropertyNamesForView = {'SelectionChangedFcn'; 'ButtonDownFcn'};
