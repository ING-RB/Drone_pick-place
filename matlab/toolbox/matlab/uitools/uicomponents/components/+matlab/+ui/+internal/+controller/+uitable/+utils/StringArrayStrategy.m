classdef StringArrayStrategy< matlab.ui.internal.controller.uitable.utils.ArrayWithColumnFormatSupportStrategy
    %STRINGARRAYSTRATEGY - This contains any code that specialized for
    %when the Data property contains string array.
    ...
    methods (Static)
        function dataType = getDataType(data)
            ...
            dataType = repmat({'string'}, 1, size(data, 2));
        end
