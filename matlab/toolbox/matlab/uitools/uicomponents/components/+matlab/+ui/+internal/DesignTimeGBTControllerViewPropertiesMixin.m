classdef DesignTimeGBTControllerViewPropertiesMixin < appdesservices.internal.interfaces.controller.mixin.ViewPropertiesHandler
    ...
    methods(Access = protected)
        function commonPropertyNamesForView = getCommonPropertyNamesForView(obj)
            ...
            commonPropertyNamesForView = {'HandleVisibility','BusyAction','Interruptible', 'Tag'};
        end
        ...
        function excludedPropertyNames = getExcludedPropertyNamesForView(obj)
            ...
            excludedPropertyNames = {'Layout_I';'Layout';'ContextMenuID';};
            excludedPropertyNames = {'Layout_I';'Layout';};
        end
