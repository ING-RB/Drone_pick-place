classdef DesignTimeContextMenuController< ...
        matlab.ui.internal.WebContextMenuController & ...
    ...
    % DesignTimeContextMenuController controller class which encapsulates
    ...
    methods
        ...
        function obj = DesignTimeContextMenuController( model, parentController, proxyView, adapter)
            %CONSTRUCTOR
            ...
            obj = obj@matlab.ui.internal.WebContextMenuController( model, parentController, proxyView );
    ...
    methods        
         function viewPvPairs = getPositionPropertiesForView(~, ~)
            ...
            % because ContextMenu does not have/need any Position-type properties
         ...
         function additionalProperties = getAdditonalPositionPropertyNamesForView(objModel)            
            % Override to suppress the default implementation in
            % DesignTimeGBTControllerPositionMixin
            % because ContextMenu does not require 
            % AspectRatioLimits and IsSizeFixed
            
            additionalProperties = {'ContextMenuOpeningFcn'};            
         end    
    ...
    methods (Access=protected)
        ...
        function excludedPropertyNames = getExcludedPropertyNamesForView(obj)
            excludedPropertyNames = {'ContextMenuID'; 'ObjectID'};
