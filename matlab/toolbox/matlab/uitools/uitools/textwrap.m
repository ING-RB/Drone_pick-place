...
if ~isempty(Columns) && (~isnumeric(Columns) || Columns <= 0 || ~mod(Columns, 1) == 0)
      error(message('MATLAB:textwrap:InvalidColumnsInput'));
end
