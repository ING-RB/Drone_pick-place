...
% make sure we are on screen and do an initial resizing of the dialog
movegui(InputFig); 
doResize(InputFig, [], inputWidthSpecified);
...
if ishghandle(InputFig) && isvalid(InputFig)
    % g3399260- Set the resize function after resizing is done to avoid calling it
