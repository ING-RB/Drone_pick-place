classdef Slider < matlab.ui.internal.toolstrip.base.Control ...
    ...
    %   <a href="matlab:help matlab.ui.internal.toolstrip.mixin.WidgetBehavior_UseSmallFont.UseSmallFont">UseSmallFont</a>        
    ...
    %       <a href="matlab:help matlab.ui.internal.toolstrip.mixin.WidgetBehavior_Compact">Compact</a>     
    %   Methods:
    ...
    methods (Access = protected)
        ...
        function buildWidgetPropertyMaps(this)
            ...
            [mcos3, peer3] = this.getWidgetPropertyNames_UseSmallFont();
            [mcos4, peer4] = this.getWidgetPropertyNames_Compact();
