classdef QABRedoButton < matlab.ui.internal.toolstrip.impl.QABPushButton
    % QAB Redo Button
    %
    % Constructor:
    %   <a href="matlab:help matlab.ui.internal.toolstrip.qab.QABRedoButton.QABRedoButton">QABRedoButton</a>     
    %
    % Properties:
    ...
    %
    % Events: 
    %   <a href="matlab:help matlab.ui.internal.toolstrip.qab.QABRedoButton.ButtonPushed">ButtonPushed</a>
    
    % Copyright 2019-2020 The MathWorks, Inc.

    properties (Access = private)
        ClassAnchor = '<a href="matlab:doc matlab.ui.internal.toolstrip.qab.QABRedoButton">QABRedoButton</a>';
    end
    ...
    methods
        ...
        %% Constructor
        function this = QABRedoButton(varargin)
            % Constructor "QABRedoButton": 
            %
            %   Create a QAB redo button.
            %
            %   Examples:
            %       qabbtn = matlab.ui.internal.toolstrip.qab.QABRedoButton();
            %       qabbtn.ButtonPushedFcn = @(varargin) disp('Redo called!');
    ...
    methods (Access = private)
        function setPropertyDefaults(this)
            ...
            % Set Icon property
            action.Icon = matlab.ui.internal.toolstrip.Icon.REDO_16;
            action.QuickAccessIcon = matlab.ui.internal.toolstrip.Icon.REDO_16;

            % Set Text property
            action.Text = message('MATLAB:toolstrip:qab:redoLabel').getString;

            % Set Description property
            action.Description = message('MATLAB:toolstrip:qab:redoDescription').getString;

            % Set Enabled property
            action.Enabled = false;

            % Set Tag property
            this.Tag = 'QABRedoButton';
        end
    end
