classdef ListItemWithCheckBox < matlab.ui.internal.toolstrip.base.Control ...
    ...
    %
    % Events:
    %   <a href="matlab:help matlab.ui.internal.toolstrip.ListItemWithCheckBox.ValueChanged">ValueChanged</a>            
    %
    ...
    events
        % Event triggered by select or unselect the checkbox in the UI.
        ValueChanged
    end
    ...
    methods
        ...
        function this = ListItemWithCheckBox(varargin)
            ...
            % super
            this = this@matlab.ui.internal.toolstrip.base.Control('ListItemWithCheckBox');
    ...
    methods (Access = protected)
        ...
        function rules = getInputArgumentRules(this) %#ok<MANU>
            ...
            rules.properties.Description = struct('type','string','isAction',true);
            rules.properties.Value = struct('type','logical','isAction',true);
            rules.input0 = true;
            rules.input1 = {{'Text'}};
            rules.input2 = {{'Text';'Description'};{'Text';'Value'}};
            rules.input3 = {{'Text';'Description';'Value'}};
        end
        ...
        function buildWidgetPropertyMaps(this)
            ...
            [mcos4, peer4] = this.getWidgetPropertyNames_ClosePopupOnClick();
        ...
        function result = checkAction(this, control) %#ok<INUSL>
            ...
            result = isa(control, 'matlab.ui.internal.toolstrip.ListItemWithCheckBox') ...
                || isa(control, 'matlab.ui.internal.toolstrip.CheckBox');
        end
