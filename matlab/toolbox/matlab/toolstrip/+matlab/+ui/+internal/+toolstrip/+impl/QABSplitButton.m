classdef QABSplitButton < matlab.ui.internal.toolstrip.base.QABControl ...
    ...
    methods
        ...
        function this = QABSplitButton(varargin)
            ...
            % super
            this = this@matlab.ui.internal.toolstrip.base.QABControl('QABSplitButton', varargin{:});
        end
    ...
    methods (Access = protected)
        ...
        function result = checkAction(this, control)
            ...
            result = isa(control, 'matlab.ui.internal.toolstrip.impl.QABSplitButton');
        end
