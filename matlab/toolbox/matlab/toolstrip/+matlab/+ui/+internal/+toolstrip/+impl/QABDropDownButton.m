classdef QABDropDownButton < matlab.ui.internal.toolstrip.base.QABControl ...
    ...
    methods
        ...
        function this = QABDropDownButton(varargin)
            ...
            % super
            this = this@matlab.ui.internal.toolstrip.base.QABControl('QABDropDownButton', varargin{:});
        end
