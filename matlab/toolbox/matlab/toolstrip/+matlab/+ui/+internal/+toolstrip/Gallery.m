classdef Gallery < matlab.ui.internal.toolstrip.base.Control
    ...
    %   <a href="matlab:help matlab.ui.internal.toolstrip.Gallery.HideDisabledItems">HideDisabledItems</a>
    %
    % Methods:
    ...
    properties (Dependent, SetAccess = private)
        ...
        %
        Popup
        % Property "HideDisabledItems": 
        %
        %   Whether the Gallery should display disabled Items when enabled
        %   Items are also present in the GalleryPopup.  By default, Items
        %   are hidden from the Gallery view when disabled to maximize the
        %   number of usable items visible and accessible to the user.
        %
        HideDisabledItems
    end
    ...
    methods
        ...
        % HideDisabledItems
        function value = get.HideDisabledItems(this)
            % GET function for Items property.
            value = this.HideDisabledItemsPrivate;
        end
        function set.HideDisabledItems(this, value)
            % SET function
            this.HideDisabledItemsPrivate = value;
            this.setPeerProperty('hideDisabledItems', value);
        end
    ...
    methods (Access = protected)
        ...
        function buildWidgetPropertyMaps(this)
            ...
            mcos = [mcos;{'MaxColumnCountPrivate';'CurrentColumnCountPrivate';'MinColumnCountPrivate';'TextOverlayPrivate';'GalleryItemRowCountPrivate';'GalleryItemTextLineCountPrivate';'GalleryItemWidthPrivate';'GalleryPopupIdPrivate';'ShouldRefreshPrivate';'ShowSelectionPrivate';'HideDisabledItemsPrivate';'DisplayStatePrivate';'ScrollToSelectionPrivate';'ColumnWidthPrivate'; 'IconSizePrivate'}];
            peer = [peer;{'maxColumnCount';'currentColumnCount';'minColumnCount';'textOverlay';'galleryItemRowCount';'galleryItemTextLineCount';'galleryItemWidth';'galleryPopupId';'shouldRefresh';'showSelection';'hideDisabledItems';'displayState';'scrollToSelection';'columnWidth'; 'iconSize'}];
    ...
    methods (Access = protected)
        ...
        function processCustomProperties(this, varargin)
            ...
            if ni>0
                ...
                PublicProps = {'MaxColumnCount','MinColumnCount', 'IconSize', 'HideDisabledItems'};
                for ct=1:2:ni
                    ...
                    switch name
                        ...
                        case 'HideDisabledItems'
                            value = varargin{ct+2};
                            ok = matlab.ui.internal.toolstrip.base.Utility.validate(value, 'logical');
                            if ok
                                widget_properties.(name) = value;
                            else
                                error(message('MATLAB:toolstrip:container:invalidHideDisabledItems'))
                            end
                    end
                end
            end
            ...
            widget_properties.ColumnWidthPrivate = popup.ColumnWidth;
            widget_properties.IconSizePrivate = popup.IconSize;
            % set properties
