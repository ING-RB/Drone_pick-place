classdef PopupList < matlab.ui.internal.toolstrip.base.Container
    ...
    properties (Dependent, SetAccess = private)
        % Property "IconSize"
        %   Specify the size of SVG icons used in ListItem widgets
        %   residing under this PopupList. Default IconSize is 24. The
        %   property is ready-only. Custom value must be provided during
        %   construction.
        IconSize
    end
    ...
    methods
        ...
        %% Constructor
        function this = PopupList(varargin)
