classdef GalleryCategory < matlab.ui.internal.toolstrip.base.Container & matlab.ui.internal.toolstrip.mixin.WidgetBehavior_Title
    ...
    methods (Access = protected)
        ...
        function PeerEventCallback(this,~,data)
            ...
            if strcmp(eventdata.EventData.EventType,'CategoryMoved') && isfield(eventdata.EventData, 'newIndex')
                currentIndex = this.getIndex();
                newIndex = eventdata.EventData.newIndex + 1; % Adjust 0 indexing to 1 indexing

                if currentIndex ~= newIndex
                    this.Parent.move(this, newIndex);
                end
            end
        end
