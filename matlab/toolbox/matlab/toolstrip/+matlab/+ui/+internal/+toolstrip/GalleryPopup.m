classdef GalleryPopup < matlab.ui.internal.toolstrip.base.Container
    ...
    % -----------------------------------------------------------------------------------------
    % ATTENTION:
    % The following settings are only valid for JavaScript rendering
    %   Properties:
    ...
    properties (Dependent, SetAccess = private)
        ...
        %   display state. The default value is icon_view. The property is 
        ...
        %   Gallery. Default value is false. The property is read-only. 
        %   Custom value must be provided during construction.
        %
        ShowSelection
        % Property "IconSize"
        %   Specify the size of SVG icons used in GalleryItem widgets
        %   residing under this GalleryPopup. Default IconSize is 24. The
        %   property is ready-only. Custome value must be provided during
        %   construction.
        IconSize
    end
    ...
    properties (Dependent, SetAccess = private, Hidden)
        ...
        %   The ratio of width to height of any gallery item displayed in the gallery and
        %   gallery popup. The default value is 1.  The property is
        %   read-only.  Custom value must be provided during construction.
        %
        ColumnWidth
    end
    ...
    methods
        ...
        function value = get.GalleryItemWidth(this)
            % GET function for GalleryItemWidth property.
        ...
        % IconSize
        function value = get.IconSize(this)
            % GET function for Popup property.
            value = this.IconSizePrivate;
        end
        function set.IconSize(this, value)
            % SET function
            this.IconSizePrivate = value;
            this.setPeerProperty('iconSize',value);
        end
        % FavoritesEnabled
        function value = get.FavoritesEnabled(this)
            % GET function for Items property.
            value = this.FavoritesEnabledPrivate;
        end
        function set.FavoritesEnabled(this, value)
            % SET function
            this.FavoritesEnabledPrivate = value;
            this.setPeerProperty('favoritesEnabled',value);
        end
        % DisplayState
        ...
        function value = get.ColumnWidth(this)
            ...
            value = this.ColumnWidthPrivate;
        end
        function set.ColumnWidth(this, value)
            % SET function
            this.ColumnWidthPrivate = value;
            this.setPeerProperty('columnWidthPrivate',value);
        end
    ...
    methods (Access = protected)
        ...
        function buildWidgetPropertyMaps(this)
            ...
            mcos = [mcos;{'GalleryItemRowCountPrivate';'GalleryItemTextLineCountPrivate';'GalleryItemWidthPrivate';'FavoritesEnabledPrivate';'DisplayStatePrivate';'FavCategoryIdPrivate';'ScrollToSelectionPrivate';'ShowHeaderPrivate';'ColumnWidthPrivate'; 'IconSizePrivate'}];
            peer = [peer;{'galleryItemRowCount';'galleryItemTextLineCount';'galleryItemWidth';'favoritesEnabled';'displayState';'favCategoryId';'scrollToSelection';'showHeader';'columnWidth'; 'iconSize'}];
    ...
    methods (Access = protected)
        ...
        function processCustomProperties(this, varargin)
            ...
            PublicProps = {'DisplayState','FavoritesEnabled','GalleryItemRowCount','GalleryItemTextLineCount','GalleryItemWidth','ShowSelection', 'ColumnWidth', 'IconSize'};
            for ct=1:2:ni
                ...
                switch name
                    ...
                    case 'ColumnWidth'
                        ...
                        if ok
                            ...
                            error(message('MATLAB:toolstrip:container:invalidColumnWidth'))
                        end
                    case 'IconSize'
                        value = varargin{ct+1};
                        ok = matlab.ui.internal.toolstrip.base.Utility.validate(value, 'real');
                        if ok
                            ...
                            error(message('MATLAB:toolstrip:container:invalidIconSize'))
                        end
                end
            end
        ...
        function PropertySetCallback(this,~,data)
            ...
            if viewmodel.internal.factory.ManagerFactoryProducer.isViewModel(this.Peer)
                if (strcmp(data.srcLang, 'JS') && strcmp(data.data.key, 'displayState'))
                    this.DisplayStatePrivate = data.data.newValue;
                end
            else
