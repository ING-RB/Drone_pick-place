classdef QABToggleSplitButton < matlab.ui.internal.toolstrip.base.QABControl ...
    ...
    % QAB Toggle Split Button
    %
    % Constructor:
    %   <a href="matlab:help matlab.ui.internal.toolstrip.impl.QABToggleSplitButton.QABToggleSplitButton">QABToggleSplitButton</a>
    %
    % Properties:
    ...
    %
    % Events:
    %   <a href="matlab:help matlab.ui.internal.toolstrip.ToggleSplitButton.SelectionChanged">SelectionChanged</a>
    %
    ...
    methods
        ...
        %% ----------- Developer API  ----------------------
        function this = QABToggleSplitButton(varargin)
            % Constructor "QABToggleSplitButton":
            %
            %   Create a QAB split button.
            %
            %   Examples:
            %       qabbtn = matlab.ui.internal.toolstrip.impl.QABToggleSplitButton(btn.getAction())
            
            % super
            this = this@matlab.ui.internal.toolstrip.base.QABControl('QABToggleSplitButton', varargin{:});
        end
    ...
    methods (Access = protected)
        ...
        function result = checkAction(this, control)
            ...
            result = isa(control, 'matlab.ui.internal.toolstrip.impl.QABToggleSplitButton');
        end
