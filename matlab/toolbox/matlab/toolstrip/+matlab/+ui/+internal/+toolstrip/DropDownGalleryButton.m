classdef DropDownGalleryButton < matlab.ui.internal.toolstrip.base.Control ...
    ...
    properties (Access = {?matlab.ui.internal.toolstrip.base.Component})
        ...
        ColumnWidthPrivate = 1                  % from popup
    end
    ...
    methods (Access = protected)
        ...
        function buildWidgetPropertyMaps(this)
            ...
            mcos = [mcos;{'PopupTypePrivate';'MaxColumnCountPrivate';'MinColumnCountPrivate';'GalleryItemRowCountPrivate';'GalleryItemTextLineCountPrivate';'GalleryItemWidthPrivate';'PopupIdPrivate';'ShowSelectionPrivate';'ScrollToSelectionPrivate';'ColumnWidthPrivate'}];
            peer = [peer;{'popupType';'maxColumnCount';'minColumnCount';'galleryItemRowCount';'galleryItemTextLineCount';'galleryItemWidth';'popupId';'showSelection';'scrollToSelection';'columnWidth'}];
    ...
    methods (Access = protected)
        ...
        function processCustomProperties(this, varargin)
            ...
            this.ColumnWidthPrivate = this.Popup.ColumnWidth;
        end
