function generateCSharp(targetFolder, nameValuePairs)
%generateCSharp Generate a C# strongly typed interface to MATLAB code
%   generateCSharp(targetFolder, Namespaces=namespaceNames, Classes=classNames, Functions=functionNames, ...)
%      Generate C# files in the directory specified by targetFolder.
%      If a file already exists, it is overwritten. The target folder
%      contains a strongly typed interface to any combination
...
%      classes. Supported MATLAB functions are user-authored as well. At least one MATLAB
...
%      in the C# files where possible. The number of generated class
...
%                   the listed namespaces and their namespaces are
%                   included in the interface. All namespace names specified
...
%                   independently.
%
%   FunctionHolderClass string - The name of the C# class that will hold the MATLAB
%                       functions that do NOT belong to a class.  Input is
%                       specified as a string or character vector.  If this 
%                       argument is not specified then the class will be 
%                       named MATLABFunctions by default.
%
%   OuterCSharpNamespace    string - The name of the C# namespace that will 
%                           contain the generated code. This is the 
%                           outermost namespace. This only accepts a scalar 
%                           string or char vector.
%
%   Examples:
%
%   % Create a C# strongly typed interface to a MATLAB function called myFunc
%   matlab.engine.typedinterface.generateCSharp("myTargetFolder", Functions="myFunc")
%
...
%   matlab.engine.typedinterface.generateCSharp("myTargetFolder", Classes="myNamespace.myClass")
%
...
%   matlab.engine.typedinterface.generateCSharp("myTargetFolder", ...
...
%   Copyright 2023 The MathWorks, Inc.
    ...
    try
        ...
        matlab.engine.internal.codegen.csharp.generateTypedInterfaceCSharp(targetFolder, nvPairsCell{:});
    catch exception
