function cppOut = writeMethodReturnSection(outputArgs, cppIn)
    %writeReturnSection fills in the return section tokens of the generated
    %method given the output arguments. Uses the templated output design.
    ...
    returnSection0 = "[rootIndent][oneIndent]MATLABCallNoOutputMethod(u""[MethodName]"", _args);";
    cppOut = replace(cppOut, "[returnSection0]", returnSection0);

    complexCatchClassSection = "";
    complexTransformSection = "";
    returnSection1 = "[rootIndent][oneIndent]matlab::data::Array _result_mda = MATLABCallOneOutputMethod(u""[MethodName]"", _args);" + newline + ...
    ...
    castSection = "";
    useSimpleScalar = "_result = ((matlab::data::TypedArray<[returnType1]>)_result_mda)[0];"; % works for simple scalars
    ...
    elseif cppCategory == utilcpp.OutputTypeCategory.GenExternalClassScalar
        ...
        returnSection1 = "[rootIndent][oneIndent]matlab::data::Array _result_mda = MATLABCallOneOutputMethod(u""[MethodName]"", _args);" + newline + ...
        "[rootIndent][oneIndent]" + className + " _object(m_matlabPtr, _result_mda);" + newline + ...
    ...
    elseif cppCategory == utilcpp.OutputTypeCategory.GenExternalClassVector
        ...
        "std::vector<matlab::data::Object> _vectorOfObjects (_MDAobjects.cbegin(), _MDAobjects.cend());" + newline+...
        ...
        "[rootIndent][oneIndent][oneIndent]_objects.push_back("+ className +"(m_matlabPtr,_obj_arr));" + newline + ...
        "[rootIndent][oneIndent]}" + newline + ...
        "[rootIndent][oneIndent] return _objects;";
    end
    ...
    for x = 2 : numOut
        returnSectionX = "[rootIndent][oneIndent]std::vector<matlab::data::Array> _result_mda = MATLABCallMultiOutputMethod(u""[MethodName]"","+x+", _args);" + newline + ...
            "[complexCatchClassSection]" + ...
        ...
        for i = 1 : x 
            ...
            simpleCast = newline + "[rootIndent][oneIndent]std::get<"+(i-1)+">(_result) = ((matlab::data::TypedArray<[out"+i+"]>)[complexTransformSection][0];";
            ...
            elseif cppCategory == utilcpp.OutputTypeCategory.GenExternalClassScalar
                % For now use MDA instead of generatable class
                 castPart = newline + ...
                 "[rootIndent][oneIndent]" + outputArgs(i).MATLABArrayInfo.ClassName +" _obj"+i+" (m_matlabPtr, _result_mda[" + (i-1) +"]);" + newline + ...
            ...
            elseif cppCategory == utilcpp.OutputTypeCategory.GenExternalClassVector
                ...
                "std::vector<matlab::data::Object> _vectorOfObjects"+i+" (_MDAobjects" + i + ".cbegin(), _MDAobjects" + i + ".cend());" + newline+...
                ...
                "[rootIndent][oneIndent][oneIndent]_objects"+i+".push_back("+classNameWithScope+"(m_matlabPtr,_obj_arr" + i + "));" + newline + ...
                "[rootIndent][oneIndent]}" + newline + ...
