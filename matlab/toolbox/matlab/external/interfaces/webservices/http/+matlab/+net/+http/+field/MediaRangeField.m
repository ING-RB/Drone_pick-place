...
%  value.
%
%  MediaRangeField methods:
%     convert  - Return vector of MediaType objects
%
...
% Copyright 2015-2019 The MathWorks, Inc.
    methods
        ...
        %   TYPES = convert(FIELDS) parses the values in the vector of FIELDS as a
        %   comma-separated list of values, converts each value to a MediaType
        %   object, and returns a vector of them. Each value is a media-type
        %   expression as defined in RFC 7231, <a href="http://tools.ietf.org/html/rfc7231#section-3.1.1.1">section 3.1.1.1</a>. This syntax is 
        %   used in both the Content-Type and Accept header fields.
        %
