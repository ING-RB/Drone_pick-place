...
%   RFC 7230, <a href="http://tools.ietf.org/html/rfc7230#section-3.1.2">section 3.1.2</a>.
%
        ...
        function str = char(obj)
            if isnumeric(obj.StatusCode)
                if isempty(obj.ProtocolVersion)
                    ...
                    pv = string(obj.ProtocolVersion);
                end
                if isempty(obj.ReasonPhrase)
                    rp = "";
                else
                    rp = obj.ReasonPhrase;
                end
                str = char(pv + " " + string(obj.StatusCode) + " " + rp);
            else
