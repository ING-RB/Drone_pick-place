...
%     replaceFields - replace header fields
...
% Copyright 2015-2024 The MathWorks, Inc.
    ...
    methods
        ...
        function obj = set.Body(obj, value)
            ...
            elseif isa(value, 'matlab.net.http.io.ContentProvider')
                obj.Body = matlab.lang.WeakReference(value);
            else
        ...
        function value = get.Body(obj)
            if isa(obj.Body, 'matlab.lang.WeakReference')
                value = obj.Body.Handle;
            else
                value = obj.Body;
            end
        end
    ...
    methods (Sealed)
        ...
        %   character vectors.
        %
        %   This method is intended for logging or debugging and the output may
        ...
        %
        %   This method is intended for diagnostics or debugging and is designed to
        %   be human-readable. The output may change in future releases and is not
        %   intended to be parsed by automated tools.
        %
        ...
        %   error. This shouldn't be possible, but just in case.
            if isempty(contentTypeField) || isempty(contentTypeField.Value)
                ...
                try
                    ...
                    mediaType = contentTypeField.convert();
                catch e
