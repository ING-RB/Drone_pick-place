...
% Copyright 2015-2018 The MathWorks, Inc.
    ...
    enumeration
        ...
        % TransmissionError - an error occurred sending or receiving the message.
        %   It could be due to an I/O error such as a disconnect or timeout, failure
        %   in a ContentProvider or ContentConsumer, or error trying to convert the
        %   outgoing or incoming data from or to MATLAB data. LogRecord.Exception
        ...
        %   payload could not be read, the ResponseMessage will contain the headers and
        %   may contain all or part of the payload that was received.
        %
