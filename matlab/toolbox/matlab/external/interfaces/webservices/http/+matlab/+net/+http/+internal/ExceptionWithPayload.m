...
%  We throw this exception after receiving the header and all or part of the payload of a
%  ResponseMessage, when we could not complete processing the payload (i.e.,
%  converting it to MATLAB data). For example, we failed trying to convert a payload
%  whose Content-Type is application/json to a MATLAB structure.
%
