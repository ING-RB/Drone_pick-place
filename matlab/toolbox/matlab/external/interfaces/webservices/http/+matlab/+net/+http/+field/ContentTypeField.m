...
%   ResponseMessage that contains a single media type specification indicating the
%   type of content in the body of the message (RequestMessage.Body.Data). In a
%   RequestMessage that contains a nonempty Body, if you don't explicitly add such a
%   field, MATLAB adds on on the type of data you insert in the Data. If you specify
%   a ContentTypeField, this will determine how your outbound data is converted.  For
%   more information on this conversion see the description of MessageBody.Data.
%
