...
%
%    If you are sending a message interactively and did not catch the
%    HTTPException, you can get it from MException.last:
%
%      resp = req.send(url);
%      (throws and displays an HTTPException)
%      e = MException.last;  % get the HTTPException
%      show(e.History);      % show what happened
%
