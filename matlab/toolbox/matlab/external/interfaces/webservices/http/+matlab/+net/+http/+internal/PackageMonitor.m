...
% User must call refresh() when any adding a class in the package in order for
% this class to pick it up. This is only required in development because
% HeaderField (the base class of all these classes) only allows subclasses in this
% package, and all the classes in this package are sealed.
