                ...
                if strcmp(varName,'Properties')
                    ...
                    case 2
                        ...
                        if obj.Properties.SupportsPartialAccess
                            [varargout{1:nargout}] = matlab.io.internal.partialLoad(obj.Properties.Source, varSubset, '-mat');
                        else
                ...
                if strcmp(varName,'Properties')
                    ...
                    switch length(indexingStruct) 
                        ...
                        case 2
                            ...
                            if obj.Properties.SupportsPartialAccess
                                matlab.io.internal.partialSave(obj.Properties.Source, value, varSubset);
                            else
...
function varSubset = createMetaDescriptionOfIndexing(varName, varInfo, indexingStruct) 
    ...
    if iscellstr(indexExpression) && ~any(strcmp(indexExpression,':'))
        ...
        % indexing.
        subsets = matlab.io.internal.Subset(indexingStruct(depthOfIndexing).type, {indexExpression});
    else
        ...
        for dim = 1:numberOfDims
            ...
            if strcmp(indexVector, ':')
                ...
                if ~isequal(indexVector(:)', minBound(1):stride:maxBound(1)) || stride <= 0
        ...
        subsets = matlab.io.internal.Subset(indexingStruct(depthOfIndexing).type, boundsTriplet);
    end
    varSubset = matlab.io.internal.VariableSubset(varName, subsets);
end
