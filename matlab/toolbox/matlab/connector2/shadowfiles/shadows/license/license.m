...
% Convert possible strings to chars
[varargin{:}] = convertStringsToChars(varargin{:});

if nargin == 0
    entitlements = connector.internal.getEntitledProducts();
    if isempty(entitlements.entitledProducts)
        varargout{1} = builtin('license');
    else
        licenses = entitlements.licenseNumbers;
