classdef LSM6DSOBlock < matlabshared.sensors.simulink.internal.LSM6DSRAnd6DSOBlockBase
    % LSM6DSO 6 DOF IMU sensor.
    %
    % <a href="https://www.st.com/resource/en/datasheet/lsm6dso.pdf">Device Datasheet</a>

    %   Copyright 2020-2022 The MathWorks, Inc.
    %#codegen
    % W.r.t to the exposed features, LSM6DSO and LSM6DSR are equivalent
    % except for Gyroscope range
    ...
    methods(Access = protected)
        function createSensorObjectImpl(obj)
            ...
            obj.SensorObject = lsm6dso(obj.HwUtilityObject,"Bus",obj.I2CBus,'I2CAddress',obj.I2CAddress,...
        ...
        function maskDisplayCmds = getMaskDisplayImpl(obj)
            ...
            maskDisplayCmds = [ ...
                ...
                ['text(52,12,' [''' ' 'LSM6DSO' ''',''horizontalAlignment'',''right'');' newline]]   ...
                outport_label
                ];
        end
    end
    ...
    methods(Access = protected, Static)
        function header = getHeaderImpl()
            header = matlab.system.display.Header(mfilename('class'), 'Title',...
                'LSM6DSO 6DOF IMU Sensor','Text',message('matlab_sensors:blockmask:lsm6dsMaskDescription').getString,'ShowSourceLink', false);
        end
    end
end