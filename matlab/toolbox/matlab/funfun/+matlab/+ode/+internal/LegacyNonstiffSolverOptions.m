%matlab.ode.internal.LegacyNonstiffSolverOptions  Solver options common to most MATLAB ODE solvers.

%    Copyright 2023-2024 MathWorks, Inc.

classdef LegacyNonstiffSolverOptions < matlab.ode.Options
    properties
    ...
    methods
        function obj = LegacyNonstiffSolverOptions(nv)
            arguments
                nv.?matlab.ode.internal.LegacyNonstiffSolverOptions
            end
            for k=fields(nv)'
                obj.(k{:}) = nv.(k{:});
            end
