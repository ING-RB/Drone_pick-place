...
A = left_mult(A,p,q,method,classname);  % Left multiplications by orthogonal matrices.
A = left_mult(A',p,q,method,classname); % Right multiplications by orthogonal matrices.

end

function A = left_mult(A,p,q,method,classname)
