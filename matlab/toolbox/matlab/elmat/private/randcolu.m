...
%   unit 2-norm, with random singular values from a uniform distribution.
%   GALLERY('RANDCOLU',N,M), where M >= N, produces an M-by-N matrix.
%   A'*A is a correlation matrix of similar form to that produced by
%   GALLERY('RANDCORR',N). The eigenvalues of the latter are uniformly
%   distributed, while for the first, the square roots of the eigenvalues
