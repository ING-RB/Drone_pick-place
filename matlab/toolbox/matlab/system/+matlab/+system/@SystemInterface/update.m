...
%   
%   If System object defines an updateImpl method, the update method processes 
%   the object inputs to update the object states according to the object 
%   algorithm. The number of input arguments depends on the algorithm, and may
%   depend also on one or more property settings. The update method for some 
