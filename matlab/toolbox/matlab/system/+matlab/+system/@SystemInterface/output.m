...
%   
%   If System object defines an outputImpl method, the output method processes
%   the object states and the direct feedthrough inputs to create the output 
%   according to the object algorithm. The number of input and output arguments
%   depends on the algorithm and may depend also on one or more property 
%   settings. The output method for some objects accepts fixed-point (fi) 
%   inputs.
%          
