...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_octomap_msgs
max_serialized_size_key_GetOctomap_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_octomap_msgs
max_serialized_size_key_GetOctomap_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_octomap_msgs
cdr_serialize(
  const octomap_msgs::srv::GetOctomap_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  octomap_msgs::srv::GetOctomap_Event & ros_message);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_octomap_msgs
max_serialized_size_GetOctomap_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_octomap_msgs
max_serialized_size_key_GetOctomap_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_octomap_msgs
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, octomap_msgs, srv, GetOctomap_Event)();
