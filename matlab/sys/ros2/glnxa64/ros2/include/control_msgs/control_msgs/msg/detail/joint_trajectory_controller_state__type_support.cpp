...
void fetch_function__JointTrajectoryControllerState__joint_names(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__JointTrajectoryControllerState__joint_names(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__JointTrajectoryControllerState__joint_names(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__JointTrajectoryControllerState__joint_names(untyped_member, index));
...
size_t size_function__JointTrajectoryControllerState__multi_dof_joint_names(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<std::string> *>(untyped_member);
  return member->size();
}

const void * get_const_function__JointTrajectoryControllerState__multi_dof_joint_names(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<std::string> *>(untyped_member);
  return &member[index];
...
void * get_function__JointTrajectoryControllerState__multi_dof_joint_names(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<std::string> *>(untyped_member);
  return &member[index];
...
void fetch_function__JointTrajectoryControllerState__multi_dof_joint_names(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__JointTrajectoryControllerState__multi_dof_joint_names(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__JointTrajectoryControllerState__multi_dof_joint_names(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__JointTrajectoryControllerState__multi_dof_joint_names(untyped_member, index));
  const auto & value = *reinterpret_cast<const std::string *>(untyped_value);
  item = value;
}

void resize_function__JointTrajectoryControllerState__multi_dof_joint_names(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<std::string> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember JointTrajectoryControllerState_message_member_array[11] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    fetch_function__JointTrajectoryControllerState__joint_names,  // fetch(index, &value) function pointer
    assign_function__JointTrajectoryControllerState__joint_names,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_msgs::msg::JointTrajectoryControllerState, reference),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_msgs::msg::JointTrajectoryControllerState, feedback),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_msgs::msg::JointTrajectoryControllerState, output),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_msgs::msg::JointTrajectoryControllerState, multi_dof_joint_names),  // bytes offset in struct
    nullptr,  // default value
    size_function__JointTrajectoryControllerState__multi_dof_joint_names,  // size() function pointer
    get_const_function__JointTrajectoryControllerState__multi_dof_joint_names,  // get_const(index) function pointer
    get_function__JointTrajectoryControllerState__multi_dof_joint_names,  // get(index) function pointer
    fetch_function__JointTrajectoryControllerState__multi_dof_joint_names,  // fetch(index, &value) function pointer
    assign_function__JointTrajectoryControllerState__multi_dof_joint_names,  // assign(index, value) function pointer
    resize_function__JointTrajectoryControllerState__multi_dof_joint_names  // resize(index) function pointer
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_msgs::msg::JointTrajectoryControllerState, multi_dof_reference),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_msgs::msg::JointTrajectoryControllerState, multi_dof_feedback),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_msgs::msg::JointTrajectoryControllerState, multi_dof_error),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_msgs::msg::JointTrajectoryControllerState, multi_dof_output),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
