...
static rosidl_typesupport_introspection_c__MessageMember control_msgs__msg__JointTrajectoryControllerState__rosidl_typesupport_introspection_c__JointTrajectoryControllerState_message_member_array[11] = {
  {
    "header",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control_msgs, msg, JointTrajectoryControllerState)() {
  ...
  control_msgs__msg__JointTrajectoryControllerState__rosidl_typesupport_introspection_c__JointTrajectoryControllerState_message_member_array[8].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, trajectory_msgs, msg, MultiDOFJointTrajectoryPoint)();
