...
set(_exported_libraries "ros2_tf2_ros")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING
          "Package 'tf2_ros' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND tf2_ros_LIBRARIES ${_cfg} "${_lib}")
...
# TODO(dirk-thomas) deduplicate tf2_ros_LIBRARIES
