...
call:ament_prepend_unique_value PATH "%AMENT_CURRENT_PREFIX%\opt\console_bridge_vendor\bin"
call:ament_prepend_unique_value LD_LIBRARY_PATH "%AMENT_CURRENT_PREFIX%\opt\console_bridge_vendor\lib"
call:ament_prepend_unique_value LD_LIBRARY_PATH "%AMENT_CURRENT_PREFIX%\opt\console_bridge_vendor\lib64"
