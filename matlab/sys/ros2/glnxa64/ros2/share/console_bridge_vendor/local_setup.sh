...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/console_bridge_vendor/environment/vendor_package.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/console_bridge_vendor/environment/vendor_package_cmake_prefix.sh"
