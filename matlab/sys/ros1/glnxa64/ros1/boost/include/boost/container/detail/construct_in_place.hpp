...
{     mwboost::container::allocator_traits<Allocator>::construct(a, dest, *source);  }
...
{
   mwboost::container::allocator_traits<Allocator>::construct(a, dest);
}
...
{
   mwboost::container::allocator_traits<Allocator>::construct(a, dest, default_init);
}
