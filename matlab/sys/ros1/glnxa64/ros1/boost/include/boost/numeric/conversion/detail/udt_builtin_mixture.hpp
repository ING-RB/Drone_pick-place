...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace numeric { namespace convdetail
{
  // Integral Constants for 'UdtMixture'
  typedef mwboost::integral_constant<udt_builtin_mixture_enum, builtin_to_builtin> builtin2builtin_c ;
  typedef mwboost::integral_constant<udt_builtin_mixture_enum, builtin_to_udt>     builtin2udt_c ;
  typedef mwboost::integral_constant<udt_builtin_mixture_enum, udt_to_builtin>     udt2builtin_c ;
  typedef mwboost::integral_constant<udt_builtin_mixture_enum, udt_to_udt>         udt2udt_c ;
...
} } } // namespace mwboost::numeric::convdetail
