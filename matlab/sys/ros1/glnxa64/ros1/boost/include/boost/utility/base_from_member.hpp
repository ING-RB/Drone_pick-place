...
struct remove_cv_ref
{
    typedef typename ::mwboost::remove_cv<typename
     ::mwboost::remove_reference<T>::type>::type  type;

};  // mwboost::detail::remove_cv_ref
...
struct is_related
    : public ::mwboost::is_same<
     typename ::mwboost::detail::remove_cv_ref<T>::type,
     typename ::mwboost::detail::remove_cv_ref<U>::type >
{};
...
struct enable_if_unrelated
    : public ::mwboost::enable_if_c<true>
{};

template<typename T, typename U, typename ...U2>
struct enable_if_unrelated<T, U, U2...>
    : public ::mwboost::disable_if< ::mwboost::detail::is_related<T, U> >
{};
#endif
...
protected:
    ...
    template <typename ...T, typename EnableIf = typename
     ::mwboost::detail::enable_if_unrelated<base_from_member, T...>::type>
