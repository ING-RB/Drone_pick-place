...
public:
    ...
    {
#if defined(BOOST_SP_ENABLE_DEBUG_HOOKS)
        mwboost::sp_scalar_constructor_hook( px, sizeof(X), this );
#endif
    }
    ...
    {
#if defined(BOOST_SP_ENABLE_DEBUG_HOOKS)
        mwboost::sp_scalar_destructor_hook( px_, sizeof(X), this );
#endif
        mwboost::checked_delete( px_ );
    }
...
public:
    ...
    {
        return ti == BOOST_SP_TYPEID_(D)? mwboost::detail::get_local_deleter( mwboost::addressof( del ) ): 0;
    }
...
public:
    ...
    void * get_local_deleter( sp_typeinfo_ const & ti ) BOOST_SP_NOEXCEPT BOOST_OVERRIDE
    {
        return ti == BOOST_SP_TYPEID_( D )? mwboost::detail::get_local_deleter( mwboost::addressof( d_ ) ): 0;
    }
