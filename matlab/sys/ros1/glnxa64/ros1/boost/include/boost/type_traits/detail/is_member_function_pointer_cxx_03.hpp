...
template <class T> struct is_member_function_pointer 
   : public ::mwboost::integral_constant<bool, ::mwboost::type_traits::is_mem_fun_pointer_impl<typename remove_cv<T>::type>::value>{};
...
#pragma warning(disable:6334)
        ...
        BOOST_STATIC_CONSTANT(
            bool, value = (
                1 == sizeof(::mwboost::type_traits::is_mem_fun_pointer_tester(self_type::make_t))
            ));
#if BOOST_WORKAROUND(BOOST_MSVC_FULL_VER, >= 140050000)
#pragma warning(pop)
#endif
...
struct is_member_function_pointer_impl
    : public is_mem_fun_pointer_select< 
      ::mwboost::is_reference<T>::value || ::mwboost::is_array<T>::value>::template result_<T>{};
...
struct is_member_function_pointer
   : public integral_constant<bool, ::mwboost::detail::is_member_function_pointer_impl<T>::value>{};
