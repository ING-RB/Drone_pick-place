...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace parameter { namespace aux {
    ...
    {
        typedef ::mwboost::parameter::aux::parameter_requirements<
            typename ::mwboost::parameter::aux::tag_type<ParameterSpec>::type
          , typename ::mwboost::parameter::aux::predicate<ParameterSpec>::type
          , ::mwboost::parameter::aux::has_default<ParameterSpec>
        > type;
    };
