...
protected:
    ...
    explicit BOOST_SYSTEM_CONSTEXPR error_category( mwboost::ulong_long_type id ) BOOST_NOEXCEPT: id_( id ), stdcat_(), sc_init_()
    {
    }
...
static const mwboost::ulong_long_type generic_category_id = ( mwboost::ulong_long_type( 0xB2AB117A ) << 32 ) + 0x257EDFD0;
static const mwboost::ulong_long_type system_category_id = generic_category_id + 1;
static const mwboost::ulong_long_type interop_category_id = generic_category_id + 2;
