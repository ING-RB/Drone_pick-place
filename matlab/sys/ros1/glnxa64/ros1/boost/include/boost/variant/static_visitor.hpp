...
template <typename R = ::mwboost::detail::static_visitor_default_return>
...
template< typename T > struct is_static_visitor
  : public ::mwboost::integral_constant<bool,(::mwboost::detail::is_static_visitor_impl<T>::value)>
{
public:
