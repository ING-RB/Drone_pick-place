...
namespace mwboost {} namespace boost = mwboost; namespace mwboost
{
    ...
    namespace hash_detail
    {
        template<class T,
            ...
            bool is_unsigned = mwboost::is_unsigned<T>::value,
        ...
        template<class T, std::size_t size_t_bits, std::size_t type_bits> struct hash_integral_impl<T, true, false, size_t_bits, type_bits>
        {
            static std::size_t fn( T v )
            {
                typedef typename mwboost::make_unsigned<T>::type U;
    ...
    template <typename T>
    typename mwboost::enable_if_<mwboost::is_integral<T>::value, std::size_t>::type
        hash_value( T v )
    {
    ...
    template <typename T>
    typename mwboost::enable_if_<mwboost::is_enum<T>::value, std::size_t>::type
        hash_value( T v )
    {
        // This should in principle return the equivalent of
        //
        // mwboost::hash_value( to_underlying(v) );
        //
    ...
    template <typename T>
    typename mwboost::enable_if_<mwboost::is_floating_point<T>::value, std::size_t>::type
        hash_value( T v )
    {
        return mwboost::hash_detail::hash_float_impl<T>::fn( v + 0 );
    }
    ...
    {
        mwboost::uintptr_t x = reinterpret_cast<mwboost::uintptr_t>( v );
        return mwboost::hash_value( x + (x >> 3) );
    }
    ...
    {
        return mwboost::hash_range( x, x + N );
    }
    ...
    {
        std::size_t re = mwboost::hash<T>()( v.real() );
        std::size_t im = mwboost::hash<T>()( v.imag() );
    ...
    std::size_t hash_value( std::pair<A, B> const& v )
    {
        ...
        mwboost::hash_combine( seed, v.first );
        mwboost::hash_combine( seed, v.second );
    ...
    template <typename T>
    typename mwboost::enable_if_<container_hash::is_range<T>::value && !container_hash::is_contiguous_range<T>::value && !container_hash::is_unordered_range<T>::value, std::size_t>::type
        hash_value( T const& v )
    {
        return mwboost::hash_range( v.begin(), v.end() );
    }

    // contiguous ranges (string, vector, array)

    template <typename T>
    typename mwboost::enable_if_<container_hash::is_contiguous_range<T>::value, std::size_t>::type
        hash_value( T const& v )
    {
        return mwboost::hash_range( v.data(), v.data() + v.size() );
    }

    // unordered ranges (unordered_set, unordered_map)

    template <typename T>
    typename mwboost::enable_if_<container_hash::is_unordered_range<T>::value, std::size_t>::type
        hash_value( T const& v )
    {
        return mwboost::hash_unordered_range( v.begin(), v.end() );
    }
    ...
    typename mwboost::enable_if_<container_hash::is_range<L<T...>>::value && !container_hash::is_contiguous_range<L<T...>>::value && !container_hash::is_unordered_range<L<T...>>::value, std::size_t>::type
    ...
    template<template<class...> class L, class... T>
    typename mwboost::enable_if_<container_hash::is_contiguous_range<L<T...>>::value, std::size_t>::type
        hash_value( L<T...> const& v )
    {
        return mwboost::hash_range( v.data(), v.data() + v.size() );
    }
    ...
    typename mwboost::enable_if_<container_hash::is_contiguous_range<L<T, N>>::value, std::size_t>::type
    ...
    template<template<class...> class L, class... T>
    typename mwboost::enable_if_<container_hash::is_unordered_range<L<T...>>::value, std::size_t>::type
        hash_value( L<T...> const& v )
    {
        return mwboost::hash_unordered_range( v.begin(), v.end() );
    }
...
# pragma warning(disable: 4100) // unreferenced formal parameter
    ...
    template <typename T>
    typename mwboost::enable_if_<container_hash::is_described_class<T>::value, std::size_t>::type
        hash_value( T const& v )
    {
        static_assert( !mwboost::is_union<T>::value, "described unions are not supported" );
        ...
        mp11::mp_for_each<Bd>([&](auto D){
            ...
            mwboost::hash_combine( r, (B const&)v );
        ...
        mp11::mp_for_each<Md>([&](auto D){
            ...
            mwboost::hash_combine( r, v.*D.pointer );
...
# pragma warning(pop)
    ...
    {
        return mwboost::hash_value( x.get() );
    }
    ...
    inline std::size_t hash_value( std::error_code const& v )
    {
        ...
        mwboost::hash_combine( seed, v.value() );
        mwboost::hash_combine( seed, &v.category() );
    ...
    //
    // mwboost::hash_combine
    //

    template <class T>
    inline void hash_combine( std::size_t& seed, T const& v )
    {
        seed = mwboost::hash_detail::hash_mix( seed + 0x9e3779b9 + mwboost::hash<T>()( v ) );
    }
    ...
    template<class E, class T, class A> struct hash< std::basic_string<E, T, A> >
    {
        ...
        {
            return mwboost::hash_value( val );
        }
    };

#endif

    // mwboost::unordered::hash_is_avalanching

    namespace unordered
    {
        template<class T> struct hash_is_avalanching;
        template<class Ch> struct hash_is_avalanching< mwboost::hash< std::basic_string<Ch> > >: mwboost::is_integral<Ch> {};

        // mwboost::is_integral<char8_t> is false, but should be true (https://github.com/boostorg/type_traits/issues/175)
#if defined(__cpp_char8_t) && __cpp_char8_t >= 201811L
        template<> struct hash_is_avalanching< mwboost::hash< std::basic_string<char8_t> > >: mwboost::true_type {};
#endif

#if !defined(BOOST_NO_CXX17_HDR_STRING_VIEW)

        template<class Ch> struct hash_is_avalanching< mwboost::hash< std::basic_string_view<Ch> > >: mwboost::is_integral<Ch> {};

#if defined(__cpp_char8_t) && __cpp_char8_t >= 201811L
        template<> struct hash_is_avalanching< mwboost::hash< std::basic_string_view<char8_t> > >: mwboost::true_type {};
#endif
