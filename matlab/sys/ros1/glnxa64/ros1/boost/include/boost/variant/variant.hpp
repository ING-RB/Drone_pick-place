    ...
    struct apply
        : mpl::size_t<
              ::mwboost::integer::static_lcm<
                ...
                , ::mwboost::alignment_of<Item>::value
                >::value
            >
    {};
};
...
//
// This implementation is designed to prefer mwboost::blank over other potential
...
private: // helpers, for metafunction result (below)
    ...
    // [...now search the rest of the sequence for mwboost::blank...]

    typedef typename mpl::iter_fold_if<
          mpl::iterator_range< first_result_it,end_it >
        , first_result_index, mpl::protect< mpl::next<> >
        , mpl::protect< mpl::not_same_as<mwboost::blank> >
        >::type second_result_;
...
struct is_variant_move_noexcept_constructible {
    typedef typename mwboost::mpl::find_if<
        Types, mpl::not_<mwboost::is_nothrow_move_constructible<mwboost::mpl::_1> >
    >::type iterator_t;

    typedef typename mwboost::mpl::end<Types>::type end_t;
    typedef typename mwboost::is_same<
        iterator_t, end_t
    >::type type;
};
...
struct is_variant_move_noexcept_assignable {
    typedef typename mwboost::mpl::find_if<
        Types, mpl::not_<mwboost::is_nothrow_move_assignable<mwboost::mpl::_1> >
    >::type iterator_t;
...
struct is_constructible_ext:
    mwboost::mpl::or_<
        mwboost::is_constructible<
            T1,
            T2
        >,
        mwboost::is_constructible<
            T1,
            typename mwboost::add_lvalue_reference<T2>::type
        >
    >
{};
...
struct is_variant_constructible_from:
    mwboost::mpl::not_< mwboost::is_same<
        typename mwboost::mpl::find_if<
            Types,
            is_constructible_ext<mwboost::mpl::_1, T>
        >::type,
        typename mwboost::mpl::end<Types>::type
    > >
{};

template <BOOST_VARIANT_ENUM_PARAMS(typename T), class Types>
struct is_variant_constructible_from< mwboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Types >:
    mwboost::is_same<
        typename mwboost::mpl::find_if<
            typename mwboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>::recursive_enabled_types,
            mpl::not_< is_variant_constructible_from< mwboost::mpl::_1, Types> >
        >::type,
        typename mwboost::mpl::end< typename mwboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>::recursive_enabled_types >::type
    >
{};

template <BOOST_VARIANT_ENUM_PARAMS(typename T), class Types>
struct is_variant_constructible_from< const mwboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>& , Types >:
    is_variant_constructible_from<mwboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Types >
{};
...
template <BOOST_VARIANT_ENUM_PARAMS(typename T), class Types>
struct is_variant_constructible_from< mwboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const && , Types >:
    is_variant_constructible_from<mwboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Types >
{};
...
public: // metafunction result
    ...
    typedef ::mwboost::aligned_storage<
...
public: // visitor interface
    ...
    T& operator()(U&) const
    {
        ...
        return ::mwboost::detail::variant::forced_return< T& >();
    }
};
...
public: // internal visitor interface
    ...
    template <typename T>
    void internal_visit(mwboost::detail::variant::backup_holder<T>& operand, long) const
    {
        new(storage_) T( operand.get() );
    }

    template <typename T>
    void internal_visit(const mwboost::detail::variant::backup_holder<T>& operand, long) const
    {
        new(storage_) T( operand.get() );
    }
...
public: // internal visitor interface
    ...
    void internal_visit(mwboost::detail::variant::backup_holder<T>& operand, long) const
    {
        new(storage_) T( ::mwboost::detail::variant::move(operand.get()) );
    }

    template <typename T>
    void internal_visit(T& operand, int) const BOOST_NOEXCEPT_IF(BOOST_NOEXCEPT_EXPR(T(mwboost::declval<T>())))
    {
        new(storage_) T(::mwboost::detail::variant::move(operand));
    }
};
#endif
...
public: // internal visitor interfaces
    ...
    {
        lhs_content.get()
            = ::mwboost::detail::variant::move(static_cast<backup_holder<T>* >(rhs_storage_)->get());
    }
    ...
    void internal_visit(T& lhs_content, int) const
    {
        ...
        // Hint: Are any of the bounded types const-qualified or references?
        //
        lhs_content = ::mwboost::detail::variant::move(*static_cast<T* >(rhs_storage_));
    }
...
public: // visitor interface
    ...
    bool operator()(T& lhs)
    {
        lhs = ::mwboost::detail::variant::move(rhs_);
        return true;
    }
...
private: // helpers, for visitor interface (below)
        ...
        )
    {
        ...
        LhsT backup_lhs_content(
              ::mwboost::detail::variant::move(lhs_content)
            ); // nothrow
        ...
        BOOST_CATCH (...)
        {
            ...
            new(lhs_.storage_.address())
                LhsT(
                      ::mwboost::detail::variant::move(backup_lhs_content)
                    ); // nothrow
...
public: // internal visitor interfaces
    ...
    void operator()(T& operand) const
    {
        ...
        // ...and swap:
        ::mwboost::detail::variant::move_swap( operand, other );
    }
...
class reflect
    : public static_visitor<const mwboost::typeindex::type_info&>
{
public: // visitor interfaces

    template <typename T>
    const mwboost::typeindex::type_info& operator()(const T&) const BOOST_NOEXCEPT
    {
        return mwboost::typeindex::type_id<T>().type_info();
    }
...
public: // internal visitor interfaces
    ...
    {
        return visitor_(::mwboost::move(operand));
    }
...
public: // internal visitor interfaces, cont.
    ...
    template <typename T>
    result_type internal_visit(mwboost::recursive_wrapper<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }

    template <typename T>
    result_type internal_visit(const mwboost::recursive_wrapper<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }

    template <typename T>
    result_type internal_visit(mwboost::detail::reference_content<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }

    template <typename T>
    result_type internal_visit(const mwboost::detail::reference_content<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }

    template <typename T>
    result_type internal_visit(mwboost::detail::variant::backup_holder<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }

    template <typename T>
    result_type internal_visit(const mwboost::detail::variant::backup_holder<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
...
private: // helpers, for typedefs (below)
    ...
    BOOST_STATIC_ASSERT((
          ::mwboost::mpl::not_< mpl::empty<specified_types> >::value
        ));
...
public: // structors
    ...
    variant()
              ...
              BOOST_NOEXCEPT_IF(mwboost::has_nothrow_constructor<internal_T0>::value)
#endif
    {
#ifdef _MSC_VER
#pragma warning( push )
...
#   endif
        ...
        template <typename T>
        int internal_visit(mwboost::detail::reference_content<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const mwboost::detail::reference_content<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(mwboost::detail::variant::backup_holder<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const mwboost::detail::variant::backup_holder<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(mwboost::recursive_wrapper<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const mwboost::recursive_wrapper<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }
...
private: // helpers, for structors, below
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    template <typename T>
    typename mwboost::enable_if<mwboost::is_rvalue_reference<T&&> >::type convert_construct(
          T&& operand
        , int
        , mpl::false_ = mpl::false_() // is_foreign_variant
        )
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    template <typename Variant>
    typename mwboost::enable_if<mwboost::is_rvalue_reference<Variant&&> >::type convert_construct(
          Variant&& operand
        , long
        , mpl::true_// is_foreign_variant
        )
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    template <typename Variant>
    typename mwboost::enable_if<mwboost::is_rvalue_reference<Variant&&> >::type convert_construct_variant(Variant&& operand)
    {
        // [Determine if the given variant is itself a bounded type, or if its
        //  content needs to be converted (i.e., it is a 'foreign' variant):]
        //
    ...
    typename mwboost::enable_if<mpl::or_<
        mwboost::is_same<mwboost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>, variant>,
        mwboost::detail::variant::is_variant_constructible_from<mwboost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>&, internal_types>
    > >::type convert_construct(
          mwboost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>& operand
        , long
        )
    {
    ...
    typename mwboost::enable_if<mpl::or_<
        mwboost::is_same<mwboost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>, variant>,
        mwboost::detail::variant::is_variant_constructible_from<const mwboost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>&, internal_types>
    > >::type convert_construct(
          const mwboost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>& operand
        , long
        )
    {
        convert_construct_variant(operand);
...
public: // structors, cont.
    ...
    variant(const T& operand,
        typename mwboost::enable_if<mpl::or_<
            mpl::and_<
                mpl::not_< mwboost::is_same<T, variant> >,
                mwboost::detail::variant::is_variant_constructible_from<const T&, internal_types>
            >,
            mwboost::is_same<T, mwboost::recursive_variant_> >,
            bool >::type = true)
    {
    ...
    variant(
        ...
        , typename mwboost::enable_if<mpl::or_<
            mpl::and_<
                mpl::not_< is_const<T> >,
                mpl::not_< mwboost::is_same<T, variant> >,
                mwboost::detail::variant::is_variant_constructible_from<T&, internal_types>
            >,
            mwboost::is_same<T, mwboost::recursive_variant_> >,
            bool >::type = true
        )
    ...
    variant(T&& operand,
        typename mwboost::enable_if<mpl::or_<
            mpl::and_<
                mwboost::is_rvalue_reference<T&&>,
                mpl::not_< mwboost::is_const<T> >,
                mpl::not_< mwboost::is_same<T, variant> >,
                mwboost::detail::variant::is_variant_constructible_from<T&&, internal_types>
            >,
            mwboost::is_same<T, mwboost::recursive_variant_> >,
...
public: // queries
    ...
    const mwboost::typeindex::type_info& type() const
    {
...
private: // precondition assertions
    ...
    BOOST_STATIC_ASSERT(( ::mwboost::mpl::is_sequence<Types>::value ));
    typedef typename mwboost::mpl::insert_range<
      mwboost::mpl::list<>
    , mwboost::mpl::end< mwboost::mpl::list<> >::type
    , Types
