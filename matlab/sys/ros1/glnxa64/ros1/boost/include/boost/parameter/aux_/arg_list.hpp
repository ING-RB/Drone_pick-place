...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace parameter { namespace aux {
    ...
    struct empty_arg_list
    {
        struct tagged_arg
        {
            typedef ::mwboost::parameter::void_ value_type;
        };
        ...
        static ::mwboost::parameter::aux::no_tag has_key(KW*);
        ...
        inline BOOST_CONSTEXPR Default&
            operator[](::mwboost::parameter::aux::default_<K,Default> x) const
        {
            return x.value;
        }
        ...
        template <typename K, typename Default>
        inline BOOST_CONSTEXPR Default&&
            operator[](::mwboost::parameter::aux::default_r_<K,Default> x) const
        {
        ...
        // MPL sequence support
        typedef ::mwboost::parameter::aux::empty_arg_list type; // convenience
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace parameter { namespace aux {
    ...
    template <
        typename TaggedArg
      , typename Next = ::mwboost::parameter::aux::empty_arg_list
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
      , typename EmitsErrors = ::mwboost::mp11::mp_true
#else
      , typename EmitsErrors = ::mwboost::mpl::true_
#endif
    >
    class arg_list : public Next
    {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using _holds_maybe = typename ::mwboost::parameter::aux
     ...
     public:
        ...
        typedef ::mwboost::parameter::aux::arg_list<TaggedArg,Next> self;
        typedef typename TaggedArg::key_type key_type;

#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using reference = typename ::mwboost::mp11::mp_if<
            _holds_maybe
          , ::mwboost::parameter::aux
            ::get_reference<typename TaggedArg::value_type>
          , ::mwboost::parameter::aux::get_reference<TaggedArg>
        >::type;

        using value_type = ::mwboost::mp11
        ...
        inline BOOST_CONSTEXPR arg_list(
            ::mwboost::parameter::aux::value_type_is_not_void
          , A0&& a0
        ) : Next(
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
                ::mwboost::mp11::mp_if<
                ...
                typename ::mwboost::mpl::if_<
                    ...
                    >
                  , ::mwboost::parameter::aux::value_type_is_void
                  , ::mwboost::parameter::aux::value_type_is_not_void
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
                >()
#else
        ...
        inline BOOST_CONSTEXPR arg_list(
          ...
          , arg(::mwboost::parameter::aux::void_reference())
        {
        }
        ...
        struct binding
        {
            ...
            using fn = ::mwboost::mp11::mp_if<
              ...
              , ::mwboost::mp11::mp_apply_q<
                    next_binding
                  , ::mwboost::mp11::mp_list<KW,Default,Reference>
                >
            >;
#endif
        };
        ...
        static ::mwboost::parameter::aux::yes_tag has_key(key_type*);
        using Next::has_key;

     private:
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using _has_unique_key = ::mwboost::mp11::mp_bool<
#else
        typedef ::mwboost::mpl::bool_<
            ...
            ) == sizeof(::mwboost::parameter::aux::no_tag)
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        >;
#else
        > _has_unique_key;
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            get_default(D const&, ::mwboost::mp11::mp_false) const
#else
            get_default(D const&, ::mwboost::mpl::false_) const
#endif
        {
        ...
        inline BOOST_CONSTEXPR reference
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            get_default(D const& d, ::mwboost::mp11::mp_true) const
#else
            get_default(D const& d, ::mwboost::mpl::true_) const
#endif
        {
            return (
                this->arg.get_value()
     ...
     public:
        inline BOOST_CONSTEXPR reference
            operator[](::mwboost::parameter::keyword<key_type> const&) const
        {
    ...
    !BOOST_WORKAROUND(BOOST_MSVC, < 1910)
        ...
        inline BOOST_CONSTEXPR reference
            operator[](
                ::mwboost::parameter::aux::default_<key_type,Default> const& d
            ) const
        {
        ...
        inline BOOST_CONSTEXPR reference
            operator[](
                ::mwboost::parameter::aux::default_r_<key_type,Default> const& d
            ) const
        {
            return this->get_default(d, _holds_maybe());
        }
    ...
    !BOOST_WORKAROUND(BOOST_MSVC, < 1910)
        ...
        static typename ::mwboost::lazy_enable_if<
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            ::mwboost::mp11::mp_if<
                EmitsErrors
              ...
              , _has_unique_key
            >
          , ::mwboost::parameter::aux::augment_predicate_mp11<
#else
            typename ::mwboost::mpl::if_<
                EmitsErrors
              , ::mwboost::mpl::true_
        ...
        inline BOOST_CONSTEXPR ::mwboost::parameter::aux::arg_list<
            ::mwboost::parameter::aux::tagged_argument<KW,T2>
          , self
        >
            operator,(
                ::mwboost::parameter::aux::tagged_argument<KW,T2> const& x
            ) const
        {
        ...
        template <typename KW, typename T2>
        inline BOOST_CONSTEXPR ::mwboost::parameter::aux::arg_list<
            ::mwboost::parameter::aux::tagged_argument_rref<KW,T2>
          , self
        >
            operator,(
                ::mwboost::parameter::aux::tagged_argument_rref<KW,T2> const& x
            ) const
        {
            return ::mwboost::parameter::aux::arg_list<
                ::mwboost::parameter::aux::tagged_argument_rref<KW,T2>
    ...
    struct empty_arg_list
    {
        ...
        inline BOOST_CONSTEXPR empty_arg_list(
            BOOST_PP_ENUM_PARAMS(
              ...
              , ::mwboost::parameter::void_ BOOST_PP_INTERCEPT
            )
        )
        {
        }
        ...
        struct key_owner
        {
            ...
            struct apply
            {
                typedef ::mwboost::parameter::aux::empty_arg_list type;
            };
        };
    ...
    class arg_list : public Next
    {
     ...
     public:
        ...
        inline BOOST_CONSTEXPR arg_list(
            ...
            BOOST_PP_ENUM_BINARY_PARAMS(
              ...
              , ::mwboost::parameter::aux::void_reference()
            )
          , arg(a0)
        {
        }
     ...
     public:
            ...
            struct apply
            {
                typedef typename ::mwboost::mpl::eval_if<
                  ...
                  , ::mwboost::mpl::identity<
                        ::mwboost::parameter::aux::arg_list<TaggedArg,Next>
                    >
                  , ::mwboost::mpl::apply_wrap1<next_key_owner,KW>
                >::type type;
            };
        };
        ...
        inline BOOST_CONSTEXPR typename ::mwboost::mpl::apply_wrap3<
          ...
          , ::mwboost::mpl::true_
        >::type
            operator[](::mwboost::parameter::keyword<KW> const& x) const
        {
            typename ::mwboost::mpl::apply_wrap1<key_owner,KW>::type const&
                sublist = *this;
        ...
        // fails.
        inline BOOST_CONSTEXPR reference
            get(::mwboost::parameter::keyword<key_type> const&) const
        {
            BOOST_MPL_ASSERT_NOT((_holds_maybe));
            return this->arg.get_value();
        }
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace parameter { namespace aux {
    ...
    struct arg_list_cons<>
    {
        using type = ::mwboost::parameter::aux::empty_arg_list;
    };

    template <typename ArgTuple0, typename ...Tuples>
    struct arg_list_cons<ArgTuple0,Tuples...>
    {
        using type = ::mwboost::parameter::aux::arg_list<
            typename ArgTuple0::tagged_arg
          , typename ::mwboost::parameter::aux::arg_list_cons<Tuples...>::type
    ...
    class flat_like_arg_list
      : public ::mwboost::parameter::aux::arg_list_cons<ArgTuples...>::type
    {
        using _base_type = typename ::mwboost::parameter::aux
    ...
    template <>
    class flat_like_arg_list<>
      : public ::mwboost::parameter::aux::empty_arg_list
    {
        using _base_type = ::mwboost::parameter::aux::empty_arg_list;
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace parameter { namespace aux {
    ...
    {
        typedef ::mwboost::mpl::forward_iterator_tag category;
    ...
    template <>
    struct arg_list_iterator< ::mwboost::parameter::aux::empty_arg_list>
    {
    };
}}} // namespace mwboost::parameter::aux
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace mpl {
    ...
    template <>
    struct begin_impl< ::mwboost::parameter::aux::arg_list_tag>
    {
        template <typename S>
        struct apply
        {
            typedef ::mwboost::parameter::aux::arg_list_iterator<S> type;
        };
    };

    template <>
    struct end_impl< ::mwboost::parameter::aux::arg_list_tag>
    {
        template <typename>
        struct apply
        {
            typedef ::mwboost::parameter::aux::arg_list_iterator<
                ::mwboost::parameter::aux::empty_arg_list
            > type;
        };
    };
}} // namespace mwboost::mpl
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace mpl {
    ...
    template <>
    struct has_key_impl< ::mwboost::parameter::aux::arg_list_tag>
    {
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace mpl {
    ...
    template <>
    struct count_impl< ::mwboost::parameter::aux::arg_list_tag>
    {
        template <typename ArgList, typename Keyword>
        struct apply
        {
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace mpl {
    ...
    template <>
    struct key_type_impl< ::mwboost::parameter::aux::arg_list_tag>
    {
        template <typename ArgList, typename Keyword>
        struct apply
        {
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace mpl {
    ...
    template <>
    struct value_type_impl< ::mwboost::parameter::aux::arg_list_tag>
      : ::mwboost::mpl::key_type_impl< ::mwboost::parameter::aux::arg_list_tag>
    {
    };
}} // namespace mwboost::mpl
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace mpl {
    ...
    template <>
    struct at_impl< ::mwboost::parameter::aux::arg_list_tag>
      : ::mwboost::mpl::key_type_impl< ::mwboost::parameter::aux::arg_list_tag>
    {
    };
}} // namespace mwboost::mpl
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace mpl {
    ...
    template <>
    struct order_impl< ::mwboost::parameter::aux::arg_list_tag>
    {
        template <typename ArgList, typename Keyword>
        struct apply
        {
            typedef typename ::mwboost::mpl::find<ArgList,Keyword>::type Itr;
            typedef typename ::mwboost::mpl::eval_if<
                ::mwboost::is_void<
                    typename ::mwboost::parameter
                    ::value_type<ArgList,Keyword,void>::type
                >
              , ::mwboost::mpl::identity< ::mwboost::mpl::void_>
              , ::mwboost::mpl::distance<
                    Itr
                  , ::mwboost::parameter::aux::arg_list_iterator<
                        ::mwboost::parameter::aux::empty_arg_list
                    >
                >
            >::type type;
