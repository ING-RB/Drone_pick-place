...
#else
     typedef mwboost::uintmax_t static_min_max_unsigned_type;
     typedef mwboost::intmax_t  static_min_max_signed_type;
     typedef mwboost::uintmax_t static_log2_argument_type;
     typedef int              static_log2_result_type;
#endif
...
#if !defined(BOOST_NO_INTEGRAL_INT64_T) && defined(BOOST_HAS_LONG_LONG)
  template< mwboost::ulong_long_type MaxValue >   // maximum value to require support
#else
...
#else
     typedef mwboost::uintmax_t static_gcd_type;
#endif
