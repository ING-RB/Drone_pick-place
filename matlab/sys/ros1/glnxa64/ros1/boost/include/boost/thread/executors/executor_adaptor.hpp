...
namespace executors
{
  ...
  public:
    ...
    executor_adaptor(BOOST_THREAD_RV_REF(Args) ... args) : ex(mwboost::forward<Args>(args)...) {}
#else
    /**
     * executor_adaptor constructor
     */
    ...
    void submit(BOOST_THREAD_RV_REF(work) closure)  {
      return ex.submit(mwboost::move(closure));
    }
    ...
    {
      //submit(work(mwboost::forward<Closure>(closure)));
      work w((mwboost::forward<Closure>(closure)));
      submit(mwboost::move(w));
    }
