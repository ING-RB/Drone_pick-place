...
//!   - mwboost::container::vector
//!   - mwboost::container::stable_vector
//!   - mwboost::container::static_vector
//!   - mwboost::container::small_vector_base
//!   - mwboost::container::small_vector
//!   - mwboost::container::devector
//!   - mwboost::container::slist
//!   - mwboost::container::list
//!   - mwboost::container::set
//!   - mwboost::container::multiset
//!   - mwboost::container::map
//!   - mwboost::container::multimap
//!   - mwboost::container::flat_set
//!   - mwboost::container::flat_multiset
//!   - mwboost::container::flat_map
//!   - mwboost::container::flat_multimap
//!   - mwboost::container::basic_string
//!   - mwboost::container::string
//!   - mwboost::container::wstring
//!
//! Forward declares the following allocators:
//!   - mwboost::container::allocator
//!   - mwboost::container::node_allocator
//!   - mwboost::container::adaptive_pool
//!
//! Forward declares the following polymorphic resource classes:
//!   - mwboost::container::pmr::memory_resource
//!   - mwboost::container::pmr::polymorphic_allocator
//!   - mwboost::container::pmr::monotonic_buffer_resource
//!   - mwboost::container::pmr::pool_options
//!   - mwboost::container::pmr::unsynchronized_pool_resource
//!   - mwboost::container::pmr::synchronized_pool_resource
//!
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost{ namespace container{ namespace dtl{
   namespace bi = mwboost::intrusive;
   namespace bid = mwboost::intrusive::detail;
}}}

namespace mwboost {} namespace boost = mwboost; namespace mwboost{ namespace container{ namespace pmr{
   namespace bi = mwboost::intrusive;
   namespace bid = mwboost::intrusive::detail;
}}}
