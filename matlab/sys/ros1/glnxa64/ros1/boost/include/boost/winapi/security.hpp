...
#else
typedef mwboost::winapi::PVOID_ PSECURITY_DESCRIPTOR;
#endif

BOOST_WINAPI_IMPORT mwboost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
InitializeSecurityDescriptor(
    PSECURITY_DESCRIPTOR pSecurityDescriptor,
    mwboost::winapi::DWORD_ dwRevision);
BOOST_WINAPI_IMPORT mwboost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
SetSecurityDescriptorDacl(
    PSECURITY_DESCRIPTOR pSecurityDescriptor,
    mwboost::winapi::BOOL_ bDaclPresent,
    ::_ACL* pDacl,
    mwboost::winapi::BOOL_ bDaclDefaulted);
}
#endif
