...
namespace local_time{
   ...
   * A mwboost::local_time::bad_offset exception will be thrown for:<br>
   ...
   * A mwboost::local_time::bad_adjustment exception will be thrown for:<br>
  ...
  private:
    ...
    void calc_zone(const string_type& obj){
      ...
      if(sit != obj_end){
        ...
        {
          mwboost::throw_exception(bad_offset(posix_time::to_simple_string(base_utc_offset_)));
        }
      }
      ...
      if(sit != obj_end){
        ...
        {
          mwboost::throw_exception(bad_adjustment(posix_time::to_simple_string(dst_offsets_.dst_adjust_)));
        }
      }
    ...
    void calc_rules(const string_type& start, const string_type& end){
      ...
      {
        mwboost::throw_exception(bad_offset(posix_time::to_simple_string(dst_offsets_.dst_start_offset_)));
      }
      ...
      {
        mwboost::throw_exception(bad_offset(posix_time::to_simple_string(dst_offsets_.dst_end_offset_)));
      }
    }
