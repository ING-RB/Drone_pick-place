      ...
      public:
          BOOST_THREAD_NO_COPYABLE(thread_data)
            thread_data(BOOST_THREAD_RV_REF(F) f_, BOOST_THREAD_RV_REF(ArgTypes)... args_):
              fp(mwboost::forward<F>(f_), mwboost::forward<ArgTypes>(args_)...)
            {}
...
//            {}
        ...
        template<typename F>
        class thread_data<mwboost::reference_wrapper<F> >:
            public detail::thread_data_base
        {
        private:
            F& f;
        public:
            BOOST_THREAD_NO_COPYABLE(thread_data)
            thread_data(mwboost::reference_wrapper<F> f_):
                f(f_)
            {}
            void run()
            {
        ...
        template<typename F>
        class thread_data<const mwboost::reference_wrapper<F> >:
            public detail::thread_data_base
        {
        private:
            F& f;
        public:
            BOOST_THREAD_NO_COPYABLE(thread_data)
            thread_data(const mwboost::reference_wrapper<F> f_):
                f(f_)
            {}
            void run()
            {
    ...
    private:
        ...
        void start_thread()
        {
          ...
          {
            mwboost::throw_exception(thread_resource_error());
          }
        }
        ...
        static inline detail::thread_data_ptr make_thread_info(BOOST_THREAD_RV_REF(F) f, BOOST_THREAD_RV_REF(ArgTypes)... args)
        {
            return detail::thread_data_ptr(detail::heap_new<
                  detail::thread_data<typename mwboost::remove_reference<F>::type, ArgTypes...>
                  >(
                    mwboost::forward<F>(f), mwboost::forward<ArgTypes>(args)...
                  )
                );
        }
#else
        ...
        {
            return detail::thread_data_ptr(detail::heap_new<detail::thread_data<typename mwboost::remove_reference<F>::type> >(
                mwboost::forward<F>(f)));
        }
#endif
        static inline detail::thread_data_ptr make_thread_info(void (*f)())
        {
            return detail::thread_data_ptr(detail::heap_new<detail::thread_data<void(*)()> >(
                mwboost::forward<void(*)()>(f)));
        }
#else
        template<typename F>
        static inline detail::thread_data_ptr make_thread_info(F f
            , typename disable_if_c<
                //mwboost::thread_detail::is_convertible<F&,BOOST_THREAD_RV_REF(F)>::value ||
    ...
    public:
        ...
        //, typename disable_if<is_same<typename decay<F>::type, thread>, dummy* >::type=0
          ...
          thread_info(make_thread_info(thread_detail::decay_copy(mwboost::forward<F>(f))))
        {
            start_thread();
        }
        template <
        ...
        explicit thread(F f
        , typename disable_if_c<
        mwboost::thread_detail::is_rv<F>::value // todo as a thread_detail::is_rv
        //mwboost::thread_detail::is_convertible<F&,BOOST_THREAD_RV_REF(F)>::value
            //|| is_same<typename decay<F>::type, thread>::value
           , dummy* >::type=0
        ):
        ...
        template <class F>
        thread(attributes const& attrs, F f
            , typename disable_if<mwboost::thread_detail::is_rv<F>, dummy* >::type=0
            //, typename disable_if<mwboost::thread_detail::is_convertible<F&,BOOST_THREAD_RV_REF(F) >, dummy* >::type=0
        ):
            thread_info(make_thread_info(f))
        {
            start_thread(attrs);
        ...
        thread_info(make_thread_info(mwboost::move<F>(f))) // todo : Add forward
#else
        ...
        thread(F&& f, Arg&& arg, Args&&... args) :
          thread_info(make_thread_info(
              ...
              thread_detail::decay_copy(mwboost::forward<Arg>(arg)),
              thread_detail::decay_copy(mwboost::forward<Args>(args))...)
          )
        ...
        thread(F f,A1 a1,typename disable_if<mwboost::thread_detail::is_convertible<F&,thread_attributes >, dummy* >::type=0):
            thread_info(make_thread_info(mwboost::bind(mwboost::type<void>(),f,a1)))
        {
            start_thread();
        }
        template <class F,class A1,class A2>
        thread(F f,A1 a1,A2 a2):
            thread_info(make_thread_info(mwboost::bind(mwboost::type<void>(),f,a1,a2)))
        {
            start_thread();
        }
        ...
        thread(F f,A1 a1,A2 a2,A3 a3):
            thread_info(make_thread_info(mwboost::bind(mwboost::type<void>(),f,a1,a2,a3)))
        {
            start_thread();
        }
        ...
        thread(F f,A1 a1,A2 a2,A3 a3,A4 a4):
            thread_info(make_thread_info(mwboost::bind(mwboost::type<void>(),f,a1,a2,a3,a4)))
        {
            start_thread();
        }
        ...
        thread(F f,A1 a1,A2 a2,A3 a3,A4 a4,A5 a5):
            thread_info(make_thread_info(mwboost::bind(mwboost::type<void>(),f,a1,a2,a3,a4,a5)))
        {
            start_thread();
        }
        ...
        thread(F f,A1 a1,A2 a2,A3 a3,A4 a4,A5 a5,A6 a6):
            thread_info(make_thread_info(mwboost::bind(mwboost::type<void>(),f,a1,a2,a3,a4,a5,a6)))
        {
            start_thread();
        }
        ...
        thread(F f,A1 a1,A2 a2,A3 a3,A4 a4,A5 a5,A6 a6,A7 a7):
            thread_info(make_thread_info(mwboost::bind(mwboost::type<void>(),f,a1,a2,a3,a4,a5,a6,a7)))
        {
            start_thread();
        }
        ...
        thread(F f,A1 a1,A2 a2,A3 a3,A4 a4,A5 a5,A6 a6,A7 a7,A8 a8):
            thread_info(make_thread_info(mwboost::bind(mwboost::type<void>(),f,a1,a2,a3,a4,a5,a6,a7,a8)))
        {
            start_thread();
        }
        ...
        thread(F f,A1 a1,A2 a2,A3 a3,A4 a4,A5 a5,A6 a6,A7 a7,A8 a8,A9 a9):
            thread_info(make_thread_info(mwboost::bind(mwboost::type<void>(),f,a1,a2,a3,a4,a5,a6,a7,a8,a9)))
        {
            start_thread();
        }
#endif
    ...
    public:
        ...
        {
          return do_try_join_until(mwboost::detail::internal_platform_timepoint(t));
        }
...
#if defined BOOST_THREAD_USES_DATETIME
        inline BOOST_SYMBOL_VISIBLE void sleep(::mwboost::xtime const& abs_time)
        {
  ...
  std::basic_ostream<charT, traits>&
    ...
    namespace this_thread
    {
        inline thread::id get_id() BOOST_NOEXCEPT
        {
             ...
             return pthread_self();
        #else
            mwboost::detail::thread_data_base* const thread_info=get_or_make_current_thread_data();
    ...
    inline void thread::join() {
        if (this_thread::get_id() == get_id())
          mwboost::throw_exception(thread_resource_error(static_cast<int>(system::errc::resource_deadlock_would_occur), "boost thread: trying joining itself"));
...
//#endif
    ...
    {
        template<typename F>
        void mwboostat_thread_exit(F f)
        {
