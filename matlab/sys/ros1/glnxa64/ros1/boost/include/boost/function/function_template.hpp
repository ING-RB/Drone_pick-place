...
#else
#  define BOOST_FUNCTION_VOID_RETURN_TYPE mwboost::detail::function::unusable
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost {
    ...
    namespace function {
      ...
      struct BOOST_FUNCTION_MEMBER_INVOKER
      {
...

        {
          ...
          return mwboost::mem_fn(*f)(BOOST_FUNCTION_ARGS);
        }
      };
      ...
      struct BOOST_FUNCTION_VOID_MEMBER_INVOKER
      {
...

        {
          MemberPtr* f =
            reinterpret_cast<MemberPtr*>(function_obj_ptr.data);
          BOOST_FUNCTION_RETURN(mwboost::mem_fn(*f)(BOOST_FUNCTION_ARGS));
        }
      };
#endif
      ...
      /**
       * vtable for a specific mwboost::function instance. This
       * structure must be an aggregate so that we can use static
       * initialization in mwboost::function's assign_to and assign_to_a
      ...
      private:
        ...
        bool assign_to(MemberPtr f, function_buffer& functor, member_ptr_tag) const
        {
          ...
          if (f) {
            this->assign_to(mwboost::mem_fn(f), functor);
            return true;
          } else {
            return false;
          }
        ...
        bool assign_to_a(MemberPtr f, function_buffer& functor, Allocator a, member_ptr_tag) const
        {
          ...
          // right target_type() values.
          if (f) {
            this->assign_to_a(mwboost::mem_fn(f), functor, a);
            return true;
          } else {
            return false;
          }
        ...
        {
          if (!mwboost::detail::function::has_empty_target(mwboost::addressof(f))) {
  ...
  public:
    ...
    typedef R         result_type;
#else
    typedef  typename mwboost::detail::function::function_return_type<R>::type
      result_type;
#endif // BOOST_NO_VOID_RETURNS

  private:
    typedef mwboost::detail::function::BOOST_FUNCTION_VTABLE<
  ...
  public:
    ...
    // add signature for mwboost::lambda
    ...
    {
      if (this->empty())
        mwboost::throw_exception(bad_function_call());
...
#           endif
#         endif
          std::memcpy(this->functor.data, f.functor.data, sizeof(mwboost::detail::function::function_buffer));
#         if defined(BOOST_GCC) && (BOOST_GCC >= 40700)
#           pragma GCC diagnostic pop
#         endif
        } else
          get_vtable()->base.manager(f.functor, this->functor,
                                     mwboost::detail::function::clone_functor_tag);
      }
    }
    ...
    {
      using mwboost::detail::function::vtable_base;

      typedef typename mwboost::detail::function::get_function_tag<Functor>::type tag;
      typedef mwboost::detail::function::BOOST_FUNCTION_GET_INVOKER<tag> get_invoker;
      ...
      if (stored_vtable.assign_to(f, functor)) {
        ...
        if (mwboost::has_trivial_copy_constructor<Functor>::value &&
            mwboost::has_trivial_destructor<Functor>::value &&
            mwboost::detail::function::function_allows_small_object_optimization<Functor>::value)
          value |= static_cast<std::size_t>(0x01);
        vtable = reinterpret_cast<mwboost::detail::function::vtable_base *>(value);
      } else
        vtable = 0;
    }
...
#endif
            get_vtable()->base.manager(f.functor, this->functor,
                                     mwboost::detail::function::move_functor_tag);
#if defined(BOOST_GCC) && (__GNUC__ >= 11)
# pragma GCC diagnostic pop
#endif
          f.vtable = 0;
...
// Poison comparisons between mwboost::function objects of the same type.
template<typename R BOOST_FUNCTION_COMMA BOOST_FUNCTION_TEMPLATE_PARMS>
