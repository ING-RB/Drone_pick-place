...
public:
    ...
    /// Derived class to not use mwboost::hash_range().
    inline std::size_t hash_code() const BOOST_NOEXCEPT {
        const char* const name_raw = derived().raw_name();
        return mwboost::hash_range(name_raw, name_raw + std::strlen(name_raw));
    }
...
protected:
    ...
    /// mwboost::typeindex::type_id() will call this method, if Derived has same type as mwboost::typeindex::type_index.
    ///
    ...
    /// This is a factory method that is used to create instances of Derived classes.
    /// mwboost::typeindex::type_id_with_cvr() will call this method, if Derived has same type as mwboost::typeindex::type_index.
    ///
    /// \b Override: This function \b may be redefined and made public in Derived class. Overrides \b must not throw. 
    ...
    /// This is a factory method that is used to create instances of Derived classes.
    /// mwboost::typeindex::type_id_runtime(const T&) will call this method, if Derived has same type as mwboost::typeindex::type_index.
    ///
