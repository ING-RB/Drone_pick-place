...
// @endcond
   ...
   class BOOST_RV_ATTRIBUTE_MAY_ALIAS rv
      : public ::mwboost::move_detail::if_c
         < ::mwboost::move_detail::is_class<T>::value
         , T
         , ::mwboost::move_detail::nat
         >::type
   {
      rv();
      ~rv() throw();
   ...
   struct is_rv
      ...
      : integral_constant<bool, ::mwboost::move_detail::is_rv_impl<T>::value >
   {};
   ...
   struct has_move_emulation_enabled
      : ::mwboost::move_detail::has_move_emulation_enabled_impl<T>
   {};

   template<class T>
   struct has_move_emulation_disabled
   {
      static const bool value = !::mwboost::move_detail::has_move_emulation_enabled_impl<T>::value;
   };
   ...
   #define BOOST_RV_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      ::mwboost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_RV_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      ::mwboost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   #define BOOST_COPY_ASSIGN_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      const ::mwboost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_COPY_ASSIGN_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      const ::mwboost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   BOOST_MOVE_FORCEINLINE typename ::mwboost::move_detail::enable_if_c
      <  ::mwboost::move_detail::is_lvalue_reference<Ret>::value ||
        !::mwboost::has_move_emulation_enabled<T>::value
      , T&>::type
   ...
   BOOST_MOVE_FORCEINLINE typename ::mwboost::move_detail::enable_if_c
      < !::mwboost::move_detail::is_lvalue_reference<Ret>::value &&
         ::mwboost::has_move_emulation_enabled<T>::value
      , ::mwboost::rv<T>&>::type
         move_return(::mwboost::rv<T>& x) BOOST_NOEXCEPT
   {
      return x;
   }

   template <class T>
   BOOST_MOVE_FORCEINLINE T& unrv(::mwboost::rv<T> &rv) BOOST_NOEXCEPT
   ...
   #define BOOST_MOVE_RET(RET_TYPE, REF)\
      mwboost::move_detail::move_return< RET_TYPE >(REF)
   //

   #define BOOST_MOVE_BASE(BASE_TYPE, ARG) \
      ::mwboost::move((BASE_TYPE&)(ARG))
   //

   #define BOOST_MOVE_TO_LV(ARG) \
      ::mwboost::move_detail::unrv(ARG)
   //
   ...
   #define BOOST_MOVABLE_BUT_NOT_COPYABLE(TYPE)\
      ...
      public:\
      BOOST_MOVE_FORCEINLINE operator ::mwboost::rv<TYPE>&() \
      {  return *BOOST_MOVE_TO_RV_CAST(::mwboost::rv<TYPE>*, this);  }\
      BOOST_MOVE_FORCEINLINE operator const ::mwboost::rv<TYPE>&() const \
      {  return *BOOST_MOVE_TO_RV_CAST(const ::mwboost::rv<TYPE>*, this);  }\
      private:\
   //
   ...
   template< class T>
   struct forward_type< mwboost::rv<T> >
   { typedef T type; };
   ...
   //!cast to the base type before calling `::mwboost::move()` due to rvalue reference limitations.
   //!
