    ...
    namespace detail
    {
            ...
            , const CharT opening_brace, const CharT closing_brace) BOOST_NOEXCEPT
        {
            ...
            if (lc_iequal(begin, lc_nan, lc_NAN, 3)) {
                ...
                else value = mwboost::core::copysign(std::numeric_limits<T>::quiet_NaN(), static_cast<T>(-1));
                return true;
            } else if (
                ( /* 'INF' or 'inf' */
        ...
        {
            const CharT minus = lcast_char_constants<CharT>::minus;
            if (mwboost::core::isnan(value)) {
                if (mwboost::core::signbit(value)) {
                    *begin = minus;
                    ++ begin;
                }
                ...
                return true;
            } else if (mwboost::core::isinf(value)) {
                if (mwboost::core::signbit(value)) {
                    *begin = minus;
                    ++ begin;
                }
