...
private:
    ...
    mwboost::system::error_category const * pc_;

public:

    mwboost::system::error_category const & original_category() const BOOST_NOEXCEPT
    {
        return *pc_;
    }
...
public:
    ...
    explicit std_category( mwboost::system::error_category const * pc, unsigned id ): pc_( pc )
    {
        if( id != 0 )
        {
