...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
    using make_items = ::mwboost::mp11::mp_if<
        ::std::is_same<Arg,::mwboost::parameter::void_>
      , ::mwboost::mp11::mp_identity< ::mwboost::parameter::void_>
      , ::mwboost::parameter::aux::make_item<Spec,Arg,Tail>
    >;
#else
    struct make_items
      : ::mwboost::mpl::eval_if<
            ::mwboost::is_same<Arg,::mwboost::parameter::void_>
