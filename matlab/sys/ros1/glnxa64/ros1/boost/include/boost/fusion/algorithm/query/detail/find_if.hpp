...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace fusion { namespace detail
{
    ...
    struct static_find_if
    {
        ...
        template <typename Iterator>
        BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED
        static typename mwboost::disable_if<traits::is_random_access<Iterator>, type>::type
        ...
        template <typename Iterator>
        BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED
        static typename mwboost::enable_if<traits::is_random_access<Iterator>, type>::type
        iter_call(Iterator const& iter)
        {
