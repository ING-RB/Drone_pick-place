...
{
   typedef typename remove_cv<T>::type no_cv_t;
   BOOST_STATIC_CONSTANT(bool, value = (!(::mwboost::detail::is_signed_values<T>::minus_one  > mwboost::detail::is_signed_values<T>::zero)));
};
...
{
   typedef ::mwboost::detail::is_signed_select_helper< ::mwboost::is_integral<T>::value || ::mwboost::is_enum<T>::value> selector;
...
template <class T> struct is_signed : public integral_constant<bool, mwboost::detail::is_signed_impl<T>::value> {};
...
template <> struct is_signed< ::mwboost::long_long_type> : public true_type{};
template <> struct is_signed<const ::mwboost::long_long_type> : public true_type{};
template <> struct is_signed<volatile ::mwboost::long_long_type> : public true_type{};
template <> struct is_signed<const volatile ::mwboost::long_long_type> : public true_type{};

template <> struct is_signed< ::mwboost::ulong_long_type> : public false_type{};
template <> struct is_signed<const ::mwboost::ulong_long_type> : public false_type{};
template <> struct is_signed<volatile ::mwboost::ulong_long_type> : public false_type{};
template <> struct is_signed<const volatile ::mwboost::ulong_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN != 0
