...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace optional_detail {
...
template <typename T>
struct optional_value_type< ::mwboost::optional<T> >
{
  typedef T type;
};

}} // namespace mwboost::optional_detail
...
class optional_base : public optional_tag
{
  ...
  protected :
    ...
    typedef typename mwboost::remove_const<T>::type unqualified_value_type;
  ...
  protected:
    ...
    BOOST_NOEXCEPT_IF(::mwboost::is_nothrow_move_constructible<T>::value)
      :
      m_initialized(false)
    {
      if ( rhs.is_initialized() )
        construct( mwboost::move(rhs.get_impl()) );
    }
#endif
    ...
    explicit optional_base ( Expr&& expr, PtrExpr const* tag )
      ...
      m_initialized(false)
    {
      construct(mwboost::forward<Expr>(expr),tag);
    }
    ...
    BOOST_NOEXCEPT_IF(::mwboost::is_nothrow_move_constructible<T>::value && ::mwboost::is_nothrow_move_assignable<T>::value)
    {
    ...
    void assign ( optional_base&& rhs )
    {
      ...
      {
        if ( rhs.is_initialized() )
             assign_value( mwboost::move(rhs.get_impl()) );
        else destroy();
      }
      else
      {
    ...
    {
      if (is_initialized())
           assign_value( mwboost::move(val) );
      else construct( mwboost::move(val) );
    }
#endif
    ...
    {
      if (is_initialized())
        assign_expr_to_initialized(mwboost::forward<Expr>(expr),tag);
      else construct(mwboost::forward<Expr>(expr),tag);
    }
#else
    template<class Expr>
  ...
  protected :
    ...
    void construct ( rval_reference_type val )
     {
       ::new (m_storage.address()) unqualified_value_type( mwboost::move(val) ) ;
       m_initialized = true ;
     }
#endif
    ...
    {
      ::new (m_storage.address()) unqualified_value_type( mwboost::forward<Args>(args)... ) ;
      m_initialized = true ;
    }
    ...
    {
      destroy();
      construct(in_place_init, mwboost::forward<Args>(args)...);
    }
    ...
    void construct ( in_place_init_t, Arg&& arg )
     {
       ::new (m_storage.address()) unqualified_value_type( mwboost::forward<Arg>(arg) );
       m_initialized = true ;
     }
    ...
    void emplace_assign ( Arg&& arg )
     {
       destroy();
       construct(in_place_init, mwboost::forward<Arg>(arg)) ;
     }
    ...
    void construct ( Expr&& factory, in_place_factory_base const* )
     {
       mwboost_optional_detail::construct<value_type>(factory, m_storage.address());
       m_initialized = true ;
     }
    ...
    {
      new (m_storage.address()) unqualified_value_type(mwboost::forward<Expr>(expr)) ;
      m_initialized = true ;
    }
    ...
    {
      assign_value( mwboost::forward<Expr>(expr) );
    }
#else
    // Constructs using any expression implicitly convertible to the single argument
    // of a one-argument T constructor.
    ...
    void construct ( Expr&& expr, optional_tag const* )
     {
       if ( expr.is_initialized() )
       {
         ...
         new (m_storage.address()) unqualified_value_type(mwboost::move(expr.get())) ;
         m_initialized = true ;
       }
     }
#else
...
struct is_optional_or_tag
  : mwboost::conditional< mwboost::is_base_of<optional_detail::optional_tag, BOOST_DEDUCED_TYPENAME mwboost::decay<U>::type>::value
                     || mwboost::is_same<BOOST_DEDUCED_TYPENAME mwboost::decay<U>::type, none_t>::value
                     || mwboost::is_same<BOOST_DEDUCED_TYPENAME mwboost::decay<U>::type, in_place_init_t>::value
                     || mwboost::is_same<BOOST_DEDUCED_TYPENAME mwboost::decay<U>::type, in_place_init_if_t>::value,
    mwboost::true_type, mwboost::false_type>::type
{};

template <typename T, typename U>
struct has_dedicated_constructor
  : mwboost::disjunction<is_optional_or_tag<U>, mwboost::is_same<T, BOOST_DEDUCED_TYPENAME mwboost::decay<U>::type> >
{};

template <typename U>
struct is_in_place_factory
  : mwboost::disjunction< mwboost::is_base_of<mwboost::in_place_factory_base, BOOST_DEDUCED_TYPENAME mwboost::decay<U>::type>,
                        mwboost::is_base_of<mwboost::typed_in_place_factory_base, BOOST_DEDUCED_TYPENAME mwboost::decay<U>::type> >
{};
...
struct is_factory_or_constructible_to_T
  : mwboost::disjunction< is_in_place_factory<U>, mwboost::is_constructible<T, U&&> >
{};

template <typename T, typename U>
struct is_optional_constructible : mwboost::is_constructible<T, U>
{};

#else

template <typename, typename>
struct is_factory_or_constructible_to_T : mwboost::true_type
{};

template <typename T, typename U>
struct is_optional_constructible : mwboost::true_type
{};
...
struct is_opt_assignable
  : mwboost::conjunction<mwboost::is_convertible<U&&, T>, mwboost::is_assignable<T&, U&&> >
{};
...
template <typename T, typename U>
struct is_opt_assignable : mwboost::is_convertible<U, T>
{};
...
struct is_factory_or_opt_assignable_to_T
  : mwboost::disjunction< is_in_place_factory<U>, is_opt_assignable<T, U> >
{};
...
struct optional_uses_direct_storage_for
  : mwboost::conditional<(mwboost::is_scalar<T>::value && !mwboost::is_const<T>::value && !mwboost::is_volatile<T>::value)
                      , mwboost::true_type, mwboost::false_type>::type
{};
...
#  define BOOST_OPTIONAL_BASE_TYPE(T) mwboost::conditional< optional_config::optional_uses_direct_storage_for<T>::value, \
  ...
  : public BOOST_OPTIONAL_BASE_TYPE(T)
{
  ...
  public :
    ...
    // Can throw if T::T(T &&) does
    optional ( rval_reference_type val ) : base(optional_detail::init_value_tag(), mwboost::forward<T>(val))
      {}
#endif
    ...
    /// Creates an optional<T> initialized with 'val' IFF cond is true, otherwise creates an uninitialized optional.
    // Can throw if T::T(T &&) does
    optional ( bool cond, rval_reference_type val ) : base( cond, mwboost::forward<T>(val) )
      {}
#endif
    ...
    explicit optional ( optional<U> const& rhs
                        ...
                        ,BOOST_DEDUCED_TYPENAME mwboost::enable_if< optional_detail::is_optional_constructible<T, U const&>, bool>::type = true
#endif
                      )
      :
      base()
...
#ifndef BOOST_OPTIONAL_DETAIL_NO_SFINAE_FRIENDLY_CONSTRUCTORS
                        ,BOOST_DEDUCED_TYPENAME mwboost::enable_if< optional_detail::is_optional_constructible<T, U>, bool>::type = true
#endif
                      )
      :
      base()
    {
      if ( rhs.is_initialized() )
        this->construct( mwboost::move(rhs.get()) );
    }
#endif
  ...
  explicit optional ( Expr&& expr,
                      BOOST_DEDUCED_TYPENAME mwboost::enable_if< optional_detail::is_optional_val_init_candidate<T, Expr>, bool>::type = true
  )
    : base(mwboost::forward<Expr>(expr),mwboost::addressof(expr))
    {}

#else
    template<class Expr>
    explicit optional ( Expr const& expr ) : base(expr,mwboost::addressof(expr)) {}
    ...
    template<class Expr>
    BOOST_DEDUCED_TYPENAME mwboost::enable_if<optional_detail::is_optional_val_assign_candidate<T, Expr>, optional&>::type
    operator= ( Expr&& expr )
      {
        this->assign_expr(mwboost::forward<Expr>(expr),mwboost::addressof(expr));
        return *this ;
      }
    ...
    optional& operator= ( Expr const& expr )
      {
        this->assign_expr(expr,mwboost::addressof(expr));
        return *this ;
      }
#endif // !defined  BOOST_OPTIONAL_DETAIL_NO_RVALUE_REFERENCES
    ...
    BOOST_DEDUCED_TYPENAME mwboost::enable_if<mwboost::is_same<T, BOOST_DEDUCED_TYPENAME mwboost::decay<T_>::type>, optional&>::type
    operator= ( T_&& val )
      {
        this->assign( mwboost::forward<T_>(val) ) ;
        return *this ;
      }
    ...
    {
      this->emplace_assign( mwboost::forward<Args>(args)... );
    }

    template<class... Args>
    explicit optional ( in_place_init_t, Args&&... args )
    : base( in_place_init, mwboost::forward<Args>(args)... )
    {}

    template<class... Args>
    explicit optional ( in_place_init_if_t, bool cond, Args&&... args )
    : base( in_place_init_if, cond, mwboost::forward<Args>(args)... )
    {}
    ...
    void emplace ( Arg&& arg )
     {
       this->emplace_assign( mwboost::forward<Arg>(arg) );
     }
    ...
    reference_type_of_temporary_wrapper operator *() && { return mwboost::move(this->get()) ; }
#else
    reference_const_type operator *() const { return this->get() ; }
    reference_type       operator *()       { return this->get() ; }
    ...
    template <typename F>
    optional<typename mwboost::result_of<F(reference_type)>::type> map(F f) &
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename mwboost::result_of<F(reference_const_type)>::type> map(F f) const&
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename mwboost::result_of<F(reference_type_of_temporary_wrapper)>::type> map(F f) &&
      {
        if (this->has_value())
          return f(mwboost::move(this->get()));
        else
          return none;
      }

    template <typename F>
    optional<typename optional_detail::optional_value_type<typename mwboost::result_of<F(reference_type)>::type>::type> flat_map(F f) &
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename optional_detail::optional_value_type<typename mwboost::result_of<F(reference_const_type)>::type>::type> flat_map(F f) const&
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename optional_detail::optional_value_type<typename mwboost::result_of<F(reference_type_of_temporary_wrapper)>::type>::type> flat_map(F f) &&
      {
        if (this->has_value())
          return f(mwboost::move(get()));
        else
          return none;
      }
...
template<class T>
inline
optional<BOOST_DEDUCED_TYPENAME mwboost::decay<T>::type> make_optional ( T && v  )
{
  return optional<BOOST_DEDUCED_TYPENAME mwboost::decay<T>::type>(mwboost::forward<T>(v));
}

// Returns optional<T>(cond,v)
template<class T>
inline
optional<BOOST_DEDUCED_TYPENAME mwboost::decay<T>::type> make_optional ( bool cond, T && v )
{
  return optional<BOOST_DEDUCED_TYPENAME mwboost::decay<T>::type>(cond,mwboost::forward<T>(v));
}
...
{
  BOOST_STATIC_ASSERT_MSG(sizeof(CharType) == 0, "If you want to output mwboost::optional, include header <boost/optional/optional_io.hpp>");
  return os;
}
