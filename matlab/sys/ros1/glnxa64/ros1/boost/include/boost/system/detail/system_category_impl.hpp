...
inline mwboost::system::error_condition mwboost::system::detail::system_error_category::default_error_condition( int ev ) const BOOST_NOEXCEPT
{
    ...
    {
        return error_condition( mwboost::system::detail::generic_value_tag( e2 ) );
    }
}
...
inline mwboost::system::error_condition mwboost::system::detail::system_error_category::default_error_condition( int ev ) const BOOST_NOEXCEPT
{
    return error_condition( mwboost::system::detail::generic_value_tag( ev ) );
}

#endif // #if defined(BOOST_WINDOWS_API)

inline std::string mwboost::system::detail::system_error_category::message( int ev ) const
{
    return system_error_category_message( ev );
}

inline char const * mwboost::system::detail::system_error_category::message( int ev, char * buffer, std::size_t len ) const BOOST_NOEXCEPT
{
