...
namespace mwboost {} namespace boost = mwboost; namespace mwboost {
  namespace unordered {
    namespace detail {
      ...
      struct is_transparent : public mwboost::false_type
      {
      };

      template <class T>
      struct is_transparent<T,
        typename mwboost::make_void<typename T::is_transparent>::type>
      ...
      template <class Key, class UnorderedMap> struct transparent_non_iterable
      {
        ...
        static bool const value =
          ...
          !mwboost::is_convertible<Key, iterator>::value &&
          !mwboost::is_convertible<Key, const_iterator>::value;
      };
      ...
      constexpr bool const is_input_iterator_v =
        !mwboost::is_integral<InputIterator>::value;
      ...
      struct is_allocator<A,
        mwboost::void_t<typename A::value_type,
      ...
      constexpr bool const is_hash_v =
        !mwboost::is_integral<H>::value && !is_allocator_v<H>;
