...
//#define BOOST_INTERPROCESS_BOOTSTAMP_IS_GETTICKCOUNT64_BASED
...
// MW BEGIN PATCH
// MW uses GETTICKCOUNT64 as default method on Windows
// due to bootup time bug on Windows
#ifdef BOOST_INTERPROCESS_BOOTSTAMP_IS_GETTICKCOUNT64_BASED
#  define BOOST_INTERPROCESS_BOOTSTAMP_IS_GETTICKCOUNT64_BASED_VALUE 1
#else
#  define BOOST_INTERPROCESS_BOOTSTAMP_IS_GETTICKCOUNT64_BASED_VALUE 0
#endif
// MW END PATCH
...
#define BOOST_INTERPROCESS_BOOTSTAMP_VALUE_SUM \
   (BOOST_INTERPROCESS_BOOTSTAMP_IS_EVENTLOG_BASED_VALUE + \
    ...
    BOOST_INTERPROCESS_BOOTSTAMP_IS_GETTICKCOUNT64_BASED_VALUE)

#if 1 < BOOST_INTERPROCESS_BOOTSTAMP_VALUE_SUM
#  error "Only one of \
          BOOST_INTERPROCESS_BOOTSTAMP_IS_SESSION_MANAGER_BASED, \
          BOOST_INTERPROCESS_BOOTSTAMP_IS_EVENTLOG_BASED and \
          BOOST_INTERPROCESS_BOOTSTAMP_IS_GETTICKCOUNT64_BASED_VALUE can be defined"
#endif
...
union system_timeofday_information
{
   struct data_t
   {
      ...
      ::mwboost::ulong_long_type ullBootTimeBias;
      ::mwboost::ulong_long_type ullSleepTimeBias;
   } data;
...
typedef mwboost::winapi::LONG_ LSTATUS;

typedef mwboost::winapi::DWORD_ (__stdcall *LPTHREAD_START_ROUTINE_)
   (mwboost::winapi::LPVOID_ lpThreadParameter);


//#ifndef BOOST_USE_WINDOWS_H
//typedef mwboost::winapi::LARGE_INTEGER_ LARGE_INTEGER_EXT;
//#else
//typedef LARGE_INTEGER LARGE_INTEGER_EXT;
//#endif

}} //namespace mwboost::ipwinapiext
...
//Error handling
BOOST_SYMBOL_IMPORT BOOST_WINAPI_DETAIL_VOID BOOST_WINAPI_WINAPI_CC SetLastError(mwboost::winapi::DWORD_ dwErrCode);

//File management
BOOST_SYMBOL_IMPORT mwboost::winapi::DWORD_ BOOST_WINAPI_WINAPI_CC GetFileType(mwboost::winapi::HANDLE_ hTemplateFile);
BOOST_SYMBOL_IMPORT mwboost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC FlushFileBuffers(mwboost::winapi::HANDLE_ hFile);

//threading

BOOST_SYMBOL_IMPORT mwboost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC CreateThread
   ( ::_SECURITY_ATTRIBUTES* lpThreadAttributes
   , mwboost::winapi::SIZE_T_ dwStackSize
   , mwboost::ipwinapiext::LPTHREAD_START_ROUTINE_ lpStartAddress
   , mwboost::winapi::LPVOID_ lpParameter
   , mwboost::winapi::DWORD_ dwCreationFlags
   , mwboost::winapi::LPDWORD_ lpThreadId
   );

//Virtual Memory
BOOST_SYMBOL_IMPORT mwboost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC VirtualLock(mwboost::winapi::LPVOID_ lpAddress, mwboost::winapi::SIZE_T_ dwSize);
BOOST_SYMBOL_IMPORT mwboost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC VirtualUnlock(mwboost::winapi::LPVOID_ lpAddress, mwboost::winapi::SIZE_T_ dwSize);
BOOST_SYMBOL_IMPORT mwboost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC VirtualProtect( mwboost::winapi::LPVOID_ lpAddress, mwboost::winapi::SIZE_T_ dwSize
                                                                              , mwboost::winapi::DWORD_ flNewProtect, mwboost::winapi::PDWORD_ lpflOldProtect);
//registry.hpp
BOOST_WINAPI_DETAIL_DECLARE_HANDLE(HKEY);


BOOST_SYMBOL_IMPORT mwboost::ipwinapiext::LSTATUS BOOST_WINAPI_WINAPI_CC RegOpenKeyExA
   (::HKEY hKey, const char *lpSubKey, mwboost::winapi::DWORD_ ulOptions, mwboost::winapi::DWORD_ samDesired, ::HKEY *phkResult);
BOOST_SYMBOL_IMPORT mwboost::ipwinapiext::LSTATUS BOOST_WINAPI_WINAPI_CC RegOpenKeyExW
   (::HKEY hKey, const wchar_t *lpSubKey, mwboost::winapi::DWORD_ ulOptions, mwboost::winapi::DWORD_ samDesired, ::HKEY *phkResult);
BOOST_SYMBOL_IMPORT mwboost::ipwinapiext::LSTATUS BOOST_WINAPI_WINAPI_CC RegQueryValueExA
   (::HKEY hKey, const char *lpValueName, mwboost::winapi::DWORD_ *lpReserved, mwboost::winapi::DWORD_ *lpType, mwboost::winapi::BYTE_ *lpData, mwboost::winapi::DWORD_ *lpcbData);
BOOST_SYMBOL_IMPORT mwboost::ipwinapiext::LSTATUS BOOST_WINAPI_WINAPI_CC RegQueryValueExW
   (::HKEY hKey, const wchar_t *lpValueName, mwboost::winapi::DWORD_ *lpReserved, mwboost::winapi::DWORD_ *lpType, mwboost::winapi::BYTE_ *lpData, mwboost::winapi::DWORD_ *lpcbData);
BOOST_SYMBOL_IMPORT mwboost::ipwinapiext::LSTATUS BOOST_WINAPI_WINAPI_CC RegCloseKey(::HKEY hKey);


//Event Log
BOOST_SYMBOL_IMPORT mwboost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC OpenEventLogA(const char* lpUNCServerName, const char* lpSourceName);
BOOST_SYMBOL_IMPORT mwboost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC OpenEventLogW(const wchar_t* lpUNCServerName, const wchar_t* lpSourceName);
BOOST_SYMBOL_IMPORT mwboost::winapi::BOOL_   BOOST_WINAPI_WINAPI_CC CloseEventLog(mwboost::winapi::HANDLE_ hEventLog);
BOOST_SYMBOL_IMPORT mwboost::winapi::BOOL_   BOOST_WINAPI_WINAPI_CC ReadEventLogA
   ( mwboost::winapi::HANDLE_ hEventLog, mwboost::winapi::DWORD_ dwReadFlags, mwboost::winapi::DWORD_ dwRecordOffset, void* lpBuffer
   , mwboost::winapi::DWORD_ nNumberOfBytesToRead, mwboost::winapi::DWORD_ *pnBytesRead, mwboost::winapi::DWORD_ *pnMinNumberOfBytesNeeded);
BOOST_SYMBOL_IMPORT mwboost::winapi::BOOL_   BOOST_WINAPI_WINAPI_CC ReadEventLogW
   ( mwboost::winapi::HANDLE_ hEventLog, mwboost::winapi::DWORD_ dwReadFlags, mwboost::winapi::DWORD_ dwRecordOffset, void* lpBuffer
   , mwboost::winapi::DWORD_ nNumberOfBytesToRead, mwboost::winapi::DWORD_ *pnBytesRead, mwboost::winapi::DWORD_ *pnMinNumberOfBytesNeeded); 
...
//Threads
BOOST_FORCEINLINE mwboost::winapi::HANDLE_ CreateThread
   ( mwboost::winapi::SECURITY_ATTRIBUTES_* lpThreadAttributes
   , mwboost::winapi::SIZE_T_ dwStackSize
   , mwboost::ipwinapiext::LPTHREAD_START_ROUTINE_ lpStartAddress
   , mwboost::winapi::LPVOID_ lpParameter
   , mwboost::winapi::DWORD_ dwCreationFlags
...
//Error handling
BOOST_FORCEINLINE BOOST_WINAPI_DETAIL_VOID SetLastError(mwboost::winapi::DWORD_ dwErrCode)
{  ::SetLastError(dwErrCode); }

//File management
BOOST_FORCEINLINE mwboost::winapi::DWORD_ GetFileType(mwboost::winapi::HANDLE_ hTemplateFile)
{  return ::GetFileType(hTemplateFile);   }

BOOST_FORCEINLINE mwboost::winapi::BOOL_ FlushFileBuffers(mwboost::winapi::HANDLE_ hFile)
{  return ::FlushFileBuffers(hFile);   }

//Virtual Memory
BOOST_FORCEINLINE mwboost::winapi::BOOL_ VirtualLock(mwboost::winapi::LPVOID_ lpAddress, mwboost::winapi::SIZE_T_ dwSize)
{  return ::VirtualLock(lpAddress, dwSize);  }

BOOST_FORCEINLINE mwboost::winapi::BOOL_ VirtualUnlock(mwboost::winapi::LPVOID_ lpAddress, mwboost::winapi::SIZE_T_ dwSize)
{  return ::VirtualUnlock(lpAddress, dwSize);   }

BOOST_FORCEINLINE mwboost::winapi::BOOL_ VirtualProtect( mwboost::winapi::LPVOID_ lpAddress, mwboost::winapi::SIZE_T_ dwSize
                                                     , mwboost::winapi::DWORD_ flNewProtect, mwboost::winapi::PDWORD_ lpflOldProtect)
{  return ::VirtualProtect(lpAddress, dwSize, flNewProtect, lpflOldProtect);  }

//registry.hpp
BOOST_FORCEINLINE mwboost::ipwinapiext::LSTATUS RegOpenKeyExA
   (mwboost::ipwinapiext::HKEY_ hKey, const char *lpSubKey, mwboost::winapi::DWORD_ ulOptions, mwboost::winapi::DWORD_ samDesired, mwboost::ipwinapiext::HKEY_ *phkResult)
{
   return ::RegOpenKeyExA(reinterpret_cast< ::HKEY >(hKey), lpSubKey, ulOptions, samDesired, reinterpret_cast< ::HKEY* >(phkResult));
}

BOOST_FORCEINLINE mwboost::ipwinapiext::LSTATUS RegOpenKeyExW
   (mwboost::ipwinapiext::HKEY_ hKey, const wchar_t *lpSubKey, mwboost::winapi::DWORD_ ulOptions, mwboost::winapi::DWORD_ samDesired, mwboost::ipwinapiext::HKEY_ *phkResult)
{
   return ::RegOpenKeyExW(reinterpret_cast< ::HKEY >(hKey), lpSubKey, ulOptions, samDesired, reinterpret_cast< ::HKEY* >(phkResult));
}

BOOST_FORCEINLINE mwboost::ipwinapiext::LSTATUS RegQueryValueExA
   (mwboost::ipwinapiext::HKEY_ hKey, const char *lpValueName, mwboost::winapi::DWORD_ *lpReserved, mwboost::winapi::DWORD_ *lpType, mwboost::winapi::BYTE_ *lpData, mwboost::winapi::DWORD_ *lpcbData)
{
   return ::RegQueryValueExA(reinterpret_cast< ::HKEY >(hKey), lpValueName, lpReserved, lpType, lpData, lpcbData);
}

BOOST_FORCEINLINE mwboost::ipwinapiext::LSTATUS RegQueryValueExW
   (mwboost::ipwinapiext::HKEY_ hKey, const wchar_t *lpValueName, mwboost::winapi::DWORD_ *lpReserved, mwboost::winapi::DWORD_ *lpType, mwboost::winapi::BYTE_ *lpData, mwboost::winapi::DWORD_ *lpcbData)
{
   return ::RegQueryValueExW(reinterpret_cast< ::HKEY >(hKey), lpValueName, lpReserved, lpType, lpData, lpcbData);
}

BOOST_FORCEINLINE mwboost::ipwinapiext::LSTATUS RegCloseKey(mwboost::ipwinapiext::HKEY_ hKey)
{
   return ::RegCloseKey(reinterpret_cast< ::HKEY >(hKey));
}

BOOST_FORCEINLINE void GetSystemInfo(mwboost::winapi::LPSYSTEM_INFO_ lpSystemInfo)
...
typedef mwboost::winapi::SYSTEM_INFO_ interprocess_system_info;
typedef mwboost::winapi::OVERLAPPED_ interprocess_overlapped;
typedef mwboost::winapi::FILETIME_ interprocess_filetime;
typedef mwboost::winapi::WIN32_FIND_DATAA_ win32_find_data_a;
typedef mwboost::winapi::WIN32_FIND_DATAW_ win32_find_data_w;
typedef mwboost::winapi::SECURITY_ATTRIBUTES_ interprocess_security_attributes;
typedef mwboost::winapi::SECURITY_DESCRIPTOR_ interprocess_security_descriptor;
typedef mwboost::winapi::BY_HANDLE_FILE_INFORMATION_ interprocess_by_handle_file_information;
typedef mwboost::winapi::HMODULE_ hmodule;
typedef mwboost::ipwinapiext::HKEY_ hkey;
typedef mwboost::winapi::FARPROC_ farproc_t;
...
class interprocess_all_access_security
{
   ...
   interprocess_all_access_security()
      : initialized(false)
   {
      if(!mwboost::winapi::InitializeSecurityDescriptor(&sd, security_descriptor_revision))
         return;
      if(!mwboost::winapi::SetSecurityDescriptorDacl(&sd, true, 0, false))
         return;
...
inline void * create_file_mapping (void * handle, unsigned long access, ::mwboost::ulong_long_type file_offset, const char * name, interprocess_security_attributes *psec)
{
   const mwboost::winapi::DWORD_ high_size = mwboost::winapi::DWORD_(file_offset >> 32);
   const mwboost::winapi::DWORD_ low_size  = mwboost::winapi::DWORD_(file_offset);
   return CreateFileMappingA (handle, psec, access, high_size, low_size, name);
}

inline void * create_file_mapping (void * handle, unsigned long access, ::mwboost::ulong_long_type file_offset, const wchar_t * name, interprocess_security_attributes *psec)
{
   const mwboost::winapi::DWORD_ high_size = mwboost::winapi::DWORD_(file_offset >> 32);
   const mwboost::winapi::DWORD_ low_size  = mwboost::winapi::DWORD_(file_offset);
...
inline void *map_view_of_file_ex(void *handle, unsigned long file_access, ::mwboost::ulong_long_type offset, std::size_t numbytes, void *base_addr)
{
   const mwboost::winapi::DWORD_ offset_low  = mwboost::winapi::DWORD_(offset & ((::mwboost::ulong_long_type)0xFFFFFFFF));
   const mwboost::winapi::DWORD_ offset_high = mwboost::winapi::DWORD_(offset >> 32);
...
inline void *create_file(const CharT *name, unsigned long access, unsigned long creation_flags, unsigned long attributes, interprocess_security_attributes *psec)
{
   for (unsigned int attempt(0); attempt < error_sharing_violation_tries; ++attempt){
      void * const handle = mwboost::winapi::create_file(name, access,
...
{  mwboost::ipwinapiext::GetSystemInfo(info); }

inline bool flush_view_of_file(void *base_addr, std::size_t numbytes)
{  return 0 != mwboost::winapi::FlushViewOfFile(base_addr, numbytes); }

inline bool virtual_unlock(void *base_addr, std::size_t numbytes)
{  return 0 != mwboost::ipwinapiext::VirtualUnlock(base_addr, numbytes); }

inline bool virtual_protect(void *base_addr, std::size_t numbytes, unsigned long flNewProtect, unsigned long &lpflOldProtect)
{  return 0 != mwboost::ipwinapiext::VirtualProtect(base_addr, numbytes, flNewProtect, &lpflOldProtect); }

inline bool flush_file_buffers(void *handle)
{  return 0 != mwboost::ipwinapiext::FlushFileBuffers(handle); }

inline bool get_file_size(void *handle, __int64 &size)
{  return 0 != mwboost::winapi::GetFileSizeEx(handle, (mwboost::winapi::LARGE_INTEGER_*)&size);  }

template<class CharT>
inline bool create_directory(const CharT *name)
{
   interprocess_all_access_security sec;
   return 0 != mwboost::winapi::create_directory(name, sec.get_attributes());
}

template<class CharT>
inline bool remove_directory(const CharT *lpPathName)
{  return 0 != mwboost::winapi::remove_directory(lpPathName);   }

template<class CharT>
inline unsigned long get_temp_path(unsigned long length, CharT *buffer)
{  return mwboost::winapi::get_temp_path(length, buffer);   }

inline int set_end_of_file(void *handle)
{  return 0 != mwboost::winapi::SetEndOfFile(handle);   }

inline bool set_file_pointer(void *handle, __int64 distance, __int64 *new_file_pointer, unsigned long move_method)
{
   mwboost::winapi::LONG_ highPart = mwboost::winapi::LONG_(distance >> 32u);
   mwboost::winapi::DWORD_ r = mwboost::winapi::SetFilePointer(handle, (long)distance, &highPart, move_method);
   bool br = r != mwboost::winapi::INVALID_SET_FILE_POINTER_ || mwboost::winapi::GetLastError() != 0;
...
{  return 0 != mwboost::winapi::LockFileEx(hnd, flags, reserved, size_low, size_high, overlapped); }
...
{  return 0 != mwboost::winapi::UnlockFileEx(hnd, reserved, size_low, size_high, overlapped);  }
...
{  return 0 != mwboost::winapi::WriteFile(hnd, buffer, bytes_to_write, bytes_written, overlapped);  }
...
{  return 0 != mwboost::winapi::ReadFile(hnd, buffer, bytes_to_read, bytes_read, overlapped);  }

inline bool get_file_information_by_handle(void *hnd, interprocess_by_handle_file_information *info)
{  return 0 != mwboost::winapi::GetFileInformationByHandle(hnd, info);  }
...
{  return mwboost::winapi::LoadLibraryA(name); }

inline bool free_library(hmodule module)
{  return 0 != mwboost::winapi::FreeLibrary(module); }

inline farproc_t get_proc_address(hmodule module, const char *name)
{  return mwboost::winapi::GetProcAddress(module, name); }

inline void *get_current_process()
{  return mwboost::winapi::GetCurrentProcess();  }

inline hmodule get_module_handle(const char *name)
{  return mwboost::winapi::GetModuleHandleA(name); }
...
{  return mwboost::ipwinapiext::RegOpenKeyExA(hKey, lpSubKey, ulOptions, samDesired, phkResult); }
...
{  return mwboost::ipwinapiext::RegOpenKeyExW(hKey, lpSubKey, ulOptions, samDesired, phkResult); }
...
{  return mwboost::ipwinapiext::RegQueryValueExA(hKey, lpValueName, lpReserved, lpType, lpData, lpcbData); }
...
{  return mwboost::ipwinapiext::RegQueryValueExW(hKey, lpValueName, lpReserved, lpType, lpData, lpcbData); }

inline long reg_close_key(hkey hKey)
{  return mwboost::ipwinapiext::RegCloseKey(hKey); }
...
class nt_query_mem_deleter
{
   ...
   static const std::size_t rename_suffix =
      (SystemTimeOfDayInfoLength + sizeof(unsigned long) + sizeof(mwboost::winapi::DWORD_))*2;
...
inline bool unlink_file(const CharT *filename)
{
   ...
   BOOST_TRY{
      ...
      handle_closer h_closer(fh);
      {
         ...
         static volatile mwboost::uint32_t u32_count = 0;
         interlocked_decrement(reinterpret_cast<volatile long*>(&u32_count));
         buffer_to_wide_str(const_cast<const mwboost::uint32_t *>(&u32_count), sizeof(mwboost::uint32_t), &pfri->FileName[filename_string_length]);
         filename_string_length += sizeof(mwboost::uint32_t)*2;
...
{
   return 0 != mwboost::winapi::QueryPerformanceCounter(reinterpret_cast<mwboost::winapi::LARGE_INTEGER_*>(lpPerformanceCount));
}

inline bool query_performance_frequency(__int64 *lpFrequency)
{
   return 0 != mwboost::winapi::QueryPerformanceFrequency(reinterpret_cast<mwboost::winapi::LARGE_INTEGER_*>(lpFrequency));
}
...
// MW BEGIN PATCH
#if defined(BOOST_INTERPROCESS_BOOTSTAMP_IS_GETTICKCOUNT64_BASED)

// Obtains the bootup time from GetTickCount64 windows api
// GetTickCount64 is available from Windows vista amd Windows server 2008
inline bool get_last_bootup_time(std::string &stamp)
{
    // Boot-up time is inconsistent when the underlying tick-count clock, and the system time clock are updated
    // Because GetTickCount64() is divided by 1000 (to get time in seconds), if you happen to query each of
    // these time inputs at around the boundary that the system clock moves forward by exactly one whole second,
    // we end up getting different boot-up time. Divide-by-twenty  to allow the comparison to occur within 20
    // second window.
    // g2155104 : Follow-up with Boost team to look for a stable method
    auto const bootup_time = (((std::time(nullptr)) - (GetTickCount64() / 1000)) / 20) * 20;
    stamp = std::to_string(bootup_time);
    return true;
}

inline bool get_last_bootup_time(std::wstring& stamp) // for wchar_t support
{
    // Boot-up time is inconsistent when the underlying tick-count clock, and the system time clock are updated
    // Because GetTickCount64() is divided by 1000 (to get time in seconds), if you happen to query each of
    // these time inputs at around the boundary that the system clock moves forward by exactly one whole second,
    ...
    // g2155104 : Follow-up with Boost team to look for a stable method
    auto const bootup_time = (((std::time(nullptr)) - (GetTickCount64() / 1000)) / 20) * 20;
    stamp = std::to_wstring(bootup_time);
    return true;
}
#endif //BOOST_INTERPROCESS_BOOTSTAMP_IS_GETTICKCOUNT64_BASED
// MW END PATCH
