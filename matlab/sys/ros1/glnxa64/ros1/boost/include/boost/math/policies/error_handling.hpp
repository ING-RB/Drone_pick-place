...
namespace mwboost {} namespace boost = mwboost; namespace mwboost{ namespace math{
...
{
   typedef typename mwboost::math::policies::precision<T, mwboost::math::policies::policy<> >::type prec_type;
   std::stringstream ss;
   if(prec_type::value)
   {
...
#ifndef BOOST_NO_RTTI
  replace_all_in_string(function, "%1%", mwboost::math::policies::detail::name_of<T>());
#else
...
inline T raise_domain_error(
           ...
           const char* message,
           const T& val,
           const ::mwboost::math::policies::domain_error< ::mwboost::math::policies::throw_on_error>&)
{
...
inline constexpr T raise_domain_error(
           ...
           const char* ,
           const T& ,
           const ::mwboost::math::policies::domain_error< ::mwboost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
...
inline T raise_domain_error(
           ...
           const char* ,
           const T& ,
           const ::mwboost::math::policies::domain_error< ::mwboost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = EDOM;
   // This may or may not do the right thing, but the user asked for the error
...
inline T raise_domain_error(
           ...
           const char* message,
           const T& val,
           const  ::mwboost::math::policies::domain_error< ::mwboost::math::policies::user_error>&)
{
...
inline T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::mwboost::math::policies::pole_error< ::mwboost::math::policies::throw_on_error>&)
{
#ifdef BOOST_NO_EXCEPTIONS
   static_assert(sizeof(T) == 0, "Error handler called with throw_on_error and BOOST_NO_EXCEPTIONS set.");
#else
   return mwboost::math::policies::detail::raise_domain_error(function, message, val,  ::mwboost::math::policies::domain_error< ::mwboost::math::policies::throw_on_error>());
#endif
}
...
inline constexpr T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::mwboost::math::policies::pole_error< ::mwboost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   return  ::mwboost::math::policies::detail::raise_domain_error(function, message, val,  ::mwboost::math::policies::domain_error< ::mwboost::math::policies::ignore_error>());
}
...
inline constexpr T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::mwboost::math::policies::pole_error< ::mwboost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   return  ::mwboost::math::policies::detail::raise_domain_error(function, message, val,  ::mwboost::math::policies::domain_error< ::mwboost::math::policies::errno_on_error>());
}
...
inline T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::mwboost::math::policies::pole_error< ::mwboost::math::policies::user_error>&)
{
...
inline T raise_overflow_error(
           const char* function,
           const char* message,
           const  ::mwboost::math::policies::overflow_error< ::mwboost::math::policies::throw_on_error>&)
{
#ifdef BOOST_NO_EXCEPTIONS
   static_assert(sizeof(T) == 0, "Error handler called with throw_on_error and BOOST_NO_EXCEPTIONS set.");
#else
   ...
   return std::numeric_limits<T>::has_infinity ? std::numeric_limits<T>::infinity() : mwboost::math::tools::max_value<T>();
#endif
}
...
inline constexpr T raise_overflow_error(
           const char* ,
           const char* ,
           const  ::mwboost::math::policies::overflow_error< ::mwboost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return std::numeric_limits<T>::has_infinity ? std::numeric_limits<T>::infinity() : mwboost::math::tools::max_value<T>();
...
inline T raise_overflow_error(
           const char* ,
           const char* ,
           const  ::mwboost::math::policies::overflow_error< ::mwboost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_overflow_error(
           const char* function,
           const char* message,
           const  ::mwboost::math::policies::overflow_error< ::mwboost::math::policies::user_error>&)
{
...
inline T raise_underflow_error(
           const char* function,
           const char* message,
           const  ::mwboost::math::policies::underflow_error< ::mwboost::math::policies::throw_on_error>&)
{
#ifdef BOOST_NO_EXCEPTIONS
   static_assert(sizeof(T) == 0, "Error handler called with throw_on_error and BOOST_NO_EXCEPTIONS set.");
#else
...
inline constexpr T raise_underflow_error(
           const char* ,
           const char* ,
           const  ::mwboost::math::policies::underflow_error< ::mwboost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return T(0);
...
inline T raise_underflow_error(
           const char* /* function */,
           const char* /* message */,
           const  ::mwboost::math::policies::underflow_error< ::mwboost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_underflow_error(
           const char* function,
           const char* message,
           const  ::mwboost::math::policies::underflow_error< ::mwboost::math::policies::user_error>&)
{
...
inline T raise_denorm_error(
           ...
           const char* message,
           const T& /* val */,
           const  ::mwboost::math::policies::denorm_error< ::mwboost::math::policies::throw_on_error>&)
{
#ifdef BOOST_NO_EXCEPTIONS
   static_assert(sizeof(T) == 0, "Error handler called with throw_on_error and BOOST_NO_EXCEPTIONS set.");
#else
...
inline constexpr T raise_denorm_error(
           ...
           const char* ,
           const T&  val,
           const  ::mwboost::math::policies::denorm_error< ::mwboost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return val;
...
inline T raise_denorm_error(
           ...
           const char* ,
           const T& val,
           const  ::mwboost::math::policies::denorm_error< ::mwboost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_denorm_error(
           ...
           const char* message,
           const T& val,
           const  ::mwboost::math::policies::denorm_error< ::mwboost::math::policies::user_error>&)
{
...
inline T raise_evaluation_error(
           ...
           const char* message,
           const T& val,
           const  ::mwboost::math::policies::evaluation_error< ::mwboost::math::policies::throw_on_error>&)
{
#ifdef BOOST_NO_EXCEPTIONS
   static_assert(sizeof(T) == 0, "Error handler called with throw_on_error and BOOST_NO_EXCEPTIONS set.");
#else
   raise_error<mwboost::math::evaluation_error, T>(function, message, val);
   // we never get here:
   return T(0);
#endif
}
...
inline constexpr T raise_evaluation_error(
           ...
           const char* ,
           const T& val,
           const  ::mwboost::math::policies::evaluation_error< ::mwboost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return val;
...
inline T raise_evaluation_error(
           ...
           const char* ,
           const T& val,
           const  ::mwboost::math::policies::evaluation_error< ::mwboost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = EDOM;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_evaluation_error(
           ...
           const char* message,
           const T& val,
           const  ::mwboost::math::policies::evaluation_error< ::mwboost::math::policies::user_error>&)
{
...
inline TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType&,
           const  ::mwboost::math::policies::rounding_error< ::mwboost::math::policies::throw_on_error>&)
{
#ifdef BOOST_NO_EXCEPTIONS
   static_assert(sizeof(T) == 0, "Error handler called with throw_on_error and BOOST_NO_EXCEPTIONS set.");
#else
   raise_error<mwboost::math::rounding_error, T>(function, message, val);
   // we never get here:
   return TargetType(0);
#endif
}
...
inline constexpr TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType&,
           const  ::mwboost::math::policies::rounding_error< ::mwboost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
...
inline TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType&,
           const  ::mwboost::math::policies::rounding_error< ::mwboost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType& t,
           const  ::mwboost::math::policies::rounding_error< ::mwboost::math::policies::user_error>&)
{
...
inline T raise_indeterminate_result_error(
           ...
           const T& val,
           const R& ,
           const ::mwboost::math::policies::indeterminate_result_error< ::mwboost::math::policies::throw_on_error>&)
{
#ifdef BOOST_NO_EXCEPTIONS
   static_assert(sizeof(T) == 0, "Error handler called with throw_on_error and BOOST_NO_EXCEPTIONS set.");
#else
...
inline constexpr T raise_indeterminate_result_error(
           ...
           const T& ,
           const R& result,
           const ::mwboost::math::policies::indeterminate_result_error< ::mwboost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return result;
...
inline T raise_indeterminate_result_error(
           ...
           const T& ,
           const R& result,
           const ::mwboost::math::policies::indeterminate_result_error< ::mwboost::math::policies::errno_on_error>&)
{
   errno = EDOM;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_indeterminate_result_error(
           ...
           const T& val,
           const R& ,
           const ::mwboost::math::policies::indeterminate_result_error< ::mwboost::math::policies::user_error>&)
{
...
BOOST_FORCEINLINE bool check_overflow(T val, R* result, const char* function, const Policy& pol) noexcept(BOOST_MATH_IS_FLOAT(R) && BOOST_MATH_IS_FLOAT(T) && (Policy::value != throw_on_error) && (Policy::value != user_error))
{
   ...
   {
      mwboost::math::policies::detail::raise_overflow_error<R>(function, nullptr, pol);
...
BOOST_FORCEINLINE bool check_underflow(T val, R* result, const char* function, const Policy& pol) noexcept(BOOST_MATH_IS_FLOAT(R) && BOOST_MATH_IS_FLOAT(T) && (Policy::value != throw_on_error) && (Policy::value != user_error))
{
   ...
   {
      *result = static_cast<R>(mwboost::math::policies::detail::raise_underflow_error<R>(function, nullptr, pol));
      return true;
   }
   return false;
}
...
BOOST_FORCEINLINE bool check_denorm(T val, R* result, const char* function, const Policy& pol) noexcept(BOOST_MATH_IS_FLOAT(R) && BOOST_MATH_IS_FLOAT(T) && (Policy::value != throw_on_error) && (Policy::value != user_error))
{
   ...
   {
      *result = static_cast<R>(mwboost::math::policies::detail::raise_denorm_error<R>(function, 0, static_cast<R>(val), pol));
      return true;
   }
   return false;
}
