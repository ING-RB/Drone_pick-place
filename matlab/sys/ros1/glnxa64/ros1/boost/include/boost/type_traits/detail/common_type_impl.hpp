...
{
    BOOST_STATIC_CONSTANT( bool, ct = mwboost::is_class<T>::value || mwboost::is_union<T>::value );
    BOOST_STATIC_CONSTANT( bool, cu = mwboost::is_class<U>::value || mwboost::is_union<U>::value );
...
template<class T, class U> struct common_type_class: public mwboost::conditional<

    mwboost::is_convertible<T, U>::value && !mwboost::is_convertible<U, T>::value,
    mwboost::type_identity<U>,

    typename mwboost::conditional<

        mwboost::is_convertible<U, T>::value && !mwboost::is_convertible<T, U>::value,
        mwboost::type_identity<T>,
...
template<class T, class U> struct common_type_impl: public mwboost::conditional<
    ct_class<T, U>::value,
...
template<class T, class U> struct common_type_impl3: public mwboost::conditional<
    mwboost::is_pointer<T>::value || mwboost::is_pointer<U>::value,
...
template<class T, class U> struct common_type_impl4: public mwboost::conditional<
    mwboost::is_member_pointer<T>::value || mwboost::is_member_pointer<U>::value,
