...
struct detect_precision_loss
{
    ...
    typedef mwboost::numeric::Trunc<Source> Rounder;
    typedef BOOST_DEDUCED_TYPENAME conditional<
        mwboost::is_arithmetic<Source>::value, Source, Source const&
    >::type argument_type ;
...
{
    inline bool operator() ( mwboost::numeric::range_check_result r ) const BOOST_NOEXCEPT {
        return (r == mwboost::numeric::cInRange);
    }
};
...
inline bool noexcept_numeric_convert(const Source& arg, Target& result) BOOST_NOEXCEPT {
    typedef mwboost::numeric::converter<
            Target,
            Source,
            mwboost::numeric::conversion_traits<Target, Source >,
            nothrow_overflow_handler,
            detect_precision_loss<Source >
    > converter_orig_t;

    typedef BOOST_DEDUCED_TYPENAME mwboost::conditional<
        mwboost::is_base_of< detect_precision_loss<Source >, converter_orig_t >::value,
        converter_orig_t,
...
struct lexical_cast_dynamic_num_ignoring_minus
{
    static inline bool try_convert(const Source &arg, Target& result) BOOST_NOEXCEPT {
        typedef BOOST_DEDUCED_TYPENAME mwboost::conditional<
                mwboost::is_float<Source>::value,
                mwboost::type_identity<Source>,
                mwboost::make_unsigned<Source>
        >::type usource_lazy_t;
 ...
 *
 *
 * Rule 2) required because mwboost::lexical_cast has the behavior of
...
{
    typedef BOOST_DEDUCED_TYPENAME mwboost::remove_volatile<Source>::type source_type;

    static inline bool try_convert(source_type arg, Target& result) BOOST_NOEXCEPT {
        typedef BOOST_DEDUCED_TYPENAME mwboost::conditional<
            mwboost::is_unsigned<Target>::value &&
            (mwboost::is_signed<source_type>::value || mwboost::is_float<source_type>::value) &&
            !(mwboost::is_same<source_type, bool>::value) &&
            !(mwboost::is_same<Target, bool>::value),
