...
namespace gregorian {
  ...
  typedef mwboost::date_time::period_formatter<wchar_t> wperiod_formatter;
  typedef mwboost::date_time::period_formatter<char>    period_formatter;
  
  typedef mwboost::date_time::date_facet<date,wchar_t> wdate_facet;
  typedef mwboost::date_time::date_facet<date,char>    date_facet;

  typedef mwboost::date_time::period_parser<date,char>       period_parser;
  typedef mwboost::date_time::period_parser<date,wchar_t>    wperiod_parser;
    
  typedef mwboost::date_time::special_values_formatter<char> special_values_formatter; 
  typedef mwboost::date_time::special_values_formatter<wchar_t> wspecial_values_formatter; 
  
  typedef mwboost::date_time::special_values_parser<date,char> special_values_parser; 
  typedef mwboost::date_time::special_values_parser<date,wchar_t> wspecial_values_parser; 
  
  typedef mwboost::date_time::date_input_facet<date,char>    date_input_facet;
  typedef mwboost::date_time::date_input_facet<date,wchar_t> wdate_input_facet;

  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const mwboost::gregorian::date& d) {
    mwboost::io::ios_flags_saver iflags(os);
    typedef mwboost::date_time::date_facet<date, CharT> custom_date_facet;
  ...
  {
    mwboost::io::ios_flags_saver iflags(is);
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const mwboost::gregorian::date_duration& dd) {
    mwboost::io::ios_flags_saver iflags(os);
    typedef mwboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const mwboost::gregorian::date_period& dp) {
    mwboost::io::ios_flags_saver iflags(os);
    typedef mwboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const mwboost::gregorian::greg_month& gm) {
    mwboost::io::ios_flags_saver iflags(os);
    typedef mwboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const mwboost::gregorian::greg_weekday& gw) {
    mwboost::io::ios_flags_saver iflags(os);
    typedef mwboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const mwboost::gregorian::partial_date& pd) {
    mwboost::io::ios_flags_saver iflags(os);
    typedef mwboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const mwboost::gregorian::nth_day_of_the_week_in_month& nkd) {
    mwboost::io::ios_flags_saver iflags(os);
    typedef mwboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const mwboost::gregorian::first_day_of_the_week_in_month& fkd) {
    mwboost::io::ios_flags_saver iflags(os);
    typedef mwboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const mwboost::gregorian::last_day_of_the_week_in_month& lkd) {
    mwboost::io::ios_flags_saver iflags(os);
    typedef mwboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const mwboost::gregorian::first_day_of_the_week_after& fda) {
    mwboost::io::ios_flags_saver iflags(os);
    typedef mwboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const mwboost::gregorian::first_day_of_the_week_before& fdb) {
    mwboost::io::ios_flags_saver iflags(os);
    typedef mwboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
