...
//  insert helpers  -------------------------------------------------//
            ...
            {
                ::mwboost::algorithm::detail::insert( Input, At, ::mwboost::begin(Insert), ::mwboost::end(Insert) );
            }
...
//  replace helper  -------------------------------------------------//
                ...
                const InsertT& Insert )
            {
                if(From!=To)
                {
                    ::mwboost::algorithm::detail::replace( Input, From, To, ::mwboost::begin(Insert), ::mwboost::end(Insert) );
                }
                else
                {
                    ::mwboost::algorithm::detail::insert( Input, From, ::mwboost::begin(Insert), ::mwboost::end(Insert) );
                }
            }
