...
#error "mwboost::format uses a local macro that is already defined."
#endif
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace io { namespace detail {
#if ! defined(BOOST_NO_STD_LOCALE)
