...
struct tree_opt
{
   static const mwboost::container::tree_type_enum tree_type = TreeType;
...
//! by \c mwboost::container::set, \c mwboost::container::multiset
//! \c mwboost::container::map and \c mwboost::container::multimap.
//! Supported options are: \c mwboost::container::optimize_size and \c mwboost::container::tree_type
...
{
   /// @cond
   typedef typename ::mwboost::intrusive::pack_options
      < tree_assoc_defaults,
...
template<class ...Options>
using tree_assoc_options_t = typename mwboost::container::tree_assoc_options<Options...>::type;
...
//! Helper metafunction to combine options into a single type to be used
//! by \c mwboost::container::hash_set, \c mwboost::container::hash_multiset
//! \c mwboost::container::hash_map and \c mwboost::container::hash_multimap.
//! Supported options are: \c mwboost::container::store_hash
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
template<class ...Options>
using hash_assoc_options_t = typename mwboost::container::hash_assoc_options<Options...>::type;
...
//!\c mwboost::container::growth_factor_50
//!\c mwboost::container::growth_factor_60
//!\c mwboost::container::growth_factor_100
//!
...
//! Helper metafunction to combine options into a single type to be used
//! by \c mwboost::container::vector.
//! Supported options are: \c mwboost::container::growth_factor and \c mwboost::container::stored_size
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! Supported options are: \c mwboost::container::growth_factor and \c mwboost::container::stored_size
template<class ...Options>
using vector_options_t = typename mwboost::container::vector_options<Options...>::type;
...
//! Helper metafunction to combine options into a single type to be used
//! by \c mwboost::container::small_vector.
//! Supported options are: \c mwboost::container::growth_factor and \c mwboost::container::inplace_alignment
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! Supported options are: \c mwboost::container::growth_factor and \c mwboost::container::stored_size
template<class ...Options>
using small_vector_options_t = typename mwboost::container::small_vector_options<Options...>::type;
...
//! Helper metafunction to combine options into a single type to be used
//! by \c mwboost::container::static_vector.
//! Supported options are: \c mwboost::container::throw_on_overflow and \c mwboost::container::inplace_alignment
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! Supported options are: \c mwboost::container::growth_factor and \c mwboost::container::stored_size
template<class ...Options>
using static_vector_options_t = typename mwboost::container::static_vector_options<Options...>::type;
...
//!\c mwboost::container::relocate_on_66
//!\c mwboost::container::relocate_on_75
//!\c mwboost::container::relocate_on_80
//!\c mwboost::container::relocate_on_85
//!\c mwboost::container::relocate_on_90
//!
//!If this option is not specified, a default will be used by the container.
//!
...
//! Helper metafunction to combine options into a single type to be used
//! by \c mwboost::container::devector.
//! Supported options are: \c mwboost::container::growth_factor, \c mwboost::container::stored_size
//! and \c mwboost::container::relocate_on
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! Supported options are: \c mwboost::container::growth_factor and \c mwboost::container::stored_size
template<class ...Options>
using devector_options_t = typename mwboost::container::devector_options<Options...>::type;
...
//! Helper metafunction to combine options into a single type to be used
//! by \c mwboost::container::deque.
//! Supported options are: \c mwboost::container::block_bytes
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! Supported options are: \c mwboost::container::block_bytes
template<class ...Options>
using deque_options_t = typename mwboost::container::deque_options<Options...>::type;
