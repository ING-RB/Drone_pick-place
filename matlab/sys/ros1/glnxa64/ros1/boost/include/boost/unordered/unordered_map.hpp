...
namespace mwboost {} namespace boost = mwboost; namespace mwboost {
  namespace unordered {
    ...
    public:
      ...
      typedef typename mwboost::type_identity<H>::type hasher;
      typedef typename mwboost::type_identity<P>::type key_equal;
      typedef typename mwboost::type_identity<A>::type allocator_type;

    private:
      typedef mwboost::unordered::detail::map<A, K, T, H, P> types;
    ...
    public:
      ...
      unordered_map(InputIt, InputIt,
        size_type = mwboost::unordered::detail::default_bucket_count,
  ...
  !defined(BOOST_NO_CXX11_RVALUE_REFERENCES)
      unordered_map(BOOST_RV_REF(unordered_map) other)
        BOOST_NOEXCEPT_IF(table::nothrow_move_constructible)
          : table_(other.table_, mwboost::unordered::detail::move_tag())
      {
...
// Assign
      ...
      {
        table_.assign(x.table_, mwboost::unordered::detail::true_type());
        return *this;
      }
      ...
      {
        table_.move_assign(x.table_, mwboost::unordered::detail::true_type());
        return *this;
      }
#else
...
// emplace
      ...
      std::pair<iterator, bool> emplace(BOOST_FWD_REF(Args)... args)
      {
        return table_.emplace_unique(
          table::extractor::extract(mwboost::forward<Args>(args)...),
          mwboost::forward<Args>(args)...);
      }
      ...
      std::pair<iterator, bool> emplace(
        mwboost::unordered::detail::empty_emplace =
          mwboost::unordered::detail::empty_emplace(),
        value_type v = value_type())
      {
        return this->emplace(mwboost::move(v));
      }
      ...
      {
        return table_.emplace_unique(
          table::extractor::extract(mwboost::forward<A0>(a0)),
          mwboost::unordered::detail::create_emplace_args(
            mwboost::forward<A0>(a0)));
      }
        ...
        BOOST_FWD_REF(A0) a0, BOOST_FWD_REF(A1) a1)
      {
        return table_.emplace_unique(
          table::extractor::extract(
            mwboost::forward<A0>(a0), mwboost::forward<A1>(a1)),
          mwboost::unordered::detail::create_emplace_args(
            mwboost::forward<A0>(a0), mwboost::forward<A1>(a1)));
      }
        ...
        BOOST_FWD_REF(A0) a0, BOOST_FWD_REF(A1) a1, BOOST_FWD_REF(A2) a2)
      {
        return table_.emplace_unique(
          table::extractor::extract(
            mwboost::forward<A0>(a0), mwboost::forward<A1>(a1)),
          mwboost::unordered::detail::create_emplace_args(mwboost::forward<A0>(a0),
            mwboost::forward<A1>(a1), mwboost::forward<A2>(a2)));
      }
      ...
      iterator emplace_hint(const_iterator hint,
        ...
        value_type v = value_type())
      {
        return this->emplace_hint(hint, mwboost::move(v));
      }
...
#undef BOOST_UNORDERED_EMPLACE
      ...
      {
        return this->emplace(mwboost::move(x));
      }

      template <class P2>
      typename mwboost::enable_if<
        mwboost::is_constructible<value_type, BOOST_RV_REF(P2)>,
        std::pair<iterator, bool> >::type insert(BOOST_RV_REF(P2) obj)
      {
        return this->emplace(mwboost::forward<P2>(obj));
      }
      ...
      {
        return this->emplace_hint(hint, mwboost::move(x));
      }

      template <class P2>
      typename mwboost::enable_if<
        mwboost::is_constructible<value_type, BOOST_RV_REF(P2)>, iterator>::type
      insert(const_iterator hint, BOOST_RV_REF(P2) obj)
      {
        return this->emplace_hint(hint, mwboost::forward<P2>(obj));
      }
      ...
      template <class Key>
      typename mwboost::enable_if_c<
        detail::transparent_non_iterable<Key, unordered_map>::value,
        node_type>::type
      extract(BOOST_FWD_REF(Key) k)
      {
        return node_type(table_.extract_by_key_impl(mwboost::forward<Key>(k)),
          table_.node_alloc());
      }
  ...
  (BOOST_COMP_GNUC && BOOST_COMP_GNUC < BOOST_VERSION_NUMBER(4, 6, 0))
    ...
    public:
      ...
      {
        return table_.try_emplace_unique(k, mwboost::forward<Args>(args)...);
      }
        ...
        BOOST_RV_REF(key_type) k, BOOST_FWD_REF(Args)... args)
      {
        return table_.try_emplace_unique(
          mwboost::move(k), mwboost::forward<Args>(args)...);
      }
        ...
        const_iterator hint, key_type const& k, BOOST_FWD_REF(Args)... args)
      {
        return table_.try_emplace_hint_unique(
          hint, k, mwboost::forward<Args>(args)...);
      }
      ...
      {
        return table_.try_emplace_hint_unique(
          hint, mwboost::move(k), mwboost::forward<Args>(args)...);
      }
      ...
      {
        return table_.try_emplace_unique(mwboost::forward<Key>(k));
      }
      ...
      {
        return table_.try_emplace_hint_unique(hint, mwboost::forward<Key>(k));
      }
      ...
      {
        return table_.try_emplace_unique(
          k, mwboost::unordered::detail::create_emplace_args(
               mwboost::forward<A0>(a0)));
      }
      ...
      {
        return table_.try_emplace_unique(
          mwboost::move(k), mwboost::unordered::detail::create_emplace_args(
                            mwboost::forward<A0>(a0)));
      }
      ...
      std::pair<iterator, bool> try_emplace(BOOST_RV_REF(key_type) k,
        BOOST_FWD_REF(A0) a0, BOOST_FWD_REF(A1) a1, BOOST_FWD_REF(A2) a2)
      {
        return table_.try_emplace_unique(mwboost::move(k),
          mwboost::unordered::detail::create_emplace_args(mwboost::forward<A0>(a0),
            mwboost::forward<A1>(a1), mwboost::forward<A2>(a2)));
      }
      ...
      {
        return table_.try_emplace_hint_unique(
          hint, k, mwboost::unordered::detail::create_emplace_args(
                     mwboost::forward<A0>(a0)));
      }
      ...
      {
        return table_.try_emplace_hint_unique(
          hint, mwboost::move(k), mwboost::unordered::detail::create_emplace_args(
                                  mwboost::forward<A0>(a0)));
      }
      ...
      iterator try_emplace(const_iterator hint, BOOST_RV_REF(key_type) k,
        BOOST_FWD_REF(A0) a0, BOOST_FWD_REF(A1) a1)
      {
        return table_.try_emplace_hint_unique(hint, mwboost::move(k),
          mwboost::unordered::detail::create_emplace_args(
            mwboost::forward<A0>(a0), mwboost::forward<A1>(a1)));
      }
...
#undef BOOST_UNORDERED_TRY_EMPLACE
      ...
      {
        return table_.insert_or_assign_unique(k, mwboost::forward<M>(obj));
      }
        ...
        BOOST_RV_REF(key_type) k, BOOST_FWD_REF(M) obj)
      {
        return table_.insert_or_assign_unique(
          mwboost::move(k), mwboost::forward<M>(obj));
      }
      ...
      {
        return table_.insert_or_assign_unique(k, mwboost::forward<M>(obj)).first;
      }
      ...
      {
        return table_
          .insert_or_assign_unique(mwboost::move(k), mwboost::forward<M>(obj))
          .first;
      }
      ...
      {
        return table_.erase_key_unique_impl(mwboost::forward<Key>(k));
      }
      ...
      void merge(mwboost::unordered_map<K, T, H2, P2, A>& source);
      ...
      template <typename H2, typename P2>
      void merge(mwboost::unordered_multimap<K, T, H2, P2, A>& source);
      ...
      template <class Key>
      typename mwboost::enable_if_c<detail::are_transparent<Key, H, P>::value,
        iterator>::type
      find(const Key& key)
      {
    ...
    template <class InputIterator,
      class Hash =
        mwboost::hash<mwboost::unordered::detail::iter_key_t<InputIterator> >,
      class Pred =
        std::equal_to<mwboost::unordered::detail::iter_key_t<InputIterator> >,
      class Allocator = std::allocator<
        mwboost::unordered::detail::iter_to_alloc_t<InputIterator> >,
      class = mwboost::enable_if_t<detail::is_input_iterator_v<InputIterator> >,
      class = mwboost::enable_if_t<detail::is_hash_v<Hash> >,
      class = mwboost::enable_if_t<detail::is_pred_v<Pred> >,
      class = mwboost::enable_if_t<detail::is_allocator_v<Allocator> > >
    unordered_map(InputIterator, InputIterator,
      std::size_t = mwboost::unordered::detail::default_bucket_count,
      Hash = Hash(), Pred = Pred(), Allocator = Allocator())
      -> unordered_map<mwboost::unordered::detail::iter_key_t<InputIterator>,
        mwboost::unordered::detail::iter_val_t<InputIterator>, Hash, Pred,
        Allocator>;

    template <class Key, class T,
      class Hash = mwboost::hash<mwboost::remove_const_t<Key> >,
      class Pred = std::equal_to<mwboost::remove_const_t<Key> >,
    ...
    unordered_map(std::initializer_list<std::pair<Key, T> >,
      std::size_t = mwboost::unordered::detail::default_bucket_count,
      Hash = Hash(), Pred = Pred(), Allocator = Allocator())
      -> unordered_map<mwboost::remove_const_t<Key>, T, Hash, Pred, Allocator>;
    ...
    unordered_map(InputIterator, InputIterator, std::size_t, Allocator)
      -> unordered_map<mwboost::unordered::detail::iter_key_t<InputIterator>,
        mwboost::unordered::detail::iter_val_t<InputIterator>,
        mwboost::hash<mwboost::unordered::detail::iter_key_t<InputIterator> >,
        std::equal_to<mwboost::unordered::detail::iter_key_t<InputIterator> >,
        Allocator>;
    ...
    unordered_map(InputIterator, InputIterator, std::size_t, Hash, Allocator)
      -> unordered_map<mwboost::unordered::detail::iter_key_t<InputIterator>,
        mwboost::unordered::detail::iter_val_t<InputIterator>, Hash,
        std::equal_to<mwboost::unordered::detail::iter_key_t<InputIterator> >,
        Allocator>;
    ...
    unordered_map(std::initializer_list<std::pair<Key, T> >, std::size_t,
      Allocator) -> unordered_map<mwboost::remove_const_t<Key>, T,
      mwboost::hash<mwboost::remove_const_t<Key> >,
      std::equal_to<mwboost::remove_const_t<Key> >, Allocator>;

    template <class Key, class T, class Allocator,
      class = mwboost::enable_if_t<detail::is_allocator_v<Allocator> > >
    unordered_map(std::initializer_list<std::pair<Key, T> >, Allocator)
      -> unordered_map<mwboost::remove_const_t<Key>, T,
        mwboost::hash<mwboost::remove_const_t<Key> >,
        std::equal_to<mwboost::remove_const_t<Key> >, Allocator>;
    ...
    unordered_map(std::initializer_list<std::pair<Key, T> >, std::size_t, Hash,
      Allocator) -> unordered_map<mwboost::remove_const_t<Key>, T, Hash,
      std::equal_to<mwboost::remove_const_t<Key> >, Allocator>;
...
// Assign
      ...
      {
        table_.assign(x.table_, mwboost::unordered::detail::false_type());
        return *this;
      }
      ...
      unordered_multimap& operator=(BOOST_RV_REF(unordered_multimap) x)
        BOOST_NOEXCEPT_IF(value_allocator_traits::is_always_equal::value&&
            mwboost::is_nothrow_move_assignable<H>::value&&
              mwboost::is_nothrow_move_assignable<P>::value)
      {
        table_.move_assign(x.table_, mwboost::unordered::detail::false_type());
        return *this;
      }
#else
...
// emplace
      ...
      template <class... Args> iterator emplace(BOOST_FWD_REF(Args)... args)
      {
        return iterator(table_.emplace_equiv(
          mwboost::unordered::detail::func::construct_node_from_args(
            table_.node_alloc(), mwboost::forward<Args>(args)...)));
      }
      ...
      iterator emplace(mwboost::unordered::detail::empty_emplace =
                         mwboost::unordered::detail::empty_emplace(),
        value_type v = value_type())
      {
        return this->emplace(mwboost::move(v));
      ...
      template <typename A0> iterator emplace(BOOST_FWD_REF(A0) a0)
      {
        return iterator(table_.emplace_equiv(
          mwboost::unordered::detail::func::construct_node_from_args(
            table_.node_alloc(), mwboost::unordered::detail::create_emplace_args(
                                   mwboost::forward<A0>(a0)))));
      }
      ...
      iterator emplace_hint(const_iterator hint, BOOST_FWD_REF(Args)... args)
      {
        return iterator(table_.emplace_hint_equiv(
          hint, mwboost::unordered::detail::func::construct_node_from_args(
                  table_.node_alloc(), mwboost::forward<Args>(args)...)));
      }
...
#undef BOOST_UNORDERED_EMPLACE
  ...
  (BOOST_COMP_GNUC && BOOST_COMP_GNUC < BOOST_VERSION_NUMBER(4, 6, 0))
    ...
    public:
      ...
      erase(BOOST_FWD_REF(Key) k)
      {
        return table_.erase_key_equiv_impl(mwboost::forward<Key>(k));
      }
    ...
    unordered_multimap(InputIterator, InputIterator,
      std::size_t = mwboost::unordered::detail::default_bucket_count,
      Hash = Hash(), Pred = Pred(), Allocator = Allocator())
      -> unordered_multimap<mwboost::unordered::detail::iter_key_t<InputIterator>,
        mwboost::unordered::detail::iter_val_t<InputIterator>, Hash, Pred,
        Allocator>;
    ...
    unordered_multimap(std::initializer_list<std::pair<Key, T> >,
      std::size_t = mwboost::unordered::detail::default_bucket_count,
      Hash = Hash(), Pred = Pred(), Allocator = Allocator())
      -> unordered_multimap<mwboost::remove_const_t<Key>, T, Hash, Pred,
        Allocator>;
    ...
    unordered_multimap(std::initializer_list<std::pair<Key, T> >, std::size_t,
      Allocator) -> unordered_multimap<mwboost::remove_const_t<Key>, T,
      mwboost::hash<mwboost::remove_const_t<Key> >,
      std::equal_to<mwboost::remove_const_t<Key> >, Allocator>;
    ...
    unordered_multimap(std::initializer_list<std::pair<Key, T> >, Allocator)
      -> unordered_multimap<mwboost::remove_const_t<Key>, T,
        mwboost::hash<mwboost::remove_const_t<Key> >,
        std::equal_to<mwboost::remove_const_t<Key> >, Allocator>;
    ...
    template <class Key, class T, class Hash, class Allocator,
      ...
      class = mwboost::enable_if_t<detail::is_allocator_v<Allocator> > >
    unordered_multimap(std::initializer_list<std::pair<Key, T> >, std::size_t,
      Hash, Allocator) -> unordered_multimap<mwboost::remove_const_t<Key>, T,
      Hash, std::equal_to<mwboost::remove_const_t<Key> >, Allocator>;
    ...
    unordered_map<K, T, H, P, A>::unordered_map(InputIt f, InputIt l,
      ...
      const allocator_type& a)
        : table_(mwboost::unordered::detail::initial_size(f, l, n), hf, eql, a)
    {
      this->insert(f, l);
    }
              ...
              select_on_container_copy_construction(other.get_allocator()))
    {
      if (other.size()) {
        table_.copy_buckets(
          other.table_, mwboost::unordered::detail::true_type());
      }
    }

    template <class K, class T, class H, class P, class A>
    unordered_map<K, T, H, P, A>::unordered_map(allocator_type const& a)
        : table_(mwboost::unordered::detail::default_bucket_count, hasher(),
            key_equal(), a)
    {
    }
    ...
    unordered_map<K, T, H, P, A>::unordered_map(
      BOOST_RV_REF(unordered_map) other, allocator_type const& a)
        : table_(other.table_, a, mwboost::unordered::detail::move_tag())
    {
    ...
    unordered_map<K, T, H, P, A>::unordered_map(
      ...
      const key_equal& eql, const allocator_type& a)
        : table_(
            mwboost::unordered::detail::initial_size(list.begin(), list.end(), n),
            hf, eql, a)
    {
    ...
    unordered_map<K, T, H, P, A>::unordered_map(
      InputIterator f, InputIterator l, const allocator_type& a)
        : table_(mwboost::unordered::detail::initial_size(
    ...
    unordered_map<K, T, H, P, A>::unordered_map(
      InputIt f, InputIt l, size_type n, const allocator_type& a)
        : table_(mwboost::unordered::detail::initial_size(f, l, n), hasher(),
            key_equal(), a)
    {
      this->insert(f, l);
    }
    ...
    unordered_map<K, T, H, P, A>::unordered_map(InputIt f, InputIt l,
      size_type n, const hasher& hf, const allocator_type& a)
        : table_(
            mwboost::unordered::detail::initial_size(f, l, n), hf, key_equal(), a)
    {
      this->insert(f, l);
    }
    ...
    std::size_t unordered_map<K, T, H, P, A>::max_size() const BOOST_NOEXCEPT
    {
      ...
      // size <= mlf_ * count
      return mwboost::unordered::detail::double_to_size(
    ...
    void unordered_map<K, T, H, P, A>::merge(
      mwboost::unordered_map<K, T, H2, P2, A>& source)
    {
    ...
    template <typename H2, typename P2>
    void unordered_map<K, T, H, P, A>::merge(
      mwboost::unordered_multimap<K, T, H2, P2, A>& source)
    {
      table_.merge_unique(source.table_);
    }
    ...
    {
      return table_.try_emplace_unique(mwboost::move(k)).first->second;
    }
              ...
              select_on_container_copy_construction(other.get_allocator()))
    {
      if (other.table_.size_) {
        table_.copy_buckets(
          other.table_, mwboost::unordered::detail::false_type());
      }
    }
    ...
    template <typename N, class K, class T, class A> class node_handle_map
    {
      ...
      template <typename Types> friend struct ::mwboost::unordered::detail::table;
      template <class K2, class T2, class H2, class P2, class A2>
      friend class mwboost::unordered::unordered_map;
      template <class K2, class T2, class H2, class P2, class A2>
      friend class mwboost::unordered::unordered_multimap;

      typedef typename mwboost::allocator_rebind<A, std::pair<K const, T> >::type
        value_allocator;

      typedef N node;
      typedef typename mwboost::allocator_rebind<A, node>::type node_allocator;

      typedef
        typename mwboost::allocator_pointer<node_allocator>::type node_pointer;
    ...
    private:
      node_pointer ptr_;
      mwboost::unordered::detail::optional<value_allocator> alloc_;
    ...
    public:
      ...
      ~node_handle_map()
      {
        if (ptr_) {
          ...
          mwboost::unordered::detail::node_tmp<node_allocator> tmp(
            ptr_, node_alloc);
        }
      }
      ...
      void swap(node_handle_map& n) BOOST_NOEXCEPT_IF(
        mwboost::allocator_propagate_on_container_swap<
          value_allocator>::type::value ||
        mwboost::allocator_is_always_equal<value_allocator>::type::value)
      {
        ...
        BOOST_ASSERT(!alloc_.has_value() || !n.alloc_.has_value() ||
                     mwboost::allocator_propagate_on_container_swap<
                       value_allocator>::type::value ||
                     alloc_ == n.alloc_);
        if (mwboost::allocator_propagate_on_container_swap<
              value_allocator>::type::value ||
            !alloc_.has_value() || !n.alloc_.has_value()) {
          mwboost::swap(alloc_, n.alloc_);
        }
        mwboost::swap(ptr_, n.ptr_);
      }
    };
    ...
    private:
      ...
      // typedef typename mwboost::allocator_rebind<A,
    ...
    {
      mwboost::swap(x.node, y.node);
      mwboost::swap(x.inserted, y.inserted);
      mwboost::swap(x.position, y.position);
    }
  } // namespace unordered
} // namespace mwboost
