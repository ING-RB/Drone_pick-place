...
/*
  ...
  the mwboost::signals2::signal class.
  ...
  namespace signals2
  {
    ...
    class signal_type
    {
      typedef parameter::parameters<
          parameter::required<keywords::tag::signature_type, is_function<mwboost::mpl::_> >,
    ...
    public:
      ...
      typedef typename parameter::value_type
        <
          ...
          optional_last_value
            <
              typename mwboost::function_traits<signature_type>::result_type
            >
        >::type combiner_type;
