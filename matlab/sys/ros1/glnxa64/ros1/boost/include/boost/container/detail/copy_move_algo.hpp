...
template<class It>
struct are_elements_contiguous< ::mwboost::move_iterator<It> >
...
template <class Pointer, bool IsConst>
struct are_elements_contiguous<mwboost::container::vec_iterator<Pointer, IsConst> >
{
   static const bool value = true;
};
...
template <class PointedType, class DifferenceType, class OffsetType, std::size_t OffsetAlignment>
struct are_elements_contiguous< ::mwboost::interprocess::offset_ptr<PointedType, DifferenceType, OffsetType, OffsetAlignment> >
{
   static const bool value = true;
};
...
struct are_contiguous_and_same
   : mwboost::move_detail::and_
      ...
      , is_same< typename remove_const< typename ::mwboost::container::iter_value<I>::type >::type
               , typename ::mwboost::container::iterator_traits<O>::value_type
               >
      >
{};
...
struct is_memtransfer_copy_assignable
   : mwboost::move_detail::and_
      ...
      , dtl::is_trivially_copy_assignable< typename ::mwboost::container::iter_value<I>::type >
      >
{};
...
struct is_memtransfer_copy_constructible
   : mwboost::move_detail::and_
      < are_contiguous_and_same<I, O>
      , dtl::is_trivially_copy_constructible< typename ::mwboost::container::iter_value<I>::type >
      >
{};
...
{
   typedef typename mwboost::container::iter_value<I>::type      value_type;
   typedef typename mwboost::container::iterator_traits<F>::difference_type r_difference_type;
   value_type *const dest_raw = mwboost::movelib::iterator_to_raw_pointer(r);
   const value_type *const beg_raw = mwboost::movelib::iterator_to_raw_pointer(f);
   const value_type *const end_raw = mwboost::movelib::iterator_to_raw_pointer(l);
...
BOOST_CONTAINER_FORCEINLINE F memmove_n(I f, std::size_t n, F r) BOOST_NOEXCEPT_OR_NOTHROW
{
   ...
   typedef typename mwboost::container::iterator_traits<F>::difference_type r_difference_type;
   if(BOOST_LIKELY(n != 0)){
      void *dst = mwboost::movelib::iterator_to_raw_pointer(r);
      const void *src = mwboost::movelib::iterator_to_raw_pointer(f);
      if (dst && src)
...
BOOST_CONTAINER_FORCEINLINE I memmove_n_source(I f, std::size_t n, F r) BOOST_NOEXCEPT_OR_NOTHROW
{
   if(BOOST_LIKELY(n != 0)){
      typedef typename mwboost::container::iter_value<I>::type value_type;
      typedef typename mwboost::container::iterator_traits<I>::difference_type i_difference_type;
      void *dst = mwboost::movelib::iterator_to_raw_pointer(r);
      const void *src = mwboost::movelib::iterator_to_raw_pointer(f);
      if (dst && src)
         std::memmove(dst, src, sizeof(value_type)*n);
...
{
   typedef typename mwboost::container::iter_value<I>::type value_type;
   typedef typename mwboost::container::iterator_traits<F>::difference_type i_difference_type;
   typedef typename mwboost::container::iterator_traits<F>::difference_type f_difference_type;
...
{
   typedef typename ::mwboost::container::iterator_traits<O>::value_type value_type;
...
struct enable_if_trivially_destructible
   : enable_if_c < dtl::is_trivially_destructible
                  <typename mwboost::container::iter_value<I>::type>::value
               , R>
{};
...
//!   \code
//!   for (; f != l; ++r, ++f)
//!      allocator_traits::construct(a, &*r, mwboost::move(*f));
//!   \endcode
//!
//! <b>Returns</b>: r
template
   ...
   uninitialized_move_alloc(Allocator &a, I f, I l, F r)
{
   ...
   BOOST_TRY{
      while (f != l) {
         allocator_traits<Allocator>::construct(a, mwboost::movelib::iterator_to_raw_pointer(r), mwboost::move(*f));
         ++f; ++r;
      }
   }
   BOOST_CATCH(...){
      for (; back != r; ++back){
         allocator_traits<Allocator>::destroy(a, mwboost::movelib::iterator_to_raw_pointer(back));
      }
      BOOST_RETHROW;
   }
   BOOST_CATCH_END
   ...
   uninitialized_copy_alloc(Allocator &a, I f, I l, F r)
{
   ...
   BOOST_TRY{
      while (f != l) {
         allocator_traits<Allocator>::construct(a, mwboost::movelib::iterator_to_raw_pointer(r), *f);
         ++f; ++r;
      }
   }
   BOOST_CATCH(...){
   ...
   uninitialized_copy_alloc_n_source(Allocator &a, I f, std::size_t n, F r)
{
   ...
   BOOST_TRY{
      while (n) {
         mwboost::container::construct_in_place(a, mwboost::movelib::iterator_to_raw_pointer(r), f);
         ++f; ++r; --n;
      }
   }
   BOOST_CATCH(...){
   ...
   uninitialized_value_init_alloc_n(Allocator &a, std::size_t n, F r)
{
   ...
   BOOST_TRY{
      while (n) {
         --n;
         allocator_traits<Allocator>::construct(a, mwboost::movelib::iterator_to_raw_pointer(r));
         ++r;
      }
   }
   BOOST_CATCH(...){
...
{
   typedef typename mwboost::container::iterator_traits<F>::value_type value_type;
   typedef typename mwboost::container::iterator_traits<F>::difference_type r_difference_type;

   if (BOOST_LIKELY(n != 0)){
      std::memset((void*)mwboost::movelib::iterator_to_raw_pointer(r), 0, sizeof(value_type)*n);
      r += static_cast<r_difference_type>(n);
   }
   return r;
}
...
inline F uninitialized_default_init_alloc_n(Allocator &a, std::size_t n, F r)
{
   ...
   BOOST_TRY{
      while (n) {
         --n;
         allocator_traits<Allocator>::construct(a, mwboost::movelib::iterator_to_raw_pointer(r), default_init);
         ++r;
      }
   }
   BOOST_CATCH(...){
...
inline void uninitialized_fill_alloc(Allocator &a, F f, F l, const T &t)
{
   ...
   BOOST_TRY{
      while (f != l) {
         allocator_traits<Allocator>::construct(a, mwboost::movelib::iterator_to_raw_pointer(f), t);
         ++f;
      }
   }
   BOOST_CATCH(...){
...
inline F uninitialized_fill_alloc_n(Allocator &a, const T &v, std::size_t n, F r)
{
   ...
   BOOST_TRY{
      while (n) {
         --n;
         allocator_traits<Allocator>::construct(a, mwboost::movelib::iterator_to_raw_pointer(r), v);
         ++r;
      }
   }
   BOOST_CATCH(...){
   ...
   copy_n_source(I f, U n, F r)
{
   while (n) {
      --n;
      mwboost::container::assign_in_place(r, f);
      ++f; ++r;
   }
   return f;
}
...
{
   typedef typename mwboost::container::iter_value<I>::type value_type;
   const std::size_t n = mwboost::container::iterator_udistance(f, l);
   if (BOOST_LIKELY(n != 0)){
      r -= n;
      std::memmove((mwboost::movelib::iterator_to_raw_pointer)(r), (mwboost::movelib::iterator_to_raw_pointer)(f), sizeof(value_type)*n);
   }
   return r;
}
   ...
   destroy_alloc_n(Allocator &a, I f, U n)
{
   while(n){
      --n;
      allocator_traits<Allocator>::destroy(a, mwboost::movelib::iterator_to_raw_pointer(f));
      ++f;
   }
}
   ...
   deep_swap_alloc_n( Allocator &a, F short_range_f, std::size_t  n_i, G large_range_f, std::size_t n_j)
{
   ...
   for (; n != n_i ; ++short_range_f, ++large_range_f, ++n){
      mwboost::adl_move_swap(*short_range_f, *large_range_f);
   }
   mwboost::container::uninitialized_move_alloc_n(a, large_range_f, std::size_t(n_j - n_i), short_range_f);  // may throw
   mwboost::container::destroy_alloc_n(a, large_range_f, std::size_t(n_j - n_i));
}
   ...
   deep_swap_alloc_n( Allocator &a, F short_range_f, std::size_t n_i, G large_range_f, std::size_t n_j)
{
   ...
   void *const large_ptr = static_cast<void*>(mwboost::movelib::iterator_to_raw_pointer(large_range_f));
   void *const short_ptr = static_cast<void*>(mwboost::movelib::iterator_to_raw_pointer(short_range_f));
   void *const stora_ptr = static_cast<void*>(mwboost::movelib::iterator_to_raw_pointer(storage.data));
   std::memcpy(stora_ptr, large_ptr, n_i_bytes);
   std::memcpy(large_ptr, short_ptr, n_i_bytes);
   std::memcpy(short_ptr, stora_ptr, n_i_bytes);
   mwboost::container::iterator_uadvance(large_range_f, n_i);
   mwboost::container::iterator_uadvance(short_range_f, n_i);
   mwboost::container::uninitialized_move_alloc_n(a, large_range_f, std::size_t(n_j - n_i), short_range_f);  // may throw
   mwboost::container::destroy_alloc_n(a, large_range_f, std::size_t(n_j - n_i));
}
   ...
   deep_swap_alloc_n( Allocator &a, F short_range_f, std::size_t n_i, G large_range_f, std::size_t n_j)
{
   ...
   char *large_ptr = static_cast<char*>(static_cast<void*>(mwboost::movelib::iterator_to_raw_pointer(large_range_f)));
   char *short_ptr = static_cast<char*>(static_cast<void*>(mwboost::movelib::iterator_to_raw_pointer(short_range_f)));
...
{
   if (n_o < n_i){
      inp_start = mwboost::container::copy_n_source_dest(inp_start, n_o, out_start);     // may throw
      mwboost::container::uninitialized_copy_alloc_n(a, inp_start, std::size_t(n_i - n_o), out_start);// may throw
   }
   else{
      out_start = mwboost::container::copy_n(inp_start, n_i, out_start);  // may throw
      mwboost::container::destroy_alloc_n(a, out_start, std::size_t(n_o - n_i));
   }
}
...
{
   if (n_o < n_i){
      inp_start = mwboost::container::move_n_source_dest(inp_start, n_o, out_start);  // may throw
      mwboost::container::uninitialized_move_alloc_n(a, inp_start, std::size_t(n_i - n_o), out_start);  // may throw
   }
   else{
      out_start = mwboost::container::move_n(inp_start, n_i, out_start);  // may throw
      mwboost::container::destroy_alloc_n(a, out_start, std::size_t(n_o - n_i));
   }
}
...
{
   typedef typename ::mwboost::container::allocator_traits<Allocator>::value_type value_type;
   ...
   , InsertionProxy insertion_proxy)
{
   ...
   O d_last = ::mwboost::container::uninitialized_move_alloc(a, first, pos, d_first);
   ...
   (void) ::mwboost::container::uninitialized_move_alloc(a, pos, last, d_last);
   ...
   , InsertionProxy insertion_proxy)
{
   ...
   F aux = first;   --aux;
   allocator_traits<Allocator>::construct(a, mwboost::movelib::iterator_to_raw_pointer(aux), mwboost::move(*first));
   value_destructor_t on_exception(a, mwboost::movelib::iterator_to_raw_pointer(aux));
   //Copy previous to last objects to the initialized end
   aux = first; ++aux;
   aux = mwboost::container::move(aux, pos, first);
   ...
   , InsertionProxy insertion_proxy)
{
   ...
   if(elems_before >= n){
      ...
      F nxt = ::mwboost::container::uninitialized_move_alloc_n_source(a, first, n, first_less_n);
      array_destructor_t on_exception(first_less_n, first, a);
      //Copy previous to last objects to the initialized end
      nxt = mwboost::container::move(nxt, pos, first);
      //Insert new objects in the pos
      ...
      F aux = ::mwboost::container::uninitialized_move_alloc(a, first, pos, first - n);
   ...
   , InsertionProxy insertion_proxy)
{
   ...
   allocator_traits<Allocator>::construct(a, mwboost::movelib::iterator_to_raw_pointer(last), mwboost::move(*last_m_n));
   value_destructor_t on_exception(a, mwboost::movelib::iterator_to_raw_pointer(last));
   //Copy previous to last objects to the initialized end
   mwboost::container::move_backward(pos, last_m_n, last);
   //Insert new objects in the pos
   ...
   , InsertionProxy insertion_proxy)
{
   ...
   if(elems_after >= n){
      ...
      F const nxt = ::mwboost::container::uninitialized_move_alloc_n(a, last_m_n, n, last);
      ...
      //The new elements don't fit in the [pos, end()) range.
      //Copy old [pos, end()) elements to the uninitialized memory (a gap is created)
      F new_last = ::mwboost::container::uninitialized_move_alloc(a, pos, last, pos + n);
...
, Allocator& a)
{
   ...
   if (raw_before >= before_plus_new) {
      ...
      B const new_elem_pos = ::mwboost::container::uninitialized_move_alloc(a, old_start, pos, new_start);
      ...
      if (raw_before >= new_size) {
         ...
         if (before_plus_new != new_size) { //Special case to avoid operations in back insertion
            ...
            ::mwboost::container::uninitialized_move_alloc(a, pos, old_finish, new_start_end);
         }
      ...
      //raw_before is so big that divides old_end
         ...
         BOOST_IF_CONSTEXPR(!trivial_dctr) {
            ...
            ::mwboost::container::uninitialized_move_alloc_n(a, pos, raw_gap, new_start_plus);
            new_values_destroyer.release();
            ...
            remaining_pos = ::mwboost::container::move_forward_overlapping(remaining_pos, old_finish, old_start);
            (void)remaining_pos;
            //Once moved, avoid calling the destructors if trivial after move
            if(!trivial_dctr_after_move) {
               mwboost::container::destroy_alloc(a, remaining_pos, old_finish);
            }
         }
      ...
      if (raw_before <= elemsbefore) {
         ...
         ::mwboost::container::uninitialized_move_alloc_n(a, old_start, raw_before, new_start);
         ...
         B const next = ::mwboost::container::move(old_next, pos, old_start);
         ...
         if (!do_after) {
            ...
            B const p = ::mwboost::container::move_forward_overlapping(pos, old_finish, new_first);
            (void)p;
            if(!trivial_dctr_after_move)
               mwboost::container::destroy_alloc(a, p, old_finish);
         }
      }
      else {
         ...
         B const new_pos = ::mwboost::container::uninitialized_move_alloc(a, old_start, pos, new_start);
         array_destructor_t new_values_destroyer(new_start, a, elemsbefore);
         ...
         if (do_after) {
            ...
            B const move_end = ::mwboost::container::move_forward_overlapping(pos, old_finish, move_start);
            ...
            if(!trivial_dctr_after_move) {
               mwboost::container::destroy_alloc(a, move_end, old_finish);
            }
         }
      }
      ...
      if (do_after) {
         ...
         if (elemsafter >= n_after) {
            ...
            ::mwboost::container::uninitialized_move_alloc(a, finish_n, old_finish, old_finish);
            old_values_destroyer.increment_size(n_after);
            //Displace the rest of old_end to the new position
            mwboost::container::move_backward_overlapping(pos, finish_n, old_finish);
            ...
            ::mwboost::container::uninitialized_move_alloc(a, pos, old_finish, mid_last);
   ...
   , Allocator& a)
{
   ...
   if (raw_after >= after_plus_new) {
      ...
      ::mwboost::container::uninitialized_move_alloc(a, pos, old_finish, new_elem_pos+n);
      ...
      if (raw_after >= new_size) {
         ...
         //
         //Now initialize the rest of memory with the last old values
         ::mwboost::container::uninitialized_move_alloc(a, old_start, pos, new_start);
         //All new elements correctly constructed, avoid new element destruction
         new_values_destroyer.release();
         //Old values destroyed automatically with "old_values_destroyer"
         //when "old_values_destroyer" goes out of scope unless the have trivial
      ...
      //raw_before is so big that divides old_end
         ...
         ::mwboost::container::uninitialized_move_alloc_n(a, pre_pos_raw, raw_gap, old_finish);
         new_values_destroyer.release();
         old_values_destroyer.increment_size(raw_after);
         //Now move remaining last objects in the old buffer begin
         BOOST_ASSERT(old_start != old_finish);
         mwboost::container::move_backward_overlapping(old_start, pre_pos_raw, old_finish);
         old_values_destroyer.release();
         if (!trivial_dctr_after_move) {
            mwboost::container::destroy_alloc(a, old_start, new_start);
         }
      }
   }
   else{
      ...
      if (raw_after > elemsafter) {
         ...
         ::mwboost::container::uninitialized_move_alloc(a, pos, old_finish, p);
         ...
         //Displace old_end, but make sure data has to be moved
         p = ::mwboost::container::move_backward_overlapping(old_start, pos, new_rng_start);

         //Destroy remaining moved elements from old_begin except if they
         //have trivial destructor after being moved
         old_values_destroyer.release();
         if (!trivial_dctr_after_move) {
            mwboost::container::destroy_alloc(a, old_start, p);
         }
      }
      else {
         ...
         ::mwboost::container::uninitialized_move_alloc_n(a, old_end_pivot, raw_after, old_finish);
         //The buffer is all constructed
         old_values_destroyer.increment_size_backwards(raw_after);

         //Now copy the first part of old_end overwriting itself
         B const new_end_pos = ::mwboost::container::move_backward_overlapping(pos, old_end_pivot, old_finish);
         B const new_beg_pos = new_end_pos - n;

         //Now copy the new_beg elements
         insertion_proxy.copy_n_and_update(a, new_beg_pos, n);
         B const p = ::mwboost::container::move_backward_overlapping(old_start, pos, new_beg_pos);
         old_values_destroyer.release();
