...
struct mp_valid_impl
{
    ...
    static mwboost::true_type check_s(int);

    template<template<class...> class>
    static mwboost::false_type check_s(...);
...
template<template<class...> class F, class... T> using mp_defer = typename mwboost::conditional<mp_valid<F, T...>::value, mp_defer_impl<F, T...>, mp_empty>::type;
