...
namespace mwboost {} namespace boost = mwboost; namespace mwboost
{
            ...
            for(;;)
            {
                ...
                for(;;)
                {
                    ...
                    if(new_state.exclusive || new_state.exclusive_waiting_blocked)
                    {
                        ...
                        {
                            mwboost::throw_exception(mwboost::lock_error());
                        }
                    }
                    else
                    {
                ...
                BOOST_VERIFY(winapi::WaitForSingleObjectEx(semaphores[unlock_sem],::mwboost::detail::win32::infinite,0)==0);
            }
        }
    ...
    public:
        ...
        bool timed_lock_shared(mwboost::system_time const& wait_until)
        {
        ...
        void lock()
        {
            for(;;)
            {
                ...
                #endif
                BOOST_VERIFY(winapi::WaitForMultipleObjectsEx(2,semaphores,wait_all,::mwboost::detail::win32::infinite,0)<2);
            }
        }
...
#if defined BOOST_THREAD_USES_DATETIME
        bool timed_lock(mwboost::system_time const& wait_until)
        {
            const detail::real_platform_timepoint t(wait_until);
