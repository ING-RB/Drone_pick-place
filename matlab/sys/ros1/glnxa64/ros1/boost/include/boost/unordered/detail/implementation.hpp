...
namespace mwboost {} namespace boost = mwboost; namespace mwboost {
  namespace unordered {
    namespace detail {
      ...
      template <typename I>
      struct is_forward : mwboost::is_base_of<std::forward_iterator_tag,
      ...
      struct enable_if_forward
        : mwboost::enable_if_c<mwboost::unordered::detail::is_forward<I>::value,
            ReturnType>
      {
      };
      ...
      struct disable_if_forward
        : mwboost::disable_if_c<mwboost::unordered::detail::is_forward<I>::value,
            ReturnType>
      {
      };
    }
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost {
  namespace unordered {
    namespace detail {
      ...
      template <class I>
      inline typename mwboost::unordered::detail::enable_if_forward<I,
        std::size_t>::type
      insert_size(I i, I j)
      {
      ...
      template <class I>
      inline typename mwboost::unordered::detail::disable_if_forward<I,
      ...
      inline std::size_t initial_size(I i, I j,
        std::size_t num_buckets =
          mwboost::unordered::detail::default_bucket_count)
      {
        return (std::max)(
          mwboost::unordered::detail::insert_size(i, j), num_buckets);
      }
      ...
      struct compressed_base : mwboost::empty_value<T>
      {
        compressed_base(T const& x) : empty_value<T>(mwboost::empty_init_t(), x)
        {
        }
        compressed_base(T& x, move_tag)
            : empty_value<T>(mwboost::empty_init_t(), mwboost::move(x))
        {
        }
      ...
      template <typename T, int Index>
      struct generate_base : mwboost::unordered::detail::compressed_base<T, Index>
      {
      ...
      struct compressed
        : private mwboost::unordered::detail::generate_base<T1, 1>::type,
          private mwboost::unordered::detail::generate_base<T2, 2>::type
      {
        ...
        {
          first() = mwboost::move(x.first());
          second() = mwboost::move(x.second());
        }

        void swap(compressed& x)
        {
          mwboost::swap(first(), x.first());
          mwboost::swap(second(), x.second());
        }
...
// will be default-initialized.
      ...
      template <typename T>
      typename mwboost::add_lvalue_reference<T>::type make();
      struct choice9
      {
        typedef char (&type)[9];
      };
...
#define BOOST_UNORDERED_EMPLACE_FORWARD mwboost::forward<Args>(args)...
...
#define BOOST_UNORDERED_EARGS_MEMBER(z, n, _)                                  \
  typedef typename mwboost::add_lvalue_reference<BOOST_PP_CAT(A, n)>::type       \
    BOOST_PP_CAT(Arg, n);                                                      \
  BOOST_PP_CAT(Arg, n) BOOST_PP_CAT(a, n);
...
#define BOOST_UNORDERED_CALL_FORWARD(z, i, a)                                  \
  mwboost::forward<BOOST_PP_CAT(A, i)>(BOOST_PP_CAT(a, i))
...
// Uses the standard versions if available.
      ...
      typedef mwboost::unordered::detail::integral_constant<bool, true> true_type;
      typedef mwboost::unordered::detail::integral_constant<bool, false>
        false_type;
...
#pragma warning(pop)
      ...
      template <typename ValueType> struct value_base
      {
        ...
        typename mwboost::aligned_storage<sizeof(value_type),
          mwboost::alignment_of<value_type>::value>::type data_;
      ...
      template <typename T> class optional
      {
        ...
        mwboost::unordered::detail::value_base<T> value_;
        bool has_value_;

        void destroy()
        {
          if (has_value_) {
            mwboost::unordered::detail::func::destroy(value_.value_ptr());
            has_value_ = false;
          }
        }
        ...
        void move(optional<T>& x)
        {
          ...
          new (value_.value_ptr()) T(mwboost::move(x.value_.value()));
          mwboost::unordered::detail::func::destroy(x.value_.value_ptr());
          has_value_ = true;
          x.has_value_ = false;
        }
      ...
      public:
        ...
        void swap(optional<T>& x)
        {
          if (has_value_ != x.has_value_) {
            ...
            mwboost::swap(value_.value(), x.value_.value());
          }
        }
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost {
  namespace unordered {
    namespace detail {
      ...
      struct allocator_traits : mwboost::allocator_traits<Alloc>
      {
      };

      template <typename Alloc, typename T>
      struct rebind_wrap : mwboost::allocator_rebind<Alloc, T>
      {
      };
    }
  }
  ...
  namespace unordered {
    namespace detail {
      namespace func {
        ...
        {
          new ((void*)address) T(mwboost::forward<Args>(args)...);
        }
      }
    }
  }
  ...
  namespace unordered {
    namespace detail {
      namespace func {
        ...
        {
          new ((void*)address) T(mwboost::forward<A0>(a0));
        }
      }
    }
  }
...
// construct_from_tuple for mwboost::tuple
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost {
  namespace unordered {
    namespace detail {
      namespace func {
        template <typename Alloc, typename T>
        void construct_from_tuple(Alloc&, T* ptr, mwboost::tuple<>)
        {
          new ((void*)ptr) T();
        }

        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 1, mwboost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 2, mwboost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 3, mwboost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 4, mwboost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 5, mwboost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 6, mwboost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 7, mwboost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 8, mwboost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 9, mwboost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 10, mwboost)
      }
    }
  }
}
...
// construct_from_tuple for mwboost::tuple on old versions of sunpro.
//
// Old versions of Sun C++ had problems with template overloads of
// mwboost::tuple, so to fix it I added a distinct type for each length to
...
#define BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(z, n, namespace_)                 \
  template <typename Alloc, typename T,                                        \
    BOOST_PP_ENUM_PARAMS_Z(z, n, typename A)>                                  \
  void construct_from_tuple_impl(mwboost::unordered::detail::func::length<n>,    \
    Alloc&, T* ptr,                                                            \
    namespace_::tuple<BOOST_PP_ENUM_PARAMS_Z(z, n, A)> const& x)               \
  {                                                                            \
    new ((void*)ptr)                                                           \
    ...
    namespace detail {
      namespace func {
        ...
        void construct_from_tuple_impl(
          mwboost::unordered::detail::func::length<0>, Alloc&, T* ptr,
          mwboost::tuple<>)
        {
          new ((void*)ptr) T();
        }
        ...
        {
          construct_from_tuple_impl(mwboost::unordered::detail::func::length<
                                      mwboost::tuples::length<Tuple>::value>(),
            alloc, ptr, x);
        }
      }
    }
      ...
      namespace func {
        ...
        template <typename A0> struct use_piecewise
        {
          static choice1::type test(
            choice1, mwboost::unordered::piecewise_construct_t);
          ...
          enum
          {
            value = sizeof(choice1::type) ==
                    sizeof(test(choose(), mwboost::unordered::detail::make<A0>()))
          };
        };
        ...
        {
          mwboost::allocator_construct(
            alloc, address, mwboost::forward<Args>(args)...);
        }

        // For backwards compatibility, implement a special case for
        // piecewise_construct with mwboost::tuple
        ...
        template <typename A0> struct detect_boost_tuple
        {
          ...
          static choice1::type test(choice1,
            mwboost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> const&);
        ...
        to_std_tuple_impl(mwboost::mp11::mp_list<Args...>,
          mwboost::tuple<TupleArgs...>& tuple, mwboost::mp11::index_sequence<Is...>)
        {
          (void) tuple;
          return std::tuple<typename std::add_lvalue_reference<Args>::type...>(
            mwboost::get<Is>(tuple)...);
        }
        ...
        template <class... Args>
        mwboost::mp11::mp_transform<add_lvalue_reference_t,
          mwboost::mp11::mp_remove<std::tuple<Args...>,
            mwboost::tuples::null_type> >
        to_std_tuple(mwboost::tuple<Args...>& tuple)
        {
          using list = mwboost::mp11::mp_remove<mwboost::mp11::mp_list<Args...>,
            mwboost::tuples::null_type>;
          using list_size = mwboost::mp11::mp_size<list>;
          using index_seq = mwboost::mp11::make_index_sequence<list_size::value>;
        ...
        inline typename mwboost::enable_if_c<use_piecewise<A0>::value &&
        ...
        {
          mwboost::allocator_construct(alloc, address, std::piecewise_construct,
        ...
        construct_from_args(Alloc& alloc, std::pair<A, B>* address,
          BOOST_FWD_REF(A0), BOOST_FWD_REF(A1) a1, BOOST_FWD_REF(A2) a2)
        {
          mwboost::unordered::detail::func::construct_from_tuple(
            alloc, mwboost::addressof(address->first), mwboost::forward<A1>(a1));
          BOOST_TRY
          {
            mwboost::unordered::detail::func::construct_from_tuple(
              alloc, mwboost::addressof(address->second), mwboost::forward<A2>(a2));
          }
          BOOST_CATCH(...)
          {
            mwboost::unordered::detail::func::destroy(
              mwboost::addressof(address->first));
            BOOST_RETHROW
          }
          BOOST_CATCH_END
        }
        ...
        {
          new ((void*)address) T(mwboost::forward<A0>(args.a0));
        }
        ...
        {
          new ((void*)address)
            T(mwboost::forward<A0>(args.a0), mwboost::forward<A1>(args.a1));
        }
        ...
        {
          new ((void*)address) T(mwboost::forward<A0>(args.a0),
            mwboost::forward<A1>(args.a1), mwboost::forward<A2>(args.a2));
        }
...
#define BOOST_UNORDERED_CONSTRUCT_IMPL(z, num_params, _)                       \
  ...
  inline void construct_from_args(Alloc&, T* address,                          \
    mwboost::unordered::detail::BOOST_PP_CAT(emplace_args, num_params) <         \
...
#undef BOOST_UNORDERED_CONSTRUCT_IMPL
        ...
        inline typename enable_if<use_piecewise<A0>, void>::type
        construct_from_args(Alloc& alloc, std::pair<A, B>* address,
          mwboost::unordered::detail::emplace_args3<A0, A1, A2> const& args)
        {
          mwboost::unordered::detail::func::construct_from_tuple(
            alloc, mwboost::addressof(address->first), args.a1);
          BOOST_TRY
          {
            mwboost::unordered::detail::func::construct_from_tuple(
              alloc, mwboost::addressof(address->second), args.a2);
          }
          BOOST_CATCH(...)
          {
            mwboost::unordered::detail::func::destroy(
  ...
  namespace unordered {
    namespace detail {
      ...
      template <typename NodeAlloc> struct node_constructor
      {
        ...
        typedef mwboost::unordered::detail::allocator_traits<NodeAlloc>
      ...
      {
        if (node_) {
          mwboost::unordered::detail::func::destroy(mwboost::to_address(node_));
      ...
      template <typename Alloc> void node_constructor<Alloc>::create_node()
      {
        ...
        new ((void*)mwboost::to_address(node_)) node();
      }

      template <typename NodeAlloc> struct node_tmp
      {
        typedef typename mwboost::allocator_value_type<NodeAlloc>::type node;
        typedef typename mwboost::allocator_pointer<NodeAlloc>::type node_pointer;
        typedef typename node::value_type value_type;
        typedef typename mwboost::allocator_rebind<NodeAlloc, value_type>::type
          value_allocator;
      ...
      template <typename Alloc> node_tmp<Alloc>::~node_tmp()
      {
        if (node_) {
          ...
          mwboost::allocator_destroy(val_alloc, node_->value_ptr());
          mwboost::allocator_deallocate(alloc_, node_, 1);
        }
      }
    }
  }
  ...
  namespace unordered {
    namespace detail {
      namespace func {
        ...
        inline typename mwboost::allocator_pointer<Alloc>::type
        construct_node_from_args(Alloc& alloc, BOOST_UNORDERED_EMPLACE_ARGS)
        {
          typedef typename mwboost::allocator_value_type<Alloc>::type node;
          typedef typename node::value_type value_type;
          typedef typename mwboost::allocator_rebind<Alloc, value_type>::type
            value_allocator;
        ...
        inline typename mwboost::allocator_pointer<Alloc>::type construct_node(
          Alloc& alloc, BOOST_FWD_REF(U) x)
        {
          ...
          mwboost::allocator_construct(
            val_alloc, a.node_->value_ptr(), mwboost::forward<U>(x));
          return a.release();
        }
        ...
        construct_node_pair(Alloc& alloc, BOOST_FWD_REF(Key) k)
        {
          ...
          mwboost::allocator_construct(
            ...
            std::forward_as_tuple(mwboost::forward<Key>(k)),
          ...
          Alloc& alloc, BOOST_FWD_REF(Key) k, BOOST_FWD_REF(Mapped) m)
        {
          ...
          mwboost::allocator_construct(val_alloc, a.node_->value_ptr(),
            std::piecewise_construct,
            std::forward_as_tuple(mwboost::forward<Key>(k)),
            std::forward_as_tuple(mwboost::forward<Mapped>(m)));
          return a.release();
        }
      ...
      defined(BOOST_LIBSTDCXX11))
          mwboost::allocator_construct(val_alloc, a.node_->value_ptr(),
            std::piecewise_construct,
            std::forward_as_tuple(mwboost::forward<Key>(k)),
            std::forward_as_tuple(mwboost::forward<Args>(args)...));
#else
          ...
          mwboost::allocator_construct(val_alloc, a.node_->value_ptr(),
            std::piecewise_construct,
            std::forward_as_tuple(mwboost::forward<Key>(k)),
            std::make_tuple(mwboost::forward<Args>(args)...));
#endif
          return a.release();
        }
        ...
        template <typename Alloc, typename Key>
        inline
          typename mwboost::unordered::detail::allocator_traits<Alloc>::pointer
          construct_node_pair(Alloc& alloc, BOOST_FWD_REF(Key) k)
        {
          node_constructor<Alloc> a(alloc);
          a.create_node();
          mwboost::unordered::detail::func::construct_value(
            mwboost::addressof(a.node_->value_ptr()->first),
            mwboost::forward<Key>(k));
          BOOST_TRY
          {
            mwboost::unordered::detail::func::construct_value(
              mwboost::addressof(a.node_->value_ptr()->second));
          }
          BOOST_CATCH(...)
          {
            mwboost::unordered::detail::func::destroy(
            ...
            Alloc& alloc, BOOST_FWD_REF(Key) k, BOOST_UNORDERED_EMPLACE_ARGS)
        {
          ...
          BOOST_TRY
          {
            mwboost::unordered::detail::func::construct_from_args(alloc,
              mwboost::addressof(a.node_->value_ptr()->second),
    ...
    namespace detail {
      ...
      public:
        static const bool nothrow_move_assignable =
          mwboost::is_nothrow_move_assignable<H>::value &&
          mwboost::is_nothrow_move_assignable<P>::value;
        static const bool nothrow_move_constructible =
          mwboost::is_nothrow_move_constructible<H>::value &&
          mwboost::is_nothrow_move_constructible<P>::value;
        static const bool nothrow_swappable =
          mwboost::is_nothrow_swappable<H>::value &&
          mwboost::is_nothrow_swappable<P>::value;
      ...
      private:
        ...
        typedef typename mwboost::aligned_storage<sizeof(function_pair),
          mwboost::alignment_of<function_pair>::value>::type aligned_function;
      ...
      public:
        ...
        functions(functions& bf, mwboost::unordered::detail::move_tag)
            : current_(0)
        {
          construct_functions(current_, bf.current_functions(),
            mwboost::unordered::detail::integral_constant<bool,
        ...
        {
          return *::mwboost::unordered::detail::launder(
      ...
      private:
        ...
        void construct_functions(unsigned char which, function_pair const& f,
          mwboost::unordered::detail::false_type =
            mwboost::unordered::detail::false_type())
        {
          BOOST_ASSERT(!(which & 2));
        ...
        void construct_functions(unsigned char which, function_pair& f,
          mwboost::unordered::detail::true_type)
        {
          BOOST_ASSERT(!(which & 2));
          new ((void*)&funcs_[which])
            function_pair(f, mwboost::unordered::detail::move_tag());
        }
...
#define BOOST_UNORDERED_RV_REF(T) BOOST_RV_REF(T)
      ...
      template <typename T>
      struct rv_ref : mwboost::conditional<mwboost::is_class<T>::value,
                        mwboost::unordered::detail::rv_ref_impl<T>,
                        please_ignore_this_overload>::type
      {
      };

#define BOOST_UNORDERED_RV_REF(T)                                              \
  typename mwboost::unordered::detail::rv_ref<T>::type
#endif
...
#pragma warning(disable : 4127) // conditional expression is constant
      ...
      namespace iterator_detail {
        ...
        public:
          ...
          {
            pointer x = mwboost::addressof(p->value());
            return x;
          }
          ...
          bool operator==(
            mwboost::unordered::detail::iterator_detail::c_iterator<Node,
        ...
        private:
          ...
          template <class Types> friend struct mwboost::unordered::detail::table;
          ...
          bool equal(
            const mwboost::unordered::detail::iterator_detail::c_iterator<Node,
        ...
        public:
          ...
          bool operator==(
            mwboost::unordered::detail::iterator_detail::iterator<Node,
              Bucket> const& other) const BOOST_NOEXCEPT
          {
            return equal(other);
          }
      ...
      struct table : mwboost::unordered::detail::functions<typename Types::hasher,
      ...
      public:
        ...
        typedef mwboost::unordered::detail::functions<typename Types::hasher,
          typename Types::key_equal>
          functions;

        typedef typename Types::value_allocator value_allocator;
        typedef typename mwboost::allocator_void_pointer<value_allocator>::type void_pointer;
        typedef node<value_type, void_pointer> node_type;

        typedef mwboost::unordered::detail::grouped_bucket_array<
          bucket<node_type, void_pointer>, value_allocator, prime_fmod_size<> >
          bucket_array_type;

        typedef typename bucket_array_type::node_allocator_type
          node_allocator_type;
        typedef typename mwboost::allocator_pointer<node_allocator_type>::type node_pointer;

        typedef mwboost::unordered::detail::node_constructor<node_allocator_type>
          node_constructor;
        typedef mwboost::unordered::detail::node_tmp<node_allocator_type> node_tmp;
      ...
      public:
        ...
        std::size_t max_bucket_count() const
        {
          ...
          return size_policy::size(size_policy::size_index(
            mwboost::allocator_max_size(this->node_alloc())));
        }
        ...
        void recalculate_max_load()
        {
          ...
          max_load_ =
            bc == 0 ? 0
                    : mwboost::unordered::detail::double_to_size(
        ...
        table(table& x, mwboost::unordered::detail::move_tag m)
            : functions(x, m), size_(x.size_), mlf_(x.mlf_),
              max_load_(x.max_load_), buckets_(mwboost::move(x.buckets_))
        {
          x.size_ = 0;
          x.max_load_ = 0;
        }
        ...
        table(table& x, node_allocator_type const& a,
          mwboost::unordered::detail::move_tag m)
        ...
        {
          mwboost::unordered::detail::func::ignore_unused_variable_warning(other);
        ...
        void swap(table& x)
        {
          BOOST_ASSERT(mwboost::allocator_propagate_on_container_swap<
                         node_allocator_type>::type::value ||
                       node_alloc() == x.node_alloc());
          swap(x, mwboost::unordered::detail::integral_constant<bool,
        ...
        {
          buckets_ = mwboost::move(other.buckets_);
        ...
        void move_construct_buckets(table& src)
        {
          ...
          for (iterator pos = src.begin(); pos != src.end(); ++pos) {
            node_tmp b(detail::func::construct_node(
                         this->node_alloc(), mwboost::move(pos.p->value())),
              this->node_alloc());
        ...
        void delete_node(node_pointer p)
        {
          ...
          value_allocator val_alloc(alloc);
          mwboost::allocator_destroy(val_alloc, p->value_ptr());
          mwboost::allocator_deallocate(alloc, p, 1);
        }
        ...
        {
          typedef typename mwboost::allocator_propagate_on_container_copy_assignment<node_allocator_type>::type pocca;
        ...
        void assign(table const &x, UniqueType is_unique, true_type)
        {
          ...
          else
          {
            ...
            delete_buckets();
            buckets_.reset_allocator(x.node_alloc());
            buckets_ = mwboost::move(new_buckets);
        ...
        void move_assign(table& x, UniqueType is_unique)
        {
          if (this != &x) {
            move_assign(x, is_unique,
              mwboost::unordered::detail::integral_constant<bool,
                mwboost::allocator_propagate_on_container_move_assignment<
                  node_allocator_type>::type::value>());
          }
        }
        ...
        node_pointer* find_prev(Key const& key, bucket_iterator itb)
        {
          if (size_ > 0) {
            ...
            for (node_pointer* pp = mwboost::addressof(itb->next); *pp;
                pp = mwboost::addressof((*pp)->next)) {
          ...
          const_key_type& k, BOOST_UNORDERED_EMPLACE_ARGS)
        {
          ...
          if (pos) {
            ...
            node_tmp b(mwboost::unordered::detail::func::construct_node_from_args(
        ...
        emplace_return try_emplace_unique(BOOST_FWD_REF(Key) k)
        {
          ...
          if (pos) {
            ...
            node_tmp tmp(
              detail::func::construct_node_pair(alloc, mwboost::forward<Key>(k)),
              alloc);
          ...
          BOOST_FWD_REF(Key) k, BOOST_UNORDERED_EMPLACE_ARGS)
        {
          ...
          node_tmp b(
            mwboost::unordered::detail::func::construct_node_pair_from_args(
          ...
          BOOST_FWD_REF(Key) k, BOOST_FWD_REF(M) obj)
        {
          ...
          node_pointer p = this->find_node_impl(k, itb);
          if (p) {
            p->value().second = mwboost::forward<M>(obj);
            return emplace_return(iterator(p, itb), false);
          }

          node_tmp b(mwboost::unordered::detail::func::construct_node_pair(
                       this->node_alloc(), mwboost::forward<Key>(k),
                       mwboost::forward<M>(obj)),
            node_alloc());
        ...
        void merge_unique(mwboost::unordered::detail::table<Types2>& other)
        {
          typedef mwboost::unordered::detail::table<Types2> other_table;
          BOOST_STATIC_ASSERT((mwboost::is_same<node_type,
        ...
        iterator erase_node(c_iterator pos) {
          ...
          bucket_iterator itb = pos.itb;
          node_pointer* pp = mwboost::addressof(itb->next);
          while (*pp != pos.p) {
            pp = mwboost::addressof((*pp)->next);
          }
        ...
        void move_assign_buckets(table& src, true_type)
        {
          ...
          for (iterator pos = src.begin(); pos != last; ++pos) {
            value_type value = mwboost::move(*pos);
            const_key_type& key = extractor::extract(value);
            std::size_t const key_hash = this->hash(key);
            ...
            node_tmp tmp(
              detail::func::construct_node(alloc, mwboost::move(value)), alloc);
        ...
        // safety. Strong otherwise
        template <class I>
        typename mwboost::unordered::detail::enable_if_forward<I, void>::type
        insert_range_equiv(I i, I j)
        {
          ...
          if (distance == 1) {
            emplace_equiv(mwboost::unordered::detail::func::construct_node(
              this->node_alloc(), *i));
          } else {
            ...
            for (; i != j; ++i) {
              emplace_no_rehash_equiv(
                mwboost::unordered::detail::func::construct_node(
                  this->node_alloc(), *i));
            }
          }
        }
        ...
        template <class I>
        typename mwboost::unordered::detail::disable_if_forward<I, void>::type
        insert_range_equiv(I i, I j)
        {
          for (; i != j; ++i) {
            emplace_equiv(mwboost::unordered::detail::func::construct_node(
      ...
      inline void table<Types>::rehash_impl(std::size_t num_buckets)
      {
        ...
        BOOST_TRY
        {
          mwboost::unordered::detail::span<bucket_type> bspan = buckets_.raw();
...
#pragma warning(pop)
      ...
      template <typename Key, typename T> struct is_key
      {
        ...
        enum
        {
          value = sizeof(test(mwboost::unordered::detail::make<T>())) ==
                  sizeof(choice2::type)
        };

        typedef
          typename mwboost::conditional<value, Key const&, no_key>::type type;
      };
      ...
      {
        typedef ValueType value_type;
        typedef typename mwboost::remove_const<typename mwboost::unordered::detail::
        ...
        template <class Second>
        static key_type const& extract(
          mwboost::rv<std::pair<key_type, Second> > const& v)
        {
          return v.first;
        }
        ...
        template <class Second>
        static key_type const& extract(
          mwboost::rv<std::pair<key_type const, Second> > const& v)
        {
          return v.first;
        }
#endif
...
#define BOOST_UNORDERED_KEY_FROM_TUPLE(namespace_)                             \
  ...
  static no_key extract(mwboost::unordered::piecewise_construct_t,               \
  ...
  static typename is_key<key_type, T>::type extract(                           \
    mwboost::unordered::piecewise_construct_t, namespace_ tuple<T> const& k,     \
    T2 const&)                                                                 \
  {                                                                            \
...
#define BOOST_UNORDERED_KEY_FROM_TUPLE(namespace_)                             \
  static no_key extract(                                                       \
    mwboost::unordered::piecewise_construct_t, namespace_ tuple<> const&)        \
  {                                                                            \
    return no_key();                                                           \
  }                                                                            \
                                                                               \
  ...
  {                                                                            \
    return typename is_key<key_type, T>::type(namespace_ get<0>(k));           \
        ...
        BOOST_UNORDERED_KEY_FROM_TUPLE(mwboost::)
