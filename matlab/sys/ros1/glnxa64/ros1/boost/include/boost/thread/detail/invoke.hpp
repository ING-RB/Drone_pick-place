...
#define BOOST_THREAD_PROVIDES_INVOKE
    ...
    invoke(BOOST_THREAD_RV_REF(Fp) f, BOOST_THREAD_RV_REF(A0) a0, BOOST_THREAD_RV_REF(Args) ...args)
        -> decltype((mwboost::forward<A0>(a0).*f)(mwboost::forward<Args>(args)...))
    {
        return (mwboost::forward<A0>(a0).*f)(mwboost::forward<Args>(args)...);
    }
    ...
    invoke(BOOST_THREAD_RV_REF(Fp) f, BOOST_THREAD_RV_REF(A0) a0)
        -> decltype(mwboost::forward<A0>(a0).*f)
    {
        return mwboost::forward<A0>(a0).*f;
    }
    ...
    -> decltype(mwboost::forward<Fp>(f)(mwboost::forward<Args>(args)...))
    {
      return mwboost::forward<Fp>(f)(mwboost::forward<Args>(args)...);
    }
    ...
    invoke(BOOST_THREAD_RV_REF(Fp) f, BOOST_THREAD_RV_REF(A0) a0, BOOST_THREAD_RV_REF(A1) a1)
        -> decltype((mwboost::forward<A0>(a0).*f)(mwboost::forward<A1>(a1)))
    {
        return (mwboost::forward<A0>(a0).*f)(mwboost::forward<A1>(a1));
    }
    ...
    invoke(BOOST_THREAD_RV_REF(Fp) f, BOOST_THREAD_RV_REF(A0) a0, BOOST_THREAD_RV_REF(A1) a1, BOOST_THREAD_RV_REF(A2) a2)
        -> decltype((mwboost::forward<A0>(a0).*f)(mwboost::forward<A1>(a1), mwboost::forward<A2>(a2)))
    {
        return (mwboost::forward<A0>(a0).*f)(mwboost::forward<A1>(a1), mwboost::forward<A2>(a2));
    }
    ...
    -> decltype(mwboost::forward<Fp>(f)())
    {
      return mwboost::forward<Fp>(f)();
    }
    template <class Fp, class A1>
    inline
    auto invoke(BOOST_THREAD_RV_REF(Fp) f, BOOST_THREAD_RV_REF(A1) a1)
    -> decltype(mwboost::forward<Fp>(f)(mwboost::forward<A1>(a1)))
    {
      return mwboost::forward<Fp>(f)(mwboost::forward<A1>(a1));
    ...
    -> decltype(mwboost::forward<Fp>(f)(mwboost::forward<A1>(a1), mwboost::forward<A2>(a2)))
    {
      return mwboost::forward<Fp>(f)(mwboost::forward<A1>(a1), mwboost::forward<A2>(a2));
    }
    ...
    -> decltype(mwboost::forward<Fp>(f)(mwboost::forward<A1>(a1), mwboost::forward<A2>(a2), mwboost::forward<A3>(a3)))
    {
      return mwboost::forward<Fp>(f)(mwboost::forward<A1>(a1), mwboost::forward<A2>(a2), mwboost::forward<A3>(a3));
    }
    ...
    {
      return std::bind(mwboost::forward<Fp>(f), mwboost::forward<A1>(a1))();
    }
    ...
    {
      return std::bind(mwboost::forward<Fp>(f), mwboost::forward<A1>(a1), mwboost::forward<A2>(a2))();
    }
    ...
    {
      return std::bind(mwboost::forward<Fp>(f), mwboost::forward<A1>(a1), mwboost::forward<A2>(a2), mwboost::forward<A3>(a3))();
    }
...
//    }
    ...
    inline Ret do_invoke(mwboost::false_type, BOOST_THREAD_RV_REF(Fp) f, BOOST_THREAD_RV_REF(Args) ...args)
    {
      return mwboost::forward<Fp>(f)(mwboost::forward<Args>(args)...);
    }

    template <class Ret, class Fp, class ...Args>
    inline Ret do_invoke(mwboost::true_type, BOOST_THREAD_RV_REF(Fp) f, BOOST_THREAD_RV_REF(Args) ...args)
    {
      return f(mwboost::forward<Args>(args)...);
    }
    ...
    {
      return mwboost::detail::do_invoke<Ret>(mwboost::is_pointer<Fp>(), mwboost::forward<Fp>(f), mwboost::forward<Args>(args)...);
    }
#else // BOOST_NO_CXX11_VARIADIC_TEMPLATES
    // bullet 1
    // (t1.*f)(t2, ..., tN) when f is a pointer to a member function of a class T and t1 is an object of
    ...
    {
        return (a0.*f)(mwboost::forward<A1>(a1));
    }
    template <class Ret, class A, class A0, class A1>
    inline
    typename enable_if_c
    ...
    {
        return (a0.*f)(mwboost::forward<A1>(a1), mwboost::forward<A2>(a2));
    }
    template <class Ret, class A, class A0, class A1, class A2>
    inline
    typename enable_if_c
    ...
    {
        return (a0.*f)(mwboost::forward<A1>(a1), mwboost::forward<A2>(a2), mwboost::forward<A3>(a3));
    }
    template <class Ret, class A, class A0, class A1, class A2, class A3>
    inline
    typename enable_if_c
...
///
    ...
    {
        return (mwboost::forward<A0>(a0).*f)(mwboost::forward<A1>(a1), mwboost::forward<A2>(a2), mwboost::forward<A3>(a3));
    }
    template <class Ret, class A, class A0, class A1, class A2, class A3>
    inline
    typename enable_if_c
...
///
    ...
    {
      return ((*mwboost::forward<A0>(a0)).*f)(a1);
    }
    template <class Ret, class A, class A0, class A1>
    inline
    typename enable_if_c
...
//    }
    ...
    template <class Ret, class Fp>
    inline Ret do_invoke(mwboost::false_type, BOOST_THREAD_FWD_REF(Fp) f)
    {
      return mwboost::forward<Fp>(f)();
    }
    template <class Ret, class Fp>
    inline Ret do_invoke(mwboost::true_type, BOOST_THREAD_FWD_REF(Fp) f)
    {
      return f();
    }
    template <class Ret, class Fp>
    ...
    {
      return mwboost::detail::do_invoke<Ret>(mwboost::is_pointer<Fp>(), mwboost::forward<Fp>(f));
    }

    template <class Ret, class Fp, class A1>
    inline Ret do_invoke(mwboost::false_type, BOOST_THREAD_FWD_REF(Fp) f, BOOST_THREAD_RV_REF(A1) a1)
    {
      return mwboost::forward<Fp>(f)(mwboost::forward<A1>(a1));
    }
    template <class Ret, class Fp, class A1>
    inline Ret do_invoke(mwboost::true_type, BOOST_THREAD_FWD_REF(Fp) f, BOOST_THREAD_RV_REF(A1) a1)
    {
      return f(mwboost::forward<A1>(a1));
    }
    template <class Ret, class Fp, class A1>
    inline
    typename disable_if_c
    ...
    {
      return mwboost::detail::do_invoke<Ret>(mwboost::is_pointer<Fp>(), mwboost::forward<Fp>(f), mwboost::forward<A1>(a1));
    }

    template <class Ret, class Fp, class A1, class A2>
    inline Ret do_invoke(mwboost::false_type, BOOST_THREAD_FWD_REF(Fp) f, BOOST_THREAD_RV_REF(A1) a1, BOOST_THREAD_RV_REF(A2) a2)
    {
      return mwboost::forward<Fp>(f)(mwboost::forward<A1>(a1), mwboost::forward<A2>(a2));
    }
    template <class Ret, class Fp, class A1, class A2>
    inline Ret do_invoke(mwboost::true_type, BOOST_THREAD_FWD_REF(Fp) f, BOOST_THREAD_RV_REF(A1) a1, BOOST_THREAD_RV_REF(A2) a2)
    {
      return f(mwboost::forward<A1>(a1), mwboost::forward<A2>(a2));
    }
    template <class Ret, class Fp, class A1, class A2>
    inline
    typename disable_if_c
    ...
    {
      return mwboost::detail::do_invoke<Ret>(mwboost::is_pointer<Fp>(), mwboost::forward<Fp>(f), mwboost::forward<A1>(a1), mwboost::forward<A2>(a2));
    }

    template <class Ret, class Fp, class A1, class A2, class A3>
    inline Ret do_invoke(mwboost::false_type, BOOST_THREAD_FWD_REF(Fp) f, BOOST_THREAD_RV_REF(A1) a1, BOOST_THREAD_RV_REF(A2) a2, BOOST_THREAD_RV_REF(A3) a3)
    {
      return mwboost::forward<Fp>(f)(mwboost::forward<A1>(a1), mwboost::forward<A2>(a2), mwboost::forward<A3>(a3));
    }
    template <class Ret, class Fp, class A1, class A2, class A3>
    inline Ret do_invoke(mwboost::true_type, BOOST_THREAD_FWD_REF(Fp) f, BOOST_THREAD_RV_REF(A1) a1, BOOST_THREAD_RV_REF(A2) a2, BOOST_THREAD_RV_REF(A3) a3)
    {
      return f(mwboost::forward<A1>(a1), mwboost::forward<A2>(a2), mwboost::forward<A3>(a3));
    }
    template <class Ret, class Fp, class A1, class A2, class A3>
    inline
    typename disable_if_c
    ...
    {
      return mwboost::detail::do_invoke<Ret>(mwboost::is_pointer<Fp>(), mwboost::forward<Fp>(f), mwboost::forward<A1>(a1), mwboost::forward<A2>(a2), mwboost::forward<A3>(a3));
    }


    template <class Ret, class Fp, class A1>
    inline Ret do_invoke(mwboost::false_type, BOOST_THREAD_FWD_REF(Fp) f, A1 a1)
    {
      return mwboost::forward<Fp>(f)(a1);
    }
    template <class Ret, class Fp, class A1>
    inline Ret do_invoke(mwboost::true_type, BOOST_THREAD_FWD_REF(Fp) f, A1 a1)
    {
      return f(a1);
    }
    template <class Ret, class Fp, class A1>
    ...
    {
      return mwboost::detail::do_invoke<Ret>(mwboost::is_pointer<Fp>(), mwboost::forward<Fp>(f), a1);
    }

    template <class Ret, class Fp, class A1, class A2>
    inline Ret do_invoke(mwboost::false_type, BOOST_THREAD_FWD_REF(Fp) f, A1 a1, A2 a2)
    {
      return mwboost::forward<Fp>(f)(a1, a2);
    }
    template <class Ret, class Fp, class A1, class A2>
    inline Ret do_invoke(mwboost::true_type, BOOST_THREAD_FWD_REF(Fp) f, A1 a1, A2 a2)
    {
      return f(a1, a2);
    }
    template <class Ret, class Fp, class A1, class A2>
    ...
    {
      return mwboost::detail::do_invoke<Ret>(mwboost::is_pointer<Fp>(), mwboost::forward<Fp>(f), a1, a2);
    }

    template <class Ret, class Fp, class A1, class A2, class A3>
    inline Ret do_invoke(mwboost::false_type, BOOST_THREAD_FWD_REF(Fp) f, A1 a1, A2 a2, A3 a3)
    {
      return mwboost::forward<Fp>(f)(a1, a2, a3);
    }
    template <class Ret, class Fp, class A1, class A2, class A3>
    inline Ret do_invoke(mwboost::true_type, BOOST_THREAD_FWD_REF(Fp) f, A1 a1, A2 a2, A3 a3)
    {
      return f(a1, a2, a3);
    }
    template <class Ret, class Fp, class A1, class A2, class A3>
    ...
    {
      return mwboost::detail::do_invoke<Ret>(mwboost::is_pointer<Fp>(), mwboost::forward<Fp>(f), a1, a2, a3);
    }
