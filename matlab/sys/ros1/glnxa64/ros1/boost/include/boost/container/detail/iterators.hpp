...
class constant_iterator
  : public ::mwboost::container::iterator
      ...
      <std::random_access_iterator_tag, T, std::ptrdiff_t, const T*, const T &>
{
   ...
   //constructed until ::mwboost::container::construct_in_place is called.
...
struct emplace_functor
{
   ...
   BOOST_CONTAINER_FORCEINLINE void inplace_impl(Allocator &a, T* ptr, const dtl::index_tuple<IdxPack...>&)
   {
      allocator_traits<Allocator>::construct
         (a, ptr, ::mwboost::forward<Args>(dtl::get<IdxPack>(args_))...);
   }
   ...
   {
      typedef typename mwboost::container::iterator_traits<DestIt>::value_type value_type;
      value_type && tmp= value_type(::mwboost::forward<Args>(dtl::get<IdxPack>(args_))...);
      *dest = ::mwboost::move(tmp);
   }
...
{\
   ...
   {\
      ...
      *dest = ::mwboost::move(const_cast<value_type &>(BOOST_MOVE_IF(N, tmp, tmp.get())));\
   }\
   \
   BOOST_MOVE_MREF##N\
};\
...
struct iiterator_types
{
   ...
   typedef typename mwboost::container::iterator_traits<IIterator>::pointer         it_pointer;
   typedef typename mwboost::container::iterator_traits<IIterator>::difference_type difference_type;
   typedef typename ::mwboost::intrusive::pointer_traits<it_pointer>::
      template rebind_pointer<value_type>::type                      pointer;
   typedef typename ::mwboost::intrusive::pointer_traits<it_pointer>::
      template rebind_pointer<const value_type>::type                const_pointer;
   typedef typename ::mwboost::intrusive::
...
{
   typedef typename ::mwboost::container::iterator
...
class iterator_from_iiterator
{
   ...
   {  return ::mwboost::intrusive::pointer_traits<pointer>::pointer_to(this->operator*());  }
...
using ::mwboost::intrusive::reverse_iterator;
