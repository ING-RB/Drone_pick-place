...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace container { namespace dtl {
...
struct move_insert_range_proxy
{
   ...
   {
      this->first_ = ::mwboost::container::uninitialized_move_alloc_n_source
         (a, this->first_, n, p);
   }
   ...
   {
      this->first_ = ::mwboost::container::move_n_source(this->first_, n, p);
   }
...
struct insert_range_proxy
{
   ...
   BOOST_CONTAINER_FORCEINLINE void uninitialized_copy_n_and_update(Allocator &a, Iterator p, std::size_t n)
   {
      this->first_ = ::mwboost::container::uninitialized_copy_alloc_n_source(a, this->first_, n, p);
   }

   template<class Iterator>
   BOOST_CONTAINER_FORCEINLINE void copy_n_and_update(Allocator &, Iterator p, std::size_t n)
   {
      this->first_ = ::mwboost::container::copy_n_source(this->first_, n, p);
   }
...
struct insert_n_copies_proxy
{
   ...
   {  mwboost::container::uninitialized_fill_alloc_n(a, v_, n, p);  }
...
{
   typedef ::mwboost::container::allocator_traits<Allocator> alloc_traits;
   typedef typename allocator_traits<Allocator>::value_type value_type;
   typedef typename dtl::aligned_storage<sizeof(value_type), dtl::alignment_of<value_type>::value>::type storage_t;

   template<class Iterator>
   BOOST_CONTAINER_FORCEINLINE void uninitialized_copy_n_and_update(Allocator &a, Iterator p, std::size_t n) const
   {  mwboost::container::uninitialized_value_init_alloc_n(a, n, p);  }
...
struct insert_default_initialized_n_proxy
{
   ...
   template<class Iterator>
   BOOST_CONTAINER_FORCEINLINE void uninitialized_copy_n_and_update(Allocator &a, Iterator p, std::size_t n) const
   {  mwboost::container::uninitialized_default_init_alloc_n(a, n, p);  }
...
struct insert_copy_proxy
{
   ...
   BOOST_CONTAINER_FORCEINLINE void uninitialized_copy_n_and_update(Allocator &a, Iterator p, std::size_t n) const
   {
      ...
      alloc_traits::construct( a, mwboost::movelib::iterator_to_raw_pointer(p), v_);
   }
...
struct insert_move_proxy
{
   ...
   {
      BOOST_ASSERT(n == 1);  (void)n;
      alloc_traits::construct( a, mwboost::movelib::iterator_to_raw_pointer(p), ::mwboost::move(v_) );
   }
...
BOOST_CONTAINER_FORCEINLINE insert_move_proxy<Allocator> get_insert_value_proxy(BOOST_RV_REF(typename mwboost::container::iterator_traits<It>::value_type) v)
{
   return insert_move_proxy<Allocator>(v);
}

template<class It, class Allocator>
BOOST_CONTAINER_FORCEINLINE insert_copy_proxy<Allocator> get_insert_value_proxy(const typename mwboost::container::iterator_traits<It>::value_type &v)
{
...
struct insert_nonmovable_emplace_proxy
{
   ...
   {
      BOOST_ASSERT(n == 1); (void)n;
      alloc_traits::construct( a, mwboost::movelib::iterator_to_raw_pointer(p), ::mwboost::forward<Args>(get<IdxPack>(this->args_))... );
   }
   ...
   :  public insert_nonmovable_emplace_proxy<Allocator, Args...>
{
   ...
   BOOST_CONTAINER_FORCEINLINE explicit insert_emplace_proxy(BOOST_FWD_REF(Args)... args)
      : base_t(::mwboost::forward<Args>(args)...)
   {}
   ...
   BOOST_CONTAINER_FORCEINLINE void priv_copy_some_and_update(Allocator &a, const index_tuple<IdxPack...>&, Iterator p, std::size_t n)
   {
      BOOST_ASSERT(n ==1); (void)n;
      typename dtl::aligned_storage<sizeof(value_type), dtl::alignment_of<value_type>::value>::type v;
      alloc_traits::construct(a, move_detail::force_ptr<value_type *>(&v), ::mwboost::forward<Args>(get<IdxPack>(this->args_))...);
      value_type *vp = move_detail::force_ptr<value_type *>(&v);
      BOOST_TRY{
         *p = ::mwboost::move(*vp);
      }
...
template<class Allocator>
struct insert_emplace_proxy<Allocator, typename mwboost::container::allocator_traits<Allocator>::value_type>
   : public insert_move_proxy<Allocator>
{
   static const bool single_value = true;

   BOOST_CONTAINER_FORCEINLINE explicit insert_emplace_proxy(typename mwboost::container::allocator_traits<Allocator>::value_type &&v)
...
struct insert_emplace_proxy<Allocator
   , typename mwboost::container::dtl::add_const<typename mwboost::container::allocator_traits<Allocator>::value_type>::type
   >
   : public insert_copy_proxy<Allocator>
{
   ...
   BOOST_CONTAINER_FORCEINLINE explicit insert_emplace_proxy(const typename mwboost::container::allocator_traits<Allocator>::value_type &v)
...
{\
   ...
   {\
      BOOST_ASSERT(n == 1); (void)n;\
      alloc_traits::construct(a, mwboost::movelib::iterator_to_raw_pointer(p) BOOST_MOVE_I##N BOOST_MOVE_MFWD##N);\
   }\
   \
   template<class Iterator>\
...
//Specializations to avoid an unneeded temporary when emplacing from a single argument o type value_type
template<class Allocator>
struct insert_emplace_proxy_arg1<Allocator, ::mwboost::rv<typename mwboost::container::allocator_traits<Allocator>::value_type> >
   : public insert_move_proxy<Allocator>
{
   static const bool single_value = true;

   BOOST_CONTAINER_FORCEINLINE explicit insert_emplace_proxy_arg1(typename mwboost::container::allocator_traits<Allocator>::value_type &v)
   : insert_move_proxy<Allocator>(v)
   {}
};

template<class Allocator>
struct insert_emplace_proxy_arg1<Allocator, typename mwboost::container::allocator_traits<Allocator>::value_type>
   : public insert_copy_proxy<Allocator>
{
   static const bool single_value = true;

   BOOST_CONTAINER_FORCEINLINE explicit insert_emplace_proxy_arg1(const typename mwboost::container::allocator_traits<Allocator>::value_type &v)
   : insert_copy_proxy<Allocator>(v)
   {}
};
