...
/*! \file
    ...
    or \c std::list<mwboost::iterator_range<std::string::iterator>>
*/
...
//  find_all  ------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::mwboost::algorithm::iter_find(
                Result,
                Input,
...
//  tokenize  -------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::mwboost::algorithm::iter_split(
                Result,
                Input,
                ::mwboost::algorithm::token_finder( Pred, eCompress ) );         
        }
