...
template<class T>
struct has_move_emulation_enabled_impl< ::mwboost::rv<T> >
{  static const bool value = false;  };
...
template< class T >
struct is_rvalue_reference< mwboost::rv<T>& >
{  static const bool value = true;  };

template< class T >
struct is_rvalue_reference< const mwboost::rv<T>& >
{  static const bool value = true;  };
...
namespace detail_add_rvalue_reference
{
   ...
   struct add_rvalue_reference_impl< T, true, rv > { typedef ::mwboost::rv<T>& type; };
} // namespace detail_add_rvalue_reference
