...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace math { namespace tools { namespace detail {
template <typename T>
struct type {};
...
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(t)              mwboost::math::tools::detail::type<t>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(t)         mwboost::math::tools::detail::type<t>*
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE(t, v)       mwboost::math::tools::detail::non_type<t, v>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE_SPEC(t, v)  mwboost::math::tools::detail::non_type<t, v>*
...
}} // namespace mwboost namespace math
...
#    define BOOST_FPU_EXCEPTION_GUARD mwboost::math::detail::fpu_guard local_guard_object;
