...
#   include <boost/move/utility_core.hpp> // for mwboost::move, mwboost::forward
#endif
...
public: // visitor interfaces
    ...
    {
        return visitor_(::mwboost::move(value1_), ::mwboost::forward<Value2>(value2));
    }
    ...
    operator()(Value2&& value2)
    {
        return visitor_(value1_, ::mwboost::forward<Value2>(value2));
    }
...
public: // visitor interfaces
    ...
    operator()(Value1&& value1)
    {
        apply_visitor_binary_invoke<
              Visitor
            , Value1
            , ! ::mwboost::is_lvalue_reference<Value1>::value
            > invoker(visitor_, value1);

        return mwboost::apply_visitor(invoker, ::mwboost::move(visitable2_));
    }
    ...
    operator()(Value1&& value1)
    {
        ...
        return mwboost::apply_visitor(invoker, visitable2_);
    }
...
{
    ::mwboost::detail::variant::apply_visitor_binary_unwrap<
          Visitor, Visitable2, ! ::mwboost::is_lvalue_reference<Visitable2>::value
        > unwrapper(visitor, visitable2);

    return mwboost::apply_visitor(unwrapper, ::mwboost::forward<Visitable1>(visitable1));
}
...
apply_visitor( Visitor& visitor, Visitable1& visitable1, Visitable2& visitable2)
{
    ...
    return mwboost::apply_visitor(unwrapper, visitable1);
}
...
{
    ::mwboost::detail::variant::apply_visitor_binary_unwrap<
          const Visitor, Visitable2, ! ::mwboost::is_lvalue_reference<Visitable2>::value
        > unwrapper(visitor, visitable2);
...
inline decltype(auto) apply_visitor(Visitor& visitor, Visitable1&& visitable1, Visitable2&& visitable2,
    ...
    >::type = true)
{
    ::mwboost::detail::variant::apply_visitor_binary_unwrap_cpp14<
          Visitor, Visitable2, ! ::mwboost::is_lvalue_reference<Visitable2>::value
        > unwrapper(visitor, visitable2);
