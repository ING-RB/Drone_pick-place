...
namespace mwboost {} namespace boost = mwboost; namespace mwboost
{
  ...
  namespace signals2
  {
    ...
    {};
    template<typename T> struct weak_ptr_traits<mwboost::weak_ptr<T> >
    {
      typedef mwboost::shared_ptr<T> shared_type;
    };
#ifndef BOOST_NO_CXX11_SMART_PTR
    ...
    template<typename T> struct shared_ptr_traits<mwboost::shared_ptr<T> >
    {
      typedef mwboost::weak_ptr<T> weak_type;
    };
#ifndef BOOST_NO_CXX11_SMART_PTR
    ...
    namespace detail
    {
      ...
      private:
        mwboost::scoped_ptr<foreign_weak_ptr_impl_base> _p;
      };
    } // namespace detail
