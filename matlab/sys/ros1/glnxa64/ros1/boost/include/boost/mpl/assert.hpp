...
mwboost::mpl::aux::weighted_tag<1>::type operator==( assert_, assert_ );
mwboost::mpl::aux::weighted_tag<2>::type operator!=( assert_, assert_ );
mwboost::mpl::aux::weighted_tag<3>::type operator>(  assert_, assert_ );
mwboost::mpl::aux::weighted_tag<4>::type operator>=( assert_, assert_ );
mwboost::mpl::aux::weighted_tag<5>::type operator<( assert_, assert_ );
mwboost::mpl::aux::weighted_tag<6>::type operator<=( assert_, assert_ );
...
struct eval_assert {
    ...
    typedef typename ::mwboost::mpl::if_c<p_type::value,
...
template< typename Pred >
typename assert_arg_type< mwboost::mpl::not_<Pred> >::type 
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          mwboost::mpl::assertion_failed<false>( \
              mwboost::mpl::make_assert_arg< \
                  typename mwboost::mpl::eval_assert<void pred>::type \
                >() \
            ) \
        ) \
    ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          mwboost::mpl::assertion_failed<false>( \
              mwboost::mpl::make_assert_arg< \
                  typename mwboost::mpl::eval_assert_not<void pred>::type \
                >() \
            ) \
        ) \
    ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          mwboost::mpl::assertion_failed<false>( \
              mwboost::mpl::assert_arg( (void (*) pred)0, 1 ) \
            ) \
        ) \
    ) \
/**/
...
enum { \
      BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          mwboost::mpl::assertion<false>::failed( \
              mwboost::mpl::assert_not_arg( (void (*) pred)0, 1 ) \
            ) \
        ) \
}\
/**/
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        mwboost::mpl::assertion_failed<BOOST_PP_CAT(mpl_assert_rel_value,counter)>( \
            (mwboost::mpl::failed ************ ( mwboost::mpl::assert_relation< \
                  mwboost::mpl::assert_::relations( sizeof( \
                      mwboost::mpl::assert_::arg rel mwboost::mpl::assert_::arg \
                    ) ) \
                , x \
                , y \
                >::************)) 0 ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        mwboost::mpl::assertion_failed<BOOST_PP_CAT(mpl_assert_rel_value,counter)>( \
              mwboost::mpl::assert_rel_arg( mwboost::mpl::assert_relation< \
                  mwboost::mpl::assert_::relations(BOOST_PP_CAT(mpl_assert_rel,counter)) \
                , x \
                , y \
                >() ) \
            ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
        mwboost::mpl::assertion_failed<(x rel y)>( mwboost::mpl::assert_rel_arg( \
              mwboost::mpl::BOOST_MPL_AUX_ASSERT_RELATION(x,y,(&mwboost::mpl::operator rel))() \
            ) ) \
        ) \
    ) \
/**/
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
        mwboost::mpl::assertion_failed<(x rel y)>( (mwboost::mpl::failed ************ ( \
            mwboost::mpl::BOOST_MPL_AUX_ASSERT_RELATION(x,y,(&mwboost::mpl::operator rel))::************))0 ) \
        ) \
    ) \
/**/
#   endif
...
struct msg; \
typedef struct BOOST_PP_CAT(msg,counter) : mwboost::mpl::assert_ \
{ \
    using mwboost::mpl::assert_::types; \
    static mwboost::mpl::failed ************ (msg::************ assert_arg()) types_ \
    { return 0; } \
} BOOST_PP_CAT(mpl_assert_arg,counter); \
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        mwboost::mpl::assertion<(c)>::failed( BOOST_PP_CAT(mpl_assert_arg,counter)::assert_arg() ) \
        ) \
    ) \
/**/
#else
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        mwboost::mpl::assertion_failed<(c)>( BOOST_PP_CAT(mpl_assert_arg,counter)::assert_arg() ) \
        ) \
    ) \
/**/
#endif
