...
using mwboost::movelib::iterator_traits;
using mwboost::movelib::iter_difference;
using mwboost::movelib::iter_value;
using mwboost::movelib::iter_category;
using mwboost::movelib::iter_size;
...
////////////////////////////////////////////////////////////////////////////////
//    Conversion from mwboost::iterator traversals to std tags
////////////////////////////////////////////////////////////////////////////////
...
struct get_std_category_from_tag
   <mwboost::iterators::detail::iterator_category_with_traversal
      <Category, mwboost::iterators::incrementable_traversal_tag> >
{
...
struct get_std_category_from_tag
   <mwboost::iterators::detail::iterator_category_with_traversal
      <Category, mwboost::iterators::single_pass_traversal_tag> >
{
   typedef std::input_iterator_tag type;
};
...
struct get_std_category_from_tag
   <mwboost::iterators::detail::iterator_category_with_traversal
      <Category, mwboost::iterators::forward_traversal_tag> >
{
   typedef std::input_iterator_tag type;
};
...
struct get_std_category_from_tag
   <mwboost::iterators::detail::iterator_category_with_traversal
      <Category, mwboost::iterators::bidirectional_traversal_tag> >
{
...
struct get_std_category_from_tag
   <mwboost::iterators::detail::iterator_category_with_traversal
      <Category, mwboost::iterators::random_access_traversal_tag> >
{
...
struct get_std_category_from_it
   : get_std_category_from_tag< typename mwboost::intrusive::iter_category<It>::type >
{};
...
struct iterator_enable_if_tag
   : ::mwboost::move_detail::enable_if_c
      < ::mwboost::move_detail::is_same
...
struct iterator_enable_if_convertible_tag
   : ::mwboost::move_detail::enable_if_c
      < ::mwboost::move_detail::is_same_or_convertible
         < typename get_std_category_from_it<I>::type
         , Tag
         >::value &&
        !::mwboost::move_detail::is_same_or_convertible
...
struct iterator_enable_if_tag_difference_type
   : iterator_enable_if_tag<I, Tag, typename mwboost::intrusive::iter_difference<I>::type>
{};

template<class I, class Tag>
struct iterator_disable_if_tag_difference_type
   : iterator_disable_if_tag<I, Tag, typename mwboost::intrusive::iter_difference<I>::type>
{};
