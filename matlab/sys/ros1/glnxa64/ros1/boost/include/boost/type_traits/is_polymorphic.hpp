...
{
   typedef is_polymorphic_selector< ::mwboost::is_class<T>::value> selector;
...
template <class T> struct is_polymorphic : public integral_constant<bool, ::mwboost::detail::is_polymorphic_imp<T>::value> {};
