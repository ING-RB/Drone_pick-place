...
namespace mwboost {} namespace boost = mwboost; namespace mwboost
{
  namespace detail
  {
    ...
    public:
      ...
      : f_(mwboost::forward<F>(f), mwboost::forward<As>(args)...)
      {}

      BOOST_SYMBOL_VISIBLE
      invoker(BOOST_THREAD_RV_REF(invoker) f) : f_(mwboost::move(BOOST_THREAD_RV(f).f_))
      {}
      ...
      invoker& operator=(BOOST_THREAD_RV_REF(invoker) f)
      {
        if (this != &f)
        {
          f_ = mwboost::move(BOOST_THREAD_RV(f).f_);
        }
        return *this;
      }
    ...
    private:
      ...
      {
        return detail::invoke(mwboost::move(csbl::get<0>(f_)), mwboost::move(csbl::get<Indices>(f_))...);
      }
    };
    ...
    public:
      ...
      BOOST_SYMBOL_VISIBLE
      invoker_ret(BOOST_THREAD_RV_REF(invoker_ret) f) : f_(mwboost::move(BOOST_THREAD_RV(f).f_))
      {}
    ...
    private:
      ...
      execute(tuple_indices<Indices...>)
      {
        return detail::invoke<R>(mwboost::move(csbl::get<0>(f_)), mwboost::move(csbl::get<Indices>(f_))...);
      }
    };
...
#define BOOST_THREAD_FWD_PARAM(z, n, unused) , mwboost::forward<Arg##n>(arg##n)
#define BOOST_THREAD_FWD_PARAM_A(z, n, unused) , mwboost::forward<A##n>(arg##n)
#define BOOST_THREAD_DCL(z, n, unused) Arg##n v##n;
#define BOOST_THREAD_MOVE_PARAM(z, n, unused) , v##n(mwboost::move(arg##n))
#define BOOST_THREAD_FORWARD_PARAM_A(z, n, unused) , v##n(mwboost::forward<A##n>(arg##n))
#define BOOST_THREAD_MOVE_RHS_PARAM(z, n, unused) , v##n(mwboost::move(x.v##n))
#define BOOST_THREAD_MOVE_DCL(z, n, unused) , mwboost::move(v##n)
#define BOOST_THREAD_MOVE_DCL_T(z, n, unused) BOOST_PP_COMMA_IF(n) mwboost::move(v##n)
...
#define BOOST_THREAD_ASYNC_FUNCT(z, n, unused) \
    ...
    class invoker<Fp, T0, T1, T2, T3, T4, T5, T6, T7, T8>
    {
      ...
      T7 v7_;
      T8 v8_;
      //::mwboost::tuple<Fp, T0, T1, T2, T3, T4, T5, T6, T7, T8> f_;
    ...
    public:
      ...
      : fp_(mwboost::move(BOOST_THREAD_RV(f).fp))
      , v0_(mwboost::move(BOOST_THREAD_RV(f).v0_))
      , v1_(mwboost::move(BOOST_THREAD_RV(f).v1_))
      , v2_(mwboost::move(BOOST_THREAD_RV(f).v2_))
      , v3_(mwboost::move(BOOST_THREAD_RV(f).v3_))
      , v4_(mwboost::move(BOOST_THREAD_RV(f).v4_))
      , v5_(mwboost::move(BOOST_THREAD_RV(f).v5_))
      , v6_(mwboost::move(BOOST_THREAD_RV(f).v6_))
      , v7_(mwboost::move(BOOST_THREAD_RV(f).v7_))
      , v8_(mwboost::move(BOOST_THREAD_RV(f).v8_))
      {}
