/*
  Helper class used by variadic implementation of variadic mwboost::signals2::signal.
...
// if compiler has std::tuple use it instead of mwboost::tuple
// because mwboost::tuple does not have variadic template support at present.
#ifdef BOOST_NO_CXX11_HDR_TUPLE
#include <boost/tuple/tuple.hpp>
#define BOOST_SIGNALS2_TUPLE mwboost::tuple
#define BOOST_SIGNALS2_GET mwboost::get
#else
#include <tuple>
      ...
      private:
        template<typename Func, unsigned ... indices, typename ... Args>
          R m_invoke(Func &func, unsigned_meta_array<indices...>, const BOOST_SIGNALS2_TUPLE<Args...> & args,
            typename mwboost::disable_if<mwboost::is_void<typename Func::result_type> >::type * = 0
          ) const
        {
        ...
        template<typename Func, unsigned ... indices, typename ... Args>
          R m_invoke(Func &func, unsigned_meta_array<indices...>, const BOOST_SIGNALS2_TUPLE<Args...> & args,
            typename mwboost::enable_if<mwboost::is_void<typename Func::result_type> >::type * = 0
          ) const
        {
