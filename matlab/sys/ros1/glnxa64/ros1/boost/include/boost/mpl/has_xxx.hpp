...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace mpl { namespace aux {
...
template< typename T, typename name = ::mwboost::mpl::aux::has_xxx_tag > \
struct BOOST_PP_CAT(trait,_impl) : T \
{ \
    static mwboost::mpl::aux::no_tag \
    test(void(*)(::mwboost::mpl::aux::has_xxx_tag)); \
    \
    static mwboost::mpl::aux::yes_tag test(...); \
    \
    BOOST_STATIC_CONSTANT(bool, value = \
          sizeof(test(static_cast<void(*)(name)>(0))) \
            != sizeof(mwboost::mpl::aux::no_tag) \
        ); \
    typedef mwboost::mpl::bool_<value> type; \
}; \
\
template< typename T, typename fallback_ = mwboost::mpl::bool_<default_> > \
struct trait \
    : mwboost::mpl::if_c< \
          mwboost::mpl::aux::msvc_is_incomplete<T>::value \
        , mwboost::mpl::bool_<false> \
...
{ \
    BOOST_STATIC_CONSTANT(bool, value = false); \
    typedef mwboost::mpl::bool_<false> type; \
}; \
/**/
...
{ \
    ...
    { \
        template < class U > \
        static int  resolve( mwboost::mpl::aux::type_wrapper<U> const volatile * \
                           , mwboost::mpl::aux::type_wrapper<typename U::name >* = 0 ); \
        static char resolve( ... ); \
    }; \
    typedef mwboost::mpl::aux::type_wrapper<T> t_; \
    BOOST_STATIC_CONSTANT( bool, value = ( sizeof( trait_tester_impl::resolve( static_cast< t_ * >(0) ) ) == sizeof(int) ) ); \
}; \
template< typename T, typename fallback_ = mwboost::mpl::bool_<default_> > \
struct trait           \
{                      \
    BOOST_STATIC_CONSTANT( bool, value = (trait_tester< T, mwboost::is_class< T >::value >::value) );     \
    typedef mwboost::mpl::bool_< trait< T, fallback_ >::value > type; \
};
...
{ \
    ...
    { \
        template< typename U > \
        static mwboost::mpl::aux::yes_tag test( \
              mwboost::mpl::aux::type_wrapper<U> const volatile* \
            , mwboost::mpl::aux::type_wrapper<BOOST_MSVC_TYPENAME U::name>* = 0 \
            ); \
    \
        static mwboost::mpl::aux::no_tag test(...); \
    }; \
    \
    typedef mwboost::mpl::aux::type_wrapper<T> t_; \
    BOOST_STATIC_CONSTANT(bool, value = \
          sizeof(gcc_3_2_wknd::test(static_cast<t_*>(0))) \
            == sizeof(mwboost::mpl::aux::yes_tag) \
        ); \
    typedef mwboost::mpl::bool_<value> type; \
}; \
/**/
...
#     define BOOST_MPL_HAS_MEMBER_MULTI_ACCEPT(z, n, args) \
        template< typename V > \
        static mwboost::mpl::aux::yes_tag \
        BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)( \
            mwboost::mpl::aux::type_wrapper< V > const volatile* \
...
#       define BOOST_MPL_HAS_MEMBER_TEST(args) \
          sizeof( \
              BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)( \
                  static_cast< mwboost::mpl::aux::type_wrapper< U >* >(0) \
              ) \
          ) == sizeof(mwboost::mpl::aux::yes_tag) \
        /**/
#     else
...
#   define BOOST_MPL_HAS_MEMBER_IMPLEMENTATION( \
      ...
      template< \
          typename T \
        , typename fallback_ \
              = mwboost::mpl::bool_< BOOST_PP_ARRAY_ELEM(3, args) > \
      > \
...
#   define BOOST_MPL_HAS_XXX_TEMPLATE_NAMED_DEF(trait, name, default_) \
      template< typename T \
              , typename fallback_ = mwboost::mpl::bool_< default_ > > \
      struct trait { \
          BOOST_STATIC_CONSTANT(bool, value = fallback_::value); \
          typedef fallback_ type; \
      }; \
