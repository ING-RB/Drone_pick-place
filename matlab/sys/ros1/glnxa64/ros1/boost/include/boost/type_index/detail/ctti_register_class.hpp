...
/// \brief Contains BOOST_TYPE_INDEX_REGISTER_CLASS macro implementation that uses mwboost::typeindex::ctti_type_index.
...
#define BOOST_TYPE_INDEX_REGISTER_CLASS                                                                             \
    virtual const mwboost::typeindex::detail::ctti_data& boost_type_index_type_id_runtime_() const BOOST_NOEXCEPT {   \
        return mwboost::typeindex::detail::ctti_construct_typeid_ref(this);                                           \
    }                                                                                                               \
/**/
/// @endcond
