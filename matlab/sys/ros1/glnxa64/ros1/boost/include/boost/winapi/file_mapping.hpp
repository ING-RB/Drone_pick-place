...
CreateFileMappingA(
    ...
    mwboost::winapi::DWORD_ flProtect,
    mwboost::winapi::DWORD_ dwMaximumSizeHigh,
    mwboost::winapi::DWORD_ dwMaximumSizeLow,
...
MapViewOfFile(
    mwboost::winapi::HANDLE_ hFileMappingObject,
    mwboost::winapi::DWORD_ dwDesiredAccess,
    mwboost::winapi::DWORD_ dwFileOffsetHigh,
    mwboost::winapi::DWORD_ dwFileOffsetLow,
    mwboost::winapi::SIZE_T_ dwNumberOfBytesToMap);

BOOST_WINAPI_IMPORT mwboost::winapi::LPVOID_ BOOST_WINAPI_WINAPI_CC
MapViewOfFileEx(
    mwboost::winapi::HANDLE_ hFileMappingObject,
    mwboost::winapi::DWORD_ dwDesiredAccess,
    mwboost::winapi::DWORD_ dwFileOffsetHigh,
    mwboost::winapi::DWORD_ dwFileOffsetLow,
    mwboost::winapi::SIZE_T_ dwNumberOfBytesToMap,
    mwboost::winapi::LPVOID_ lpBaseAddress);
...
FlushViewOfFile(
    mwboost::winapi::LPCVOID_ lpBaseAddress,
    mwboost::winapi::SIZE_T_ dwNumberOfBytesToFlush);

BOOST_WINAPI_IMPORT_EXCEPT_WM mwboost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
UnmapViewOfFile(mwboost::winapi::LPCVOID_ lpBaseAddress);
