...
/*
  mwboost::signals2::connection provides a handle to a signal/slot connection.
  ...
  namespace signals2
  {
    ...
    namespace detail
    {
      ...
      public:
        ...
        connection_body(const SlotType &slot_in, const mwboost::shared_ptr<mutex_type> &signal_mutex):
      ...
      private:
        mutable mwboost::shared_ptr<SlotType> m_slot;
    ...
    public:
      ...
      {}
      connection(const mwboost::weak_ptr<detail::connection_body_base> &connectionBody) BOOST_NOEXCEPT:
      ...
      {
        mwboost::shared_ptr<detail::connection_body_base> connectionBody(_weak_connection_body.lock());
      ...
      {
        mwboost::shared_ptr<detail::connection_body_base> connectionBody(_weak_connection_body.lock());
        mwboost::shared_ptr<detail::connection_body_base> otherConnectionBody(other._weak_connection_body.lock());
