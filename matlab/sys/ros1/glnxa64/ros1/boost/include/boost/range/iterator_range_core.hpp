...
namespace mwboost {} namespace boost = mwboost; namespace mwboost
{
    namespace iterator_range_detail
    {
        ...
        struct iterator_range_impl {
            ...
            {
                return IteratorT( mwboost::begin( r ) );
            }

            template< class ForwardRange >
            static IteratorT adl_end( ForwardRange& r )
            {
                return IteratorT( mwboost::end( r ) );
            }
        };
        ...
        {
            return std::lexicographical_compare( mwboost::begin(l),
                                                 mwboost::end(l),
                                                 mwboost::begin(r),
                                                 mwboost::end(r) );
        }
...
incrementable_t test_traversal_tag(mwboost::incrementable_traversal_tag);
bidirectional_t test_traversal_tag(mwboost::bidirectional_traversal_tag);
random_access_t test_traversal_tag(mwboost::random_access_traversal_tag);

template<std::size_t S>
struct pure_iterator_traversal_impl
{
    typedef mwboost::incrementable_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(bidirectional_t)>
{
    typedef mwboost::bidirectional_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(random_access_t)>
{
    typedef mwboost::random_access_traversal_tag type;
};
...
public:
    ...
    reference back() const
    {
        ...
        return *mwboost::prior(this->m_End);
    }
...
//  iterator range template class -----------------------------------------//
        ...
        /*!
            ...
            \code
                mwboost::tolower( find( s, "UPPERCASE STRING" ) );
            \endcode
...
//  iterator range free-standing operators ---------------------------//
        ...
        inline BOOST_DEDUCED_TYPENAME mwboost::enable_if<
        ...
        template< class IteratorT, class ForwardRange >
        inline BOOST_DEDUCED_TYPENAME mwboost::enable_if<
            mpl::not_<mwboost::is_base_and_derived<iterator_range_detail::iterator_range_tag, ForwardRange> >,
            bool
        >::type
        operator!=( const ForwardRange& l, const iterator_range<IteratorT>& r )
        {
...
//  iterator range utilities -----------------------------------------//
        ...
        */
        ...
        {
            return iterator_range<IteratorT>(first, mwboost::next(first, n));
        }
        ...
        namespace iterator_range_detail
        {
                             ...
                             BOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_end )
            {
                ...
                BOOST_DEDUCED_TYPENAME range_iterator<Range>::type
                    new_begin = mwboost::begin( r ),
                    new_end   = mwboost::end( r );
        ...
        */
        ...
        {
            return SeqT( mwboost::begin( r ), mwboost::end( r ) );
        }
