...
#include  <memory>
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace exception_detail { using std::shared_ptr; } }
#else
namespace mwboost {} namespace boost = mwboost; namespace mwboost { template <class T> class shared_ptr; }
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace exception_detail { using mwboost::shared_ptr; } }
#endif
...
mwboost
    ...
    exception_detail
        ...
        mwboost::source_location get_exception_throw_location( exception const & );
        }
    ...
    exception
...
#ifdef __HP_aCC
        //On HP aCC, this protected copy constructor prevents throwing mwboost::exception.
        ...
        friend mwboost::source_location exception_detail::get_exception_throw_location( exception const & );
    ...
    exception_detail
        ...
        inline mwboost::source_location get_exception_throw_location( exception const & x )
            {
