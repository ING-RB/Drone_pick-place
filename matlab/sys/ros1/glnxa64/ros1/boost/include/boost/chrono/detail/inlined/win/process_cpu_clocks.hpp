...
process_user_cpu_clock::time_point process_user_cpu_clock::now() BOOST_NOEXCEPT
{
    ...
    mwboost::winapi::FILETIME_ creation, exit, user_time, system_time;

    if ( mwboost::winapi::GetProcessTimes(
            mwboost::winapi::GetCurrentProcess(), &creation, &exit,
        ...
        system::error_code & ec)
{
    ...
    {
        mwboost::winapi::DWORD_ cause = mwboost::winapi::GetLastError();
        if (::mwboost::chrono::is_throws(ec))
        {
            mwboost::throw_exception(
                    system::system_error(
