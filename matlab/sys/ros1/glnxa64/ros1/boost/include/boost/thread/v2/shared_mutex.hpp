...
public:
    ...
    template <class Rep, class Period>
        bool try_lock_for(const mwboost::chrono::duration<Rep, Period>& rel_time);
    template <class Clock, class Duration>
        bool
        try_lock_until(
                      const mwboost::chrono::time_point<Clock, Duration>& abs_time);
    void unlock();
    ...
    template <class Rep, class Period>
        bool
        try_lock_shared_for(const mwboost::chrono::duration<Rep, Period>& rel_time);
    template <class Clock, class Duration>
        bool
...
public:
    ...
    template <class Rep, class Period>
        ...
        try_lock_upgrade_for(
                            const mwboost::chrono::duration<Rep, Period>& rel_time);
    template <class Clock, class Duration>
        bool
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost {
  namespace thread_v2 {
    ...
    class shared_mutex
    {
      typedef mwboost::mutex              mutex_t;
      typedef mwboost::condition_variable cond_t;
...
#ifdef BOOST_THREAD_USES_CHRONO
      template <class Rep, class Period>
      bool try_lock_shared_for(const mwboost::chrono::duration<Rep, Period>& rel_time)
      {
    ...
    inline shared_mutex::~shared_mutex()
    {
      mwboost::lock_guard<mutex_t> _(mut_);
    }
    ...
    {
      mwboost::unique_lock<mutex_t> lk(mut_);
      gate1_.wait(lk, mwboost::bind(&shared_mutex::no_writer, mwboost::ref(*this)));
      state_ |= write_entered_;
      gate2_.wait(lk, mwboost::bind(&shared_mutex::no_readers, mwboost::ref(*this)));
    }
    ...
    {
      mwboost::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.wait_until(lk, abs_time, mwboost::bind(
            &shared_mutex::no_writer, mwboost::ref(*this))))
      {
        return false;
      }
      state_ |= write_entered_;
      if (!gate2_.wait_until(lk, abs_time, mwboost::bind(
            &shared_mutex::no_readers, mwboost::ref(*this))))
      {
        state_ &= ~write_entered_;
        return false;
      }
    ...
    {
      mwboost::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.timed_wait(lk, abs_or_rel_time, mwboost::bind(
            &shared_mutex::no_writer, mwboost::ref(*this))))
      {
        return false;
      }
      state_ |= write_entered_;
      if (!gate2_.timed_wait(lk, abs_or_rel_time, mwboost::bind(
            &shared_mutex::no_readers, mwboost::ref(*this))))
      {
        state_ &= ~write_entered_;
        return false;
    ...
    {
      mwboost::unique_lock<mutex_t> lk(mut_);
      gate1_.wait(lk, mwboost::bind(&shared_mutex::no_writer_no_max_readers, mwboost::ref(*this)));
        ...
        const mwboost::chrono::time_point<Clock, Duration>& abs_time)
    {
      mwboost::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.wait_until(lk, abs_time, mwboost::bind(
            &shared_mutex::no_writer_no_max_readers, mwboost::ref(*this))))
      {
        return false;
      }
      count_t num_readers = (state_ & n_readers_) + 1;
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost {
  namespace thread_v2 {
    ...
    {
      mwboost::unique_lock<mutex_t> lk(mut_);
      gate1_.wait(lk, mwboost::bind(&upgrade_mutex::no_writer_no_upgrader, mwboost::ref(*this)));
      state_ |= write_entered_;
      gate2_.wait(lk, mwboost::bind(&upgrade_mutex::no_readers, mwboost::ref(*this)));
    }
        ...
        const mwboost::chrono::time_point<Clock, Duration>& abs_time)
    {
      mwboost::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.wait_until(lk, abs_time, mwboost::bind(
            &upgrade_mutex::no_writer_no_upgrader, mwboost::ref(*this))))
      {
        return false;
      }
      state_ |= write_entered_;
      if (!gate2_.wait_until(lk, abs_time, mwboost::bind(
            &upgrade_mutex::no_readers, mwboost::ref(*this))))
      {
        state_ &= ~write_entered_;
        return false;
      }
    ...
    {
      mwboost::unique_lock<mutex_t> lk(mut_);
      gate1_.wait(lk, mwboost::bind(&upgrade_mutex::no_writer_no_max_readers, mwboost::ref(*this)));
      count_t num_readers = (state_ & n_readers_) + 1;
      state_ &= ~n_readers_;
      state_ |= num_readers;
    }
        ...
        const mwboost::chrono::time_point<Clock, Duration>& abs_time)
    {
      mwboost::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.wait_until(lk, abs_time, mwboost::bind(
            &upgrade_mutex::no_writer_no_max_readers, mwboost::ref(*this))))
      {
        return false;
      }
      count_t num_readers = (state_ & n_readers_) + 1;
    ...
    {
      mwboost::unique_lock<mutex_t> lk(mut_);
      gate1_.wait(lk, mwboost::bind(&upgrade_mutex::no_writer_no_upgrader_no_max_readers, mwboost::ref(*this)));
      count_t num_readers = (state_ & n_readers_) + 1;
      state_ &= ~n_readers_;
        ...
        const mwboost::chrono::time_point<Clock, Duration>& abs_time)
    {
      mwboost::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.wait_until(lk, abs_time, mwboost::bind(
            &upgrade_mutex::no_writer_no_upgrader_no_max_readers, mwboost::ref(*this))))
      {
        return false;
      }
      count_t num_readers = (state_ & n_readers_) + 1;
