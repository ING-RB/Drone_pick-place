...
template< BOOST_MPL_PP_PARAMS(i,typename T) > \
::mwboost::mpl::aux::yes_tag operator|( \
      ::mwboost::mpl::aux::has_rebind_tag<int> \
    , name<BOOST_MPL_PP_PARAMS(i,T)>* \
    ); \
::mwboost::mpl::aux::no_tag operator|( \
      ::mwboost::mpl::aux::has_rebind_tag<int> \
    , name< BOOST_MPL_PP_ENUM(i,::mwboost::mpl::na) >* \
    ); \
/**/
...
::mwboost::mpl::aux::yes_tag operator|( \
      ::mwboost::mpl::aux::has_rebind_tag<int> \
    , ::mwboost::mpl::aux::has_rebind_tag< name<BOOST_MPL_PP_PARAMS(i,T)> >* \
    ); \
/**/
#else
#   define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params) /**/
