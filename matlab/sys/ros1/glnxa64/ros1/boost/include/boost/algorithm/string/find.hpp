...
//  Generic find -----------------------------------------------//
        ...
        */
        ...
        {
            iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_input(::mwboost::as_literal(Input));

            return Finder(::mwboost::begin(lit_input),::mwboost::end(lit_input));
        }
...
//  find_first  -----------------------------------------------//
        ...
        */
        ...
        {
            return ::mwboost::algorithm::find(Input, ::mwboost::algorithm::first_finder(Search));
        }
        ...
        */
        ...
        {
            return ::mwboost::algorithm::find(Input, ::mwboost::algorithm::first_finder(Search,is_iequal(Loc)));
        }
...
//  find_last  -----------------------------------------------//
        ...
        */
        ...
        find_last( 
            ...
            const Range2T& Search)
        {
            return ::mwboost::algorithm::find(Input, ::mwboost::algorithm::last_finder(Search));
        }
        ...
        */
        ...
        ifind_last( 
            ...
            const std::locale& Loc=std::locale())
        {
            return ::mwboost::algorithm::find(Input, ::mwboost::algorithm::last_finder(Search, is_iequal(Loc)));
        }
...
//  find_nth ----------------------------------------------------------------------//
        ...
        */
        ...
        find_nth( 
            ...
            int Nth)
        {
            return ::mwboost::algorithm::find(Input, ::mwboost::algorithm::nth_finder(Search,Nth));
        }
        ...
        */
        ...
        ifind_nth( 
            ...
            const std::locale& Loc=std::locale())
        {
            return ::mwboost::algorithm::find(Input, ::mwboost::algorithm::nth_finder(Search,Nth,is_iequal(Loc)));
        }
...
//  find_head ----------------------------------------------------------------------//
        ...
        */
        ...
        find_head( 
            ...
            int N)
        {
            return ::mwboost::algorithm::find(Input, ::mwboost::algorithm::head_finder(N));
        }
...
//  find_tail ----------------------------------------------------------------------//
        ...
        */
        ...
        find_tail( 
            ...
            int N)
        {
            return ::mwboost::algorithm::find(Input, ::mwboost::algorithm::tail_finder(N));
        }
...
//  find_token --------------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::mwboost::algorithm::find(Input, ::mwboost::algorithm::token_finder(Pred, eCompress));
        }
