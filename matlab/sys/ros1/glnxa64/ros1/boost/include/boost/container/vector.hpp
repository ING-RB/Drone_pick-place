...
class vec_iterator
{
   ...
   // Boost patch, can be removed in 1.79.0
   ...
   #endif
   typedef typename mwboost::intrusive::pointer_traits<Pointer>::element_type         value_type;
   ...
   //Define element_
   typedef typename mwboost::intrusive::pointer_traits<Pointer>::element_type         element_type;
   #endif
   typedef typename mwboost::intrusive::pointer_traits<Pointer>::difference_type      difference_type;
   typedef typename mwboost::intrusive::pointer_traits<Pointer>::size_type            size_type;
   typedef typename dtl::if_c
      < IsConst
      , typename mwboost::intrusive::pointer_traits<Pointer>::template
                                 rebind_pointer<const value_type>::type
      , Pointer
      >::type                                                                       pointer;
   typedef typename mwboost::intrusive::pointer_traits<pointer>                       ptr_traits;
   ...
   : public Allocator
{
   ...
   typedef mwboost::container::allocator_traits<allocator_type>  allocator_traits_type;
   ...
   explicit vector_alloc_holder(BOOST_FWD_REF(AllocConvertible) a) BOOST_NOEXCEPT_OR_NOTHROW
      : allocator_type(mwboost::forward<AllocConvertible>(a)), m_start(), m_size(), m_capacity()
   {}
   ...
   vector_alloc_holder(vector_uninitialized_size_t, BOOST_FWD_REF(AllocConvertible) a, SizeType initial_size)
      : allocator_type(mwboost::forward<AllocConvertible>(a))
      , m_start()
      ...
      , m_capacity()
   {
      if (BOOST_UNLIKELY(initial_size > size_type(-1))){
         mwboost::container::throw_length_error("get_next_capacity, allocator's max size reached");
      }
   ...
   vector_alloc_holder(initial_capacity_t, pointer p, size_type n, BOOST_FWD_REF(AllocFwd) a)
      : allocator_type(::mwboost::forward<AllocFwd>(a))
      , m_start(p)
      , m_size()
      , m_capacity(n)
   {}
   ...
   BOOST_CONTAINER_FORCEINLINE pointer allocation_command(mwboost::container::allocation_type command,
   ...
   {
      mwboost::adl_move_swap(this->m_start, x.m_start);
      mwboost::adl_move_swap(this->m_size, x.m_size);
      mwboost::adl_move_swap(this->m_capacity, x.m_capacity);
   }
   ...
   pointer priv_allocation_command(version_1, mwboost::container::allocation_type command,
   ...
   pointer priv_allocation_command(version_2, mwboost::container::allocation_type command,
                         size_type limit_size,
                         size_type &prefer_in_recvd_out_size,
                         pointer &reuse)
   {
   ...
   : public Allocator
{
   ...
   template<class AllocConvertible>
   explicit vector_alloc_holder(BOOST_FWD_REF(AllocConvertible) a) BOOST_NOEXCEPT_OR_NOTHROW
      : allocator_type(mwboost::forward<AllocConvertible>(a)), m_size()
   {}
   ...
   {
      ::mwboost::container::uninitialized_move_alloc_n
         (this->alloc(), mwboost::movelib::to_raw_pointer(holder.start()), m_size, mwboost::movelib::to_raw_pointer(this->start()));
      ::mwboost::container::destroy_alloc_n
         (this->alloc(), mwboost::movelib::to_raw_pointer(holder.start()), m_size);
      holder.m_size = 0;
   }
      ...
      , m_size(holder.m_size) //Initialize it to m_size as first_allocation can only succeed or abort
   {
      ...
      ::mwboost::container::uninitialized_move_alloc_n
         (this->alloc(), mwboost::movelib::to_raw_pointer(holder.start()), n, mwboost::movelib::to_raw_pointer(this->start()));
   }
   ...
   void priv_deep_swap(vector_alloc_holder<OtherAllocator, OtherStoredSizeType, OtherAllocatorVersion> &x)
   {
      ...
      value_type *const first_this = mwboost::movelib::to_raw_pointer(this->start());
      value_type *const first_x = mwboost::movelib::to_raw_pointer(x.start());

      if(this->m_size < x.m_size){
         mwboost::container::deep_swap_alloc_n<MaxTmpStorage>(this->alloc(), first_this, this->m_size, first_x, x.m_size);
      }
      else{
         mwboost::container::deep_swap_alloc_n<MaxTmpStorage>(this->alloc(), first_x, x.m_size, first_this, this->m_size);
      }
      mwboost::adl_move_swap(this->m_size, x.m_size);
   }
};
...
//! \tparam Options A type produced from \c mwboost::container::vector_options.
...
public:
   ...
   typedef ::mwboost::container::allocator_traits<allocator_type>                        allocator_traits_t;
   ...
   typedef BOOST_CONTAINER_IMPDEF(mwboost::container::reverse_iterator<iterator>)        reverse_iterator;
   typedef BOOST_CONTAINER_IMPDEF(mwboost::container::reverse_iterator<const_iterator>)  const_reverse_iterator;

private:

   #ifndef BOOST_CONTAINER_DOXYGEN_INVOKED
   typedef typename mwboost::container::
   ...
   typedef typename dtl::version<allocator_type>::type alloc_version;
   typedef mwboost::container::vector_alloc_holder
   ...
   BOOST_CONTAINER_FORCEINLINE vector(initial_capacity_t, pointer initial_memory, size_type cap, BOOST_FWD_REF(AllocFwd) a)
      : m_holder(initial_capacity_t(), initial_memory, cap, ::mwboost::forward<AllocFwd>(a))
   {}
      ...
      :  m_holder(vector_uninitialized_size, n)
   {
      ...
      this->num_alloc += n != 0;
      #endif
      mwboost::container::uninitialized_value_init_alloc_n
      ...
      :  m_holder(vector_uninitialized_size, n)
   {
      ...
      this->num_alloc += n != 0;
      #endif
      mwboost::container::uninitialized_default_init_alloc_n
         (this->m_holder.alloc(), n, this->priv_raw_begin());
   }
      ...
      :  m_holder(vector_uninitialized_size, n)
   {
      ...
      this->num_alloc += n != 0;
      #endif
      mwboost::container::uninitialized_fill_alloc_n
...
//           ) -> vector<typename iterator_traits<InIt>::value_type, new_allocator<typename iterator_traits<InIt>::value_type>>;
                 ...
                 , x.size())
   {
      ...
      #endif
      ::mwboost::container::uninitialized_copy_alloc_n
   ...
   vector(BOOST_RV_REF(vector) x) BOOST_NOEXCEPT_OR_NOTHROW
      :  m_holder(mwboost::move(x.m_holder))
      ...
      :  m_holder(vector_uninitialized_size, a, il.size())
   {
      ...
      #endif
      ::mwboost::container::uninitialized_copy_alloc_n_source
                 ...
                 )
   {
      ...
      if(is_propagable_from(x.get_stored_allocator(), x.m_holder.start(), a, false)){
         ...
         this->num_alloc += n != 0;
         #endif
         ::mwboost::container::uninitialized_move_alloc_n_source
            ( this->m_holder.alloc(), x.priv_raw_begin()
   ...
   {
      if (BOOST_LIKELY(&x != this)){
         this->priv_move_assign(mwboost::move(x));
      }
      return *this;
   }
      ...
      )
   {
      ...
      if (first == last){
         ...
         const size_type n = static_cast<size_type>(end_pos - mwboost::movelib::iterator_to_raw_pointer(cur));
      ...
      )
   {
      ...
      const it_size_type sz = mwboost::container::iterator_udistance(first, last);
      if (BOOST_UNLIKELY(sz > size_type(-1))){
         mwboost::container::throw_length_error("vector::assign, FwdIt's max length reached");
      }
      ...
      mwboost::container::copy_assign_range_alloc_n(this->m_holder.alloc(), first, input_sz, this->priv_raw_begin(), this->size());
   ...
   BOOST_CONTAINER_FORCEINLINE reference emplace_back(BOOST_FWD_REF(Args)...args)
   {
      ...
      if (BOOST_LIKELY(this->room_enough())){
         ...
         allocator_traits_type::construct(this->m_holder.alloc(), p, ::mwboost::forward<Args>(args)...);
         ...
         return *this->priv_insert_forward_range_no_capacity
            (p, 1, proxy_t(::mwboost::forward<Args>(args)...), alloc_version());
      }
   }
   ...
   BOOST_CONTAINER_FORCEINLINE bool stable_emplace_back(BOOST_FWD_REF(Args)...args)
   {
      ...
      if (BOOST_LIKELY(is_room_enough)){
         //There is more memory, just construct a new object at the end
         allocator_traits_type::construct(this->m_holder.alloc(), this->priv_raw_end(), ::mwboost::forward<Args>(args)...);
         ++this->m_holder.m_size;
      }
   ...
   BOOST_CONTAINER_FORCEINLINE iterator emplace(const_iterator position, BOOST_FWD_REF(Args) ...args)
   {
      ...
      return this->priv_insert_forward_range( vector_iterator_get_ptr(position), 1
                                            , proxy_t(::mwboost::forward<Args>(args)...));
   }
   ...
   //!
   //! <b>Complexity</b>: Linear to mwboost::container::iterator_distance [first, last).
   template <class InIt>
      ...
      )
   {
      ...
      const it_size_type sz = mwboost::container::iterator_udistance(first, last);
      if (BOOST_UNLIKELY(sz > size_type(-1))){
         mwboost::container::throw_length_error("vector::insert, FwdIt's max length reached");
      }
   ...
   //!   be equal to mwboost::container::iterator_distance(first, last)
   //!
   //! <b>Effects</b>: Insert a copy of the [first, last) range before pos.
   //!
   //! <b>Returns</b>: an iterator to the first inserted element or pos if first == last.
   ...
   //! <b>Complexity</b>: Linear to mwboost::container::iterator_distance [first, last).
   //!
   //! <b>Note</b>: This function avoids a linear operation to calculate mwboost::container::iterator_distance[first, last)
   ...
   BOOST_CONTAINER_FORCEINLINE iterator insert(const_iterator pos, size_type num, InIt first, InIt last)
   {
      ...
      BOOST_ASSERT(dtl::is_input_iterator<InIt>::value ||
                   num == mwboost::container::iterator_udistance(first, last));
      (void)last;
   ...
   iterator erase(const_iterator position)
   {
      ...
      T *const pos_ptr = mwboost::movelib::to_raw_pointer(p);
      T *const end_ptr = this->priv_raw_end();

      //Move elements forward and destroy last
      (void)::mwboost::container::move(pos_ptr + 1, end_ptr, pos_ptr);
   ...
   iterator erase(const_iterator first, const_iterator last)
   {
      ...
      if(first != last){
         ...
         T* const first_ptr = mwboost::movelib::to_raw_pointer(vector_iterator_get_ptr(first));
         T* const last_ptr  = mwboost::movelib::to_raw_pointer(vector_iterator_get_ptr(last));
         T* const new_last_ptr = mwboost::movelib::to_raw_pointer(mwboost::container::move(last_ptr, old_end_ptr, first_ptr));
         ...
         if(!value_traits::trivial_dctr_after_move || old_end_ptr == last_ptr){
            mwboost::container::destroy_alloc_n(this->get_stored_allocator(), new_last_ptr, n);
         }
   ...
   {  return x.size() == y.size() && ::mwboost::container::algo_equal(x.begin(), x.end(), y.begin());  }
   ...
   {  return mwboost::container::algo_lexicographical_compare(x.begin(), x.end(), y.begin(), y.end());  }
   ...
   BOOST_CONTAINER_FORCEINLINE void merge(InputIt first, InputIt last, Compare comp)
   {
      ...
      if(!dtl::is_input_iterator<InputIt>::value &&
         free_cap < (n = mwboost::container::iterator_udistance(first, last))){
         ...
         mwboost::movelib::adaptive_merge(raw_beg, raw_pos, raw_end, comp, raw_end, free_cap - n);
      }
   }
   ...
   BOOST_CONTAINER_FORCEINLINE void merge_unique(InputIt first, InputIt last, Compare comp)
   {
      ...
      mwboost::movelib::adaptive_merge(raw_beg, raw_pos, raw_end, comp, raw_end, this->capacity() - this->size());
   }
   ...
   void priv_merge_in_new_buffer(FwdIt first, size_type n, Compare comp, Version)
   {
      ...
      T* d_first = mwboost::movelib::to_raw_pointer(new_storage);
      size_type added = n;
      //Merge in new buffer loop
      while(1){
         if(!n) {
            ::mwboost::container::uninitialized_move_alloc(this->m_holder.alloc(), pbeg, pend, d_first);
            break;
         } 
         else if(pbeg == pend) {
            ::mwboost::container::uninitialized_move_alloc_n(this->m_holder.alloc(), first, n, d_first);
            break;
         }
         //maintain stability moving external values only if they are strictly less
            ...
            allocator_traits_type::construct( this->m_holder.alloc(), d_first, mwboost::move(*pbeg) );
            new_values_destroyer.increment_size(1u);
            ++pbeg;
            ++d_first;
         }
      ...
      mwboost::container::destroy_alloc_n(a, mwboost::movelib::to_raw_pointer(old_p), old_size);
      if (old_cap > 0) {
         ...
         < dtl::is_version<typename real_allocator<T, OtherA>::type, 0>::value >::type * = 0)
   {
      ...
      mwboost::container::move_assign_range_alloc_n(this->m_holder.alloc(), other_start, other_sz, this_start, this_sz);
         ...
         >::type * = 0)
   {
      ...
      //elements are still alive in the source container.
         ...
         this->assign( mwboost::make_move_iterator(mwboost::movelib::iterator_to_raw_pointer(x.begin()))
                     , mwboost::make_move_iterator(mwboost::movelib::iterator_to_raw_pointer(x.end()  ))
                     );
         x.clear();
      }
         ...
         < dtl::is_version<typename real_allocator<T, OtherA>::type, 0>::value >::type * = 0)
   {
      ...
      const size_type this_sz  = m_holder.m_size;
      const size_type other_sz = static_cast<size_type>(x.m_holder.m_size);
      mwboost::container::copy_assign_range_alloc_n(this->m_holder.alloc(), other_start, other_sz, this_start, this_sz);
      m_holder.set_stored_size(other_sz);
   }
      ...
      if (BOOST_UNLIKELY(&x == this)){
         ...
         if(sml.empty() && is_propagable_from(big.get_stored_allocator(), big.data(), sml.get_allocator(), propagate_alloc)){
            ...
            for(size_type i = 0; i != common_elements; ++i){
               mwboost::adl_move_swap(sml[i], big[i]);
            }
            //... and move-insert the remaining range
            sml.insert( sml.cend()
                      , mwboost::make_move_iterator(mwboost::movelib::iterator_to_raw_pointer(big.nth(common_elements)))
                      , mwboost::make_move_iterator(mwboost::movelib::iterator_to_raw_pointer(big.end()))
                      );
   ...
   BOOST_CONTAINER_FORCEINLINE dtl::insert_range_proxy<allocator_type, mwboost::move_iterator<T*> > priv_dummy_empty_proxy()
   {
      return dtl::insert_range_proxy<allocator_type, mwboost::move_iterator<T*> >
         (::mwboost::make_move_iterator((T *)0));
   }
   ...
   BOOST_CONTAINER_FORCEINLINE void priv_move_to_new_buffer(size_type new_cap, version_1)
   {
      ...
      this->priv_insert_forward_range_new_allocation
         ( mwboost::movelib::to_raw_pointer(p), new_cap, this->priv_raw_end(), 0, this->priv_dummy_empty_proxy());
   }
   ...
   void priv_move_to_new_buffer(size_type new_cap, version_2)
   {
      ...
      if(same_buffer_start){
         ...
         T * const new_mem = mwboost::movelib::to_raw_pointer(ret);
   ...
   void priv_destroy_last_n(const size_type n) BOOST_NOEXCEPT_OR_NOTHROW
   {
      ...
      mwboost::container::destroy_alloc_n(this->get_stored_allocator(), this->priv_raw_end() - n, n);
      this->m_holder.dec_stored_size(n);
   }
   ...
   void priv_uninitialized_construct_at_end(InpIt first, InpIt last)
   {
      ...
      T* const new_end_pos = mwboost::container::uninitialized_copy_alloc(this->m_holder.alloc(), first, last, old_end_pos);
   ...
   {
      return this->emplace(p, ::mwboost::forward<U>(u));
   }

   template <class U>
   BOOST_CONTAINER_FORCEINLINE void priv_push_back(BOOST_FWD_REF(U) u)
   {
      this->emplace_back(::mwboost::forward<U>(u));
   }

   //Overload to support compiler errors that instantiate too much
   BOOST_CONTAINER_FORCEINLINE void priv_push_back(::mwboost::move_detail::nat)
   {}

   BOOST_CONTAINER_FORCEINLINE iterator priv_insert(const_iterator, ::mwboost::move_detail::nat)
   {  return iterator();  }
      ...
      (T *const raw_pos, const size_type n, const InsertionProxy insert_range_proxy, version_1)
   {
      ...
      //Pass the hint so that allocators can take advantage of this.
      T * const new_buf = mwboost::movelib::to_raw_pointer(this->m_holder.allocate(new_cap));
      #ifdef BOOST_CONTAINER_VECTOR_ALLOC_STATS
      ++this->num_alloc;
      #endif
      ...
      (T *const raw_pos, const size_type n, const InsertionProxy insert_range_proxy, version_2)
   {
      ...
      if(reuse){
         ...
         //Backwards (and possibly forward) expansion
            ...
            #endif
            this->priv_insert_forward_range_expand_backwards
               (mwboost::movelib::to_raw_pointer(ret), real_cap, raw_pos, n, insert_range_proxy);
         }
      }
      //New buffer
      else{
      ...
      (const pointer &pos, const size_type n, const InsertionProxy insert_range_proxy)
   {
      ...
      T *const p = mwboost::movelib::to_raw_pointer(pos);
      //Check if we have enough memory or try to expand current memory
      ...
      (size_type first_pos, size_type last_pos, size_type limit_pos, size_type shift_count)
   {
      ...
      if((last_pos + shift_count) <= limit_pos){
         //All move assigned
         mwboost::container::move_backward(first_ptr, last_ptr, last_ptr + shift_count);
      }
      //Case B:
      else if((first_pos + shift_count) >= limit_pos){
         //All uninitialized_moved
         ::mwboost::container::uninitialized_move_alloc
      ...
      //Case C:
         ...
         ::mwboost::container::uninitialized_move_alloc(this->m_holder.alloc(), boundary_ptr, last_ptr, limit_ptr);
         //The rest is move assigned
         mwboost::container::move_backward(first_ptr, boundary_ptr, limit_ptr);
      }
      return hole_size;
   }
   ...
   {  return mwboost::movelib::to_raw_pointer(m_holder.start());  }
      ...
      (T* const raw_pos, const size_type, InsertionProxy insert_range_proxy, dtl::true_type)
   {
      ...
      if (old_finish == raw_pos){
         ...
         allocator_traits_type::construct(a, old_finish, ::mwboost::move(*before_old_finish));
         ++this->m_holder.m_size;
         //Copy previous to last objects to the initialized end
         mwboost::container::move_backward(raw_pos, before_old_finish, old_finish);
   ...
   {
      //There is enough memory
      mwboost::container::expand_forward_and_insert_alloc
      ...
      (T* const new_start, size_type new_cap, T* const pos, const size_type n, InsertionProxy insert_range_proxy)
   {
      ...
      mwboost::container::uninitialized_move_and_insert_alloc
      ...
      if(raw_old_buffer){
         BOOST_IF_CONSTEXPR(!has_trivial_destructor_after_move<value_type>::value)
            mwboost::container::destroy_alloc_n(a, raw_old_buffer, this->m_holder.m_size);
...
struct has_trivial_destructor_after_move<mwboost::container::vector<T, Allocator, Options> >
{
   typedef typename mwboost::container::vector<T, Allocator, Options>::allocator_type allocator_type;
   typedef typename ::mwboost::container::allocator_traits<allocator_type>::pointer pointer;
   static const bool value = ::mwboost::has_trivial_destructor_after_move<allocator_type>::value &&
                             ::mwboost::has_trivial_destructor_after_move<pointer>::value;
};
...
template <class Pointer, bool IsConst>
struct pointer_traits< mwboost::container::vec_iterator<Pointer, IsConst> >
   : public mwboost::intrusive::pointer_traits< mwboost::container::vec_iterator<Pointer, IsConst> >
{};
