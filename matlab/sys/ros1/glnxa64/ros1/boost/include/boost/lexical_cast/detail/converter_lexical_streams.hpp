...
#       error "mwboost::lexical_cast to use only 'C' locale during conversions."
#   endif
#endif
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost {
    ...
    namespace detail // optimized stream wrappers
    {
        template< class CharT // a result of widest_char transformation
                ...
                >
        class lexical_istream_limited_src: mwboost::noncopyable {
...
/************************************ HELPER FUNCTIONS FOR OPERATORS << ( ... ) ********************************/
            ...
            bool shl_char(T ch) {
                BOOST_STATIC_ASSERT_MSG(( sizeof(T) <= sizeof(CharT)) ,
                    "mwboost::lexical_cast does not support narrowing of char types."
                    "Use mwboost::locale instead" );
#ifndef BOOST_LEXICAL_CAST_ASSUME_C_LOCALE
                std::locale loc;
            ...
            bool shl_input_streamable(InputStreamable& input) {
                ...
                BOOST_STATIC_ASSERT((mwboost::is_same<char, CharT>::value));
#endif
            ...
            inline bool shl_signed(const T n) {
                CharT* tmp_finish = buffer + CharacterBufferSize;
                typedef BOOST_DEDUCED_TYPENAME mwboost::make_unsigned<T>::type utype;
            ...
            bool shl_real_type(float val, char* begin) {
                ...
                finish = start +
                    ...
                    sprintf(begin,
#endif
                    "%.*g", static_cast<int>(mwboost::detail::lcast_get_precision<float>()), val_as_double);
                return finish > start;
            }
            ...
            bool shl_real_type(double val, char* begin) {
                ...
                finish = start +
                    ...
                    sprintf(begin,
#endif
                    "%.*g", static_cast<int>(mwboost::detail::lcast_get_precision<double>()), val);
                return finish > start;
            }
            ...
            bool shl_real_type(long double val, char* begin) {
                ...
                finish = start +
                    ...
                    sprintf(begin,
#endif
                    "%.*Lg", static_cast<int>(mwboost::detail::lcast_get_precision<long double>()), val );
                return finish > start;
            }
#endif
            ...
            bool shl_real_type(float val, wchar_t* begin) {
                ...
                finish = start + swprintf(begin, CharacterBufferSize,
                                       L"%.*g",
                                       static_cast<int>(mwboost::detail::lcast_get_precision<float >()),
                                       val_as_double );
                return finish > start;
            }
            ...
            bool shl_real_type(double val, wchar_t* begin) {
                using namespace std;
                finish = start + swprintf(begin, CharacterBufferSize,
                                          L"%.*g", static_cast<int>(mwboost::detail::lcast_get_precision<double >()), val );
                return finish > start;
            }
            ...
            bool shl_real_type(long double val, wchar_t* begin) {
                using namespace std;
                finish = start + swprintf(begin, CharacterBufferSize,
                                          L"%.*Lg", static_cast<int>(mwboost::detail::lcast_get_precision<long double >()), val );
                return finish > start;
            }
#endif
            template <class T>
...
/************************************ OPERATORS << ( ... ) ********************************/
        public:
            ...
            template<class Alloc>
            bool operator<<(mwboost::container::basic_string<CharT,Traits,Alloc> const& str) BOOST_NOEXCEPT {
                start = str.data();
                finish = start + str.length();
                return true;
            }
            ...
            template <class C>
            BOOST_DEDUCED_TYPENAME mwboost::disable_if<mwboost::is_const<C>, bool>::type
            ...
            bool operator<<(mwboost::ulong_long_type n)   { return shl_unsigned(n); }
            bool operator<<(mwboost::long_long_type n)    { return shl_signed(n); }
            ...
            bool operator<<(const mwboost::uint128_type& n)   { return shl_unsigned(n); }
            bool operator<<(const mwboost::int128_type& n)    { return shl_signed(n); }
#endif
            ...
            BOOST_DEDUCED_TYPENAME mwboost::disable_if<mwboost::is_const<C>, bool>::type
            operator<<(mwboost::array<C, N> const& input) BOOST_NOEXCEPT {
                BOOST_STATIC_ASSERT_MSG(
                    (sizeof(mwboost::array<const C, N>) == sizeof(mwboost::array<C, N>)),
                    "mwboost::array<C, N> and mwboost::array<const C, N> must have exactly the same layout."
                );
                return ((*this) << reinterpret_cast<mwboost::array<const C, N> const& >(input));
            }

            template <std::size_t N>
            bool operator<<(mwboost::array<const CharT, N> const& input) BOOST_NOEXCEPT {
                return shl_char_array_limited(input.data(), N);
            }

            template <std::size_t N>
            bool operator<<(mwboost::array<const unsigned char, N> const& input) BOOST_NOEXCEPT {
                return ((*this) << reinterpret_cast<mwboost::array<const char, N> const& >(input));
            }

            template <std::size_t N>
            bool operator<<(mwboost::array<const signed char, N> const& input) BOOST_NOEXCEPT {
                return ((*this) << reinterpret_cast<mwboost::array<const char, N> const& >(input));
            }
            ...
            bool operator<<(std::array<C, N> const& input) BOOST_NOEXCEPT {
                BOOST_STATIC_ASSERT_MSG(
                    (sizeof(std::array<C, N>) == sizeof(mwboost::array<C, N>)),
                    "std::array and mwboost::array must have exactly the same layout. "
                    "Bug in implementation of std::array or mwboost::array."
                );
                return ((*this) << reinterpret_cast<mwboost::array<C, N> const& >(input));
            }
#endif
        ...
        template <class CharT, class Traits>
        class lexical_ostream_limited_src: mwboost::noncopyable {
...
/************************************ HELPER FUNCTIONS FOR OPERATORS >> ( ... ) ********************************/
        private:
            ...
            {
                BOOST_STATIC_ASSERT_MSG(
                    (!mwboost::is_pointer<InputStreamable>::value),
                    "mwboost::lexical_cast can not convert to pointers"
                );

#if defined(BOOST_NO_STRINGSTREAM) || defined(BOOST_NO_STD_LOCALE)
                BOOST_STATIC_ASSERT_MSG((mwboost::is_same<char, CharT>::value),
                    "mwboost::lexical_cast can not convert, because your STL library does not "
            ...
            inline bool shr_xchar(T& output) BOOST_NOEXCEPT {
                BOOST_STATIC_ASSERT_MSG(( sizeof(CharT) == sizeof(T) ),
                    "mwboost::lexical_cast does not support narrowing of character types."
                    "Use mwboost::locale instead" );
...
/************************************ OPERATORS >> ( ... ) ********************************/
        public:
...
#if defined(BOOST_HAS_LONG_LONG)
            bool operator>>(mwboost::ulong_long_type& output)     { return shr_unsigned(output); }
            bool operator>>(mwboost::long_long_type& output)      { return shr_signed(output); }
#elif defined(BOOST_HAS_MS_INT64)
...
#ifdef BOOST_HAS_INT128
            bool operator>>(mwboost::uint128_type& output)        { return shr_unsigned(output); }
            bool operator>>(mwboost::int128_type& output)         { return shr_signed(output); }
#endif
            ...
            template<class Alloc>
            bool operator>>(mwboost::container::basic_string<CharT,Traits,Alloc>& str) {
                str.assign(start, finish); return true;
            }

            template <std::size_t N>
            bool operator>>(mwboost::array<CharT, N>& output) BOOST_NOEXCEPT {
                return shr_std_array<N>(output);
            }

            template <std::size_t N>
            bool operator>>(mwboost::array<unsigned char, N>& output) BOOST_NOEXCEPT {
                return ((*this) >> reinterpret_cast<mwboost::array<char, N>& >(output));
            }

            template <std::size_t N>
            bool operator>>(mwboost::array<signed char, N>& output) BOOST_NOEXCEPT {
                return ((*this) >> reinterpret_cast<mwboost::array<char, N>& >(output));
            }
            ...
            bool operator>>(std::array<C, N>& output) BOOST_NOEXCEPT {
                BOOST_STATIC_ASSERT_MSG(
                    (sizeof(std::array<C, N>) == sizeof(mwboost::array<C, N>)),
                    "std::array<C, N> and mwboost::array<C, N> must have exactly the same layout."
                );
                return ((*this) >> reinterpret_cast<mwboost::array<C, N>& >(output));
            }
#endif
