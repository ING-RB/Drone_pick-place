...
#define BOOST_THREAD_DEFINES_THREAD_ATTRIBUTES_NATIVE_HANDLE
    ...
    namespace detail
    {
        ...
        typedef mwboost::shared_ptr<thread_data_base> thread_data_ptr;
            ...
            enable_shared_from_this<thread_data_base>
        {
            ...
            mwboost::mutex data_mutex;
            mwboost::condition_variable done_condition;
            bool done;
            bool join_started;
            bool joined;
            mwboost::detail::thread_exit_callback_node* thread_exit_callbacks;
            std::map<void const*,mwboost::detail::tss_data_node> tss_data;
