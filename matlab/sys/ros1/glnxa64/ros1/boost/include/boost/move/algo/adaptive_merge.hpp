                ...
                , typename iter_size<RandIt>::type uninitialized_len = 0)
{
   ...
   ::mwboost::movelib::adaptive_xbuf<value_type, value_type*, size_type> xbuf(uninitialized, size_type(uninitialized_len));
   ::mwboost::movelib::detail_adaptive::adaptive_merge_impl(first, size_type(middle - first), size_type(last - middle), comp, xbuf);
}
