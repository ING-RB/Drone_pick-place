...
//         , ... mwboost::mpl::identity<mwboost::parameter::aux::empty_arg_list>
//    ...>
//   >
...
#define BOOST_PARAMETER_template_args(z, n, prefix)                          \
    typename BOOST_PP_CAT(prefix, n) = ::mwboost::parameter::void_
/**/
...
#define BOOST_PARAMETER_make_arg_items_R(r, prefix, i, elem)                 \
    ::mwboost::parameter::aux::item<BOOST_PP_CAT(prefix, i),                   \
...
#define BOOST_PARAMETER_function_call_arg_list_R(r, seq)                     \
    ::mwboost::parameter::aux::make_arg_list<                                  \
