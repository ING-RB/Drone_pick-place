  ...
  namespace signals2 {
    namespace detail {
      ...
      class slot_call_iterator_t
        : public mwboost::iterator_facade<slot_call_iterator_t<Function, Iterator, ConnectionBody>,
        typename Function::result_type,
        mwboost::single_pass_traversal_tag,
        typename mwboost::add_reference<typename mwboost::add_const<typename Function::result_type>::type>::type >
      {
        typedef mwboost::iterator_facade<slot_call_iterator_t<Function, Iterator, ConnectionBody>,
          typename Function::result_type,
          mwboost::single_pass_traversal_tag,
          typename mwboost::add_reference<typename mwboost::add_const<typename Function::result_type>::type>::type >
        inherited;
