...
namespace mwboost {} namespace boost = mwboost; namespace mwboost
{
    namespace detail
    {
        ...
        struct basic_recursive_mutex_impl
        {
            ...
            {
                long const current_thread_id=mwboost::winapi::GetCurrentThreadId();
            ...
            bool timed_lock(::mwboost::system_time const& target)
            {
                long const current_thread_id=mwboost::winapi::GetCurrentThreadId();
        ...
        private:
            ...
            {
                if(::mwboost::detail::interlocked_read_acquire(&locking_thread_id)==current_thread_id)
                {
                    ++recursion_count;
                    return true;
                }
...
#if defined BOOST_THREAD_USES_DATETIME
            bool try_timed_lock(long current_thread_id,::mwboost::system_time const& target)
            {
