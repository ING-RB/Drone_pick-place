...
inline bool std_category::equivalent( int code, const std::error_condition & condition ) const BOOST_NOEXCEPT
{
    ...
    {
        mwboost::system::error_condition bn( condition.value(), *pc_ );
        return pc_->equivalent( code, bn );
    }
    else if( condition.category() == std::generic_category() || condition.category() == mwboost::system::generic_category() )
    {
        mwboost::system::error_condition bn( condition.value(), mwboost::system::generic_category() );
        return pc_->equivalent( code, bn );
    }
    ...
    {
        mwboost::system::error_condition bn( condition.value(), *pc2->pc_ );
        return pc_->equivalent( code, bn );
    }
...
inline bool std_category::equivalent( const std::error_code & code, int condition ) const BOOST_NOEXCEPT
{
    ...
    {
        mwboost::system::error_code bc( code.value(), *pc_ );
        return pc_->equivalent( bc, condition );
    }
    else if( code.category() == std::generic_category() || code.category() == mwboost::system::generic_category() )
    {
        mwboost::system::error_code bc( code.value(), mwboost::system::generic_category() );
        return pc_->equivalent( bc, condition );
    }
    ...
    {
        mwboost::system::error_code bc( code.value(), *pc2->pc_ );
        return pc_->equivalent( bc, condition );
    }

#endif

    else if( *pc_ == mwboost::system::generic_category() )
    {
