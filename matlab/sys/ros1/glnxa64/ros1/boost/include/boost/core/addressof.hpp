...
addressof(T& o) BOOST_NOEXCEPT
{
    ...
    return mwboost::detail::addrof<T>::get(o, 0);
#else
    return mwboost::detail::addrof<T>::get(mwboost::detail::addrof_ref<T>(o), 0);
#endif
}
...
BOOST_FORCEINLINE typename mwboost::detail::addrof_result<T[N]>::type
...
addressof(T& o) BOOST_NOEXCEPT
{
    return mwboost::detail::addressof(o);
}
#endif
