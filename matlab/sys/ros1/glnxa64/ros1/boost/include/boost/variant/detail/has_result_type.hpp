...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace detail { namespace variant {
...
private:
    ...
    template<typename C> static yes test(typename mwboost::remove_reference<typename C::result_type>::type*);
...
}}} // namespace mwboost::detail::variant
