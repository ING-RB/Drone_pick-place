...
{
    inline static mwboost::uint64_t fn( mwboost::uint64_t x )
    {
        mwboost::uint64_t const m = (mwboost::uint64_t(0xe9846af) << 32) + 0x9b1a615d;
...
{
    inline static mwboost::uint32_t fn( mwboost::uint32_t x )
    {
        mwboost::uint32_t const m1 = 0x21f0aaad;
        mwboost::uint32_t const m2 = 0x735a2d97;
