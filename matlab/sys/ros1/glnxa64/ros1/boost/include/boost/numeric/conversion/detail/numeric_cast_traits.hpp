...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace numeric {
    ...
    #define BOOST_NUMERIC_CONVERSION_SEQ_A() BOOST_NUMERIC_CONVERSION_BASE_BUILTIN_TYPES()(mwboost::long_long_type)(mwboost::ulong_long_type)
	#define BOOST_NUMERIC_CONVERSION_SEQ_B() (mwboost::long_long_type)(mwboost::ulong_long_type)
