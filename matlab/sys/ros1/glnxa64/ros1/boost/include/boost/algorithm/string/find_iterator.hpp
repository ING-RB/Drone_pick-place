...
//  find_iterator -----------------------------------------------//
        ...
        */
        ...
        private:
            // facade support
            friend class ::mwboost::iterator_core_access;
        ...
        public:
            ...
            */
            ...
            find_iterator(
                ...
                detail::find_iterator_base<IteratorT>(Finder,0)
            {
                iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::mwboost::as_literal(Col));
                m_Match=::mwboost::make_iterator_range(::mwboost::begin(lit_col), ::mwboost::begin(lit_col));
                m_End=::mwboost::end(lit_col);
        ...
        */
        ...
        public:
            ...
            */
            ...
            {
                iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::mwboost::as_literal(Col));
                m_Match=make_iterator_range(::mwboost::begin(lit_col), ::mwboost::begin(lit_col));
                m_Next=::mwboost::begin(lit_col);
                m_End=::mwboost::end(lit_col);
