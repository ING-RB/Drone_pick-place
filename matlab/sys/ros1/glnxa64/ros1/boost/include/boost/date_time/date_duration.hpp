...
namespace date_time {
  ...
  class BOOST_SYMBOL_VISIBLE date_duration : private
              mwboost::less_than_comparable1< date_duration< duration_rep_traits >
            , mwboost::equality_comparable1< date_duration< duration_rep_traits >
            , mwboost::addable1< date_duration< duration_rep_traits >
            , mwboost::subtractable1< date_duration< duration_rep_traits >
            , mwboost::dividable2< date_duration< duration_rep_traits >, int
            > > > > >
  {
  public:
  ...
  {
    typedef long int_type;
    typedef mwboost::date_time::int_adapter<long> impl_type;
