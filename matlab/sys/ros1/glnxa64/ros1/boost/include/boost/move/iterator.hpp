...
class move_iterator
{
   ...
   typedef typename mwboost::movelib::iterator_traits<iterator_type>::value_type        value_type;
   #if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES) || defined(BOOST_MOVE_DOXYGEN_INVOKED)
   typedef value_type &&                                                   reference;
   #else
   typedef typename ::mwboost::move_detail::if_
      < ::mwboost::has_move_emulation_enabled<value_type>
      , ::mwboost::rv<value_type>&
      , value_type & >::type                                               reference;
   #endif
   typedef It                                                              pointer;
   typedef typename mwboost::movelib::iterator_traits<iterator_type>::difference_type   difference_type;
   typedef typename mwboost::movelib::iterator_traits<iterator_type>::iterator_category iterator_category;
...
template <class I>
struct is_move_iterator< ::mwboost::move_iterator<I> >
{
...
class back_move_insert_iterator
{
   ...
   { container_m->push_back(mwboost::move(x)); return *this; }
...
public:
   ...
   { container_m->push_front(mwboost::move(x)); return *this; }
...
class move_insert_iterator
{
   ...
   {
      pos_ = container_m->insert(pos_, ::mwboost::move(x));
      ++pos_;
      return *this;
   }
