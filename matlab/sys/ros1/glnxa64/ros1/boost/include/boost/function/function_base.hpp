...
#  define BOOST_FUNCTION_ENABLE_IF_NOT_INTEGRAL(Functor,Type)              \
      typename ::mwboost::enable_if_<          \
                           !(::mwboost::is_integral<Functor>::value), \
                           Type>::type
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost {
  namespace detail {
    namespace function {
       ...
       * mwboost::function. It is a union containing function pointers,
      ...
      union function_buffer_members
      {
        ...
        struct type_t {
          ...
          const mwboost::typeindex::type_info* type;
...
# pragma warning(pop)
      ...
      struct reference_manager
      {
               ...
               functor_manager_operation_type op)
        {
          ...
          case check_functor_type_tag:
            {
              ...
              if (*out_buffer.members.type.type == mwboost::typeindex::type_id<F>()
          ...
          case get_functor_type_tag:
            out_buffer.members.type.type = &mwboost::typeindex::type_id<F>().type_info();
      ...
      /**
       * Determine if mwboost::function can use the small-object
      ...
      struct functor_manager_common
      {
                ...
                functor_manager_operation_type op)
        {
          if (op == clone_functor_tag)
            ...
            if (*out_buffer.members.type.type == mwboost::typeindex::type_id<Functor>())
              out_buffer.members.obj_ptr = &in_buffer.members.func_ptr;
            else
              out_buffer.members.obj_ptr = 0;
          } else /* op == get_functor_type_tag */ {
            out_buffer.members.type.type = &mwboost::typeindex::type_id<Functor>().type_info();
      ...
      public:
               ...
               functor_manager_operation_type op)
        {
          ...
          if (op == get_functor_type_tag) {
            out_buffer.members.type.type = &mwboost::typeindex::type_id<functor_type>().type_info();
            out_buffer.members.type.const_qualified = false;
            out_buffer.members.type.volatile_qualified = false;
          } else {
...
public:
  ...
  /** Retrieve the type of the stored function object, or type_id<void>()
      if this is empty. */
  const mwboost::typeindex::type_info& target_type() const
  {
    if (!vtable) return mwboost::typeindex::type_id<void>().type_info();
  ...
  template<typename Functor>
    Functor* target()
    {
      ...
      type_result.members.type.type = &mwboost::typeindex::type_id<Functor>().type_info();
...
#endif
/**
 * The bad_function_call exception class is thrown when a mwboost::function
 * object is invoked
 */
class BOOST_SYMBOL_VISIBLE bad_function_call : public std::runtime_error
{
public:
  bad_function_call() : std::runtime_error("call to empty mwboost::function") {}
};
#if defined(BOOST_CLANG)
...
#ifdef BOOST_NO_SFINAE
// Comparisons between mwboost::function objects and arbitrary function objects
template<typename Functor>
...
#  if !(defined(__GNUC__) && __GNUC__ == 3 && __GNUC_MINOR__ <= 3)
// Comparisons between mwboost::function objects and arbitrary function
