...
using mwboost::intrusive::algo_equal;
using mwboost::intrusive::algo_lexicographical_compare;
...
{	return mwboost::container::binder1st<Func>(func, arg);  }
...
{
   return (mwboost::container::binder2nd<Func>(func, arg));
}
...
{
   return mwboost::container::unary_negate<Func>(func);
}
