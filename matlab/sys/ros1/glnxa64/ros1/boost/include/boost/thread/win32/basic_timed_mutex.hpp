...
#pragma warning(pop)
            ...
            void lock()
            {
                ...
                if(old_count&lock_flag_value)
                {
                    ...
                    do
                    {
                        if(winapi::WaitForSingleObjectEx(sem,::mwboost::detail::win32::infinite,0)==0)
                        {
        ...
        public:
            ...
            bool timed_lock(mwboost::xtime const& timeout)
            {
                return timed_lock(mwboost::system_time(timeout));
            }
#endif
#ifdef BOOST_THREAD_USES_CHRONO
        ...
        private:
            ...
            void* get_event()
            {
                void* current_event=::mwboost::detail::interlocked_read_acquire(&event);
