...
namespace mwboost {} namespace boost = mwboost; namespace mwboost
{
    ...
    public:
        ...
        mutex()
        {
            ...
            if(res)
            {
                mwboost::throw_exception(thread_resource_error(res, "mwboost:: mutex constructor failed in pthread_mutex_init"));
            }
        }
        ~mutex()
        {
        ...
        void lock() BOOST_THREAD_ACQUIRE()
        {
            ...
            if (res)
            {
                mwboost::throw_exception(lock_error(res,"boost: mutex lock failed in pthread_mutex_lock"));
            }
        }
...
#define BOOST_THREAD_DEFINES_MUTEX_NATIVE_HANDLE
    ...
    public:
        ...
        timed_mutex()
        {
            ...
            if(res)
            {
                mwboost::throw_exception(thread_resource_error(res, "mwboost:: timed_mutex constructor failed in pthread_mutex_init"));
            }
#ifndef BOOST_THREAD_USES_PTHREAD_TIMEDLOCK
            ...
            {
                BOOST_VERIFY(!posix::pthread_mutex_destroy(&m));
                mwboost::throw_exception(thread_resource_error(res2, "mwboost:: timed_mutex constructor failed in pthread_cond_init"));
            }
            is_locked=false;
#endif
        }
