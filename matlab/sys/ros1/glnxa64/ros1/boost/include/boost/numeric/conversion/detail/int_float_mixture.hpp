...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace numeric { namespace convdetail
{
  ...
  typedef mwboost::integral_constant<int_float_mixture_enum, integral_to_integral> int2int_c ;
  typedef mwboost::integral_constant<int_float_mixture_enum, integral_to_float>    int2float_c ;
  typedef mwboost::integral_constant<int_float_mixture_enum, float_to_integral>    float2int_c ;
  typedef mwboost::integral_constant<int_float_mixture_enum, float_to_float>       float2float_c ;
