...
//        stream_format_state(const basic_ios& os)     { set_by_stream(os); }
        ...
        void apply_on(basic_ios & os,            //- applies format_state to the stream
                      mwboost::io::detail::locale_t * loc_default = 0) const;
        template<class T> 
        ...
        mwboost::optional<mwboost::io::detail::locale_t>  loc_;
    };  
...
// -   stream_format_state:: -------------------------------------------------
    ...
    void stream_format_state<Ch,Tr>:: apply_on (basic_ios & os,
                      mwboost::io::detail::locale_t * loc_default) const {
