...
# define BOOST_SP_INTERLOCKED_INCREMENT ::mwboost::detail::InterlockedIncrement
# define BOOST_SP_INTERLOCKED_DECREMENT ::mwboost::detail::InterlockedDecrement
# define BOOST_SP_INTERLOCKED_COMPARE_EXCHANGE ::mwboost::detail::InterlockedCompareExchange
# define BOOST_SP_INTERLOCKED_EXCHANGE ::mwboost::detail::InterlockedExchange
# define BOOST_SP_INTERLOCKED_EXCHANGE_ADD ::mwboost::detail::InterlockedExchangeAdd
