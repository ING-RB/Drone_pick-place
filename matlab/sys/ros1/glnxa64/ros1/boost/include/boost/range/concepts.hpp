...
// during the search for black listed compilers.
    ...
    #define BOOST_RANGE_CONCEPT_ASSERT( x )
        ...
        // use case is the combination of the mwboost::adaptors::filtered
        // class with a mwboost::lambda::bind generated functor.
            ...
            , EqualityComparable<Iterator>
        {
            ...
            {
                Iterator i2(++i);
                mwboost::ignore_unused_variable_warning(i2);
                ...
                mwboost::ignore_unused_variable_warning(r1);

                BOOST_DEDUCED_TYPENAME std::iterator_traits<Iterator>::reference r2(*(++i));
                mwboost::ignore_unused_variable_warning(r2);
            }
        private:
            Iterator i;
#endif
    ...
    struct SinglePassRangeConcept
    {
        ...
        BOOST_CONCEPT_USAGE(SinglePassRangeConcept)
        {
            ...
            iterator i1 = mwboost::begin(*m_range);
            iterator i2 = mwboost::end(*m_range);

            mwboost::ignore_unused_variable_warning(i1);
            mwboost::ignore_unused_variable_warning(i2);
    ...
    private:
        ...
        {
            const_iterator ci1 = mwboost::begin(const_range);
            const_iterator ci2 = mwboost::end(const_range);

            mwboost::ignore_unused_variable_warning(ci1);
            mwboost::ignore_unused_variable_warning(ci2);
        }
