...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace parameter { namespace aux {
    ...
    struct deduce_tag_condition_mpl
      : ::mwboost::mpl::apply_wrap2<
            typename ::mwboost::mpl::lambda<
                Predicate
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace parameter { namespace aux {
    ...
    struct deduce_tag_condition_mp11
    {
        using type = ::mwboost::mp11::mp_apply_q<
            Predicate
          , ::mwboost::mp11::mp_list<Argument,ArgumentPack>
        >;
    };

    template <typename Predicate, typename Argument, typename ArgumentPack>
    using deduce_tag_condition = ::mwboost::mp11::mp_if<
    ...
    class deduce_tag0
    {
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        typedef typename ::mwboost::parameter::aux::deduce_tag_condition<
            typename _spec::predicate
#else
        typedef typename ::mwboost::mpl::apply_wrap2<
            typename ::mwboost::mpl::lambda<
                typename _spec::predicate
              , ::mwboost::parameter::aux::lambda_tag
            >::type
        ...
        BOOST_MPL_ASSERT((
            typename ::mwboost::mpl::eval_if<
                typename ::mwboost::parameter::aux::has_key_<
                    UsedArgs
                  , typename ::mwboost::parameter::aux::tag_type<_spec>::type
                >::type
              , ::mwboost::mpl::eval_if<
                    _condition
                  , ::mwboost::mpl::if_<
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
      : ::mwboost::mp11::mp_if<
            ::std::is_same<DeducedArgs,::mwboost::parameter::void_>
          , ::mwboost::mp11::mp_identity<
                ::mwboost::mp11::mp_list< ::mwboost::parameter::void_,UsedArgs>
            >
#else
      : ::mwboost::mpl::eval_if<
            ::mwboost::is_same<DeducedArgs,::mwboost::parameter::void_>
          , ::mwboost::mpl::pair< ::mwboost::parameter::void_,UsedArgs>
#endif
          , ::mwboost::parameter::aux::deduce_tag0<
                Argument
              , ArgumentPack
              , DeducedArgs
              , UsedArgs
