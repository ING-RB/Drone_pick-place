...
namespace mwboost {} namespace boost = mwboost; namespace
mwboost
    {
    namespace
    exception_detail
        ...
        wrap_exception_ptr( std::exception_ptr const & e )
            ...
            exception_detail::clone_base const & base =
                mwboost::enable_current_exception(std_exception_ptr_wrapper(std::current_exception()));
    ...
    exception_ptr
        {
        typedef mwboost::shared_ptr<exception_detail::clone_base const> impl;
        impl ptr_;
    ...
    copy_exception( E const & e )
        ...
        return exception_ptr(mwboost::make_shared<wrapexcept<E> >(cp));
        }
    ...
    make_exception_ptr( T const & e )
        {
        return mwboost::copy_exception(e);
        }
...
# endif
    ...
    unknown_exception:
        ...
        explicit
        unknown_exception( mwboost::exception const & e ):
            mwboost::exception(e)
            {
            add_original_type(e);
            }
...
# endif
    ...
    exception_detail
        ...
        current_exception_std_exception_wrapper:
            ...
            current_exception_std_exception_wrapper( T const & e1, mwboost::exception const & e2 ):
                T(e1),
                mwboost::exception(e2)
                {
                add_original_type(e1);
                }
        ...
        get_boost_exception( T const * x )
            {
            return dynamic_cast<mwboost::exception const *>(x);
            }
#endif
        ...
        current_exception_std_exception( T const & e1 )
            {
            if( mwboost::exception const * e2 = get_boost_exception(&e1) )
                return mwboost::copy_exception(current_exception_std_exception_wrapper<T>(e1,*e2));
            else
                return mwboost::copy_exception(current_exception_std_exception_wrapper<T>(e1));
            }
        ...
        current_exception_unknown_exception()
            {
            return mwboost::copy_exception(unknown_exception());
            }

        inline
        exception_ptr
        current_exception_unknown_boost_exception( mwboost::exception const & e )
            {
            return mwboost::copy_exception(unknown_exception(e));
            }
        ...
        current_exception_unknown_std_exception( std::exception const & e )
            {
            if( mwboost::exception const * be = get_boost_exception(&e) )
