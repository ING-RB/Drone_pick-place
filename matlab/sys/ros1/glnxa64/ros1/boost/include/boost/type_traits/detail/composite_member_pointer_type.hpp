...
template<class C1, class C2> struct common_member_class
{
    typedef typename mwboost::conditional<
        ...
        mwboost::is_base_of<C1, C2>::value,
        C2,
        typename mwboost::conditional<mwboost::is_base_of<C2, C1>::value, C1, void>::type
...
private:
    ...
    typedef typename mwboost::remove_pointer<CPT>::type CT;
