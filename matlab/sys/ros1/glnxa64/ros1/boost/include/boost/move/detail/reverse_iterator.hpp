...
{
   public:
   typedef typename mwboost::movelib::iterator_traits<It>::pointer             pointer;
   typedef typename mwboost::movelib::iterator_traits<It>::reference           reference;
   typedef typename mwboost::movelib::iterator_traits<It>::difference_type     difference_type;
   typedef typename mwboost::movelib::iterator_traits<It>::iterator_category   iterator_category;
   typedef typename mwboost::movelib::iterator_traits<It>::value_type          value_type;
   ...
   BOOST_MOVE_FORCEINLINE
      reverse_iterator( const reverse_iterator<OtherIt>& r
                      , typename mwboost::move_detail::enable_if_convertible<OtherIt, It>::type* =0
                   )
      : m_current(r.base())
   {}
   ...
   template<class OtherIt>
   BOOST_MOVE_FORCEINLINE typename mwboost::move_detail::enable_if_convertible<OtherIt, It, reverse_iterator &>::type
