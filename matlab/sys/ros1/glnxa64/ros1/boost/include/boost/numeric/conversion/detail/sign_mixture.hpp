...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace numeric { namespace convdetail
{
  ...
  typedef mwboost::integral_constant<sign_mixture_enum, unsigned_to_unsigned> unsig2unsig_c ;
  typedef mwboost::integral_constant<sign_mixture_enum, signed_to_signed>     sig2sig_c ;
  typedef mwboost::integral_constant<sign_mixture_enum, signed_to_unsigned>   sig2unsig_c ;
  typedef mwboost::integral_constant<sign_mixture_enum, unsigned_to_signed>   unsig2sig_c ;
