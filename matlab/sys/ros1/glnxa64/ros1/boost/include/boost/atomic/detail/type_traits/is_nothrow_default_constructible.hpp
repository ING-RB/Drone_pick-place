...
template< typename T >
using is_nothrow_default_constructible = mwboost::has_nothrow_constructor< T >;
#else
template< typename T >
struct is_nothrow_default_constructible : public mwboost::has_nothrow_constructor< T > {};
#endif
