...
#define BOOST_MATH_STD_USING BOOST_MATH_STD_USING_CORE\
   using mwboost::math::round;\
   using mwboost::math::iround;\
   using mwboost::math::lround;\
   using mwboost::math::trunc;\
   using mwboost::math::itrunc;\
   using mwboost::math::ltrunc;\
   using mwboost::math::modf;
