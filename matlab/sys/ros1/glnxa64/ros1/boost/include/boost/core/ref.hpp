...
public:
    ...
    */
    BOOST_FORCEINLINE explicit reference_wrapper(T& t): t_(mwboost::addressof(t)) {}

#if defined( BOOST_MSVC ) && BOOST_WORKAROUND( BOOST_MSVC, == 1600 )

    BOOST_FORCEINLINE explicit reference_wrapper( T & t, ref_workaround_tag ): t_( mwboost::addressof( t ) ) {}
...
public:
    ...
    */
    template<class Y> reference_wrapper( reference_wrapper<Y> r,
        typename enable_if_c<mwboost::detail::ref_convertible<Y, T>::value,
            mwboost::detail::ref_empty>::type = mwboost::detail::ref_empty() ): t_( r.t_ )
    {
    }
