...
#define BOOST_MATH_META_INT(Type, name, Default)                                                \
   ...
   {                                                                                            \
   public:                                                                                      \
      static constexpr bool value = mwboost::math::policies::detail::is_##name##_imp<T>::value;   \
...
public:
   ...
   using type = typename std::conditional<
      (Digits2::value > ::mwboost::math::policies::detail::precision<Digits10,Digits2>::digits2_type::value),
...
{
public:
   static constexpr bool value = sizeof(mwboost::math::policies::detail::test_is_valid_arg(static_cast<T*>(nullptr))) == sizeof(char);
};
...
{
public:
   static constexpr bool value = mwboost::math::policies::detail::is_valid_policy_imp<T>::value;
};
...
{
public:
   static constexpr bool value = sizeof(mwboost::math::policies::detail::test_is_default_arg(static_cast<T*>(nullptr))) == sizeof(char);
};
...
{
public:
   static constexpr bool value = mwboost::math::policies::detail::is_default_policy_imp<T>::value;
   using type = std::integral_constant<bool, value>;
...
private:
   ...
   //
   static_assert(::mwboost::math::policies::detail::is_valid_policy<A1>::value, "::mwboost::math::policies::detail::is_valid_policy<A1>::value");
   static_assert(::mwboost::math::policies::detail::is_valid_policy<A2>::value, "::mwboost::math::policies::detail::is_valid_policy<A2>::value");
   static_assert(::mwboost::math::policies::detail::is_valid_policy<A3>::value, "::mwboost::math::policies::detail::is_valid_policy<A3>::value");
   static_assert(::mwboost::math::policies::detail::is_valid_policy<A4>::value, "::mwboost::math::policies::detail::is_valid_policy<A4>::value");
   static_assert(::mwboost::math::policies::detail::is_valid_policy<A5>::value, "::mwboost::math::policies::detail::is_valid_policy<A5>::value");
   static_assert(::mwboost::math::policies::detail::is_valid_policy<A6>::value, "::mwboost::math::policies::detail::is_valid_policy<A6>::value");
   static_assert(::mwboost::math::policies::detail::is_valid_policy<A7>::value, "::mwboost::math::policies::detail::is_valid_policy<A7>::value");
   static_assert(::mwboost::math::policies::detail::is_valid_policy<A8>::value, "::mwboost::math::policies::detail::is_valid_policy<A8>::value");
   static_assert(::mwboost::math::policies::detail::is_valid_policy<A9>::value, "::mwboost::math::policies::detail::is_valid_policy<A9>::value");
   static_assert(::mwboost::math::policies::detail::is_valid_policy<A10>::value, "::mwboost::math::policies::detail::is_valid_policy<A10>::value");
   static_assert(::mwboost::math::policies::detail::is_valid_policy<A11>::value, "::mwboost::math::policies::detail::is_valid_policy<A11>::value");
   static_assert(::mwboost::math::policies::detail::is_valid_policy<A12>::value, "::mwboost::math::policies::detail::is_valid_policy<A12>::value");
   static_assert(::mwboost::math::policies::detail::is_valid_policy<A13>::value, "::mwboost::math::policies::detail::is_valid_policy<A13>::value");
   //
...
inline constexpr int digits_imp(std::true_type const&) noexcept
{
   ...
   typedef typename mwboost::math::policies::precision<T, Policy>::type p_t;
   return p_t::value;
}
...
{
   return mwboost::math::policies::digits<T, Policy>() * 301 / 1000L;
}
...
struct series_factor_calc<T, Digits, std::true_type, std::true_type>
{
   ...
   {
      return mwboost::math::tools::epsilon<T>();
   }
};
template <class T, class Digits>
...
{
public:
   static constexpr bool value = (sizeof(::mwboost::math::policies::detail::test_is_policy(static_cast<P*>(nullptr))) == sizeof(char));
};
...
{
public:
   static constexpr bool value = mwboost::math::policies::detail::is_policy_imp<P>::value;
   using type = std::integral_constant<bool, value>;
};
