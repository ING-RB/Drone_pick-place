...
{
   BOOST_STATIC_CONSTANT(bool, value = (::mwboost::detail::is_unsigned_values<T>::minus_one > ::mwboost::detail::is_unsigned_values<T>::zero));
};
...
struct is_unsigned
{
   typedef ::mwboost::detail::is_unsigned_select_helper< ::mwboost::is_integral<T>::value || ::mwboost::is_enum<T>::value > selector;
...
template <class T> struct is_unsigned : public integral_constant<bool, mwboost::detail::is_unsigned<T>::value> {};
...
template <> struct is_unsigned< ::mwboost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const ::mwboost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<volatile ::mwboost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const volatile ::mwboost::ulong_long_type> : public true_type{};

template <> struct is_unsigned< ::mwboost::long_long_type> : public false_type{};
template <> struct is_unsigned<const ::mwboost::long_long_type> : public false_type{};
template <> struct is_unsigned<volatile ::mwboost::long_long_type> : public false_type{};
template <> struct is_unsigned<const volatile ::mwboost::long_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN == 0
