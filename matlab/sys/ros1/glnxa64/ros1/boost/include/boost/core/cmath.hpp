...
{
    return mwboost::core::isnormal( static_cast<double>( x ) );
}
...
inline int fpclassify( float x )
{
    ...
    default:
        ...
        return mwboost::core::isnormal( x )? fp_normal: fp_subnormal;
    }
}
...
{
    return mwboost::core::fpclassify( static_cast<double>( x ) );
}
...
template<class T> T copysign( T x, T y )
{
    return mwboost::core::detail::copysign_impl( x, y );
}
