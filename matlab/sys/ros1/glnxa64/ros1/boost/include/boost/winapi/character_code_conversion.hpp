...
MultiByteToWideChar(
    mwboost::winapi::UINT_ CodePage,
    mwboost::winapi::DWORD_ dwFlags,
    mwboost::winapi::LPCSTR_ lpMultiByteStr,
    int cbMultiByte,
    mwboost::winapi::LPWSTR_ lpWideCharStr,
    int cchWideChar);
...
WideCharToMultiByte(
    mwboost::winapi::UINT_ CodePage,
    mwboost::winapi::DWORD_ dwFlags,
    mwboost::winapi::LPCWSTR_ lpWideCharStr,
    int cchWideChar,
    mwboost::winapi::LPSTR_ lpMultiByteStr,
    int cbMultiByte,
    mwboost::winapi::LPCSTR_ lpDefaultChar,
    mwboost::winapi::LPBOOL_ lpUsedDefaultChar);
