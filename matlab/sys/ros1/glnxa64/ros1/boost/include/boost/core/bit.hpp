...
BOOST_CONSTEXPR inline int countl_impl( mwboost::ulong_long_type x ) BOOST_NOEXCEPT
{
    return x? __builtin_clzll( x ): std::numeric_limits<mwboost::ulong_long_type>::digits;
}
...
BOOST_CONSTEXPR int countl_zero( T x ) BOOST_NOEXCEPT
{
    ...
    return mwboost::core::detail::countl_impl( x );
}
...
inline int countl_impl( mwboost::uint32_t x ) BOOST_NOEXCEPT
{
#if defined(_MSC_VER)
...
inline int countl_impl( mwboost::uint64_t x ) BOOST_NOEXCEPT
{
    ...
    return static_cast<mwboost::uint32_t>( x >> 32 ) != 0?
        mwboost::core::detail::countl_impl( static_cast<mwboost::uint32_t>( x >> 32 ) ):
        mwboost::core::detail::countl_impl( static_cast<mwboost::uint32_t>( x ) ) + 32;

#endif
}

inline int countl_impl( mwboost::uint8_t x ) BOOST_NOEXCEPT
{
    return mwboost::core::detail::countl_impl( static_cast<mwboost::uint32_t>( x ) ) - 24;
}

inline int countl_impl( mwboost::uint16_t x ) BOOST_NOEXCEPT
{
    return mwboost::core::detail::countl_impl( static_cast<mwboost::uint32_t>( x ) ) - 16;
}
...
int countl_zero( T x ) BOOST_NOEXCEPT
{
    ...
    BOOST_STATIC_ASSERT( sizeof(T) == sizeof(mwboost::uint8_t) || sizeof(T) == sizeof(mwboost::uint16_t) || sizeof(T) == sizeof(mwboost::uint32_t) || sizeof(T) == sizeof(mwboost::uint64_t) );

    BOOST_IF_CONSTEXPR ( sizeof(T) == sizeof(mwboost::uint8_t) )
    {
        return mwboost::core::detail::countl_impl( static_cast<mwboost::uint8_t>( x ) );
    }
    else BOOST_IF_CONSTEXPR ( sizeof(T) == sizeof(mwboost::uint16_t) )
    {
        return mwboost::core::detail::countl_impl( static_cast<mwboost::uint16_t>( x ) );
    }
    else BOOST_IF_CONSTEXPR ( sizeof(T) == sizeof(mwboost::uint32_t) )
    {
        return mwboost::core::detail::countl_impl( static_cast<mwboost::uint32_t>( x ) );
    }
    else
    {
        return mwboost::core::detail::countl_impl( static_cast<mwboost::uint64_t>( x ) );
    }
}
...
BOOST_CONSTEXPR int countl_one( T x ) BOOST_NOEXCEPT
{
    ...
    return mwboost::core::countl_zero( static_cast<T>( ~x ) );
}
...
BOOST_CONSTEXPR inline int countr_impl( mwboost::ulong_long_type x ) BOOST_NOEXCEPT
{
    return x? __builtin_ctzll( x ): std::numeric_limits<mwboost::ulong_long_type>::digits;
}
...
BOOST_CONSTEXPR int countr_zero( T x ) BOOST_NOEXCEPT
{
    ...
    return mwboost::core::detail::countr_impl( x );
}
...
inline int countr_impl( mwboost::uint32_t x ) BOOST_NOEXCEPT
{
#if defined(_MSC_VER)
    ...
    return mod37[ ( -(mwboost::int32_t)x & x ) % 37 ];

#endif
}

inline int countr_impl( mwboost::uint64_t x ) BOOST_NOEXCEPT
{
#if defined(_MSC_VER) && defined(_M_X64)
    ...
    return static_cast<mwboost::uint32_t>( x ) != 0?
        mwboost::core::detail::countr_impl( static_cast<mwboost::uint32_t>( x ) ):
        mwboost::core::detail::countr_impl( static_cast<mwboost::uint32_t>( x >> 32 ) ) + 32;

#endif
}

inline int countr_impl( mwboost::uint8_t x ) BOOST_NOEXCEPT
{
    return mwboost::core::detail::countr_impl( static_cast<mwboost::uint32_t>( x ) | 0x100 );
}

inline int countr_impl( mwboost::uint16_t x ) BOOST_NOEXCEPT
{
    return mwboost::core::detail::countr_impl( static_cast<mwboost::uint32_t>( x ) | 0x10000 );
}
...
int countr_zero( T x ) BOOST_NOEXCEPT
{
    ...
    BOOST_IF_CONSTEXPR ( sizeof(T) == sizeof(mwboost::uint8_t) )
    {
        return mwboost::core::detail::countr_impl( static_cast<mwboost::uint8_t>( x ) );
    }
    else BOOST_IF_CONSTEXPR ( sizeof(T) == sizeof(mwboost::uint16_t) )
    {
        return mwboost::core::detail::countr_impl( static_cast<mwboost::uint16_t>( x ) );
    }
    else BOOST_IF_CONSTEXPR ( sizeof(T) == sizeof(mwboost::uint32_t) )
    {
        return mwboost::core::detail::countr_impl( static_cast<mwboost::uint32_t>( x ) );
    }
    else
    {
        return mwboost::core::detail::countr_impl( static_cast<mwboost::uint64_t>( x ) );
    }
}
...
BOOST_CONSTEXPR int countr_one( T x ) BOOST_NOEXCEPT
{
    ...
    return mwboost::core::countr_zero( static_cast<T>( ~x ) );
}
...
BOOST_CORE_POPCOUNT_CONSTEXPR inline int popcount_impl( mwboost::ulong_long_type x ) BOOST_NOEXCEPT
{
...
BOOST_CONSTEXPR int popcount( T x ) BOOST_NOEXCEPT
{
    ...
    return mwboost::core::detail::popcount_impl( x );
}
...
BOOST_CXX14_CONSTEXPR inline int popcount_impl( mwboost::uint32_t x ) BOOST_NOEXCEPT
{
    x = x - ( ( x >> 1 ) & 0x55555555 );
...
BOOST_CXX14_CONSTEXPR inline int popcount_impl( mwboost::uint64_t x ) BOOST_NOEXCEPT
{
...
BOOST_CXX14_CONSTEXPR int popcount( T x ) BOOST_NOEXCEPT
{
    ...
    BOOST_STATIC_ASSERT( sizeof(T) <= sizeof(mwboost::uint64_t) );

    BOOST_IF_CONSTEXPR ( sizeof(T) <= sizeof(mwboost::uint32_t) )
    {
        return mwboost::core::detail::popcount_impl( static_cast<mwboost::uint32_t>( x ) );
    }
    else
    {
        return mwboost::core::detail::popcount_impl( static_cast<mwboost::uint64_t>( x ) );
    }
}
...
BOOST_CONSTEXPR int bit_width( T x ) BOOST_NOEXCEPT
{
    ...
    return std::numeric_limits<T>::digits - mwboost::core::countl_zero( x );
}
...
BOOST_CONSTEXPR T bit_floor( T x ) BOOST_NOEXCEPT
{
    ...
    return x == 0? 0: T(1) << ( mwboost::core::bit_width( x ) - 1 );
}

namespace detail
{

BOOST_CXX14_CONSTEXPR inline mwboost::uint32_t bit_ceil_impl( mwboost::uint32_t x ) BOOST_NOEXCEPT
{
    if( x == 0 )
    {
        return 0;
...
BOOST_CXX14_CONSTEXPR inline mwboost::uint64_t bit_ceil_impl( mwboost::uint64_t x ) BOOST_NOEXCEPT
{
    if( x == 0 )
    {
        return 0;
...
BOOST_CXX14_CONSTEXPR T bit_ceil( T x ) BOOST_NOEXCEPT
{
    ...
    BOOST_IF_CONSTEXPR ( sizeof(T) <= sizeof(mwboost::uint32_t) )
    {
        return static_cast<T>( mwboost::core::detail::bit_ceil_impl( static_cast<mwboost::uint32_t>( x ) ) );
    }
    else
    {
        return static_cast<T>( mwboost::core::detail::bit_ceil_impl( static_cast<mwboost::uint64_t>( x ) ) );
    }
}
