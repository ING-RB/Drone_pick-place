...
//  replace_range --------------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::mwboost::algorithm::find_format_copy(
                Output,
                Input,
                ::mwboost::algorithm::range_finder(SearchRange),
                ::mwboost::algorithm::const_formatter(Format));
        }
        ...
        */
            ...
            const Range3T& Format)
        {
            return ::mwboost::algorithm::find_format_copy(
                Output,
                Input,
                ::mwboost::algorithm::first_finder(Search),
                ::mwboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const std::locale& Loc=std::locale() )
        {
            return ::mwboost::algorithm::find_format_copy(
                Output,
                Input,
                ::mwboost::algorithm::first_finder(Search, is_iequal(Loc)),
                ::mwboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range3T& Format )
        {
            return ::mwboost::algorithm::find_format_copy(
                Output,
                Input,
                ::mwboost::algorithm::last_finder(Search),
                ::mwboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const std::locale& Loc=std::locale() )
        {
            return ::mwboost::algorithm::find_format_copy(
                Output,
                Input,
                ::mwboost::algorithm::last_finder(Search, is_iequal(Loc)),
                ::mwboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range3T& Format )
        {
            return ::mwboost::algorithm::find_format_copy(
                Output,
                Input,
                ::mwboost::algorithm::nth_finder(Search, Nth),
                ::mwboost::algorithm::const_formatter(Format) );
        }
       ...
       */
            ...
            const std::locale& Loc=std::locale() )
        {
            return ::mwboost::algorithm::find_format_copy(
                Output,
                Input,
                ::mwboost::algorithm::nth_finder(Search, Nth, is_iequal(Loc) ),
                ::mwboost::algorithm::const_formatter(Format) );
        }
...
//  replace_all --------------------------------------------------------------------//
        ...
        */
        ...
        inline OutputIteratorT replace_all_copy(
            ...
            const Range3T& Format )
        {
            return ::mwboost::algorithm::find_format_all_copy(
                Output,
                Input,
                ::mwboost::algorithm::first_finder(Search),
                ::mwboost::algorithm::const_formatter(Format) );
        ...
        */
        ...
        inline void replace_all( 
            ...
            const Range2T& Format )
        {
            ::mwboost::algorithm::find_format_all( 
                Input, 
                ::mwboost::algorithm::first_finder(Search),
                ::mwboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range2T& Format )
        {
            return ::mwboost::algorithm::find_format_copy(
                Output,
                Input,
                ::mwboost::algorithm::head_finder(N),
                ::mwboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range2T& Format )
        {
            return ::mwboost::algorithm::find_format_copy(
                Output,
                Input,
                ::mwboost::algorithm::tail_finder(N),
                ::mwboost::algorithm::const_formatter(Format) );
        }
