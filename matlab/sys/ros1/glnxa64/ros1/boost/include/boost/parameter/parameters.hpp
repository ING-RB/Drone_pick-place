...
#define BOOST_PARAMETER_VARIADIC_MPL_SEQUENCE ::mwboost::mp11::mp_list
#else
...
#define BOOST_PARAMETER_VARIADIC_MPL_SEQUENCE ::mwboost::fusion::list
#else
...
#include <boost/fusion/mpl.hpp>
#define BOOST_PARAMETER_VARIADIC_MPL_SEQUENCE ::mwboost::fusion::deque
#else
#include <boost/mpl/vector.hpp>
#define BOOST_PARAMETER_VARIADIC_MPL_SEQUENCE ::mwboost::mpl::vector
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace parameter {
    ...
    struct parameters
    {
...
#if !defined(BOOST_PARAMETER_CAN_USE_MP11)
          : ::mwboost::mpl::if_<
                typename ::mwboost::parameter::aux::match_parameters_base_cond<
                    ArgumentPackAndError
                  , parameter_spec
                >::type
              , ::mwboost::mpl::identity<
                    ::mwboost::parameter::parameters<Spec...>
                >
              , ::mwboost::parameter::void_
            >
#endif
        ...
        struct match
          : ::mwboost::parameter::parameters<Spec...>
            ::BOOST_NESTED_TEMPLATE match_base<
                typename ::mwboost::parameter::aux::make_arg_list<
                    typename ::mwboost::parameter::aux
                    ::make_parameter_spec_items<parameter_spec,Args...>::type
                  , deduced_list
                  , ::mwboost::parameter::aux::tag_keyword_arg
        ...
        struct bind
          ...
          : ::mwboost::mpl::first<
                typename ::mwboost::parameter::aux::make_arg_list<
                    ...
                    ::make_parameter_spec_items<parameter_spec,Args...>::type
                  , deduced_list
                  , ::mwboost::parameter::aux::tag_template_keyword_arg
                >::type
            >
#endif
        {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            using type = ::mwboost::mp11::mp_at_c<
                typename ::mwboost::parameter::aux::make_arg_list<
                    typename ::mwboost::parameter::aux
                    ::make_parameter_spec_items<parameter_spec,Args...>::type
                  , deduced_list
        ...
        inline ::mwboost::parameter::aux::empty_arg_list operator()() const
        {
            return ::mwboost::parameter::aux::empty_arg_list();
        }

        template <typename A0, typename ...Args>
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        inline ::mwboost::mp11::mp_at_c<
#else
        inline typename ::mwboost::mpl::first<
#endif
            typename ::mwboost::parameter::aux::make_arg_list<
                typename ::mwboost::parameter::aux
        ...
        {
            typedef typename ::mwboost::parameter::aux::make_arg_list<
                typename ::mwboost::parameter::aux
                ::make_parameter_spec_items<parameter_spec,A0,Args...>::type
              , deduced_list
              , ::mwboost::parameter::aux::tag_keyword_arg
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            using result_type = ::mwboost::mp11::mp_at_c<list_error_pair,0>;

            using error = ::mwboost::mp11::mp_at_c<list_error_pair,1>;
#else
            typedef typename ::mwboost::mpl
...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace parameter {
    ...
    !BOOST_WORKAROUND(BOOST_BORLANDC, BOOST_TESTED_AT(0x592))
...
#else
        {
            typedef ::mwboost::parameter::parameters<
                BOOST_PP_ENUM_PARAMS(BOOST_PARAMETER_MAX_ARITY, PS)
            > type;
        };
#endif  // SFINAE enabled, not Borland
        ...
        struct bind
        {
            ...
            typedef typename ::mwboost::mpl::first<result>::type type;
        };
...
#include BOOST_PP_ITERATE()
        ...
        inline typename ::mwboost::mpl::first<
            typename ::mwboost::parameter::aux::make_arg_list<
                ::mwboost::parameter::aux::item<
                    PS0,A0
                >
              , deduced_list
              , ::mwboost::parameter::aux::tag_keyword_arg_ref
            >::type
        >::type
            operator()(A0& a0) const
        {
            ...
            typedef typename ::mwboost::mpl::first<result>::type result_type;
            typedef typename ::mwboost::mpl::second<result>::type error;
            error();
            ...
            return result_type(
                ...
                BOOST_PP_ENUM_TRAILING_PARAMS(
                  ...
                  , ::mwboost::parameter::aux::void_reference() BOOST_PP_INTERCEPT
                )
            );
        }
