...
private:
    ...
    mwboost::ulong_long_type cat_id() const BOOST_NOEXCEPT
    {
...
public:
    ...
    BOOST_SYSTEM_CONSTEXPR explicit error_condition( mwboost::system::detail::generic_value_tag vt ) BOOST_NOEXCEPT:
    ...
    template<class ErrorConditionEnum> BOOST_SYSTEM_CONSTEXPR error_condition( ErrorConditionEnum e,
      typename detail::enable_if<
        is_error_condition_enum<ErrorConditionEnum>::value && !mwboost::system::detail::is_same<ErrorConditionEnum, errc::errc_t>::value
    ...
    template<class ErrorConditionEnum> BOOST_SYSTEM_CONSTEXPR error_condition( ErrorConditionEnum e,
      typename detail::enable_if<mwboost::system::detail::is_same<ErrorConditionEnum, errc::errc_t>::value>::type* = 0) BOOST_NOEXCEPT:
        val_( e ), cat_( 0 )
    {
    }
