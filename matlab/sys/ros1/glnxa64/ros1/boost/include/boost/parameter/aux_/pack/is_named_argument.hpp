...
namespace mwboost {} namespace boost = mwboost; namespace mwboost { namespace parameter { namespace aux {
    ...
    template <typename T>
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
    using is_named_argument = ::mwboost::mp11::mp_if<
        ::mwboost::parameter::aux::is_template_keyword<T>
      , ::mwboost::mp11::mp_true
      , ::mwboost::parameter::aux::is_tagged_argument_mp11<T>
    >;
#else
    struct is_named_argument
      : ::mwboost::mpl::if_<
            ::mwboost::parameter::aux::is_template_keyword<T>
          , ::mwboost::mpl::true_
          , ::mwboost::parameter::aux::is_tagged_argument<T>
        >::type
    {
    };
#endif
