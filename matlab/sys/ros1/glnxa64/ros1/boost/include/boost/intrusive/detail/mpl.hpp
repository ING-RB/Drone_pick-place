...
using mwboost::move_detail::remove_cv;
using mwboost::move_detail::remove_reference;
using mwboost::move_detail::add_reference;
using mwboost::move_detail::remove_pointer;
using mwboost::move_detail::add_pointer;
using mwboost::move_detail::true_type;
using mwboost::move_detail::false_type;
using mwboost::move_detail::voider;
using mwboost::move_detail::enable_if_c;
using mwboost::move_detail::enable_if;
using mwboost::move_detail::disable_if_c;
using mwboost::move_detail::disable_if;
using mwboost::move_detail::is_convertible;
using mwboost::move_detail::if_c;
using mwboost::move_detail::if_;
using mwboost::move_detail::is_const;
using mwboost::move_detail::identity;
using mwboost::move_detail::alignment_of;
using mwboost::move_detail::is_empty;
using mwboost::move_detail::addressof;
using mwboost::move_detail::integral_constant;
using mwboost::move_detail::enable_if_convertible;
using mwboost::move_detail::disable_if_convertible;
using mwboost::move_detail::bool_;
using mwboost::move_detail::true_;
using mwboost::move_detail::false_;
using mwboost::move_detail::yes_type;
using mwboost::move_detail::no_type;
using mwboost::move_detail::apply;
using mwboost::move_detail::eval_if_c;
using mwboost::move_detail::eval_if;
using mwboost::move_detail::unvoid_ref;
using mwboost::move_detail::add_const_if_c;
...
#define BOOST_INTRUSIVE_INSTANTIATE_EVAL_DEFAULT_TYPE_TMPLT(TNAME)\
   ...
   {                                                              \
      ...
      static const bool value = (1 == sizeof(test<T>(0, 0)));     \
                                                                  \
      typedef typename                                            \
         ::mwboost::intrusive::detail::eval_if_c                    \
            < value                                               \
            , ::mwboost::intrusive::detail::identity<T>             \
            , ::mwboost::intrusive::detail::identity<DefaultWrap>   \
            >::type::TNAME type;                                  \
   };                                                             \
//
...
#define BOOST_INTRUSIVE_HAS_STATIC_MEMBER_FUNC_SIGNATURE(TRAITS_NAME, FUNC_NAME) \
  ...
  template<typename T> \
  static ::mwboost::intrusive::detail::yes_type test(helper<&T::FUNC_NAME>*); \
  template<typename T> static ::mwboost::intrusive::detail::no_type test(...); \
  public: \
  static const bool value = sizeof(test<U>(0)) == sizeof(::mwboost::intrusive::detail::yes_type); \
  }; \
//
...
{ \
   ...
   template <typename U> \
   static ::mwboost::intrusive::detail::no_type  test(U*, Helper<void (BaseMixin::*)(), &U::FUNC_NAME>* = 0); \
   static ::mwboost::intrusive::detail::yes_type test(...); \
   static const bool value = sizeof(::mwboost::intrusive::detail::yes_type) == sizeof(test((Base*)(0))); \
};\
//
