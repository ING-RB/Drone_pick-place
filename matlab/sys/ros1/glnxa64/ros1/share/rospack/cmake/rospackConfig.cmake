...
if("FALSE" STREQUAL "TRUE")
  set(rospack_SOURCE_PREFIX src/rospack)
  set(rospack_DEVEL_PREFIX $ENV{ROS1_INSTALL_DIR}/rospack)
  set(rospack_INSTALL_PREFIX "")
  set(rospack_PREFIX ${rospack_DEVEL_PREFIX})
else()
  set(rospack_SOURCE_PREFIX "")
  set(rospack_DEVEL_PREFIX "")
  set(rospack_INSTALL_PREFIX $ENV{ROS1_INSTALL_DIR})
...
if(NOT "include;$ENV{BOOST_INSTALL_DIR}/include;$ENV{ROS1_INSTALL_DIR}/tinyxml2/include " STREQUAL " ")
  set(rospack_INCLUDE_DIRS "")
  set(_include_dirs "include;$ENV{BOOST_INSTALL_DIR}/include;$ENV{ROS1_INSTALL_DIR}/tinyxml2/include")
...
set(libraries "rospack;/mathworks/devel/bat/B3p0/build/3p/install/12482407/glnxa64/python39/lib/libpython3.9.so;$ENV{BOOST_INSTALL_DIR}/lib/libmwboost_filesystem.so;$ENV{BOOST_INSTALL_DIR}/lib/libmwboost_program_options.so;$ENV{BOOST_INSTALL_DIR}/lib/libmwboost_system.so;$ENV{ROS1_INSTALL_DIR}/tinyxml2/lib/libtinyxml2.so")
