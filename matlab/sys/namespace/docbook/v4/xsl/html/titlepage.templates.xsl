...
<!-- @CHANGE: Add date and graphic to Book titlepage -->
  ...
  <xsl:apply-templates mode="book.titlepage.recto.auto.mode" select="info/inlinegraphic"/>
...
<xsl:template name="chapter.titlepage.recto">
  ...
  <!-- @CHANGE: Add date and graphic to chapter titlepage -->
  <xsl:apply-templates mode="chapter.titlepage.recto.auto.mode" select="chapterinfo/date"/>
  <xsl:apply-templates mode="chapter.titlepage.recto.auto.mode" select="info/date"/>
  <xsl:apply-templates mode="chapter.titlepage.recto.auto.mode" select="chapterinfo/graphic"/>
  <xsl:apply-templates mode="chapter.titlepage.recto.auto.mode" select="info/graphic"/>
  <xsl:apply-templates mode="chapter.titlepage.recto.auto.mode" select="chapterinfo/inlinegraphic"/>
  <xsl:apply-templates mode="chapter.titlepage.recto.auto.mode" select="info/inlinegraphic"/>
  <xsl:apply-templates mode="chapter.titlepage.recto.auto.mode" select="chapterinfo/mediaobject"/>
  <xsl:apply-templates mode="chapter.titlepage.recto.auto.mode" select="info/mediaobject"/>
  <!-- @ENDCHANGE -->
...
<!-- @CHANGE: Allow graphic & date on chapter titlepages -->
<xsl:template match="graphic" mode="chapter.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="chapter.titlepage.recto.style">
<xsl:apply-templates select="." mode="chapter.titlepage.recto.mode"/>
</div>
</xsl:template>

<xsl:template match="date" mode="chapter.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="chapter.titlepage.recto.style">
<xsl:apply-templates select="." mode="chapter.titlepage.recto.mode"/>
</div>
</xsl:template>

<xsl:template match="mediaobject" mode="chapter.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="chapter.titlepage.recto.style">
<xsl:apply-templates select="." mode="chapter.titlepage.recto.mode"/>
</div>
</xsl:template>
...
<xsl:template name="sect1.titlepage.recto">
  ...
  <!-- @CHANGE: Add date and graphic to sect1 titlepage -->
  <xsl:apply-templates mode="sect1.titlepage.recto.auto.mode" select="sect1info/date"/>
  <xsl:apply-templates mode="sect1.titlepage.recto.auto.mode" select="info/date"/>
  <xsl:apply-templates mode="sect1.titlepage.recto.auto.mode" select="sect1info/graphic"/>
  <xsl:apply-templates mode="sect1.titlepage.recto.auto.mode" select="info/graphic"/>
  <xsl:apply-templates mode="sect1.titlepage.recto.auto.mode" select="sect1info/inlinegraphic"/>
  <xsl:apply-templates mode="sect1.titlepage.recto.auto.mode" select="info/inlinegraphic"/>
  <xsl:apply-templates mode="sect1.titlepage.recto.auto.mode" select="sect1info/mediaobject"/>
  <xsl:apply-templates mode="sect1.titlepage.recto.auto.mode" select="info/mediaobject"/>
  <!-- @ENDCHANGE -->
...
<!-- @CHANGE: Allow graphic & date on sect1 titlepages -->
<xsl:template match="graphic" mode="sect1.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="sect1.titlepage.recto.style">
<xsl:apply-templates select="." mode="sect1.titlepage.recto.mode"/>
</div>
</xsl:template>

<xsl:template match="date" mode="sect1.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="sect1.titlepage.recto.style">
<xsl:apply-templates select="." mode="sect1.titlepage.recto.mode"/>
</div>
</xsl:template>

<xsl:template match="mediaobject" mode="sect1.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="sect1.titlepage.recto.style">
<xsl:apply-templates select="." mode="sect1.titlepage.recto.mode"/>
</div>
</xsl:template>
...
<xsl:template name="sect2.titlepage.recto">
  ...
  <!-- @CHANGE: Add date and graphic to sect2 titlepage -->
  <xsl:apply-templates mode="sect2.titlepage.recto.auto.mode" select="sect2info/date"/>
  <xsl:apply-templates mode="sect2.titlepage.recto.auto.mode" select="info/date"/>
  <xsl:apply-templates mode="sect2.titlepage.recto.auto.mode" select="sect2info/graphic"/>
  <xsl:apply-templates mode="sect2.titlepage.recto.auto.mode" select="info/graphic"/>
  <xsl:apply-templates mode="sect2.titlepage.recto.auto.mode" select="sect2info/inlinegraphic"/>
  <xsl:apply-templates mode="sect2.titlepage.recto.auto.mode" select="info/inlinegraphic"/>
  <xsl:apply-templates mode="sect2.titlepage.recto.auto.mode" select="sect2info/mediaobject"/>
  <xsl:apply-templates mode="sect2.titlepage.recto.auto.mode" select="info/mediaobject"/>
  <!-- @ENDCHANGE -->
...
<!-- @CHANGE: Allow graphic & date on sect2 titlepages -->
<xsl:template match="graphic" mode="sect2.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="sect2.titlepage.recto.style">
<xsl:apply-templates select="." mode="sect2.titlepage.recto.mode"/>
</div>
</xsl:template>

<xsl:template match="date" mode="sect2.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="sect2.titlepage.recto.style">
<xsl:apply-templates select="." mode="sect2.titlepage.recto.mode"/>
</div>
</xsl:template>

<xsl:template match="mediaobject" mode="sect2.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="sect2.titlepage.recto.style">
<xsl:apply-templates select="." mode="sect2.titlepage.recto.mode"/>
</div>
</xsl:template>
...
<xsl:template name="sect3.titlepage.recto">
  ...
  <!-- @CHANGE: Add date and graphic to sect3 titlepage -->
  <xsl:apply-templates mode="sect3.titlepage.recto.auto.mode" select="sect3info/date"/>
  <xsl:apply-templates mode="sect3.titlepage.recto.auto.mode" select="info/date"/>
  <xsl:apply-templates mode="sect3.titlepage.recto.auto.mode" select="sect3info/graphic"/>
  <xsl:apply-templates mode="sect3.titlepage.recto.auto.mode" select="info/graphic"/>
  <xsl:apply-templates mode="sect3.titlepage.recto.auto.mode" select="sect3info/inlinegraphic"/>
  <xsl:apply-templates mode="sect3.titlepage.recto.auto.mode" select="info/inlinegraphic"/>
  <xsl:apply-templates mode="sect3.titlepage.recto.auto.mode" select="sect3info/mediaobject"/>
  <xsl:apply-templates mode="sect3.titlepage.recto.auto.mode" select="info/mediaobject"/>
  <!-- @ENDCHANGE -->
...
<!-- @CHANGE: Allow graphic & date on sect3 titlepages -->
<xsl:template match="graphic" mode="sect3.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="sect3.titlepage.recto.style">
<xsl:apply-templates select="." mode="sect3.titlepage.recto.mode"/>
</div>
</xsl:template>

<xsl:template match="date" mode="sect3.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="sect3.titlepage.recto.style">
<xsl:apply-templates select="." mode="sect3.titlepage.recto.mode"/>
</div>
</xsl:template>

<xsl:template match="mediaobject" mode="sect3.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="sect3.titlepage.recto.style">
<xsl:apply-templates select="." mode="sect3.titlepage.recto.mode"/>
</div>
</xsl:template>
...
<xsl:template name="sect4.titlepage.recto">
  ...
  <!-- @CHANGE: Add date and graphic to sect4 titlepage -->
  <xsl:apply-templates mode="sect4.titlepage.recto.auto.mode" select="sect4info/date"/>
  <xsl:apply-templates mode="sect4.titlepage.recto.auto.mode" select="info/date"/>
  <xsl:apply-templates mode="sect4.titlepage.recto.auto.mode" select="sect4info/graphic"/>
  <xsl:apply-templates mode="sect4.titlepage.recto.auto.mode" select="info/graphic"/>
  <xsl:apply-templates mode="sect4.titlepage.recto.auto.mode" select="sect4info/inlinegraphic"/>
  <xsl:apply-templates mode="sect4.titlepage.recto.auto.mode" select="info/inlinegraphic"/>
  <xsl:apply-templates mode="sect4.titlepage.recto.auto.mode" select="sect4info/mediaobject"/>
  <xsl:apply-templates mode="sect4.titlepage.recto.auto.mode" select="info/mediaobject"/>
  <!-- @ENDCHANGE -->
...
<!-- @CHANGE: Allow graphic & date on sect4 titlepages -->
<xsl:template match="graphic" mode="sect4.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="sect4.titlepage.recto.style">
<xsl:apply-templates select="." mode="sect4.titlepage.recto.mode"/>
</div>
</xsl:template>

<xsl:template match="date" mode="sect4.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="sect4.titlepage.recto.style">
<xsl:apply-templates select="." mode="sect4.titlepage.recto.mode"/>
</div>
</xsl:template>

<xsl:template match="mediaobject" mode="sect4.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="sect4.titlepage.recto.style">
<xsl:apply-templates select="." mode="sect4.titlepage.recto.mode"/>
</div>
</xsl:template>
...
<xsl:template name="sect5.titlepage.recto">
  ...
  <!-- @CHANGE: Add date and graphic to sect5 titlepage -->
  <xsl:apply-templates mode="sect5.titlepage.recto.auto.mode" select="sect5info/date"/>
  <xsl:apply-templates mode="sect5.titlepage.recto.auto.mode" select="info/date"/>
  <xsl:apply-templates mode="sect5.titlepage.recto.auto.mode" select="sect5info/graphic"/>
  <xsl:apply-templates mode="sect5.titlepage.recto.auto.mode" select="info/graphic"/>
  <xsl:apply-templates mode="sect5.titlepage.recto.auto.mode" select="sect5info/inlinegraphic"/>
  <xsl:apply-templates mode="sect5.titlepage.recto.auto.mode" select="info/inlinegraphic"/>
  <xsl:apply-templates mode="sect5.titlepage.recto.auto.mode" select="sect5info/mediaobject"/>
  <xsl:apply-templates mode="sect5.titlepage.recto.auto.mode" select="info/mediaobject"/>
  <!-- @ENDCHANGE -->
...
<!-- @CHANGE: Allow graphic & date on sect5 titlepages -->
<xsl:template match="graphic" mode="sect5.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="sect5.titlepage.recto.style">
<xsl:apply-templates select="." mode="sect5.titlepage.recto.mode"/>
</div>
</xsl:template>

<xsl:template match="date" mode="sect5.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="sect5.titlepage.recto.style">
<xsl:apply-templates select="." mode="sect5.titlepage.recto.mode"/>
</div>
</xsl:template>

<xsl:template match="mediaobject" mode="sect5.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="sect5.titlepage.recto.style">
<xsl:apply-templates select="." mode="sect5.titlepage.recto.mode"/>
</div>
</xsl:template>
