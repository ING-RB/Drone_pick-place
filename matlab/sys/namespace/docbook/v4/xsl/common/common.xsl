...
<!-- @CHANGE: This solution is pretty ugly for japanese users.
...
<!-- @CHANGE: This is very common and not worth noting.  Rptgen creates links to EVERYTHING with no guarantee that a target exists.
