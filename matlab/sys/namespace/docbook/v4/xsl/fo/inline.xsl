...
<!-- @CHANGE: Report generator generates link to nonexistent id.  Ignore.
              <xsl:message>
...
<xsl:template match="emphasis">
  ...
  <xsl:choose>
    ...
    <!-- @CHANGE if there is role attribue, assume it a color definition -->
    <xsl:when test="@role and @role!='italic'">
      <fo:inline>
