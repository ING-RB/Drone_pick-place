...
<xsl:template name="reiterate.title">
...
<xsl:template name="book.titlepage.verso">
    ...
    <xsl:choose>
        <xsl:when test="bookinfo/@single-page = 'yes'">

            <xsl:if test="bookinfo/abstract or info/abstract">
                <xsl:call-template name="reiterate.title"/>
...
<xsl:template name="book.titlepage.before.verso">
    <xsl:if test="not(bookinfo/@single-page = 'yes') or bookinfo/abstract or info/abstract">
...
<!-- @CHANGE -->
<xsl:template match="*" mode="book.titlepage.recto.auto.mode">
  <!-- if an element isn't found in this mode, -->
  <!-- try the generic titlepage.mode -->
  <xsl:apply-templates select="." mode="titlepage.mode"/>
</xsl:template>

<xsl:template match="*" mode="book.titlepage.verso.auto.mode">
  <!-- if an element isn't found in this mode, -->
  <!-- try the generic titlepage.mode -->
  <xsl:apply-templates select="." mode="titlepage.mode"/>
</xsl:template>
...
<xsl:template name="chapter.titlepage.recto">
  ...
  <xsl:apply-templates mode="chapter.titlepage.recto.auto.mode" select="docinfo/graphic"/>
  ...
  <xsl:apply-templates mode="chapter.titlepage.recto.auto.mode" select="docinfo/mediaobject"/>
...
<!-- @CHANGE -->
<xsl:template match="*" mode="chapter.titlepage.recto.auto.mode">
  <!-- if an element isn't found in this mode, -->
  <!-- try the generic titlepage.mode -->
  <xsl:apply-templates select="." mode="titlepage.mode"/>
</xsl:template>

<xsl:template match="*" mode="chapter.titlepage.verso.auto.mode">
  <!-- if an element isn't found in this mode, -->
  <!-- try the generic titlepage.mode -->
  <xsl:apply-templates select="." mode="titlepage.mode"/>
</xsl:template>
...
<!-- @CHANGE -->
<xsl:template match="*" mode="sect1.titlepage.recto.auto.mode">
  <!-- if an element isn't found in this mode, -->
  <!-- try the generic titlepage.mode -->
  <xsl:apply-templates select="." mode="titlepage.mode"/>
</xsl:template>

<xsl:template match="*" mode="sect1.titlepage.verso.auto.mode">
  <!-- if an element isn't found in this mode, -->
  <!-- try the generic titlepage.mode -->
  <xsl:apply-templates select="." mode="titlepage.mode"/>
</xsl:template>
...
<!-- @CHANGE -->
<xsl:template match="*" mode="sect2.titlepage.recto.auto.mode">
  <!-- if an element isn't found in this mode, -->
  <!-- try the generic titlepage.mode -->
  <xsl:apply-templates select="." mode="titlepage.mode"/>
</xsl:template>

<xsl:template match="*" mode="sect2.titlepage.verso.auto.mode">
  <!-- if an element isn't found in this mode, -->
  <!-- try the generic titlepage.mode -->
  <xsl:apply-templates select="." mode="titlepage.mode"/>
</xsl:template>
...
<!-- @CHANGE -->
<xsl:template match="*" mode="sect3.titlepage.recto.auto.mode">
  <!-- if an element isn't found in this mode, -->
  <!-- try the generic titlepage.mode -->
  <xsl:apply-templates select="." mode="titlepage.mode"/>
</xsl:template>

<xsl:template match="*" mode="sect3.titlepage.verso.auto.mode">
  <!-- if an element isn't found in this mode, -->
  <!-- try the generic titlepage.mode -->
  <xsl:apply-templates select="." mode="titlepage.mode"/>
</xsl:template>
...
<!-- @CHANGE -->
<xsl:template match="*" mode="sect4.titlepage.recto.auto.mode">
  <!-- if an element isn't found in this mode, -->
  <!-- try the generic titlepage.mode -->
  <xsl:apply-templates select="." mode="titlepage.mode"/>
</xsl:template>

<xsl:template match="*" mode="sect4.titlepage.verso.auto.mode">
  <!-- if an element isn't found in this mode, -->
  <!-- try the generic titlepage.mode -->
  <xsl:apply-templates select="." mode="titlepage.mode"/>
</xsl:template>
...
<!-- @CHANGE -->
<xsl:template match="*" mode="sect5.titlepage.recto.auto.mode">
  <!-- if an element isn't found in this mode, -->
  <!-- try the generic titlepage.mode -->
  <xsl:apply-templates select="." mode="titlepage.mode"/>
</xsl:template>

<xsl:template match="*" mode="sect5.titlepage.verso.auto.mode">
  <!-- if an element isn't found in this mode, -->
  <!-- try the generic titlepage.mode -->
  <xsl:apply-templates select="." mode="titlepage.mode"/>
</xsl:template>
