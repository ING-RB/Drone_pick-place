...
<xsl:template name="setup.pagemasters">
  <fo:layout-master-set>
    ...
    <!-- maximum real estate pages -->
    <fo:simple-page-master master-name="maximized-landscape"
                           page-width="{$page.height}"
                           page-height="{$page.width}"
                           margin-top="{$minimized.margin.size}"
                           margin-bottom="{$minimized.margin.size}"
                           margin-left="{$minimized.margin.size}"
                           margin-right="{$minimized.margin.size}">

      <fo:region-body margin-bottom="{$minimized.margin.size}"
                      margin-top="{$minimized.margin.size}" 
                      margin-left="{$minimized.margin.size}" 
                      margin-right="{$minimized.margin.size}"/>
      <fo:region-before region-name="xsl-region-before-maximized"
                        extent="{$minimized.margin.size}"
                        display-align="before"/>
      <fo:region-after region-name="xsl-region-after-maximized"
                       extent="{$minimized.margin.size}"
                       display-align="after"/>
      <fo:region-start region-name="xsl-region-start-maximized"
                       extent="{$minimized.margin.size}"
                       display-align="before"/>
      <fo:region-end region-name="xsl-region-end-maximized"
                       extent="{$minimized.margin.size}"
                       display-align="after"/>
    </fo:simple-page-master>

    <fo:simple-page-master master-name="maximized-portrait"
                           page-width="{$page.width}"
                           page-height="{$page.height}"
                           margin-top="{$minimized.margin.size}"
                           margin-bottom="{$minimized.margin.size}"
...
<!-- @CHANGE:  Move to param.xsl so style sheet editor can pick this up.
...
<xsl:template name="footer.table">
  ...
  <xsl:choose>
    <xsl:when test="$pageclass='titlepage' and $gentext-key='book'
                    and $sequence='first'">
        <xsl:if test="/book/bookinfo/@single-page = 'yes'">
<!-- NOTE: If this area isn't large enough for the legal content, try setting "Region After Extent" from a custom stylesheet -->
