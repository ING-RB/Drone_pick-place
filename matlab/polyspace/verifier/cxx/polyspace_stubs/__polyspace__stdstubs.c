...
#if  !defined(__polyspace_adapt_types_for_stubs)
...
#else
#define CUSTOM_STUB_TYPE(function, nb_args)  ((__polyspace_##function##_known_type == 1) && \
...
#define PST_STUB_C_CUSTOM_TYPE_1(DECL_MACRO, return_std_type, function, arg0_std_type, arg0, varargs, attrs) \
    ...
    DECL_MACRO(RET_T(function), function, (ARG_T(function, 0) arg0 varargs)) attrs {
...
DECL_MACRO(RET_T(function), function, (ARG_T(function, 0) arg0,                    \
                                       ARG_T(function, 1) arg1                     \
                                       varargs)) attrs {

/* Begin a stub for a function with 2 fixed argument with arg renaming (may be needed to keep accuracy) */
#define PST_STUB_C_CUSTOM_TYPE_ARG_RENAMING_2(DECL_MACRO, return_std_type, function, arg0_std_type, arg0, \
                                              arg1_std_type, arg1,      \
                                              varargs, attrs)           \
  INSTANTIATE_FUNCTION_TYPE(function, 2)                                \
...
DECL_MACRO(RET_T(function), function, (ARG_T(function, 0) arg0,                    \
                                       ARG_T(function, 1) arg1,                    \
                                       ARG_T(function, 2) arg2                     \
                                       varargs)) attrs {

/* Begin a stub for a function with 3 fixed argument */
#define PST_STUB_C_CUSTOM_TYPE_ARG_RENAMING_3(DECL_MACRO, return_std_type, function, arg0_std_type, arg0, \
                                              arg1_std_type, arg1,      \
                                              arg2_std_type, arg2,      \
                                              varargs, attrs)           \
  INSTANTIATE_FUNCTION_TYPE(function, 3)                                \
...
#if defined PST_VISUAL && defined _DLL
...
#if (defined (PST_BUG_FINDER) && ((__GNUC__ > 2) || (__GNUC__ == 2 && __GNUC_MINOR__ >= 8))) && (! defined(POLYSPACE_LIBC_NO_THROW))
...
#define PST_STUB_C_DECL(func_return,func_name,func_args) func_return func_name func_args
#define __PST_THROW
...
#if defined(__polyspace_fdopen_nb_args) && !TEST_NB_ARGS(fdopen,2)
#define __polyspace_no_fdopen
#endif /* !TEST_NB_ARGS(fdopen,2) */
...
#ifndef __polyspace_fprintf_has_varargs
#define __polyspace_no_fprintf
#endif /* !TEST_NB_ARGS(fprintf, ...) */
#ifndef __polyspace_fscanf_has_varargs
#define __polyspace_no_fscanf
#endif /* !TEST_NB_ARGS(fscanf,...) */
#ifndef __polyspace_printf_has_varargs
#define __polyspace_no_printf
#endif /* !TEST_NB_ARGS(printf,...) */
#ifndef __polyspace_scanf_has_varargs
#define __polyspace_no_scanf
#endif /* !TEST_NB_ARGS(scanf,...) */
#ifndef __polyspace_sprintf_has_varargs
#define __polyspace_no_sprintf
#endif /* !TEST_NB_ARGS(sprintf,...) */
#ifndef __polyspace_sscanf_has_varargs
#define __polyspace_no_sscanf
#endif /* !TEST_NB_ARGS(sscanf,..) */
...
#elif !defined(__polyspace_open_nb_args)
//When open is implicitly declared, we do not provide a stub definition
#define __polyspace_no_open
...
#if defined(__polyspace___polyspace_va_arg_deref) && !defined(__polyspace_no___polyspace_va_arg_deref)
#if !defined(NO_CHECKS_INLINING) && !defined(__polyspace_no_inlined___polyspace_va_arg_deref) && !defined(PST_BUG_FINDER)
    #pragma POLYSPACE_INLINE_CHECKS "__polyspace_va_arg_deref"
#endif /* !NO_CHECKS_INLINING */

va_list __polyspace_va_arg_deref(void** ap_ps, va_list ap, int nb_arg, size_t size) { /* returns the content of a cell; i.e an address on the original argument */

    int user_arg_position = _polyspace_vararg_position + 1;

    if (ap_ps != (void**)ap) {
        ap_ps = (void**)ap;
    }
#ifndef PST_BUG_FINDER
#pragma polyspace_value_info STD_LIB_value_type("VA_ARG_INFO") "Number required for this va_arg usage"
#pragma Inspection_Point user_arg_position
        ;
#pragma polyspace_value_info
#pragma polyspace_value_info STD_LIB_value_type("VA_ARG_INFO") "Number available"
#pragma Inspection_Point nb_arg
        ;
#pragma polyspace_value_info

#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_OTHER_STD_LIB") ("Function call(s) have sufficient additional arguments for extraction with va_arg", "Function call(s) might not have sufficient additional arguments for extraction with va_arg", "Function call(s) do not have sufficient additional arguments for extraction with va_arg")
        assert(_polyspace_vararg_position<nb_arg);
#pragma polyspace_check_info


#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_OTHER_STD_LIB") ("Argument type in va_arg matches the data type of the additional argument", "Argument type in va_arg might not match the data type of the additional argument", "Argument type in va_arg does not match the data type of the additional argument" )
        assert(__ps_builtin_available_size(ap_ps[_polyspace_vararg_position]) == size);
#pragma polyspace_check_info
#endif

        return (va_list)ap_ps[_polyspace_vararg_position++];
    }
#endif /* __polyspace___polyspace_va_arg_deref */
...
#undef errno
    ...
    defined(__polyspace_fileno) || defined(__polyspace_fdopen)
#if defined(__PST_POLYSPACE_MODE)

#if defined( _polyspace_random_FILE_return_array) && defined (_polyspace_random_FILE_return_array_size)
#ifdef __cplusplus
      extern "C"
#endif
      void *memcpy(void *dest, const void *src, size_t n);
#define  make_polyspace_random_FILE(stream) memcpy(stream, _polyspace_random_FILE(), _polyspace_random_FILE_return_array_size);
      static _polyspace_random_FILE_return_array* _polyspace_random_FILE()
#else
#define  make_polyspace_random_FILE(stream) *(stream) = _polyspace_random_FILE()
      static FILE _polyspace_random_FILE()
#endif //_polyspace_random_FILE_return_array
      {
...
#define ASSERT_IS_WRITABLE_ARRAY_EXCEPT_ZERO(type, ptr, size)           \
  {                                                                     \
    type __one_byte__;                                                  \
    const void *__s0__ = (size) == 0 ? &__one_byte__ : ((type*)ptr);    \
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_remove)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_rename)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_tmpnam)
...
#pragma polyspace_check_info arg_green_orange_red_message("argument", "is a null pointer or a writable string", "may not be a writable string", "is neither a null pointer nor a writable string", "")
        if ((char*)s != (char *) 0) ASSERT_IS_WRITABLE_ARRAY(char, s, L_tmpnam);
#pragma polyspace_check_info
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_fclose)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_fflush)
...
#pragma polyspace_check_info arg_green_orange_red_message("argument", "is a null pointer or a valid stream", "may not be a valid stream", "is neither a null pointer nor a valid stream", "")
        if (stream != (FILE*)0) {
            ...
            FILE_IO_WRITE(stream);
        #else
             make_polyspace_random_FILE(stream);
        #endif /* POLYSPACE_NO_IO_WRITE */
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_tmpfile)
...
#undef RETURN
    ...
    // let the stubber create a function that returns a FILE*
    PST_STUB_C_DECL(FILE*, _silent_stub_fun_random_FILE_ptr,(void));
    ...
    PST_STUB_C_DEF_BEGIN(PST_STUB_C_DEF, FILE*, tmpfile, NO_VARARGS, __PST_THROW_OLD_LIBC)
    {
        ...
        */
        ...
        ret = _silent_stub_fun_random_FILE_ptr();
        #ifdef FILE_IO_WRITE
            FILE_IO_WRITE(ret);
        #else
            make_polyspace_random_FILE(ret);
        #endif /* POLYSPACE_NO_IO_WRITE */
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_fopen)
...
#if defined(__polyspace_fdopen)
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_fdopen)
#if !defined(NO_CHECKS_INLINING) && !defined(__polyspace_no_inlined_fdopen)
    #pragma POLYSPACE_INLINE_CHECKS "fdopen"
#endif /* !NO_CHECKS_INLINING */
#undef fdopen

#undef PST_STUB_C_DEF_BEGIN
#undef RETURN
#if CUSTOM_STUB_TYPE(fdopen, 2)
    #define PST_STUB_C_DEF_BEGIN PST_STUB_C_CUSTOM_TYPE_2
    #define RETURN(x) RETURN_CUSTOM_TYPE(fdopen, x)
#else
    #define PST_STUB_C_DEF_BEGIN PST_STUB_C_STD_TYPE_2
    #define RETURN(x) return (x)
#endif
    ...
    PST_STUB_C_DEF_BEGIN(PST_STUB_C_DEF, FILE*, fdopen, int, fd, const char *, mode, NO_VARARGS, __PST_THROW_OLD_LIBC)
    {
        FILE* ret;
#pragma polyspace_value_info STD_LIB_value_type("VALUE") "second argument (mode)"
#pragma Inspection_Point mode
...
#pragma polyspace_check_info
    ...
    PST_STUB_C_DEF_END
#endif
#endif /* __polyspace_fdopen */


#if defined(__polyspace_freopen)
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_freopen)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_setbuf)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_fprintf)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_fscanf)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_printf)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_scanf)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_sprintf)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_sscanf)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_fgetc)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_fgets)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_fputc)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_fputs)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_getc)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_getchar)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_gets)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_putc)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_putchar)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_puts)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_ungetc)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_fread)
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_FAT_PTR_STD_LIB") writable_array_message("first argument (output buffer)")
        ASSERT_IS_WRITABLE_ARRAY(char, ptr, size * nitems);
#pragma polyspace_check_info

        read_sz = _polyspace_random_int();
        APPLY_CONSTRAINT(read_sz <= nitems);
        for (i = 0; i < read_sz * size; i++) {
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_fwrite)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_fgetpos)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_fseek)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_fsetpos)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_ftell)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_rewind)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_clearerr)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_feof)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_ferror)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_perror)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_fileno)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_atof)
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_NO_MISRA") valid_string_message("argument (string buffer)")
        ASSERT_IS_VALID_STRING(s);
#pragma polyspace_check_info
        /*
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_atoi)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_atol)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_strtod)
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_NO_MISRA") valid_string_message("first argument (string buffer)")
        ASSERT_IS_VALID_STRING(str);
#pragma polyspace_check_info
        if (endptr != 0) {
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_NO_MISRA") writable_pointer_message("second argument (output address)")
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_strtol)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_strtoul)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_rand)
...
#endif //defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_rand)
#endif /* __polyspace_rand */

#if defined(__polyspace_srand)
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_srand)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_atexit)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_at_quick_exit)
...
#if (defined __cplusplus) && defined(__polyspace_at_quick_exit_is_extern_cpp)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_getenv)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_system)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_abs)
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_INT_STD_LIB_NO_MISRA") expected_range_message("argument", "[INT_MIN+1..INT_MAX]")
        assert(x != -__INT_MAX__ - 1);
#pragma polyspace_check_info
        if (x >= 0)
            res = x;
        else
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_div)
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_INT_STD_LIB_NO_MISRA") arg_green_orange_red_message("second argument (denominator)", "is non-zero", "may be zero", "is zero", "")
        ASSERT_IS_VALID_CONDITION(denom != 0);
#pragma polyspace_check_info

#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_INT_STD_LIB_NO_MISRA") arg_green_orange_red_message("return value", "does not overflow", "may overflow", "definitely overflow", "")
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_labs)
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_INT_STD_LIB_NO_MISRA") expected_range_message("argument", "[LONG_MIN+1..LONG_MAX]")
        assert(x != -__LONG_MAX__ - 1);
#pragma polyspace_check_info
        if (x >= 0)
            res = x;
        else
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_ldiv)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_lldiv)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_mblen)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_mbtowc)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_wctomb)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_mbstowcs)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_wcstombs)
...
#pragma Inspection_Point s
        ;
#pragma polyspace_value_info
#pragma polyspace_value_info STD_LIB_value_type("POINTER_ALLOCATION") "second argument (wide char buffer)"
#pragma Inspection_Point pwcs
        ;
#pragma polyspace_value_info
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_realloc)
...
#else
PST_STUB_C_DECL(void *, malloc,  (size_t)) __PST_THROW;
PST_STUB_C_DECL(void,free,(void *)) __PST_THROW;
#endif /* __cplusplus */
...
#pragma polyspace_value_info STD_LIB_value_type("VALUE") "second argument (size)"
#pragma Inspection_Point ptr
        ;
#pragma polyspace_value_info
//Add an always true check to always get a STD__LIB check
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_MEM_STD_LIB_NO_MISRA") ("size is positive or zero","size may be positive","size is not positive")
    assert (0 == 0);
#pragma polyspace_check_info
        ...
        if (size == 0) {            /*
              ...
              is freed.
            */
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_MEM_STD_LIB_NO_MISRA") ("pointer can be freed", "the pointer may not be freed", "pointer cannot be freed")
            free(ptr);
            #if defined(__polyspace_analyze_deallocation_operations)
            __ps_builtin_free(ptr);
            #endif
#pragma polyspace_check_info
            RETURN(0);
        }
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_MEM_STD_LIB_NO_MISRA") readable_pointer_message("first argument (pointer)")
             ...
             */
            ASSERT_IS_READABLE_POINTER(char, ptr); /* only check readability */
#pragma polyspace_check_info
        /*
        ...
        */
        if (_polyspace_random_int())
            RETURN(ptr);
        /*
          Otherwise, allocate a new object and copy the object pointer by 'ptr'
          to it, either entirely or up to 'size'.
          The best would be to use memcpy(tmp_ptr,ptr,_polyspace_random_int())
          but this does not compile
         */
        void* tmp_ptr = (void*) malloc(size);
        /*
        ...
        if (tmp_ptr == (void*) 0)
            return tmp_ptr;
        if (_polyspace_random_int())
            *(((char*)tmp_ptr)+_polyspace_random_int()) = *(((char*)ptr)+_polyspace_random_int());
        RETURN(tmp_ptr);
    }
    PST_STUB_C_DEF_END
#endif
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_17") valid_string_message("argument")
        ASSERT_IS_VALID_STRING(s);
#pragma polyspace_check_info
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_strcpy)
...
#ifdef PST_BUG_FINDER
//In Bug finder the argument adaptation is needed (likely for pattern matching in C-ME). In code
//prover it leads to imprecision.
#define PST_STUB_C_DEF_BEGIN PST_STUB_C_CUSTOM_TYPE_ARG_RENAMING_2
#else
#define PST_STUB_C_DEF_BEGIN PST_STUB_C_CUSTOM_TYPE_2
#endif
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_17") valid_string_message("second argument (source)")
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_17") arg_green_orange_red_message("first argument (destination)", "has the correct size", "may not be the correct size", "is not the correct size", "")
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_strncpy)
...
#undef RETURN
    ...
    //In Bug finder the argument adaptation is needed (likely for pattern matching in C-ME). In code
    //prover it leads to imprecision.
#define PST_STUB_C_DEF_BEGIN PST_STUB_C_CUSTOM_TYPE_ARG_RENAMING_3
#else
#define PST_STUB_C_DEF_BEGIN PST_STUB_C_CUSTOM_TYPE_3
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_18") bounded_valid_string_message("second argument (source)", "third argument (n)")
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_BUFFER_OVERFLOW") arg_green_orange_red_message("first argument (destination)", "is", "may not be", "is not", " allocated enough to receive the copied string")
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_strcat)
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_17") valid_string_message("first argument (destination)")
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_strncat)
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_18") valid_string_message("first argument (destination)")
        ASSERT_IS_VALID_STRING(s1);
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_memcmp)
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_MEM_STD_LIB_MISRA") arg_green_orange_red_message("first argument", "is", "may not be", "is not",  " a memory area that is accessible within the boundary given by the third argument")
        ASSERT_IS_READABLE_ARRAY_EXCEPT_ZERO(char, s1, n);
#pragma polyspace_check_info

#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_MEM_STD_LIB_MISRA") arg_green_orange_red_message("second argument", "is", "may not be", "is not",  " a memory area that is accessible within the boundary given by the third argument")
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_strcmp)
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_17") valid_string_message("first argument (first string)")
        ASSERT_IS_VALID_STRING(s1);
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_17") valid_string_message("second argument (second string)")
        ASSERT_IS_VALID_STRING(s2);
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_strcoll)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_strncmp)
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_18") bounded_valid_string_message("first argument (first string)", "third argument (n)")
        ASSERT_IS_BOUNDED_VALID_STRING(s1, n);
#pragma polyspace_check_info
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_18") bounded_valid_string_message("second argument (second string)", "third argument (n)")
        ASSERT_IS_BOUNDED_VALID_STRING(s2, n);
#pragma polyspace_check_info
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_strxfrm)
...
#ifdef PST_BUG_FINDER
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_18") arg_green_orange_red_message("second argument (source)", "is", "may not be", "is not",  " a memory area that is accessible within the boundary given by the third argument")
        ASSERT_IS_READABLE_ARRAY_EXCEPT_ZERO(char, s2, n);
#pragma polyspace_check_info
#else
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_18") arg_green_orange_red_message("second argument (source)", "is", "may not be", "is not",  " a memory area that is accessible within the boundary given by the third argument")
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_18") arg_green_orange_red_message("first argument (destination)", "is", "may not be", "is not",  " a memory area that is accessible within the boundary given by the third argument")
            ASSERT_IS_WRITABLE_ARRAY_EXCEPT_ZERO(char, s1, n);
#pragma polyspace_check_info
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_18") writable_array_message("first argument (destination)")
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_memchr)
...
#ifdef PST_BUG_FINDER
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_18") arg_green_orange_red_message("first argument", "is", "may not be", "is not",  " a memory area that is accessible within the boundary given by the third argument")
            ASSERT_IS_READABLE_ARRAY_EXCEPT_ZERO(char, p, n);
#pragma polyspace_check_info
#endif

#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_MEM_STD_LIB_MISRA") arg_green_orange_red_message("first argument", "contains the value given by the second argument or is accessible", "may not be an initialized memory area accessible", "is not an initialized memory area accessible",  " at the offset given by the third argument")
        for (i=0; i<n; i++)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_strchr)
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_17") valid_string_message("first argument")
        ASSERT_IS_VALID_STRING(s);
#pragma polyspace_check_info
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_strcspn)
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_17") valid_string_message("first argument")
        ASSERT_IS_VALID_STRING(s1);
#pragma polyspace_check_info
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_17") valid_string_message("second argument (characters to reject)")
        ASSERT_IS_VALID_STRING(s2);
#pragma polyspace_check_info
        /*
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_strpbrk)
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_17") valid_string_message("first argument")
        ASSERT_IS_VALID_STRING(s1);
#pragma polyspace_check_info
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_17") valid_string_message("second argument (characters to accept)")
        ASSERT_IS_VALID_STRING(s2);
#pragma polyspace_check_info
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_strrchr)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_strspn)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_strstr)
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_17") valid_string_message("second argument (substring)")
        ASSERT_IS_VALID_STRING(s2);
#pragma polyspace_check_info
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_strtok)
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_17") valid_string_message("first argument")
            ASSERT_IS_VALID_STRING(s1);
#pragma polyspace_check_info
            _polyspace_token_save = (char*)s1;
        }
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_MISRA_21_17") valid_string_message("second argument (separator characters)")
        ASSERT_IS_VALID_STRING(s2);
#pragma polyspace_check_info
        ...
        */
        index = _polyspace_random_int();
        APPLY_CONSTRAINT(index >= 0 && index < len);
        ret = (char*)(&_polyspace_token_save[index]);
        /*
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_strerror)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_strdup)
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_NO_MISRA") valid_string_message("argument")
        ASSERT_IS_VALID_STRING(s);
#pragma polyspace_check_info
        len = __ps_builtin_strlen(s);
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_strndup)
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_STR_STD_LIB_NO_BUFFER_OVERFLOW_NO_MISRA") bounded_valid_string_message("first argument (string)", "second argument (n)")
...
PST_STUB_C_DEF_BEGIN(PST_STUB_C_DEF, OS_EVENT*, OSMutexCreate, INT8U, prio, INT8U*, err, NO_VARARGS, __PST_THROW)
{
  ...
  */
  ...
  OS_EVENT* return_sem = (OS_EVENT*)malloc(sizeof(*return_sem));
...
#pragma polyspace_check_info STD_LIB_type("PS_INTERNAL_MEM_STD_LIB_NO_MISRA") arg_green_orange_red_message("arguments", "are valid memory areas or the number of bytes to compare is zero", "may not be valid memory areas", "are not valid memory areas", "")
        for (i=0; i < n; i++) {
            if (p[i] != q[i]) {
                res = 1;
                break;
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_chdir)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_sleep)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_unlink)
...
#pragma POLYSPACE_POLYMORPHIC "open"
    ...
    extern "C" typedef int mode_t;  // TODO BRD20231113 Should we keep this?
#else
    #include <fcntl.h>
#endif
...
#pragma POLYSPACE_POLYMORPHIC "creat"
    ...
    /* C++/5930 : sigsetjmp must be recognized on all modes */
...
#pragma polyspace_check_info
     ...
     * fact, the conversion from 'fd_set *' to 'void *' is implicit for
     * all calls to FD_ISSET).
     */
#if defined(__polyspace___polyspace_macro_FD_ISSET) && !defined(__polyspace_no_FD_ISSET) && defined(__PST_POLYSPACE_MODE)
#if defined(__cplusplus)
...
#if defined(__polyspace___polyspace_macro_FD_SET) && !defined(__polyspace_no_FD_SET) && defined(__PST_POLYSPACE_MODE)
#if defined(__cplusplus)
...
#if defined(__polyspace___polyspace_macro_FD_ZERO) && !defined(__polyspace_no_FD_ZERO) && defined(__PST_POLYSPACE_MODE)
#if defined(__cplusplus)
...
#if defined(__polyspace___polyspace_macro_FD_CLR) && !defined(__polyspace_no_FD_CLR) && defined(__PST_POLYSPACE_MODE)
#if defined(__cplusplus)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_signal)
...
#if defined(__PST_POLYSPACE_MODE) && !defined(__polyspace_no_raise)
...
#pragma POLYSPACE_PURE polyspace_fake_task
    ...
    ****************************************************************************/
        ...
        */
            ...
            #if defined(__PST_POLYSPACE_MODE)
#undef __ctype_b // TODO BRD20231113 Should we keep these types
...
#undef char
char * volatile __polyspace_absolute_address;
