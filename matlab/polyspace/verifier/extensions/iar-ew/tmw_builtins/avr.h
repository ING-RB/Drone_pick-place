...
#ifndef _IAR_EW_BUILTINS_AVR_H_
#define _IAR_EW_BUILTINS_AVR_H_

/*
 * Intrinsic Functions from IAR Embedded Workbench for AVR version V6.80.6.1079.
 */

#if defined(__TMW_COMPILER_IAREW__) && defined(__TMW_TARGET_AVR__)
...
#endif /* __TMW_COMPILER_IAREW__ && __TMW_TARGET_AVR__ */

#endif /* _IAR_EW_BUILTINS_AVR_H_ */
