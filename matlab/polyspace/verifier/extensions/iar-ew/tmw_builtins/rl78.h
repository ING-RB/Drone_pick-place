...
#ifndef _IAR_EW_BUILTINS_RL78_H_
#define _IAR_EW_BUILTINS_RL78_H_

/*
   Intrinsic Functions from IAR Embedded Workbench for RL78 version V7.80.2.
*/

#if defined(__TMW_COMPILER_IAREW__) && defined(__TMW_TARGET_RL78__)
...
#endif /* __TMW_COMPILER_IAREW__ && __TMW_TARGET_RL78__ */

#endif /* _IAR_EW_BUILTINS_RL78_H_ */
