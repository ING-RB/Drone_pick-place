...
// See more details at https://ieeexplore.ieee.org/document/7557075
    ...
    public:
        ...
        FactorIMU(const int* ids, const double& sampleRate,
            const double* gravityAcceleration,
            const double* gyroBiasNoise,
            const double* accelBiasNoise,
            const double* gyroNoise,
            const double* accelNoise,
            const double* gyroReadings,
            const double* accelReadings,
            const size_t& numReadings,
            const double* sensorTform = nullptr) : Factor() {
        ...
        void setData(const double& sampleRate, const double* gravityAcceleration, const double* gyroBiasNoise,
            const double* accelBiasNoise, const double* gyroNoise, const double* accelNoise, const double* gyroReadings,
            const double* accelReadings, const size_t& numReadings, const double* sensorTform){
    ...
    public:
        FactorIMUGS(const int* ids, const double& sampleRate,
            const double* gravityAcceleration,
            const double* gyroBiasNoise,
            const double* accelBiasNoise,
            const double* gyroNoise,
            ...
            const double* accelReadings,
            const size_t& numReadings,
            const double* sensorTform = nullptr) {
    ...
    public:
        FactorIMUGST(const int* ids, const double& sampleRate,
            const double* gravityAcceleration,
            const double* gyroBiasNoise,
            const double* accelBiasNoise,
            const double* gyroNoise,
